...
_.HeaderConstants = {
	...
	BREWFEST_HEADER = -1000193,
	CHILDRENS_WEEK_HEADER = -1000195,
	COMMON_BOSS_DROPS = -1000010,
	COMMON_VENDOR_ITEMS = -1000013,
	CRAFTED_ITEMS = -1000014,
	DARKMOON_FAIRE_HEADER = -1000196,
	DAY_OF_THE_DEAD_HEADER = -1000202,
	DISCOVERY = -1000016,
	EXPLORATION = -1000019,
	FACTIONS = -1000020,
	FEAST_OF_WINTER_VEIL_HEADER = -1000210,
	FLIGHT_PATHS = -1000021,
	HALLOWS_END_HEADER = -1000212,
	HARVEST_FESTIVAL_HEADER = -1000213,
	HOLIDAYS = -1000025,
	HONOR_TITLES = -1000142,
	IN_GAME_SHOP = -1000097,
	LOVE_IS_IN_THE_AIR_HEADER = -1000215,
	LUNAR_FESTIVAL_HEADER = -1000216,
	MIDSUMMER_FIRE_FESTIVAL_HEADER = -1000218,
	NOBLEGARDEN_HEADER = -1000219,
	PILGRIMS_BOUNTY_HEADER = -1000220,
	PIRATES_DAY_HEADER = -1000221,
	PROFESSIONS = -1000030,
	PVP = -1000144,
...
localize(L.HEADER_NAMES, {
	...
	[-1000192] = C_Map.GetAreaInfo(1769),
	[-1000193] = select(1,GetCategoryInfo(162)),
	[-1000195] = select(1,GetCategoryInfo(163)),
	[-1000196] = "Darkmoon Faire",
	[-1000202] = "Day of the Dead",
	[-1000210] = GetSpellInfo(21953),
	[-1000212] = select(1,GetCategoryInfo(158)),
	[-1000213] = "Harvest Festival",
	[-1000214] = "Kalu'ak Fishing Derby",
	[-1000215] = select(1,GetCategoryInfo(187)),
	[-1000216] = select(1,GetCategoryInfo(160)),
	[-1000218] = "Midsummer Fire Festival",
	[-1000219] = select(1,GetCategoryInfo(159)),
	[-1000220] = select(1,GetCategoryInfo(14981)),
	[-1000221] = "Pirates' Day",
	[-1000222] = "Stranglethorn Fishing Extravaganza",
	[-1000226] = "WoW's Anniversary",
	[-1000227] = select(2,GetAchievementInfo(2398)),
	[-1000228] = select(2,GetAchievementInfo(4400)),
	[-1000243] = select(1,GetCategoryInfo(14941)),
	[-1000244] = "Elemental Unrest",
	[-1000245] = select(2, GetAchievementInfo(4786)),
	[-1000246] = "The Ahn'Qiraj War Effort",
	[-1000247] = "The Opening of the Dark Portal",
	[-1000248] = "The Scepter of the Shifting Sands",
	[-1000249] = "The Scourge Invasion",
	[-1000250] = "The Silithyst Must Flow",
	[-1000251] = select(2, GetAchievementInfo(4790)),
	[-1000255] = "BlizzCon",
	[-1000256] = "Collector's Edition",
	[-1000257] = "Heroic Edition",
	[-1000258] = "Epic Edition",
	[-1000259] = "TBC Classic Deluxe Edition",
	[-1000260] = "WotLK Classic Northrend Upgrade",
	[-1000261] = "Cata Classic Blazing Upgrade",
	[-1000268] = "Starcraft II: Wings of Liberty",
	[-1000275] = "iCoke",
	[-1000276] =  AUCTION_CATEGORY_MISCELLANEOUS,
	[-1000277] = REFER_A_FRIEND,
	[-1000279] = "Spirit of Competition",
	[-1000280] = BATTLE_PET_SOURCE_9,
	[-1000283] = "Ensembles",
	[-1000284] = "Arsenals",
	[-1000285] = "Sourceless",
});
...
localize(L.HEADER_ICONS, {
	...
	[-1000192] = _.asset("achievement_reputation_timbermaw"),
	[-1000193] = _.asset("Holiday_brewfest"),
	[-1000195] = _.asset("Holiday_Children"),
	[-1000196] = _.asset("Event_dmf"),
	[-1000202] = _.asset("Holiday_Day_of_the_Dead"),
	[-1000210] = _.asset("Holiday_winter_veil"),
	[-1000212] = _.asset("Holiday_hallows_end"),
	[-1000213] = _.asset("Holiday_Harvestfest"),
	[-1000214] = "Interface/Icons/inv_fishingpole_03",
	[-1000215] = _.asset("Holiday_love"),
	[-1000216] = _.asset("Holiday_Lunar"),
	[-1000218] = _.asset("Holiday_Midsummer"),
	[-1000219] = _.asset("Holiday_noblegarden"),
	[-1000220] = _.asset("Holiday_Pilgrim"),
	[-1000221] = _.asset("Holiday_Pirate"),
	[-1000222] = "Interface/Icons/inv_misc_fish_06",
	[-1000226] = "Interface/Icons/inv_misc_celebrationcake_01",
	[-1000227] = "Interface/Icons/inv_misc_celebrationcake_01",
	[-1000228] = "Interface/Icons/inv_misc_celebrationcake_01",
	[-1000243] = "Interface/Icons/achievement_reputation_argentchampion",
	[-1000244] = _.asset("Expansion_CATA"),
	[-1000245] = "Interface/Icons/inv_misc_tournaments_symbol_gnome",
	[-1000246] = "Interface/Icons/inv_box_01",
	[-1000247] = "Interface/Icons/achievement_dungeon_outland_dungeonmaster",
	[-1000248] = "Interface/Icons/Inv_hammer_25",
	[-1000249] = "Interface/Icons/inv_stone_02",
	[-1000250] = "Interface/Icons/spell_holiday_tow_spicecloud",
	[-1000251] = "Interface/Icons/inv_misc_tournaments_banner_troll",
	[-1000255] = _.asset("Promotion_Blizzcon"),
	[-1000256] = _.asset("Promotion_Collector"),
	[-1000257] = _.asset("Weapon_Type_Heirloom"),
	[-1000258] = _.asset("Weapon_Type_Legendary"),
	[-1000259] = _.asset("Expansion_TBC"),
	[-1000260] = _.asset("Expansion_WOTLK"),
	[-1000261] = _.asset("Expansion_CATA"),
	[-1000268] = "Interface/Icons/Inv_sigil_thorim",
	[-1000275] = "Interface/Icons/Inv_drink_10",
	[-1000276] = "Interface/Icons/Spell_Misc_Drink",
	[-1000277] = "Interface/Icons/achievement_reputation_08",
	[-1000279] = "Interface/Icons/inv_jewelry_amulet_03",
	[-1000280] = "Interface/Icons/inv_misc_ticket_tarot_stack_01",
	[-1000283] = "Interface/Icons/inv_chest_leather_08",
	[-1000284] = "Interface/Icons/inv_mace_1h_bastionquest_b_02",
	[-1000285] = "Interface/Icons/inv_misc_questionmark",
});
...
localize(L.HEADER_NAMES, {
	...
	[-1000196] = "Dunkelmond-Jahrmarkt",
	[-1000202] = "Tag der Toten",
	[-1000214] = "Angelwettstreit der Kalu'ak",
	[-1000218] = "Sonnenwendfest",
	[-1000221] = "Piratentag",
	[-1000222] = "Anglerwettbewerb im Schlingendorntal",
	[-1000247] = "Die Öffnung des Dunklen Portals",
	[-1000248] = "Das Szepter der Sandstürme",
});
localize(L.HEADER_DESCRIPTIONS, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000196] = "Feria de la Luna Negra",
	[-1000202] = "Festividad de los Muertos",
	[-1000214] = "Competición de pesca Kalu'ak",
	[-1000218] = "Festival del Fuego del Solsticio de Verano",
	[-1000221] = "Día de los Piratas",
	[-1000222] = "Gran espectáculo de pesca de Tuercespina",
	[-1000247] = "La apertura del Portal Oscuro",
	[-1000248] = "El cetro del Mar de Dunas",
});
localize(L.HEADER_DESCRIPTIONS, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000196] = "Foire de Sombrelune",
	[-1000202] = "Jour des morts",
	[-1000214] = "Le tournoi de pêche kalu'ak",
	[-1000218] = "Fête du Feu du solstice d’été",
	[-1000221] = "Jour des pirates",
	[-1000222] = "Concours de pêche de Strangleronce",
	[-1000246] = "Effort de guerre d’Ahn'Qiraj",
	[-1000247] = "L'ouverture de la Porte des ténèbres",
	[-1000248] = "Le Sceptre des Sables changeants",
	[-1000256] = "Edition Collector",
	[-1000259] = "Édition BC Classic Deluxe",
});
localize(L.HEADER_DESCRIPTIONS, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000196] = "Fiera di Lunacupa",
	[-1000202] = "Giorno dei Morti",
	[-1000214] = "La gara di pesca dei Kalu'ak",
	[-1000218] = "Fuochi di Mezza Estate",
	[-1000221] = "Giorno dei Pirati",
	[-1000222] = "Gara di Pesca a Rovotorto",
	[-1000247] = "L'apertura del Portale Oscuro",
	[-1000248] = "Scettro delle Sabbie Mutevoli",
});
localize(_.ObjectNames, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000196] = "Feira de Negraluna",
	[-1000202] = "Dia dos Mortos",
	[-1000214] = "Campeonato de Pesca dos Kalu'ak",
	[-1000218] = "Festival do Fogo do Solstício",
	[-1000221] = "Dia dos Piratas",
	[-1000222] = "Festerê de Pesca da Selva do Espinhaço",
	[-1000247] = "A abertura do Portal Negro",
	[-1000248] = "Cetro das Areias Cambiantes",
});
localize(L.HEADER_DESCRIPTIONS, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000196] = "Ярмарка Новолуния",
	[-1000202] = "День мертвых",
	[-1000213] = "Неделя урожая",
	[-1000214] = "Калуакское рыбоборье",
	[-1000218] = "Огненный Солнцеворот",
	[-1000221] = "День пирата",
	[-1000222] = "Рыбомания Тернистой долины",
	[-1000226] = "Годовщина WoW",
	[-1000244] = "Буйство элементалей",
	[-1000246] = "Война в Ан'Кираже",
	[-1000247] = "Открытие Темного портала",
	[-1000248] = "Скипетр Зыбучих песков",
	[-1000249] = "Вторжение Плети",
	[-1000256] = "Коллекционное издание",
	[-1000285] = "Без Источника",
});
localize(L.HEADER_DESCRIPTIONS, {
