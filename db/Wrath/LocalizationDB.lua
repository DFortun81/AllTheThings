...
_.HeaderConstants = {
	...
	PILGRIMS_BOUNTY_HEADER = -1000194,
	PIRATES_DAY_HEADER = -1000195,
	PROFESSIONS = -1000028,
	PVP = -1000140,
...
localize(L.HEADER_NAMES, {
	...
	[-1000194] = select(1,GetCategoryInfo(14981)),
	[-1000195] = "Pirates' Day",
	[-1000197] = "Stranglethorn Fishing Extravaganza",
	[-1000201] = "WoW's Anniversary",
	[-1000202] = select(2,GetAchievementInfo(2398)),
	[-1000203] = select(2,GetAchievementInfo(4400)),
	[-1000218] = select(1,GetCategoryInfo(14941)),
	[-1000219] = "Elemental Unrest",
	[-1000220] = select(2, GetAchievementInfo(4786)),
	[-1000221] = "The Ahn'Qiraj War Effort",
	[-1000222] = "The Opening of the Dark Portal",
	[-1000223] = "The Scepter of the Shifting Sands",
	[-1000224] = "The Scourge Invasion",
	[-1000225] = "The Silithyst Must Flow",
	[-1000226] = select(2, GetAchievementInfo(4790)),
	[-1000230] = "BlizzCon",
	[-1000231] = "Collector's Edition",
	[-1000232] = "Dark Portal Pass",
	[-1000237] = "Starcraft II: Wings of Liberty",
	[-1000240] = "TBC Classic Deluxe Edition",
	[-1000242] = "WotLK Classic Northrend Heroic Upgrade",
	[-1000243] = "WotLK Classic Northrend Epic Upgrade",
	[-1000248] = "iCoke",
	[-1000249] =  AUCTION_CATEGORY_MISCELLANEOUS,
	[-1000250] = REFER_A_FRIEND,
	[-1000252] = "Spirit of Competition",
...
localize(L.HEADER_DESCRIPTIONS, {
	...
	[-1000201] = "This is a yearly recurring event that occurs between the beginning of November and the end of the year.",
...
localize(L.HEADER_ICONS, {
	...
	[-1000194] = _.asset("Holiday_Pilgrim"),
	[-1000195] = _.asset("Holiday_Pirate"),
	...
	[-1000218] = "Interface/Icons/achievement_reputation_argentchampion",
	[-1000219] = _.asset("Expansion_CATA"),
	[-1000220] = "Interface/Icons/inv_misc_tournaments_symbol_gnome",
	[-1000221] = "Interface/Icons/inv_box_01",
	[-1000222] = "Interface/Icons/achievement_dungeon_outland_dungeonmaster",
	[-1000223] = "Interface/Icons/Inv_hammer_25",
	[-1000224] = "Interface/Icons/inv_stone_02",
	[-1000225] = "Interface/Icons/spell_holiday_tow_spicecloud",
	[-1000226] = "Interface/Icons/inv_misc_tournaments_banner_troll",
	[-1000230] = _.asset("Promotion_Blizzcon"),
	[-1000231] = _.asset("Promotion_Collector"),
	[-1000232] = "Interface/Icons/achievement_dungeon_outland_dungeonmaster",
	[-1000237] = "Interface/Icons/Inv_sigil_thorim",
	[-1000240] = _.asset("Expansion_TBC"),
	[-1000242] = _.asset("Expansion_WOTLK"),
	[-1000243] = _.asset("Expansion_WOTLK"),
	[-1000248] = "Interface/Icons/Inv_drink_10",
	...
	[-1000253] = "Interface/Icons/inv_misc_ticket_tarot_stack_01",
...
localize(L.HEADER_NAMES, {
	...
	[-1000222] = "Die Öffnung des Dunklen Portals",
	[-1000223] = "Das Szepter der Sandstürme",
	[-1000232] = "Pass zum Dunklen Portal",
});
localize(L.HEADER_DESCRIPTIONS, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000195] = "Día de los Piratas",
	[-1000197] = "Gran espectáculo de pesca de Tuercespina",
	[-1000222] = "La apertura del Portal Oscuro",
	[-1000223] = "El cetro del Mar de Dunas",
	[-1000232] = "Pase para el Portal Oscuro",
});
localize(L.HEADER_DESCRIPTIONS, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000195] = "Jour des pirates",
	[-1000197] = "Concours de pêche de Strangleronce",
	[-1000221] = "Effort de guerre d’Ahn'Qiraj",
	[-1000222] = "L'ouverture de la Porte des ténèbres",
	[-1000223] = "Le Sceptre des Sables changeants",
	[-1000231] = "Edition Collector",
	[-1000232] = "Passe Porte des ténèbres",
	[-1000240] = "Édition BC Classic Deluxe",
});
localize(L.HEADER_DESCRIPTIONS, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000195] = "Giorno dei Pirati",
	[-1000197] = "Gara di Pesca a Rovotorto",
	[-1000222] = "L'apertura del Portale Oscuro",
	[-1000223] = "Scettro delle Sabbie Mutevoli",
});
localize(L.ObjectNames, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000195] = "Dia dos Piratas",
	[-1000197] = "Festerê de Pesca da Selva do Espinhaço",
	[-1000222] = "A abertura do Portal Negro",
	[-1000223] = "Cetro das Areias Cambiantes",
	[-1000232] = "Passe do Portal Negro",
});
localize(L.HEADER_DESCRIPTIONS, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000219] = "Буйство элементалей",
	[-1000221] = "Война в Ан'Кираже",
	[-1000222] = "Открытие Темного портала",
	[-1000223] = "Скипетр Зыбучих песков",
	[-1000224] = "Вторжение Плети",
	[-1000231] = "Коллекционное издание",
	[-1000232] = "Пропуск Темного портала",
...
localize(L.HEADER_NAMES, {
	...
	[-1000232] = "穿过黑暗之门",
	[-1000237] = "星际争霸II：自由之翼",
	[-1000240] = "燃烧的远征经典怀旧服典藏包",
	[-1000242] = "巫妖王之怒经典怀旧服诺森德英雄礼包",
	[-1000243] = "巫妖王之怒经典怀旧服诺森德史诗礼包",
	[-1000248] = "可口可乐活动",
	[-1000257] = "无来源",
});
localize(L.HEADER_DESCRIPTIONS, {
