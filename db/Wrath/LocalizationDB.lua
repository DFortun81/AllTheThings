...
localize(L.HEADER_NAMES, {
	...
	[-1000203] = "WoW's Anniversary",
	[-1000204] = select(2,GetAchievementInfo(2398)),
	[-1000205] = select(2,GetAchievementInfo(4400)),
	[-1000220] = select(1,GetCategoryInfo(14941)),
	[-1000221] = "Elemental Unrest",
	[-1000222] = select(2, GetAchievementInfo(4786)),
	[-1000223] = "The Ahn'Qiraj War Effort",
	[-1000224] = "The Opening of the Dark Portal",
	[-1000225] = "The Scepter of the Shifting Sands",
	[-1000226] = "The Scourge Invasion",
	[-1000227] = "The Silithyst Must Flow",
	[-1000228] = select(2, GetAchievementInfo(4790)),
	[-1000232] = "BlizzCon",
	[-1000233] = "Collector's Edition",
	[-1000234] = "Dark Portal Pass",
	[-1000239] = "Starcraft II: Wings of Liberty",
	[-1000242] = "TBC Classic Deluxe Edition",
	[-1000244] = "WotLK Classic Northrend Heroic Upgrade",
	[-1000245] = "WotLK Classic Northrend Epic Upgrade",
	[-1000250] = "iCoke",
	[-1000251] =  AUCTION_CATEGORY_MISCELLANEOUS,
	[-1000252] = REFER_A_FRIEND,
	[-1000254] = "Spirit of Competition",
	[-1000255] = BATTLE_PET_SOURCE_9,
	[-1000257] = "Ensembles",
	[-1000258] = "Arsenals",
	[-1000259] = "Sourceless",
});
localize(L.HEADER_DESCRIPTIONS, {
	...
	[-1000245] = "These rewards were made available to anyone who purchased a Northrend Heroic Upgrade for WotLK Classic. (not to be confused with the original Wrath of the Lich King Collector's Edition)",
	[-1000250] = "These were only available through the 2006 iCoke Promotion (China Only)",
	[-1000251] = "This section is for miscellaneous promotions that took place in the real world or something to do with account management.",
	[-1000254] = "This is a Battlegrounds-based event that coincides with the beginning of the Summer Olympic games. The only time this was celebrated was in 2008 to correspond to the Beijing Olympics, and although there appeared to be the intention to repeat this event, it never returned.",
	[-1000259] = "This Category contains Things that probably exist in the game but no known source.",
});
...
localize(L.HEADER_ICONS, {
	...
	[-1000220] = "Interface/Icons/achievement_reputation_argentchampion",
	[-1000221] = _.asset("Expansion_CATA"),
	[-1000222] = "Interface/Icons/inv_misc_tournaments_symbol_gnome",
	[-1000223] = "Interface/Icons/inv_box_01",
	[-1000224] = "Interface/Icons/achievement_dungeon_outland_dungeonmaster",
	[-1000225] = "Interface/Icons/Inv_hammer_25",
	[-1000226] = "Interface/Icons/inv_stone_02",
	[-1000227] = "Interface/Icons/spell_holiday_tow_spicecloud",
	[-1000228] = "Interface/Icons/inv_misc_tournaments_banner_troll",
	[-1000232] = _.asset("Promotion_Blizzcon"),
	[-1000233] = _.asset("Promotion_Collector"),
	[-1000234] = "Interface/Icons/achievement_dungeon_outland_dungeonmaster",
	[-1000239] = "Interface/Icons/Inv_sigil_thorim",
	[-1000242] = _.asset("Expansion_TBC"),
	[-1000244] = _.asset("Expansion_WOTLK"),
	[-1000245] = _.asset("Expansion_WOTLK"),
	[-1000250] = "Interface/Icons/Inv_drink_10",
	[-1000251] = "Interface/Icons/Spell_Misc_Drink",
	[-1000252] = "Interface/Icons/achievement_reputation_08",
	[-1000254] = "Interface/Icons/inv_jewelry_amulet_03",
	[-1000255] = "Interface/Icons/inv_misc_ticket_tarot_stack_01",
	[-1000257] = "Interface/Icons/inv_chest_leather_08",
	[-1000258] = "Interface/Icons/inv_mace_1h_bastionquest_b_02",
	[-1000259] = "Interface/Icons/inv_misc_questionmark",
});
...
localize(L.HEADER_NAMES, {
	...
	[-1000224] = "Die Öffnung des Dunklen Portals",
	[-1000225] = "Das Szepter der Sandstürme",
	[-1000234] = "Pass zum Dunklen Portal",
});
localize(L.HEADER_DESCRIPTIONS, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000224] = "La apertura del Portal Oscuro",
	[-1000225] = "El cetro del Mar de Dunas",
	[-1000234] = "Pase para el Portal Oscuro",
});
localize(L.HEADER_DESCRIPTIONS, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000223] = "Effort de guerre d’Ahn'Qiraj",
	[-1000224] = "L'ouverture de la Porte des ténèbres",
	[-1000225] = "Le Sceptre des Sables changeants",
	[-1000233] = "Edition Collector",
	[-1000234] = "Passe Porte des ténèbres",
	[-1000242] = "Édition BC Classic Deluxe",
});
localize(L.HEADER_DESCRIPTIONS, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000224] = "L'apertura del Portale Oscuro",
	[-1000225] = "Scettro delle Sabbie Mutevoli",
});
localize(_.ObjectNames, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000224] = "A abertura do Portal Negro",
	[-1000225] = "Cetro das Areias Cambiantes",
	[-1000234] = "Passe do Portal Negro",
});
localize(L.HEADER_DESCRIPTIONS, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000221] = "Буйство элементалей",
	[-1000223] = "Война в Ан'Кираже",
	[-1000224] = "Открытие Темного портала",
	[-1000225] = "Скипетр Зыбучих песков",
	[-1000226] = "Вторжение Плети",
	[-1000233] = "Коллекционное издание",
	[-1000234] = "Пропуск Темного портала",
	[-1000259] = "Без Источника",
});
localize(L.HEADER_DESCRIPTIONS, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000234] = "穿过黑暗之门",
	[-1000239] = "星际争霸II：自由之翼",
	[-1000242] = "燃烧的远征经典怀旧服典藏包",
	[-1000244] = "巫妖王之怒经典怀旧服诺森德英雄礼包",
	[-1000245] = "巫妖王之怒经典怀旧服诺森德史诗礼包",
	[-1000250] = "可口可乐活动",
	[-1000259] = "无来源",
});
localize(L.HEADER_DESCRIPTIONS, {
