...
_.HeaderConstants = {
	...
	DISCOVERY = -1000015,
	DRAGONRIDING_CUP_HEADER = -1000183,
	EXPLORATION = -1000018,
	FACTIONS = -1000019,
	...
	PILGRIMS_BOUNTY_HEADER = -1000200,
	PIRATES_DAY_HEADER = -1000201,
	PROFESSIONS = -1000028,
	PVP = -1000140,
...
localize(L.HEADER_NAMES, {
	...
	[-1000183] = "Dragonriding Cup",
	[-1000190] = GetSpellInfo(21953),
	[-1000192] = select(1,GetCategoryInfo(158)),
	[-1000193] = "Harvest Festival",
	[-1000194] = "Kalu'ak Fishing Derby",
	[-1000195] = select(1,GetCategoryInfo(187)),
	[-1000196] = select(1,GetCategoryInfo(160)),
	[-1000198] = "Midsummer Fire Festival",
	[-1000199] = select(1,GetCategoryInfo(159)),
	[-1000200] = select(1,GetCategoryInfo(14981)),
	[-1000201] = "Pirates' Day",
...
localize(L.HEADER_DESCRIPTIONS, {
	...
	[-1000264] = "This Category contains Things that probably exist in the game but no known source.",
});
...
localize(L.HEADER_ICONS, {
	...
	[-1000200] = _.asset("Holiday_Pilgrim"),
	[-1000201] = _.asset("Holiday_Pirate"),
	...
	[-1000262] = "Interface/Icons/inv_chest_leather_08",
	[-1000263] = "Interface/Icons/inv_mace_1h_bastionquest_b_02",
	[-1000264] = "Interface/Icons/inv_misc_questionmark",
});
...
localize(L.HEADER_NAMES, {
	...
	[-1000194] = "Angelwettstreit der Kalu'ak",
...
localize(L.HEADER_NAMES, {
	...
	[-1000194] = "Competición de pesca Kalu'ak",
	[-1000198] = "Festival del Fuego del Solsticio de Verano",
	[-1000201] = "Día de los Piratas",
...
localize(L.HEADER_NAMES, {
	...
	[-1000194] = "Le tournoi de pêche kalu'ak",
	[-1000198] = "Fête du Feu du solstice d’été",
	[-1000201] = "Jour des pirates",
...
localize(L.HEADER_NAMES, {
	...
	[-1000194] = "La gara di pesca dei Kalu'ak",
	[-1000198] = "Fuochi di Mezza Estate",
	[-1000201] = "Giorno dei Pirati",
...
localize(L.HEADER_NAMES, {
	...
	[-1000194] = "Campeonato de Pesca dos Kalu'ak",
	[-1000198] = "Festival do Fogo do Solstício",
	[-1000201] = "Dia dos Piratas",
