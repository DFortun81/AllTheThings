...
_.HeaderConstants = {
	...
	DAY_OF_THE_DEAD_HEADER = -1000182,
	DISCOVERY = -1000015,
	EXPLORATION = -1000018,
	FACTIONS = -1000019,
	FEAST_OF_WINTER_VEIL_HEADER = -1000184,
	FLIGHT_PATHS = -1000020,
	HALLOWS_END_HEADER = -1000186,
	HARVEST_FESTIVAL_HEADER = -1000187,
	HOLIDAYS = -1000023,
	HONOR_TITLES = -1000138,
	IN_GAME_SHOP = -1000093,
	LOVE_IS_IN_THE_AIR_HEADER = -1000190,
	LUNAR_FESTIVAL_HEADER = -1000191,
	MIDSUMMER_FIRE_FESTIVAL_HEADER = -1000193,
	NOBLEGARDEN_HEADER = -1000194,
	PILGRIMS_BOUNTY_HEADER = -1000196,
	PIRATES_DAY_HEADER = -1000197,
	PROFESSIONS = -1000028,
	PVP = -1000140,
...
localize(L.HEADER_NAMES, {
	...
	[-1000172] = C_Map.GetAreaInfo(1216),
	[-1000173] = select(1,GetCategoryInfo(162)),
	[-1000175] = select(1,GetCategoryInfo(163)),
	[-1000176] = "Darkmoon Faire",
	[-1000182] = "Day of the Dead",
	[-1000184] = GetSpellInfo(21953),
	[-1000186] = select(1,GetCategoryInfo(158)),
	[-1000187] = "Harvest Festival",
	[-1000189] = "Kalu'ak Fishing Derby",
	[-1000190] = select(1,GetCategoryInfo(187)),
	[-1000191] = select(1,GetCategoryInfo(160)),
	[-1000193] = "Midsummer Fire Festival",
	[-1000194] = select(1,GetCategoryInfo(159)),
	[-1000196] = select(1,GetCategoryInfo(14981)),
	[-1000197] = "Pirates' Day",
...
localize(L.HEADER_ICONS, {
	...
	[-1000172] = _.asset("achievement_reputation_timbermaw"),
	[-1000173] = _.asset("Holiday_brewfest"),
	[-1000175] = _.asset("Holiday_Children"),
	[-1000176] = _.asset("Event_dmf"),
	[-1000182] = _.asset("Holiday_Day_of_the_Dead"),
	[-1000184] = _.asset("Holiday_winter_veil"),
	[-1000186] = _.asset("Holiday_hallows_end"),
	[-1000187] = _.asset("Holiday_Harvestfest"),
	[-1000189] = "Interface/Icons/inv_fishingpole_03",
	[-1000190] = _.asset("Holiday_love"),
	[-1000191] = _.asset("Holiday_Lunar"),
	[-1000193] = _.asset("Holiday_Midsummer"),
	[-1000194] = _.asset("Holiday_noblegarden"),
	[-1000196] = _.asset("Holiday_Pilgrim"),
	[-1000197] = _.asset("Holiday_Pirate"),
...
localize(L.HEADER_NAMES, {
	...
	[-1000182] = "Tag der Toten",
	[-1000189] = "Angelwettstreit der Kalu'ak",
	[-1000193] = "Sonnenwendfest",
	[-1000197] = "Piratentag",
...
localize(L.HEADER_NAMES, {
	...
	[-1000182] = "Festividad de los Muertos",
	[-1000189] = "Competición de pesca Kalu'ak",
	[-1000193] = "Festival del Fuego del Solsticio de Verano",
	[-1000197] = "Día de los Piratas",
...
localize(L.HEADER_NAMES, {
	...
	[-1000182] = "Jour des morts",
	[-1000189] = "Le tournoi de pêche kalu'ak",
	[-1000193] = "Fête du Feu du solstice d’été",
	[-1000197] = "Jour des pirates",
...
localize(L.HEADER_NAMES, {
	...
	[-1000182] = "Giorno dei Morti",
	[-1000189] = "La gara di pesca dei Kalu'ak",
	[-1000193] = "Fuochi di Mezza Estate",
	[-1000197] = "Giorno dei Pirati",
...
localize(L.HEADER_NAMES, {
	...
	[-1000182] = "Dia dos Mortos",
	[-1000189] = "Campeonato de Pesca dos Kalu'ak",
	[-1000193] = "Festival do Fogo do Solstício",
	[-1000197] = "Dia dos Piratas",
...
localize(L.HEADER_NAMES, {
	...
	[-1000182] = "День мертвых",
	[-1000189] = "Калуакское рыбоборье",
	[-1000193] = "Огненный Солнцеворот",
	[-1000197] = "День пирата",
