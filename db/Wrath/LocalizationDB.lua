...
_.HeaderConstants = {
	...
	PILGRIMS_BOUNTY_HEADER = -1000199,
	PIRATES_DAY_HEADER = -1000200,
	PROFESSIONS = -1000028,
	PVP = -1000140,
...
localize(L.HEADER_NAMES, {
	...
	[-1000191] = select(1,GetCategoryInfo(158)),
	[-1000192] = "Harvest Festival",
	[-1000193] = "Kalu'ak Fishing Derby",
	[-1000194] = select(1,GetCategoryInfo(187)),
	[-1000195] = select(1,GetCategoryInfo(160)),
	[-1000197] = "Midsummer Fire Festival",
	[-1000198] = select(1,GetCategoryInfo(159)),
	[-1000199] = select(1,GetCategoryInfo(14981)),
	[-1000200] = "Pirates' Day",
	[-1000203] = "Stranglethorn Fishing Extravaganza",
	[-1000207] = "WoW's Anniversary",
	[-1000208] = select(2,GetAchievementInfo(2398)),
	[-1000209] = select(2,GetAchievementInfo(4400)),
	[-1000224] = select(1,GetCategoryInfo(14941)),
	[-1000225] = "Elemental Unrest",
	[-1000226] = select(2, GetAchievementInfo(4786)),
	[-1000227] = "The Ahn'Qiraj War Effort",
	[-1000228] = "The Opening of the Dark Portal",
	[-1000229] = "The Scepter of the Shifting Sands",
	[-1000230] = "The Scourge Invasion",
	[-1000231] = "The Silithyst Must Flow",
	[-1000232] = select(2, GetAchievementInfo(4790)),
	[-1000236] = "BlizzCon",
	[-1000237] = "Collector's Edition",
	[-1000238] = "Dark Portal Pass",
	[-1000243] = "Starcraft II: Wings of Liberty",
	[-1000246] = "TBC Classic Deluxe Edition",
	[-1000248] = "WotLK Classic Northrend Heroic Upgrade",
	[-1000249] = "WotLK Classic Northrend Epic Upgrade",
	[-1000254] = "iCoke",
	[-1000255] =  AUCTION_CATEGORY_MISCELLANEOUS,
	[-1000256] = REFER_A_FRIEND,
	[-1000258] = "Spirit of Competition",
	[-1000259] = BATTLE_PET_SOURCE_9,
	[-1000261] = "Ensembles",
	[-1000262] = "Arsenals",
	[-1000263] = "Sourceless",
});
localize(L.HEADER_DESCRIPTIONS, {
	...
	[-1000248] = "These rewards were made available to anyone who purchased a Northrend Heroic Upgrade for WotLK Classic. (not to be confused with the original Wrath of the Lich King Collector's Edition)",
	...
	[-1000258] = "This is a Battlegrounds-based event that coincides with the beginning of the Summer Olympic games. The only time this was celebrated was in 2008 to correspond to the Beijing Olympics, and although there appeared to be the intention to repeat this event, it never returned.",
...
localize(L.HEADER_ICONS, {
	...
	[-1000193] = "Interface/Icons/inv_fishingpole_03",
	...
	[-1000199] = _.asset("Holiday_Pilgrim"),
	[-1000200] = _.asset("Holiday_Pirate"),
	...
	[-1000224] = "Interface/Icons/achievement_reputation_argentchampion",
	[-1000225] = _.asset("Expansion_CATA"),
	[-1000226] = "Interface/Icons/inv_misc_tournaments_symbol_gnome",
	[-1000227] = "Interface/Icons/inv_box_01",
	[-1000228] = "Interface/Icons/achievement_dungeon_outland_dungeonmaster",
	[-1000229] = "Interface/Icons/Inv_hammer_25",
	[-1000230] = "Interface/Icons/inv_stone_02",
	[-1000231] = "Interface/Icons/spell_holiday_tow_spicecloud",
	[-1000232] = "Interface/Icons/inv_misc_tournaments_banner_troll",
	[-1000236] = _.asset("Promotion_Blizzcon"),
	[-1000237] = _.asset("Promotion_Collector"),
	[-1000238] = "Interface/Icons/achievement_dungeon_outland_dungeonmaster",
	...
	[-1000254] = "Interface/Icons/Inv_drink_10",
	[-1000255] = "Interface/Icons/Spell_Misc_Drink",
	[-1000256] = "Interface/Icons/achievement_reputation_08",
	[-1000258] = "Interface/Icons/inv_jewelry_amulet_03",
	[-1000259] = "Interface/Icons/inv_misc_ticket_tarot_stack_01",
	[-1000261] = "Interface/Icons/inv_chest_leather_08",
...
localize(L.HEADER_NAMES, {
	...
	[-1000193] = "Angelwettstreit der Kalu'ak",
	[-1000197] = "Sonnenwendfest",
	[-1000200] = "Piratentag",
	[-1000203] = "Anglerwettbewerb im Schlingendorntal",
	[-1000228] = "Die Öffnung des Dunklen Portals",
	[-1000229] = "Das Szepter der Sandstürme",
	[-1000238] = "Pass zum Dunklen Portal",
});
localize(L.HEADER_DESCRIPTIONS, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000193] = "Competición de pesca Kalu'ak",
	[-1000197] = "Festival del Fuego del Solsticio de Verano",
	[-1000200] = "Día de los Piratas",
	[-1000203] = "Gran espectáculo de pesca de Tuercespina",
	[-1000228] = "La apertura del Portal Oscuro",
	[-1000229] = "El cetro del Mar de Dunas",
	[-1000238] = "Pase para el Portal Oscuro",
});
localize(L.HEADER_DESCRIPTIONS, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000193] = "Le tournoi de pêche kalu'ak",
	[-1000197] = "Fête du Feu du solstice d’été",
	[-1000200] = "Jour des pirates",
	[-1000203] = "Concours de pêche de Strangleronce",
	[-1000227] = "Effort de guerre d’Ahn'Qiraj",
	[-1000228] = "L'ouverture de la Porte des ténèbres",
	[-1000229] = "Le Sceptre des Sables changeants",
	[-1000237] = "Edition Collector",
	[-1000238] = "Passe Porte des ténèbres",
...
localize(L.HEADER_NAMES, {
	...
	[-1000193] = "La gara di pesca dei Kalu'ak",
	[-1000197] = "Fuochi di Mezza Estate",
	[-1000200] = "Giorno dei Pirati",
	[-1000203] = "Gara di Pesca a Rovotorto",
	[-1000228] = "L'apertura del Portale Oscuro",
	[-1000229] = "Scettro delle Sabbie Mutevoli",
});
localize(_.ObjectNames, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000193] = "Campeonato de Pesca dos Kalu'ak",
	[-1000197] = "Festival do Fogo do Solstício",
	[-1000200] = "Dia dos Piratas",
	[-1000203] = "Festerê de Pesca da Selva do Espinhaço",
	[-1000228] = "A abertura do Portal Negro",
	[-1000229] = "Cetro das Areias Cambiantes",
	[-1000238] = "Passe do Portal Negro",
});
localize(L.HEADER_DESCRIPTIONS, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000193] = "Калуакское рыбоборье",
	[-1000197] = "Огненный Солнцеворот",
	[-1000200] = "День пирата",
	[-1000203] = "Рыбомания Тернистой долины",
	[-1000225] = "Буйство элементалей",
	[-1000227] = "Война в Ан'Кираже",
	[-1000228] = "Открытие Темного портала",
	[-1000229] = "Скипетр Зыбучих песков",
	[-1000230] = "Вторжение Плети",
	[-1000237] = "Коллекционное издание",
	[-1000238] = "Пропуск Темного портала",
