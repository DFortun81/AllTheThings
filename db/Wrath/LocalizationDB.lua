...
_.HeaderConstants = {
	...
	BREWFEST_HEADER = -1000174,
	CHILDRENS_WEEK_HEADER = -1000176,
	COMMON_BOSS_DROPS = -1000009,
	COMMON_VENDOR_ITEMS = -1000012,
	CRAFTED_ITEMS = -1000013,
	DARKMOON_FAIRE_HEADER = -1000177,
	DAY_OF_THE_DEAD_HEADER = -1000183,
	DISCOVERY = -1000015,
	EXPLORATION = -1000018,
	FACTIONS = -1000019,
	FEAST_OF_WINTER_VEIL_HEADER = -1000191,
	FLIGHT_PATHS = -1000020,
	HALLOWS_END_HEADER = -1000193,
	HARVEST_FESTIVAL_HEADER = -1000194,
	HOLIDAYS = -1000023,
	HONOR_TITLES = -1000138,
	IN_GAME_SHOP = -1000094,
	LOVE_IS_IN_THE_AIR_HEADER = -1000196,
	LUNAR_FESTIVAL_HEADER = -1000197,
	MIDSUMMER_FIRE_FESTIVAL_HEADER = -1000199,
	NOBLEGARDEN_HEADER = -1000200,
	PILGRIMS_BOUNTY_HEADER = -1000201,
	PIRATES_DAY_HEADER = -1000202,
	PROFESSIONS = -1000028,
	PVP = -1000140,
...
localize(L.HEADER_NAMES, {
	...
	[-1000081] = BLACK_MARKET_AUCTION_HOUSE,
	[-1000091] = FACTION_ALLIANCE,
	[-1000092] = FACTION_HORDE,
	[-1000093] = COMBATLOG_FILTER_STRING_NEUTRAL_UNITS,
	[-1000094] = BATTLE_PET_SOURCE_10,
	[-1000096] = ITEM_QUALITY1_DESC,
	...
	[-1000174] = select(1,GetCategoryInfo(162)),
	[-1000176] = select(1,GetCategoryInfo(163)),
	[-1000177] = "Darkmoon Faire",
	[-1000183] = "Day of the Dead",
	[-1000191] = GetSpellInfo(21953),
	[-1000193] = select(1,GetCategoryInfo(158)),
	[-1000194] = "Harvest Festival",
	[-1000195] = "Kalu'ak Fishing Derby",
	[-1000196] = select(1,GetCategoryInfo(187)),
	[-1000197] = select(1,GetCategoryInfo(160)),
	[-1000199] = "Midsummer Fire Festival",
	[-1000200] = select(1,GetCategoryInfo(159)),
	[-1000201] = select(1,GetCategoryInfo(14981)),
	[-1000202] = "Pirates' Day",
	[-1000205] = "Stranglethorn Fishing Extravaganza",
	[-1000209] = "WoW's Anniversary",
	[-1000210] = select(2,GetAchievementInfo(2398)),
	[-1000211] = select(2,GetAchievementInfo(4400)),
	[-1000226] = select(1,GetCategoryInfo(14941)),
	[-1000227] = "Elemental Unrest",
	[-1000228] = select(2, GetAchievementInfo(4786)),
	[-1000229] = "The Ahn'Qiraj War Effort",
	[-1000230] = "The Opening of the Dark Portal",
	[-1000231] = "The Scepter of the Shifting Sands",
	[-1000232] = "The Scourge Invasion",
	[-1000233] = "The Silithyst Must Flow",
	[-1000234] = select(2, GetAchievementInfo(4790)),
	[-1000238] = "BlizzCon",
	[-1000239] = "Collector's Edition",
	[-1000240] = "Dark Portal Pass",
	[-1000245] = "Starcraft II: Wings of Liberty",
	[-1000248] = "TBC Classic Deluxe Edition",
	[-1000250] = "WotLK Classic Northrend Heroic Upgrade",
	[-1000251] = "WotLK Classic Northrend Epic Upgrade",
	[-1000256] = "iCoke",
	[-1000257] =  AUCTION_CATEGORY_MISCELLANEOUS,
...
localize(L.HEADER_DESCRIPTIONS, {
	...
	[-1000094] = "This section will show you things that you could buy in the In-Game Shop in Retail.",
...
localize(L.HEADER_ICONS, {
	...
	[-1000081] = _.asset("Category_Blackmarket"),
	[-1000091] = "Interface/FriendsFrame/PlusManz-Alliance",
	[-1000092] = "Interface/FriendsFrame/PlusManz-Horde",
	[-1000093] = "Interface/FriendsFrame/PlusManz-PlusManz",
	[-1000094] = _.asset("Category_InGameShop"),
	[-1000096] = "Interface/Icons/Inv_shirt_white_01",
	...
	[-1000173] = _.asset("achievement_reputation_timbermaw"),
	[-1000174] = _.asset("Holiday_brewfest"),
	[-1000176] = _.asset("Holiday_Children"),
	[-1000177] = _.asset("Event_dmf"),
	[-1000183] = _.asset("Holiday_Day_of_the_Dead"),
	[-1000191] = _.asset("Holiday_winter_veil"),
	[-1000193] = _.asset("Holiday_hallows_end"),
	[-1000194] = _.asset("Holiday_Harvestfest"),
	[-1000195] = "Interface/Icons/inv_fishingpole_03",
	[-1000196] = _.asset("Holiday_love"),
	[-1000197] = _.asset("Holiday_Lunar"),
	[-1000199] = _.asset("Holiday_Midsummer"),
	[-1000200] = _.asset("Holiday_noblegarden"),
	[-1000201] = _.asset("Holiday_Pilgrim"),
	[-1000202] = _.asset("Holiday_Pirate"),
	...
	[-1000226] = "Interface/Icons/achievement_reputation_argentchampion",
	[-1000227] = _.asset("Expansion_CATA"),
	[-1000228] = "Interface/Icons/inv_misc_tournaments_symbol_gnome",
	[-1000229] = "Interface/Icons/inv_box_01",
	[-1000230] = "Interface/Icons/achievement_dungeon_outland_dungeonmaster",
	[-1000231] = "Interface/Icons/Inv_hammer_25",
	[-1000232] = "Interface/Icons/inv_stone_02",
	[-1000233] = "Interface/Icons/spell_holiday_tow_spicecloud",
	[-1000234] = "Interface/Icons/inv_misc_tournaments_banner_troll",
	[-1000238] = _.asset("Promotion_Blizzcon"),
	[-1000239] = _.asset("Promotion_Collector"),
	[-1000240] = "Interface/Icons/achievement_dungeon_outland_dungeonmaster",
	[-1000245] = "Interface/Icons/Inv_sigil_thorim",
	[-1000248] = _.asset("Expansion_TBC"),
	[-1000250] = _.asset("Expansion_WOTLK"),
	[-1000251] = _.asset("Expansion_WOTLK"),
	[-1000256] = "Interface/Icons/Inv_drink_10",
	[-1000257] = "Interface/Icons/Spell_Misc_Drink",
...
localize(L.HEADER_NAMES, {
	...
	[-1000177] = "Dunkelmond-Jahrmarkt",
	[-1000183] = "Tag der Toten",
	[-1000195] = "Angelwettstreit der Kalu'ak",
	[-1000199] = "Sonnenwendfest",
	[-1000202] = "Piratentag",
	[-1000205] = "Anglerwettbewerb im Schlingendorntal",
	[-1000230] = "Die Öffnung des Dunklen Portals",
	[-1000231] = "Das Szepter der Sandstürme",
	[-1000240] = "Pass zum Dunklen Portal",
});
localize(L.HEADER_DESCRIPTIONS, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000177] = "Feria de la Luna Negra",
	[-1000183] = "Festividad de los Muertos",
	[-1000195] = "Competición de pesca Kalu'ak",
	[-1000199] = "Festival del Fuego del Solsticio de Verano",
	[-1000202] = "Día de los Piratas",
	[-1000205] = "Gran espectáculo de pesca de Tuercespina",
	[-1000230] = "La apertura del Portal Oscuro",
	[-1000231] = "El cetro del Mar de Dunas",
	[-1000240] = "Pase para el Portal Oscuro",
});
localize(L.HEADER_DESCRIPTIONS, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000177] = "Foire de Sombrelune",
	[-1000183] = "Jour des morts",
	[-1000195] = "Le tournoi de pêche kalu'ak",
	[-1000199] = "Fête du Feu du solstice d’été",
	[-1000202] = "Jour des pirates",
	[-1000205] = "Concours de pêche de Strangleronce",
	[-1000229] = "Effort de guerre d’Ahn'Qiraj",
	[-1000230] = "L'ouverture de la Porte des ténèbres",
	[-1000231] = "Le Sceptre des Sables changeants",
	[-1000239] = "Edition Collector",
	[-1000240] = "Passe Porte des ténèbres",
	[-1000248] = "Édition BC Classic Deluxe",
});
localize(L.HEADER_DESCRIPTIONS, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000177] = "Fiera di Lunacupa",
	[-1000183] = "Giorno dei Morti",
	[-1000195] = "La gara di pesca dei Kalu'ak",
	[-1000199] = "Fuochi di Mezza Estate",
	[-1000202] = "Giorno dei Pirati",
	[-1000205] = "Gara di Pesca a Rovotorto",
	[-1000230] = "L'apertura del Portale Oscuro",
	[-1000231] = "Scettro delle Sabbie Mutevoli",
});
localize(_.ObjectNames, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000177] = "Feira de Negraluna",
	[-1000183] = "Dia dos Mortos",
	[-1000195] = "Campeonato de Pesca dos Kalu'ak",
	[-1000199] = "Festival do Fogo do Solstício",
	[-1000202] = "Dia dos Piratas",
	[-1000205] = "Festerê de Pesca da Selva do Espinhaço",
	[-1000230] = "A abertura do Portal Negro",
	[-1000231] = "Cetro das Areias Cambiantes",
	[-1000240] = "Passe do Portal Negro",
});
localize(L.HEADER_DESCRIPTIONS, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000177] = "Ярмарка Новолуния",
	[-1000183] = "День мертвых",
	[-1000194] = "Неделя урожая",
	[-1000195] = "Калуакское рыбоборье",
	[-1000199] = "Огненный Солнцеворот",
	[-1000202] = "День пирата",
	[-1000205] = "Рыбомания Тернистой долины",
	[-1000209] = "Годовщина WoW",
	[-1000227] = "Буйство элементалей",
	[-1000229] = "Война в Ан'Кираже",
	[-1000230] = "Открытие Темного портала",
	[-1000231] = "Скипетр Зыбучих песков",
