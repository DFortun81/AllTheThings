...
_.HeaderConstants = {
	...
	DAY_OF_THE_DEAD_HEADER = -1000181,
	DISCOVERY = -1000015,
	EXPLORATION = -1000018,
	FACTIONS = -1000019,
	FEAST_OF_WINTER_VEIL_HEADER = -1000183,
	FLIGHT_PATHS = -1000020,
	HALLOWS_END_HEADER = -1000185,
	HARVEST_FESTIVAL_HEADER = -1000186,
	HOLIDAYS = -1000023,
	HONOR_TITLES = -1000137,
	IN_GAME_SHOP = -1000093,
	LOVE_IS_IN_THE_AIR_HEADER = -1000189,
	LUNAR_FESTIVAL_HEADER = -1000190,
	MIDSUMMER_FIRE_FESTIVAL_HEADER = -1000192,
	NOBLEGARDEN_HEADER = -1000193,
	PILGRIMS_BOUNTY_HEADER = -1000195,
	PIRATES_DAY_HEADER = -1000196,
	PROFESSIONS = -1000028,
	PVP = -1000139,
	PVP_GLADIATOR = -1000136,
	QUESTS = -1000029,
	RARES = -1000030,
	REWARDS = -1000031,
	SPECIAL = -1000035,
	TIER_ZERO_POINT_FIVE_SETS = -1000145,
	TREASURES = -1000036,
	VENDORS = -1000037,
	WEAPONS = -1000071,
...
localize(L.HEADER_NAMES, {
	...
	[-1000100] = ITEM_QUALITY5_DESC,
	[-1000102] = ITEM_QUALITY0_DESC,
	[-1000110] = "Patch 1.x.x",
	[-1000111] = "Patch 2.x.x",
	[-1000112] = "Patch 3.x.x",
	[-1000119] = "Armor Enchantments",
	[-1000121] = "Weapon Enchantments",
	[-1000123] = select(2, GetAchievementInfo(2091))..": Season 1",
	[-1000124] = select(2, GetAchievementInfo(418))..": Season 2",
	[-1000125] = select(2, GetAchievementInfo(419))..": Season 3",
	[-1000126] = select(2, GetAchievementInfo(420))..": Season 4",
	[-1000127] = select(2, GetAchievementInfo(3336))..": Season 5",
	[-1000128] = "Hateful Gladiator",
	[-1000129] = select(2, GetAchievementInfo(3436))..": Season 6",
	[-1000130] = select(2, GetAchievementInfo(3758))..": Season 7",
	[-1000131] = select(2, GetAchievementInfo(4599))..": Season 8",
	[-1000132] = BATTLEGROUNDS,
	[-1000135] = "Elite Gear",
	[-1000136] = "Gladiator Gear",
	[-1000137] = "Honor Titles",
	[-1000138] = HONOR,
	[-1000139] = PVP,
	[-1000144] = "Crieve's Never Implemeneted List",
	[-1000145] = "Tier 0.5 Sets",
	[-1000146] = "Captains",
	[-1000147] = "Silithid Royalty",
	[-1000148] = "The Four Horsemen",
	[-1000149] = DUNGEON_FLOOR_BLACKROCKDEPTHS1,
	[-1000150] = DUNGEON_FLOOR_BLACKROCKDEPTHS2,
	[-1000151] = DUNGEON_FLOOR_BLACKROCKSPIRE3,
	[-1000152] = DUNGEON_FLOOR_UPPERBLACKROCKSPIRE1,
	[-1000153] = DUNGEON_FLOOR_DIREMAUL5.." (East)",
	[-1000154] = DUNGEON_FLOOR_DIREMAUL1.." (North)",
	[-1000155] = DUNGEON_FLOOR_DIREMAUL2.." (West)",
	[-1000156] = GetSpellInfo(21127),
	[-1000157] = DUNGEON_FLOOR_DESOLACE22.." (Orange Path)",
	[-1000158] = DUNGEON_FLOOR_DESOLACE21.." (Purple Path)",
	[-1000159] = "Graveyard",
	[-1000160] = "Library",
	[-1000161] = "Armory",
	[-1000162] = "Cathedral",
	[-1000163] = "Main Gate",
	[-1000164] = "Service Entrance",
	[-1000165] = "Atal'ai Defenders",
	[-1000166] = "Storming the Citadel",
	[-1000167] = "The Plagueworks",
	[-1000168] = C_Map.GetAreaInfo(4892),
	[-1000169] = "The Frostwing Halls",
	[-1000171] = C_Map.GetAreaInfo(1769),
	[-1000172] = select(1,GetCategoryInfo(162)),
	[-1000174] = select(1,GetCategoryInfo(163)),
	[-1000175] = "Darkmoon Faire",
	[-1000181] = "Day of the Dead",
	[-1000183] = GetSpellInfo(21953),
	[-1000185] = select(1,GetCategoryInfo(158)),
	[-1000186] = "Harvest Festival",
	[-1000188] = "Kalu'ak Fishing Derby",
	[-1000189] = select(1,GetCategoryInfo(187)),
	[-1000190] = select(1,GetCategoryInfo(160)),
	[-1000192] = "Midsummer Fire Festival",
	[-1000193] = select(1,GetCategoryInfo(159)),
	[-1000195] = select(1,GetCategoryInfo(14981)),
	[-1000196] = "Pirates' Day",
	[-1000198] = "Stranglethorn Fishing Extravaganza",
	[-1000202] = "WoW's Anniversary",
	[-1000203] = select(2,GetAchievementInfo(2398)),
	[-1000204] = select(2,GetAchievementInfo(4400)),
	[-1000219] = select(1,GetCategoryInfo(14941)),
	[-1000220] = "Elemental Unrest",
	[-1000221] = select(2, GetAchievementInfo(4786)),
	[-1000222] = "The Ahn'Qiraj War Effort",
	[-1000223] = "The Opening of the Dark Portal",
	[-1000224] = "The Scepter of the Shifting Sands",
	[-1000225] = "The Scourge Invasion",
	[-1000226] = "The Silithyst Must Flow",
	[-1000227] = select(2, GetAchievementInfo(4790)),
	[-1000231] = "BlizzCon",
	[-1000232] = "Collector's Edition",
	[-1000233] = "Dark Portal Pass",
	[-1000238] = "Starcraft II: Wings of Liberty",
	[-1000241] = "TBC Classic Deluxe Edition",
	[-1000243] = "WotLK Classic Northrend Heroic Upgrade",
	[-1000244] = "WotLK Classic Northrend Epic Upgrade",
	[-1000249] = "iCoke",
	[-1000250] =  AUCTION_CATEGORY_MISCELLANEOUS,
	[-1000251] = REFER_A_FRIEND,
	[-1000253] = "Spirit of Competition",
	[-1000254] = BATTLE_PET_SOURCE_9,
	[-1000256] = "Ensembles",
	[-1000257] = "Arsenals",
	[-1000258] = "Sourceless",
});
localize(L.HEADER_DESCRIPTIONS, {
	...
	[-1000144] = "If the following are sorted somewhere, please delete them from this list. Thanks.",
	[-1000151] = "Also known as 'Lower' Blackrock Spire.",
	[-1000152] = "One member of your group must have completed the Seal of Ascension quest chain in order for the fires to light and the door to open to this portion of the instance. Also known as 'Upper' Blackrock Spire.",
	[-1000153] = "This part of the instance can be accessed from the eastern-most portal. (right side)",
	[-1000154] = "This part of the instance can be accessed from the northern-most portal.",
	[-1000155] = "This part of the instance can be accessed from the western-most portal. (left side)",
...
localize(L.HEADER_ICONS, {
	...
	[-1000100] = _.asset("Weapon_Type_Legendary"),
	[-1000102] = "Interface/Icons/Inv_shirt_grey_01",
	[-1000110] = _.asset("Expansion_CLASSIC"),
	[-1000111] = _.asset("Expansion_TBC"),
	[-1000112] = _.asset("Expansion_WOTLK"),
	[-1000119] = "237019",
	[-1000121] = "237018",
	[-1000123] = "Interface/Icons/achievement_featsofstrength_gladiator_01",
	[-1000124] = "Interface/Icons/achievement_featsofstrength_gladiator_02",
	[-1000125] = "Interface/Icons/achievement_featsofstrength_gladiator_03",
	[-1000126] = "Interface/Icons/achievement_featsofstrength_gladiator_04",
	...
	[-1000132] = "Interface/Icons/INV_BannerPVP_03",
	[-1000135] = "Interface/Worldmap/GlowSkull_64Red",
	[-1000136] = "Interface/Worldmap/GlowSkull_64Purple",
	[-1000137] = "Interface/Icons/inv_sword_48",
	[-1000138] = "Interface/Icons/inv_jewelry_amulet_03",
	[-1000139] = _.asset("Category_PvP"),
	[-1000144] = "Interface/Icons/INV_Chest_Plate03",
	[-1000145] = "Interface/Icons/INV_Chest_Plate03",
	[-1000146] = "Interface/Icons/achievement_pvp_h_12",
	[-1000147] = "Interface/Icons/Inv_misc_ahnqirajtrinket_06",
	[-1000148] = "Interface/Icons/Ability_mount_undeadhorse",
	[-1000149] = "Interface/Icons/Achievement_Zone_Blackrock_01",
	[-1000150] = "Interface/Icons/Achievement_Zone_Blackrock_01",
	[-1000151] = _.asset("Achievement_Boss_Overlord_Wyrmthalak"),
	[-1000152] = "Interface/Icons/INV_Misc_Head_Dragon_01",
	[-1000153] = "Interface/Icons/Ability_Warlock_DemonicEmpowerment",
	[-1000154] = "Interface/Icons/Achievement_Reputation_Ogre",
	[-1000155] = "Interface/Icons/INV_Misc_Head_Elf_02",
	[-1000156] = "Interface/Icons/spell_arcane_portalironforge",
	[-1000157] = "Interface/Icons/INV_Misc_Gem_Opal_01",
	[-1000158] = "Interface/Icons/INV_Misc_Gem_Amethyst_02",
	[-1000159] = "Interface/Icons/Inv_misc_bone_humanskull_01",
	[-1000160] = "Interface/Icons/INV_Misc_Book_13",
	[-1000161] = "Interface/Icons/inv_helmet_25",
	[-1000162] = "Interface/Icons/inv_helmet_12",
	[-1000163] = "Interface/Icons/INV_Misc_Token_ScarletCrusade",
	[-1000164] = "Interface/Icons/INV_MISC_KEY_13",
	[-1000165] = "Interface/Icons/Inv_misc_head_troll_01",
	[-1000166] = "Interface/Icons/achievement_dungeon_icecrown_icecrownentrance",
	[-1000167] = "Interface/Icons/achievement_dungeon_plaguewing",
	[-1000168] = "Interface/Icons/achievement_dungeon_crimsonhall",
	[-1000169] = "Interface/Icons/achievement_dungeon_icecrown_frostwinghalls",
	[-1000171] = _.asset("achievement_reputation_timbermaw"),
	[-1000172] = _.asset("Holiday_brewfest"),
	[-1000174] = _.asset("Holiday_Children"),
	[-1000175] = _.asset("Event_dmf"),
	[-1000181] = _.asset("Holiday_Day_of_the_Dead"),
	[-1000183] = _.asset("Holiday_winter_veil"),
	[-1000185] = _.asset("Holiday_hallows_end"),
	[-1000186] = _.asset("Holiday_Harvestfest"),
	[-1000188] = "Interface/Icons/inv_fishingpole_03",
	[-1000189] = _.asset("Holiday_love"),
	[-1000190] = _.asset("Holiday_Lunar"),
	[-1000192] = _.asset("Holiday_Midsummer"),
	[-1000193] = _.asset("Holiday_noblegarden"),
	[-1000195] = _.asset("Holiday_Pilgrim"),
	[-1000196] = _.asset("Holiday_Pirate"),
	...
	[-1000219] = "Interface/Icons/achievement_reputation_argentchampion",
	[-1000220] = _.asset("Expansion_CATA"),
	[-1000221] = "Interface/Icons/inv_misc_tournaments_symbol_gnome",
	[-1000222] = "Interface/Icons/inv_box_01",
	[-1000223] = "Interface/Icons/achievement_dungeon_outland_dungeonmaster",
	[-1000224] = "Interface/Icons/Inv_hammer_25",
	[-1000225] = "Interface/Icons/inv_stone_02",
	[-1000226] = "Interface/Icons/spell_holiday_tow_spicecloud",
	[-1000227] = "Interface/Icons/inv_misc_tournaments_banner_troll",
	[-1000231] = _.asset("Promotion_Blizzcon"),
	[-1000232] = _.asset("Promotion_Collector"),
	[-1000233] = "Interface/Icons/achievement_dungeon_outland_dungeonmaster",
	[-1000238] = "Interface/Icons/Inv_sigil_thorim",
	[-1000241] = _.asset("Expansion_TBC"),
	[-1000243] = _.asset("Expansion_WOTLK"),
	[-1000244] = _.asset("Expansion_WOTLK"),
	[-1000249] = "Interface/Icons/Inv_drink_10",
	[-1000250] = "Interface/Icons/Spell_Misc_Drink",
	[-1000251] = "Interface/Icons/achievement_reputation_08",
	[-1000253] = "Interface/Icons/inv_jewelry_amulet_03",
	[-1000254] = "Interface/Icons/inv_misc_ticket_tarot_stack_01",
	[-1000256] = "Interface/Icons/inv_chest_leather_08",
	[-1000257] = "Interface/Icons/inv_mace_1h_bastionquest_b_02",
	[-1000258] = "Interface/Icons/inv_misc_questionmark",
});
...
localize(L.HEADER_NAMES, {
	...
	[-1000128] = "Hasserfüllten Gladiator",
	[-1000135] = "Elite Rüstung",
	[-1000136] = "Gladiatoren Rüstung",
	[-1000148] = "Die Vier Reiter",
	[-1000159] = "Friedhof",
	[-1000160] = "Bibliothek",
	[-1000161] = "Waffenkammer",
	[-1000162] = "Kathedrale",
	[-1000166] = "Sturm auf die Zitadelle",
	[-1000167] = "Die Seuchenwerke",
	[-1000169] = "Die Frostschwingenhallen",
	[-1000175] = "Dunkelmond-Jahrmarkt",
	[-1000181] = "Tag der Toten",
	[-1000188] = "Angelwettstreit der Kalu'ak",
	[-1000192] = "Sonnenwendfest",
	[-1000196] = "Piratentag",
	[-1000198] = "Anglerwettbewerb im Schlingendorntal",
	[-1000223] = "Die Öffnung des Dunklen Portals",
	[-1000224] = "Das Szepter der Sandstürme",
	[-1000233] = "Pass zum Dunklen Portal",
});
localize(L.HEADER_DESCRIPTIONS, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000128] = "Gladiador Odioso",
	[-1000148] = "Los Cuatro Jinetes",
	[-1000166] = "Asaltar la Ciudadela",
	[-1000167] = "Los Talleres de la Peste",
	[-1000169] = "Las Cámaras de Alaescarcha",
	[-1000175] = "Feria de la Luna Negra",
	[-1000181] = "Festividad de los Muertos",
	[-1000188] = "Competición de pesca Kalu'ak",
	[-1000192] = "Festival del Fuego del Solsticio de Verano",
	[-1000196] = "Día de los Piratas",
	[-1000198] = "Gran espectáculo de pesca de Tuercespina",
	[-1000223] = "La apertura del Portal Oscuro",
	[-1000224] = "El cetro del Mar de Dunas",
	[-1000233] = "Pase para el Portal Oscuro",
});
localize(L.HEADER_DESCRIPTIONS, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000123] = select(2, GetAchievementInfo(2091))..": Saison 1",
	[-1000124] = select(2, GetAchievementInfo(418))..": Saison 2",
	[-1000125] = select(2, GetAchievementInfo(419))..": Saison 3",
	[-1000126] = select(2, GetAchievementInfo(420))..": Saison 4",
	[-1000127] = select(2, GetAchievementInfo(3336))..": Saison 5",
	[-1000128] = "Gladiateur Haineux",
	[-1000129] = select(2, GetAchievementInfo(3436))..": Saison 6",
	[-1000130] = select(2, GetAchievementInfo(3758))..": Saison 7",
	[-1000131] = select(2, GetAchievementInfo(4599))..": Saison 8",
	[-1000135] = "Équipement Élite",
	[-1000136] = "Équipement Gladiateur",
	[-1000145] = "Ensembles Tier 0.5",
	[-1000146] = "Capitaines",
	[-1000148] = "Les quatre cavaliers",
	[-1000153] = DUNGEON_FLOOR_DIREMAUL5.." (Est)",
	[-1000154] = DUNGEON_FLOOR_DIREMAUL1.." (Nord)",
	[-1000155] = DUNGEON_FLOOR_DIREMAUL2.." (Ouest)",
	[-1000159] = "Cimetière",
	[-1000160] = "Librairie",
	[-1000161] = "Armurerie",
	[-1000162] = "Cathédrale",
	[-1000165] = "Défenseurs Atal'ai",
	[-1000166] = "La prise de la citadelle",
	[-1000167] = "La Pesterie",
	[-1000169] = "Les salles de l'Aile de givre",
	[-1000175] = "Foire de Sombrelune",
	[-1000181] = "Jour des morts",
	[-1000188] = "Le tournoi de pêche kalu'ak",
	[-1000192] = "Fête du Feu du solstice d’été",
	[-1000196] = "Jour des pirates",
	[-1000198] = "Concours de pêche de Strangleronce",
	[-1000222] = "Effort de guerre d’Ahn'Qiraj",
	[-1000223] = "L'ouverture de la Porte des ténèbres",
	[-1000224] = "Le Sceptre des Sables changeants",
	[-1000232] = "Edition Collector",
	[-1000233] = "Passe Porte des ténèbres",
	[-1000241] = "Édition BC Classic Deluxe",
});
localize(L.HEADER_DESCRIPTIONS, {
...
localize(L.HEADER_NAMES, {
	[-1000128] = "Gladiatore Perfido",
	[-1000148] = "I Cavalieri dell'Apocalisse",
	[-1000166] = "Assalto alla rocca",
	[-1000167] = "Sale della Pestilenza",
	[-1000169] = "Sale delle Ali del Gelo",
	[-1000175] = "Fiera di Lunacupa",
	[-1000181] = "Giorno dei Morti",
	[-1000188] = "La gara di pesca dei Kalu'ak",
	[-1000192] = "Fuochi di Mezza Estate",
	[-1000196] = "Giorno dei Pirati",
	[-1000198] = "Gara di Pesca a Rovotorto",
	[-1000223] = "L'apertura del Portale Oscuro",
	[-1000224] = "Scettro delle Sabbie Mutevoli",
});
localize(_.ObjectNames, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000128] = "Gladiador Odioso",
	[-1000148] = "Os Quatro Cavaleiros",
	[-1000166] = "Invasão da Cidadela",
	[-1000167] = "Antro da Peste",
	[-1000169] = "Salões da Asa Gélida",
	[-1000175] = "Feira de Negraluna",
	[-1000181] = "Dia dos Mortos",
	[-1000188] = "Campeonato de Pesca dos Kalu'ak",
	[-1000192] = "Festival do Fogo do Solstício",
	[-1000196] = "Dia dos Piratas",
	[-1000198] = "Festerê de Pesca da Selva do Espinhaço",
	[-1000223] = "A abertura do Portal Negro",
	[-1000224] = "Cetro das Areias Cambiantes",
	[-1000233] = "Passe do Portal Negro",
});
localize(L.HEADER_DESCRIPTIONS, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000123] = select(2, GetAchievementInfo(2091))..": Сезон 1",
	[-1000124] = select(2, GetAchievementInfo(418))..": Сезон 2",
	[-1000125] = select(2, GetAchievementInfo(419))..": Сезон 3",
	[-1000126] = select(2, GetAchievementInfo(420))..": Сезон 4",
	[-1000127] = select(2, GetAchievementInfo(3336))..": Сезон 5",
	[-1000128] = "Злобный гладиатор",
	[-1000129] = select(2, GetAchievementInfo(3436))..": Сезон 6",
	[-1000130] = select(2, GetAchievementInfo(3758))..": Сезон 7",
	[-1000131] = select(2, GetAchievementInfo(4599))..": Сезон 8",
	[-1000135] = "Элитные доспехи",
	[-1000136] = "Доспехи Гладиатора",
	[-1000145] = "Комплекты T0.5",
	[-1000146] = "Капитаны",
	[-1000148] = "Четыре Всадника",
	[-1000153] = DUNGEON_FLOOR_DIREMAUL5.." (Восток)",
	[-1000154] = DUNGEON_FLOOR_DIREMAUL1.." (Север)",
	[-1000155] = DUNGEON_FLOOR_DIREMAUL2.." (Запад)",
	[-1000159] = "Кладбище",
	[-1000160] = "Библиотека",
	[-1000161] = "Оружейная",
	[-1000162] = "Собор",
	[-1000165] = "Защитники Атал'ай",
	[-1000166] = "Штурм цитадели",
	[-1000167] = "Чумодельня",
	[-1000169] = "Залы Ледокрылых",
	[-1000175] = "Ярмарка Новолуния",
	[-1000181] = "День мертвых",
	[-1000188] = "Калуакское рыбоборье",
	[-1000192] = "Огненный Солнцеворот",
	[-1000196] = "День пирата",
	[-1000198] = "Рыбомания Тернистой долины",
	[-1000220] = "Буйство элементалей",
	[-1000222] = "Война в Ан'Кираже",
	[-1000223] = "Открытие Темного портала",
	[-1000224] = "Скипетр Зыбучих песков",
	[-1000225] = "Вторжение Плети",
	[-1000232] = "Коллекционное издание",
	[-1000233] = "Пропуск Темного портала",
	[-1000258] = "Без Источника",
});
localize(L.HEADER_DESCRIPTIONS, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000056] = "三箱",
	[-1000057] = "最终宝箱",
	[-1000123] = select(2, GetAchievementInfo(2091)).."：第1赛季",
	[-1000124] = select(2, GetAchievementInfo(418)).."：第2赛季",
	[-1000125] = select(2, GetAchievementInfo(419)).."：第3赛季",
	[-1000126] = select(2, GetAchievementInfo(420)).."：第4赛季",
	[-1000127] = select(2, GetAchievementInfo(3336)).."：第5赛季",
	[-1000128] = "憎恨角斗士",
	[-1000129] = select(2, GetAchievementInfo(3436)).."：第6赛季",
	[-1000130] = select(2, GetAchievementInfo(3758)).."：第7赛季",
	[-1000131] = select(2, GetAchievementInfo(4599)).."：第8赛季",
	[-1000135] = "精锐套装",
	[-1000136] = "角斗士套装",
	[-1000145] = "等级 0.5 套装",
	[-1000146] = "船长",
	[-1000148] = "四骑士",
	[-1000153] = DUNGEON_FLOOR_DIREMAUL5.." (东)",
	[-1000154] = DUNGEON_FLOOR_DIREMAUL1.." (北)",
	[-1000155] = DUNGEON_FLOOR_DIREMAUL2.." (西)",
	[-1000159] = "墓地",
	[-1000160] = "图书馆",
	[-1000161] = "武器库",
	[-1000162] = "修道院",
	...
	[-1000233] = "穿过黑暗之门",
	[-1000238] = "星际争霸II：自由之翼",
	[-1000241] = "燃烧的远征经典怀旧服典藏包",
	[-1000243] = "巫妖王之怒经典怀旧服诺森德英雄礼包",
	[-1000244] = "巫妖王之怒经典怀旧服诺森德史诗礼包",
	[-1000249] = "可口可乐活动",
	[-1000258] = "无来源",
});
localize(L.HEADER_DESCRIPTIONS, {
