...
_.HeaderConstants = {
	...
	BREWFEST_HEADER = -1000190,
	CHILDRENS_WEEK_HEADER = -1000192,
	COMMON_BOSS_DROPS = -1000010,
	COMMON_VENDOR_ITEMS = -1000013,
	CRAFTED_ITEMS = -1000014,
	DARKMOON_FAIRE_HEADER = -1000193,
	DAY_OF_THE_DEAD_HEADER = -1000199,
	DISCOVERY = -1000016,
	EXPLORATION = -1000019,
	FACTIONS = -1000020,
	FEAST_OF_WINTER_VEIL_HEADER = -1000207,
	FLIGHT_PATHS = -1000021,
	HALLOWS_END_HEADER = -1000209,
	HARVEST_FESTIVAL_HEADER = -1000210,
	HOLIDAYS = -1000025,
	HONOR_TITLES = -1000141,
	IN_GAME_SHOP = -1000096,
	LOVE_IS_IN_THE_AIR_HEADER = -1000212,
	LUNAR_FESTIVAL_HEADER = -1000213,
	MIDSUMMER_FIRE_FESTIVAL_HEADER = -1000215,
	NOBLEGARDEN_HEADER = -1000216,
	PILGRIMS_BOUNTY_HEADER = -1000217,
	PIRATES_DAY_HEADER = -1000218,
	PROFESSIONS = -1000030,
	PVP = -1000143,
	...
	REWARDS = -1000033,
	SPECIAL = -1000037,
	TIER_ZERO_POINT_FIVE_SETS = -1000162,
	TREASURES = -1000038,
	VENDORS = -1000039,
	WEAPONS = -1000073,
...
localize(L.HEADER_NAMES, {
	...
	[-1000142] = HONOR,
	[-1000143] = PVP,
	[-1000161] = "Crieve's Never Implemented List",
	[-1000162] = "Tier 0.5 Sets",
	[-1000163] = "Captains",
	[-1000164] = "Silithid Royalty",
	[-1000165] = "The Four Horsemen",
	[-1000166] = DUNGEON_FLOOR_BLACKROCKDEPTHS1,
	[-1000167] = DUNGEON_FLOOR_BLACKROCKDEPTHS2,
	[-1000168] = DUNGEON_FLOOR_BLACKROCKSPIRE3,
	[-1000169] = DUNGEON_FLOOR_UPPERBLACKROCKSPIRE1,
	[-1000170] = DUNGEON_FLOOR_DIREMAUL5.." (East)",
	[-1000171] = DUNGEON_FLOOR_DIREMAUL1.." (North)",
	[-1000172] = DUNGEON_FLOOR_DIREMAUL2.." (West)",
	[-1000173] = GetSpellInfo(21127),
	[-1000174] = DUNGEON_FLOOR_DESOLACE22.." (Orange Path)",
	[-1000175] = DUNGEON_FLOOR_DESOLACE21.." (Purple Path)",
	[-1000176] = "Graveyard",
	[-1000177] = "Library",
	[-1000178] = "Armory",
	[-1000179] = "Cathedral",
	[-1000180] = "Main Gate",
	[-1000181] = "Service Entrance",
	[-1000182] = "Atal'ai Defenders",
	[-1000183] = "Storming the Citadel",
	[-1000184] = "The Plagueworks",
	[-1000185] = C_Map.GetAreaInfo(4892),
	[-1000186] = "The Frostwing Halls",
	[-1000189] = C_Map.GetAreaInfo(1769),
	[-1000190] = select(1,GetCategoryInfo(162)),
	[-1000192] = select(1,GetCategoryInfo(163)),
	[-1000193] = "Darkmoon Faire",
	[-1000199] = "Day of the Dead",
	[-1000207] = GetSpellInfo(21953),
	[-1000209] = select(1,GetCategoryInfo(158)),
	[-1000210] = "Harvest Festival",
	[-1000211] = "Kalu'ak Fishing Derby",
	[-1000212] = select(1,GetCategoryInfo(187)),
	[-1000213] = select(1,GetCategoryInfo(160)),
	[-1000215] = "Midsummer Fire Festival",
	[-1000216] = select(1,GetCategoryInfo(159)),
	[-1000217] = select(1,GetCategoryInfo(14981)),
	[-1000218] = "Pirates' Day",
	[-1000219] = "Stranglethorn Fishing Extravaganza",
	[-1000223] = "WoW's Anniversary",
	[-1000224] = select(2,GetAchievementInfo(2398)),
	[-1000225] = select(2,GetAchievementInfo(4400)),
	[-1000240] = select(1,GetCategoryInfo(14941)),
	[-1000241] = "Elemental Unrest",
	[-1000242] = select(2, GetAchievementInfo(4786)),
	[-1000243] = "The Ahn'Qiraj War Effort",
	[-1000244] = "The Opening of the Dark Portal",
	[-1000245] = "The Scepter of the Shifting Sands",
	[-1000246] = "The Scourge Invasion",
	[-1000247] = "The Silithyst Must Flow",
	[-1000248] = select(2, GetAchievementInfo(4790)),
	[-1000252] = "BlizzCon",
	[-1000253] = "Collector's Edition",
	[-1000254] = "Heroic Edition",
	[-1000255] = "Epic Edition",
	[-1000256] = "TBC Classic Deluxe Edition",
	[-1000257] = "WotLK Classic Northrend Upgrade",
	[-1000258] = "Cata Classic Blazing Upgrade",
	[-1000265] = "Starcraft II: Wings of Liberty",
	[-1000272] = "iCoke",
	[-1000273] =  AUCTION_CATEGORY_MISCELLANEOUS,
	[-1000274] = REFER_A_FRIEND,
	[-1000276] = "Spirit of Competition",
	[-1000277] = BATTLE_PET_SOURCE_9,
	[-1000280] = "Ensembles",
	[-1000281] = "Arsenals",
	[-1000282] = "Sourceless",
});
localize(L.HEADER_DESCRIPTIONS, {
	...
	[-1000161] = "If the following are sorted somewhere, please delete them from this list. Thanks.",
	[-1000168] = "Also known as 'Lower' Blackrock Spire.",
	[-1000169] = "One member of your group must have completed the Seal of Ascension quest chain in order for the fires to light and the door to open to this portion of the instance. Also known as 'Upper' Blackrock Spire.",
	[-1000170] = "This part of the instance can be accessed from the eastern-most portal. (right side)",
	[-1000171] = "This part of the instance can be accessed from the northern-most portal.",
	[-1000172] = "This part of the instance can be accessed from the western-most portal. (left side)",
	[-1000180] = "Stratholme is divided into two sides.\n\nThis side is commonly referred to as the \"Live\" or \"Scarlet\" side, which the Scarlet Crusade has taken over.",
	[-1000181] = "Stratholme is divided into two sides.\n\nThis side is commonly referred to as the \"Dead\" or \"Scourge\" side, which the Scourge has taken over.",
	[-1000223] = "This is a yearly recurring event that occurs between the beginning of November and the end of the year.",
	[-1000241] = "The Elemental Unrest was a world event that heralded the Cataclysm. The event culminated in elementals attacking Stormwind, Orgrimmar, Ironforge, and Thunder Bluff. Players defeating these elementals and freeing trapped citizens within their entire city were granted access to two special boss encounters.",
	[-1000242] = "Operation: Gnomeregan was the name of Gelbin Mekkatorque's plan for the retaking of the surface of Gnomeregan. Only Alliance players between level 75 and 80 were able to serve during the operation, but lower level players helped by motivating other gnomes or by turning in items.",
	[-1000243] = "The Ruins of Ahn'Qiraj and Temple of Ahn'Qiraj were not be immediately available with the release of Phase 5. Instead, server communities had to undertake a massive war effort to open the raids by gathering supplies to prepare for the war and completing an epic questline that ultimately culminates in the banging of a gong to open the gates and release the horrors within upon the world.\n\nOnce both factions have finished their contribution, there is a 5-day grace period where. Afterwards, there is a server-wide 10 hour event which spans several zones in Kalimdor the moment someone bangs the gong.\n\nHow quickly Ahn'Qiraj opens depends on the server and its faction balance.\n\nWe recommend delaying the War Effort as long as possible to allow for the most number of people to obtain the Scarab Lord mount as everyone that finishes The Scepter of the Shifting Sands quest line will be granted the same rewards!",
	[-1000244] = "The Opening of the Dark Portal was a one-time event that happened between Prepatch and the launch of TBC and subsequentially removed after. The tabard is the only tabard in the game with the Flex emote built into it and is highly covetted by collectors. Highlord Kruul would spawn randomly outside of the major cities and max level zones of the time.",
...
localize(L.HEADER_ICONS, {
	...
	[-1000102] = _.asset("Weapon_Type_Heirloom"),
	...
	[-1000161] = "Interface/Icons/INV_Chest_Plate03",
	[-1000162] = "Interface/Icons/INV_Chest_Plate03",
	[-1000163] = "Interface/Icons/achievement_pvp_h_12",
	[-1000164] = "Interface/Icons/Inv_misc_ahnqirajtrinket_06",
	[-1000165] = "Interface/Icons/Ability_mount_undeadhorse",
	[-1000166] = "Interface/Icons/Achievement_Zone_Blackrock_01",
	[-1000167] = "Interface/Icons/Achievement_Zone_Blackrock_01",
	[-1000168] = _.asset("Achievement_Boss_Overlord_Wyrmthalak"),
	[-1000169] = "Interface/Icons/INV_Misc_Head_Dragon_01",
	[-1000170] = "Interface/Icons/Ability_Warlock_DemonicEmpowerment",
	[-1000171] = "Interface/Icons/Achievement_Reputation_Ogre",
	[-1000172] = "Interface/Icons/INV_Misc_Head_Elf_02",
	[-1000173] = "Interface/Icons/spell_arcane_portalironforge",
	[-1000174] = "Interface/Icons/INV_Misc_Gem_Opal_01",
	[-1000175] = "Interface/Icons/INV_Misc_Gem_Amethyst_02",
	[-1000176] = "Interface/Icons/Inv_misc_bone_humanskull_01",
	[-1000177] = "Interface/Icons/INV_Misc_Book_13",
	[-1000178] = "Interface/Icons/inv_helmet_25",
	[-1000179] = "Interface/Icons/inv_helmet_12",
	[-1000180] = "Interface/Icons/INV_Misc_Token_ScarletCrusade",
	[-1000181] = "Interface/Icons/INV_MISC_KEY_13",
	[-1000182] = "Interface/Icons/Inv_misc_head_troll_01",
	[-1000183] = "Interface/Icons/achievement_dungeon_icecrown_icecrownentrance",
	[-1000184] = "Interface/Icons/achievement_dungeon_plaguewing",
	[-1000185] = "Interface/Icons/achievement_dungeon_crimsonhall",
	[-1000186] = "Interface/Icons/achievement_dungeon_icecrown_frostwinghalls",
	[-1000189] = _.asset("achievement_reputation_timbermaw"),
	[-1000190] = _.asset("Holiday_brewfest"),
	[-1000192] = _.asset("Holiday_Children"),
	[-1000193] = _.asset("Event_dmf"),
	[-1000199] = _.asset("Holiday_Day_of_the_Dead"),
	[-1000207] = _.asset("Holiday_winter_veil"),
	[-1000209] = _.asset("Holiday_hallows_end"),
	[-1000210] = _.asset("Holiday_Harvestfest"),
	[-1000211] = "Interface/Icons/inv_fishingpole_03",
	[-1000212] = _.asset("Holiday_love"),
	[-1000213] = _.asset("Holiday_Lunar"),
	[-1000215] = _.asset("Holiday_Midsummer"),
	[-1000216] = _.asset("Holiday_noblegarden"),
	[-1000217] = _.asset("Holiday_Pilgrim"),
	[-1000218] = _.asset("Holiday_Pirate"),
	[-1000219] = "Interface/Icons/inv_misc_fish_06",
	[-1000223] = "Interface/Icons/inv_misc_celebrationcake_01",
	[-1000224] = "Interface/Icons/inv_misc_celebrationcake_01",
	[-1000225] = "Interface/Icons/inv_misc_celebrationcake_01",
	[-1000240] = "Interface/Icons/achievement_reputation_argentchampion",
	[-1000241] = _.asset("Expansion_CATA"),
	[-1000242] = "Interface/Icons/inv_misc_tournaments_symbol_gnome",
	[-1000243] = "Interface/Icons/inv_box_01",
	[-1000244] = "Interface/Icons/achievement_dungeon_outland_dungeonmaster",
	[-1000245] = "Interface/Icons/Inv_hammer_25",
	[-1000246] = "Interface/Icons/inv_stone_02",
	[-1000247] = "Interface/Icons/spell_holiday_tow_spicecloud",
	[-1000248] = "Interface/Icons/inv_misc_tournaments_banner_troll",
	[-1000252] = _.asset("Promotion_Blizzcon"),
	[-1000253] = _.asset("Promotion_Collector"),
	[-1000254] = _.asset("Weapon_Type_Heirloom"),
	[-1000255] = _.asset("Weapon_Type_Legendary"),
	[-1000256] = _.asset("Expansion_TBC"),
	[-1000257] = _.asset("Expansion_WOTLK"),
	[-1000258] = _.asset("Expansion_CATA"),
	[-1000265] = "Interface/Icons/Inv_sigil_thorim",
	[-1000272] = "Interface/Icons/Inv_drink_10",
	[-1000273] = "Interface/Icons/Spell_Misc_Drink",
	[-1000274] = "Interface/Icons/achievement_reputation_08",
	[-1000276] = "Interface/Icons/inv_jewelry_amulet_03",
	[-1000277] = "Interface/Icons/inv_misc_ticket_tarot_stack_01",
...
localize(L.HEADER_NAMES, {
	...
	[-1000165] = "Die Vier Reiter",
	[-1000176] = "Friedhof",
	[-1000177] = "Bibliothek",
	[-1000178] = "Waffenkammer",
	[-1000179] = "Kathedrale",
	[-1000183] = "Sturm auf die Zitadelle",
	[-1000184] = "Die Seuchenwerke",
	[-1000186] = "Die Frostschwingenhallen",
	[-1000193] = "Dunkelmond-Jahrmarkt",
	[-1000199] = "Tag der Toten",
	[-1000211] = "Angelwettstreit der Kalu'ak",
	[-1000215] = "Sonnenwendfest",
	[-1000218] = "Piratentag",
	[-1000219] = "Anglerwettbewerb im Schlingendorntal",
	[-1000244] = "Die Öffnung des Dunklen Portals",
	[-1000245] = "Das Szepter der Sandstürme",
});
localize(L.HEADER_DESCRIPTIONS, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000165] = "Los Cuatro Jinetes",
	[-1000183] = "Asaltar la Ciudadela",
	[-1000184] = "Los Talleres de la Peste",
	[-1000186] = "Las Cámaras de Alaescarcha",
	[-1000193] = "Feria de la Luna Negra",
	[-1000199] = "Festividad de los Muertos",
	[-1000211] = "Competición de pesca Kalu'ak",
	[-1000215] = "Festival del Fuego del Solsticio de Verano",
	[-1000218] = "Día de los Piratas",
	[-1000219] = "Gran espectáculo de pesca de Tuercespina",
	[-1000244] = "La apertura del Portal Oscuro",
	[-1000245] = "El cetro del Mar de Dunas",
});
localize(L.HEADER_DESCRIPTIONS, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000162] = "Ensembles Tier 0.5",
	[-1000163] = "Capitaines",
	[-1000165] = "Les quatre cavaliers",
	[-1000170] = DUNGEON_FLOOR_DIREMAUL5.." (Est)",
	[-1000171] = DUNGEON_FLOOR_DIREMAUL1.." (Nord)",
	[-1000172] = DUNGEON_FLOOR_DIREMAUL2.." (Ouest)",
	[-1000176] = "Cimetière",
	[-1000177] = "Librairie",
	[-1000178] = "Armurerie",
	[-1000179] = "Cathédrale",
	[-1000182] = "Défenseurs Atal'ai",
	[-1000183] = "La prise de la citadelle",
	[-1000184] = "La Pesterie",
	[-1000186] = "Les salles de l'Aile de givre",
	[-1000193] = "Foire de Sombrelune",
	[-1000199] = "Jour des morts",
	[-1000211] = "Le tournoi de pêche kalu'ak",
	[-1000215] = "Fête du Feu du solstice d’été",
	[-1000218] = "Jour des pirates",
	[-1000219] = "Concours de pêche de Strangleronce",
	[-1000243] = "Effort de guerre d’Ahn'Qiraj",
	[-1000244] = "L'ouverture de la Porte des ténèbres",
	[-1000245] = "Le Sceptre des Sables changeants",
	[-1000253] = "Edition Collector",
	[-1000256] = "Édition BC Classic Deluxe",
});
localize(L.HEADER_DESCRIPTIONS, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000165] = "I Cavalieri dell'Apocalisse",
	[-1000183] = "Assalto alla rocca",
	[-1000184] = "Sale della Pestilenza",
	[-1000186] = "Sale delle Ali del Gelo",
	[-1000193] = "Fiera di Lunacupa",
	[-1000199] = "Giorno dei Morti",
	[-1000211] = "La gara di pesca dei Kalu'ak",
	[-1000215] = "Fuochi di Mezza Estate",
	[-1000218] = "Giorno dei Pirati",
	[-1000219] = "Gara di Pesca a Rovotorto",
	[-1000244] = "L'apertura del Portale Oscuro",
	[-1000245] = "Scettro delle Sabbie Mutevoli",
});
localize(_.ObjectNames, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000131] = "Gladiador Odioso",
	[-1000165] = "Os Quatro Cavaleiros",
	[-1000183] = "Invasão da Cidadela",
	[-1000184] = "Antro da Peste",
	[-1000186] = "Salões da Asa Gélida",
	[-1000193] = "Feira de Negraluna",
	[-1000199] = "Dia dos Mortos",
	[-1000211] = "Campeonato de Pesca dos Kalu'ak",
	[-1000215] = "Festival do Fogo do Solstício",
	[-1000218] = "Dia dos Piratas",
	[-1000219] = "Festerê de Pesca da Selva do Espinhaço",
	[-1000244] = "A abertura do Portal Negro",
	[-1000245] = "Cetro das Areias Cambiantes",
});
localize(L.HEADER_DESCRIPTIONS, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000162] = "Комплекты T0.5",
	[-1000163] = "Капитаны",
	[-1000165] = "Четыре Всадника",
	[-1000170] = DUNGEON_FLOOR_DIREMAUL5.." (Восток)",
	[-1000171] = DUNGEON_FLOOR_DIREMAUL1.." (Север)",
	[-1000172] = DUNGEON_FLOOR_DIREMAUL2.." (Запад)",
	[-1000176] = "Кладбище",
	[-1000177] = "Библиотека",
	[-1000178] = "Оружейная",
	[-1000179] = "Собор",
	[-1000182] = "Защитники Атал'ай",
	[-1000183] = "Штурм цитадели",
	[-1000184] = "Чумодельня",
	[-1000186] = "Залы Ледокрылых",
	[-1000193] = "Ярмарка Новолуния",
	[-1000199] = "День мертвых",
	[-1000210] = "Неделя урожая",
	[-1000211] = "Калуакское рыбоборье",
	[-1000215] = "Огненный Солнцеворот",
	[-1000218] = "День пирата",
	[-1000219] = "Рыбомания Тернистой долины",
	[-1000223] = "Годовщина WoW",
	[-1000241] = "Буйство элементалей",
	[-1000243] = "Война в Ан'Кираже",
	[-1000244] = "Открытие Темного портала",
	[-1000245] = "Скипетр Зыбучих песков",
	[-1000246] = "Вторжение Плети",
	[-1000253] = "Коллекционное издание",
	[-1000282] = "Без Источника",
});
localize(L.HEADER_DESCRIPTIONS, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000163] = "船长",
	[-1000165] = "四骑士",
	[-1000170] = DUNGEON_FLOOR_DIREMAUL5.." (东)",
	[-1000171] = DUNGEON_FLOOR_DIREMAUL1.." (北)",
	[-1000172] = DUNGEON_FLOOR_DIREMAUL2.." (西)",
	[-1000176] = "墓地",
	[-1000177] = "图书馆",
	[-1000178] = "武器库",
	[-1000179] = "修道院",
