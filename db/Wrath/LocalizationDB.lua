...
_.HeaderConstants = {
	...
	BREWFEST_HEADER = -1000191,
	CHILDRENS_WEEK_HEADER = -1000193,
	COMMON_BOSS_DROPS = -1000010,
	COMMON_VENDOR_ITEMS = -1000013,
	CRAFTED_ITEMS = -1000014,
	DARKMOON_FAIRE_HEADER = -1000194,
	DAY_OF_THE_DEAD_HEADER = -1000200,
	DISCOVERY = -1000016,
	EXPLORATION = -1000019,
	FACTIONS = -1000020,
	FEAST_OF_WINTER_VEIL_HEADER = -1000208,
	FLIGHT_PATHS = -1000021,
	HALLOWS_END_HEADER = -1000210,
	HARVEST_FESTIVAL_HEADER = -1000211,
	HOLIDAYS = -1000025,
	HONOR_TITLES = -1000142,
	IN_GAME_SHOP = -1000097,
	LOVE_IS_IN_THE_AIR_HEADER = -1000213,
	LUNAR_FESTIVAL_HEADER = -1000214,
	MIDSUMMER_FIRE_FESTIVAL_HEADER = -1000216,
	NOBLEGARDEN_HEADER = -1000217,
	PILGRIMS_BOUNTY_HEADER = -1000218,
	PIRATES_DAY_HEADER = -1000219,
	PROFESSIONS = -1000030,
	PVP = -1000144,
	...
	REWARDS = -1000033,
	SPECIAL = -1000037,
	TIER_ZERO_POINT_FIVE_SETS = -1000163,
	TREASURES = -1000038,
	VENDORS = -1000039,
	WEAPONS = -1000073,
...
localize(L.HEADER_NAMES, {
	...
	[-1000143] = HONOR,
	[-1000144] = PVP,
	[-1000162] = "Crieve's Never Implemented List",
	[-1000163] = "Tier 0.5 Sets",
	[-1000164] = "Captains",
	[-1000165] = "Silithid Royalty",
	[-1000166] = "The Four Horsemen",
	[-1000167] = DUNGEON_FLOOR_BLACKROCKDEPTHS1,
	[-1000168] = DUNGEON_FLOOR_BLACKROCKDEPTHS2,
	[-1000169] = DUNGEON_FLOOR_BLACKROCKSPIRE3,
	[-1000170] = DUNGEON_FLOOR_UPPERBLACKROCKSPIRE1,
	[-1000171] = DUNGEON_FLOOR_DIREMAUL5.." (East)",
	[-1000172] = DUNGEON_FLOOR_DIREMAUL1.." (North)",
	[-1000173] = DUNGEON_FLOOR_DIREMAUL2.." (West)",
	[-1000174] = GetSpellInfo(21127),
	[-1000175] = DUNGEON_FLOOR_DESOLACE22.." (Orange Path)",
	[-1000176] = DUNGEON_FLOOR_DESOLACE21.." (Purple Path)",
	[-1000177] = "Graveyard",
	[-1000178] = "Library",
	[-1000179] = "Armory",
	[-1000180] = "Cathedral",
	[-1000181] = "Main Gate",
	[-1000182] = "Service Entrance",
	[-1000183] = "Atal'ai Defenders",
	[-1000184] = "Storming the Citadel",
	[-1000185] = "The Plagueworks",
	[-1000186] = C_Map.GetAreaInfo(4892),
	[-1000187] = "The Frostwing Halls",
	[-1000190] = C_Map.GetAreaInfo(1769),
	[-1000191] = select(1,GetCategoryInfo(162)),
	[-1000193] = select(1,GetCategoryInfo(163)),
	[-1000194] = "Darkmoon Faire",
	[-1000200] = "Day of the Dead",
	[-1000208] = GetSpellInfo(21953),
	[-1000210] = select(1,GetCategoryInfo(158)),
	[-1000211] = "Harvest Festival",
	[-1000212] = "Kalu'ak Fishing Derby",
	[-1000213] = select(1,GetCategoryInfo(187)),
	[-1000214] = select(1,GetCategoryInfo(160)),
	[-1000216] = "Midsummer Fire Festival",
	[-1000217] = select(1,GetCategoryInfo(159)),
	[-1000218] = select(1,GetCategoryInfo(14981)),
	[-1000219] = "Pirates' Day",
	[-1000220] = "Stranglethorn Fishing Extravaganza",
	[-1000224] = "WoW's Anniversary",
	[-1000225] = select(2,GetAchievementInfo(2398)),
	[-1000226] = select(2,GetAchievementInfo(4400)),
	[-1000241] = select(1,GetCategoryInfo(14941)),
	[-1000242] = "Elemental Unrest",
	[-1000243] = select(2, GetAchievementInfo(4786)),
	[-1000244] = "The Ahn'Qiraj War Effort",
	[-1000245] = "The Opening of the Dark Portal",
	[-1000246] = "The Scepter of the Shifting Sands",
	[-1000247] = "The Scourge Invasion",
	[-1000248] = "The Silithyst Must Flow",
	[-1000249] = select(2, GetAchievementInfo(4790)),
	[-1000253] = "BlizzCon",
	[-1000254] = "Collector's Edition",
	[-1000255] = "Heroic Edition",
	[-1000256] = "Epic Edition",
	[-1000257] = "TBC Classic Deluxe Edition",
	[-1000258] = "WotLK Classic Northrend Upgrade",
	[-1000259] = "Cata Classic Blazing Upgrade",
	[-1000266] = "Starcraft II: Wings of Liberty",
	[-1000273] = "iCoke",
	[-1000274] =  AUCTION_CATEGORY_MISCELLANEOUS,
	[-1000275] = REFER_A_FRIEND,
	[-1000277] = "Spirit of Competition",
	[-1000278] = BATTLE_PET_SOURCE_9,
	[-1000281] = "Ensembles",
	[-1000282] = "Arsenals",
	[-1000283] = "Sourceless",
});
...
localize(L.HEADER_ICONS, {
	...
	[-1000162] = "Interface/Icons/INV_Chest_Plate03",
	[-1000163] = "Interface/Icons/INV_Chest_Plate03",
	[-1000164] = "Interface/Icons/achievement_pvp_h_12",
	[-1000165] = "Interface/Icons/Inv_misc_ahnqirajtrinket_06",
	[-1000166] = "Interface/Icons/Ability_mount_undeadhorse",
	[-1000167] = "Interface/Icons/Achievement_Zone_Blackrock_01",
	[-1000168] = "Interface/Icons/Achievement_Zone_Blackrock_01",
	[-1000169] = _.asset("Achievement_Boss_Overlord_Wyrmthalak"),
	[-1000170] = "Interface/Icons/INV_Misc_Head_Dragon_01",
	[-1000171] = "Interface/Icons/Ability_Warlock_DemonicEmpowerment",
	[-1000172] = "Interface/Icons/Achievement_Reputation_Ogre",
	[-1000173] = "Interface/Icons/INV_Misc_Head_Elf_02",
	[-1000174] = "Interface/Icons/spell_arcane_portalironforge",
	[-1000175] = "Interface/Icons/INV_Misc_Gem_Opal_01",
	[-1000176] = "Interface/Icons/INV_Misc_Gem_Amethyst_02",
	[-1000177] = "Interface/Icons/Inv_misc_bone_humanskull_01",
	[-1000178] = "Interface/Icons/INV_Misc_Book_13",
	[-1000179] = "Interface/Icons/inv_helmet_25",
	[-1000180] = "Interface/Icons/inv_helmet_12",
	[-1000181] = "Interface/Icons/INV_Misc_Token_ScarletCrusade",
	[-1000182] = "Interface/Icons/INV_MISC_KEY_13",
	[-1000183] = "Interface/Icons/Inv_misc_head_troll_01",
	[-1000184] = "Interface/Icons/achievement_dungeon_icecrown_icecrownentrance",
	[-1000185] = "Interface/Icons/achievement_dungeon_plaguewing",
	[-1000186] = "Interface/Icons/achievement_dungeon_crimsonhall",
	[-1000187] = "Interface/Icons/achievement_dungeon_icecrown_frostwinghalls",
	[-1000190] = _.asset("achievement_reputation_timbermaw"),
	[-1000191] = _.asset("Holiday_brewfest"),
	[-1000193] = _.asset("Holiday_Children"),
	[-1000194] = _.asset("Event_dmf"),
	[-1000200] = _.asset("Holiday_Day_of_the_Dead"),
	[-1000208] = _.asset("Holiday_winter_veil"),
	[-1000210] = _.asset("Holiday_hallows_end"),
	[-1000211] = _.asset("Holiday_Harvestfest"),
	[-1000212] = "Interface/Icons/inv_fishingpole_03",
	[-1000213] = _.asset("Holiday_love"),
	[-1000214] = _.asset("Holiday_Lunar"),
	[-1000216] = _.asset("Holiday_Midsummer"),
	[-1000217] = _.asset("Holiday_noblegarden"),
	[-1000218] = _.asset("Holiday_Pilgrim"),
	[-1000219] = _.asset("Holiday_Pirate"),
	[-1000220] = "Interface/Icons/inv_misc_fish_06",
	[-1000224] = "Interface/Icons/inv_misc_celebrationcake_01",
	[-1000225] = "Interface/Icons/inv_misc_celebrationcake_01",
	[-1000226] = "Interface/Icons/inv_misc_celebrationcake_01",
	[-1000241] = "Interface/Icons/achievement_reputation_argentchampion",
	[-1000242] = _.asset("Expansion_CATA"),
	[-1000243] = "Interface/Icons/inv_misc_tournaments_symbol_gnome",
	[-1000244] = "Interface/Icons/inv_box_01",
	[-1000245] = "Interface/Icons/achievement_dungeon_outland_dungeonmaster",
	[-1000246] = "Interface/Icons/Inv_hammer_25",
	[-1000247] = "Interface/Icons/inv_stone_02",
	[-1000248] = "Interface/Icons/spell_holiday_tow_spicecloud",
	[-1000249] = "Interface/Icons/inv_misc_tournaments_banner_troll",
	[-1000253] = _.asset("Promotion_Blizzcon"),
	[-1000254] = _.asset("Promotion_Collector"),
	[-1000255] = _.asset("Weapon_Type_Heirloom"),
	[-1000256] = _.asset("Weapon_Type_Legendary"),
	[-1000257] = _.asset("Expansion_TBC"),
	[-1000258] = _.asset("Expansion_WOTLK"),
	[-1000259] = _.asset("Expansion_CATA"),
	[-1000266] = "Interface/Icons/Inv_sigil_thorim",
	[-1000273] = "Interface/Icons/Inv_drink_10",
	[-1000274] = "Interface/Icons/Spell_Misc_Drink",
	[-1000275] = "Interface/Icons/achievement_reputation_08",
	[-1000277] = "Interface/Icons/inv_jewelry_amulet_03",
	[-1000278] = "Interface/Icons/inv_misc_ticket_tarot_stack_01",
	[-1000281] = "Interface/Icons/inv_chest_leather_08",
	[-1000282] = "Interface/Icons/inv_mace_1h_bastionquest_b_02",
	[-1000283] = "Interface/Icons/inv_misc_questionmark",
});
...
localize(L.HEADER_NAMES, {
	...
	[-1000166] = "Die Vier Reiter",
	[-1000177] = "Friedhof",
	[-1000178] = "Bibliothek",
	[-1000179] = "Waffenkammer",
	[-1000180] = "Kathedrale",
	[-1000184] = "Sturm auf die Zitadelle",
	[-1000185] = "Die Seuchenwerke",
	[-1000187] = "Die Frostschwingenhallen",
	[-1000194] = "Dunkelmond-Jahrmarkt",
	[-1000200] = "Tag der Toten",
	[-1000212] = "Angelwettstreit der Kalu'ak",
	[-1000216] = "Sonnenwendfest",
	[-1000219] = "Piratentag",
	[-1000220] = "Anglerwettbewerb im Schlingendorntal",
	[-1000245] = "Die Öffnung des Dunklen Portals",
	[-1000246] = "Das Szepter der Sandstürme",
});
localize(L.HEADER_DESCRIPTIONS, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000166] = "Los Cuatro Jinetes",
	[-1000184] = "Asaltar la Ciudadela",
	[-1000185] = "Los Talleres de la Peste",
	[-1000187] = "Las Cámaras de Alaescarcha",
	[-1000194] = "Feria de la Luna Negra",
	[-1000200] = "Festividad de los Muertos",
	[-1000212] = "Competición de pesca Kalu'ak",
	[-1000216] = "Festival del Fuego del Solsticio de Verano",
	[-1000219] = "Día de los Piratas",
	[-1000220] = "Gran espectáculo de pesca de Tuercespina",
	[-1000245] = "La apertura del Portal Oscuro",
	[-1000246] = "El cetro del Mar de Dunas",
});
localize(L.HEADER_DESCRIPTIONS, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000163] = "Ensembles Tier 0.5",
	[-1000164] = "Capitaines",
	[-1000166] = "Les quatre cavaliers",
	[-1000171] = DUNGEON_FLOOR_DIREMAUL5.." (Est)",
	[-1000172] = DUNGEON_FLOOR_DIREMAUL1.." (Nord)",
	[-1000173] = DUNGEON_FLOOR_DIREMAUL2.." (Ouest)",
	[-1000177] = "Cimetière",
	[-1000178] = "Librairie",
	[-1000179] = "Armurerie",
	[-1000180] = "Cathédrale",
	[-1000183] = "Défenseurs Atal'ai",
	[-1000184] = "La prise de la citadelle",
	[-1000185] = "La Pesterie",
	[-1000187] = "Les salles de l'Aile de givre",
	[-1000194] = "Foire de Sombrelune",
	[-1000200] = "Jour des morts",
	[-1000212] = "Le tournoi de pêche kalu'ak",
	[-1000216] = "Fête du Feu du solstice d’été",
	[-1000219] = "Jour des pirates",
	[-1000220] = "Concours de pêche de Strangleronce",
	[-1000244] = "Effort de guerre d’Ahn'Qiraj",
	[-1000245] = "L'ouverture de la Porte des ténèbres",
	[-1000246] = "Le Sceptre des Sables changeants",
	[-1000254] = "Edition Collector",
	[-1000257] = "Édition BC Classic Deluxe",
});
localize(L.HEADER_DESCRIPTIONS, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000166] = "I Cavalieri dell'Apocalisse",
	[-1000184] = "Assalto alla rocca",
	[-1000185] = "Sale della Pestilenza",
	[-1000187] = "Sale delle Ali del Gelo",
	[-1000194] = "Fiera di Lunacupa",
	[-1000200] = "Giorno dei Morti",
	[-1000212] = "La gara di pesca dei Kalu'ak",
	[-1000216] = "Fuochi di Mezza Estate",
	[-1000219] = "Giorno dei Pirati",
	[-1000220] = "Gara di Pesca a Rovotorto",
	[-1000245] = "L'apertura del Portale Oscuro",
	[-1000246] = "Scettro delle Sabbie Mutevoli",
});
localize(_.ObjectNames, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000132] = "Gladiador Odioso",
	[-1000166] = "Os Quatro Cavaleiros",
	[-1000184] = "Invasão da Cidadela",
	[-1000185] = "Antro da Peste",
	[-1000187] = "Salões da Asa Gélida",
	[-1000194] = "Feira de Negraluna",
	[-1000200] = "Dia dos Mortos",
	[-1000212] = "Campeonato de Pesca dos Kalu'ak",
	[-1000216] = "Festival do Fogo do Solstício",
	[-1000219] = "Dia dos Piratas",
	[-1000220] = "Festerê de Pesca da Selva do Espinhaço",
	[-1000245] = "A abertura do Portal Negro",
	[-1000246] = "Cetro das Areias Cambiantes",
});
localize(L.HEADER_DESCRIPTIONS, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000163] = "Комплекты T0.5",
	[-1000164] = "Капитаны",
	[-1000166] = "Четыре Всадника",
	[-1000171] = DUNGEON_FLOOR_DIREMAUL5.." (Восток)",
	[-1000172] = DUNGEON_FLOOR_DIREMAUL1.." (Север)",
	[-1000173] = DUNGEON_FLOOR_DIREMAUL2.." (Запад)",
	[-1000177] = "Кладбище",
	[-1000178] = "Библиотека",
	[-1000179] = "Оружейная",
	[-1000180] = "Собор",
	[-1000183] = "Защитники Атал'ай",
	[-1000184] = "Штурм цитадели",
	[-1000185] = "Чумодельня",
	[-1000187] = "Залы Ледокрылых",
	[-1000194] = "Ярмарка Новолуния",
	[-1000200] = "День мертвых",
	[-1000211] = "Неделя урожая",
	[-1000212] = "Калуакское рыбоборье",
	[-1000216] = "Огненный Солнцеворот",
	[-1000219] = "День пирата",
	[-1000220] = "Рыбомания Тернистой долины",
	[-1000224] = "Годовщина WoW",
	[-1000242] = "Буйство элементалей",
	[-1000244] = "Война в Ан'Кираже",
	[-1000245] = "Открытие Темного портала",
	[-1000246] = "Скипетр Зыбучих песков",
	[-1000247] = "Вторжение Плети",
	[-1000254] = "Коллекционное издание",
	[-1000283] = "Без Источника",
});
localize(L.HEADER_DESCRIPTIONS, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000164] = "船长",
	[-1000166] = "四骑士",
	[-1000171] = DUNGEON_FLOOR_DIREMAUL5.." (东)",
	[-1000172] = DUNGEON_FLOOR_DIREMAUL1.." (北)",
	[-1000173] = DUNGEON_FLOOR_DIREMAUL2.." (西)",
	[-1000177] = "墓地",
	[-1000178] = "图书馆",
	[-1000179] = "武器库",
	[-1000180] = "修道院",
