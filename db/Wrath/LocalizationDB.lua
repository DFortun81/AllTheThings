...
localize(L.HEADER_NAMES, {
	...
	[-1000217] = select(1,GetCategoryInfo(14941)),
	[-1000218] = "Elemental Unrest",
	[-1000219] = select(2, GetAchievementInfo(4786)),
	[-1000220] = "The Ahn'Qiraj War Effort",
	[-1000221] = "The Opening of the Dark Portal",
	[-1000222] = "The Scepter of the Shifting Sands",
	[-1000223] = "The Scourge Invasion",
	[-1000224] = "The Silithyst Must Flow",
	[-1000225] = select(2, GetAchievementInfo(4790)),
	[-1000229] = "BlizzCon",
	[-1000230] = "Collector's Edition",
	[-1000231] = "Dark Portal Pass",
	[-1000236] = "Starcraft II: Wings of Liberty",
	[-1000239] = "TBC Classic Deluxe Edition",
	[-1000241] = "WotLK Classic Northrend Heroic Upgrade",
	[-1000242] = "WotLK Classic Northrend Epic Upgrade",
	[-1000247] = "iCoke",
	[-1000248] =  AUCTION_CATEGORY_MISCELLANEOUS,
	[-1000249] = REFER_A_FRIEND,
	[-1000251] = "Spirit of Competition",
	[-1000252] = BATTLE_PET_SOURCE_9,
	[-1000254] = "Ensembles",
	[-1000255] = "Arsenals",
	[-1000256] = "Sourceless",
});
localize(L.HEADER_DESCRIPTIONS, {
	...
	[-1000247] = "These were only available through the 2006 iCoke Promotion (China Only)",
	[-1000248] = "This section is for miscellaneous promotions that took place in the real world or something to do with account management.",
	[-1000251] = "This is a Battlegrounds-based event that coincides with the beginning of the Summer Olympic games. The only time this was celebrated was in 2008 to correspond to the Beijing Olympics, and although there appeared to be the intention to repeat this event, it never returned.",
	[-1000256] = "This Category contains Things that probably exist in the game but no known source.",
});
...
localize(L.HEADER_ICONS, {
	...
	[-1000217] = "Interface/Icons/achievement_reputation_argentchampion",
	[-1000218] = _.asset("Expansion_CATA"),
	[-1000219] = "Interface/Icons/inv_misc_tournaments_symbol_gnome",
	[-1000220] = "Interface/Icons/inv_box_01",
	[-1000221] = "Interface/Icons/achievement_dungeon_outland_dungeonmaster",
	[-1000222] = "Interface/Icons/Inv_hammer_25",
	[-1000223] = "Interface/Icons/inv_stone_02",
	[-1000224] = "Interface/Icons/spell_holiday_tow_spicecloud",
	[-1000225] = "Interface/Icons/inv_misc_tournaments_banner_troll",
	[-1000229] = _.asset("Promotion_Blizzcon"),
	[-1000230] = _.asset("Promotion_Collector"),
	[-1000231] = "Interface/Icons/achievement_dungeon_outland_dungeonmaster",
	[-1000236] = "Interface/Icons/Inv_sigil_thorim",
	[-1000239] = _.asset("Expansion_TBC"),
	[-1000241] = _.asset("Expansion_WOTLK"),
	[-1000242] = _.asset("Expansion_WOTLK"),
	[-1000247] = "Interface/Icons/Inv_drink_10",
	[-1000248] = "Interface/Icons/Spell_Misc_Drink",
	[-1000249] = "Interface/Icons/achievement_reputation_08",
	[-1000251] = "Interface/Icons/inv_jewelry_amulet_03",
	[-1000252] = "Interface/Icons/inv_misc_ticket_tarot_stack_01",
	[-1000254] = "Interface/Icons/inv_chest_leather_08",
	[-1000255] = "Interface/Icons/inv_mace_1h_bastionquest_b_02",
	[-1000256] = "Interface/Icons/inv_misc_questionmark",
});
...
localize(L.HEADER_NAMES, {
	...
	[-1000221] = "Die Öffnung des Dunklen Portals",
	[-1000222] = "Das Szepter der Sandstürme",
	[-1000231] = "Pass zum Dunklen Portal",
});
localize(L.HEADER_DESCRIPTIONS, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000221] = "La apertura del Portal Oscuro",
	[-1000222] = "El cetro del Mar de Dunas",
	[-1000231] = "Pase para el Portal Oscuro",
});
localize(L.HEADER_DESCRIPTIONS, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000220] = "Effort de guerre d’Ahn'Qiraj",
	[-1000221] = "L'ouverture de la Porte des ténèbres",
	[-1000222] = "Le Sceptre des Sables changeants",
	[-1000230] = "Edition Collector",
	[-1000231] = "Passe Porte des ténèbres",
	[-1000239] = "Édition BC Classic Deluxe",
});
localize(L.HEADER_DESCRIPTIONS, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000221] = "L'apertura del Portale Oscuro",
	[-1000222] = "Scettro delle Sabbie Mutevoli",
});
localize(L.ObjectNames, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000221] = "A abertura do Portal Negro",
	[-1000222] = "Cetro das Areias Cambiantes",
	[-1000231] = "Passe do Portal Negro",
});
localize(L.HEADER_DESCRIPTIONS, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000218] = "Буйство элементалей",
	[-1000220] = "Война в Ан'Кираже",
	[-1000221] = "Открытие Темного портала",
	[-1000222] = "Скипетр Зыбучих песков",
	[-1000223] = "Вторжение Плети",
	[-1000230] = "Коллекционное издание",
	[-1000231] = "Пропуск Темного портала",
	[-1000256] = "Без Источника",
});
localize(L.HEADER_DESCRIPTIONS, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000231] = "穿过黑暗之门",
	[-1000236] = "星际争霸II：自由之翼",
	[-1000239] = "燃烧的远征经典怀旧服典藏包",
	[-1000241] = "巫妖王之怒经典怀旧服诺森德英雄礼包",
	[-1000242] = "巫妖王之怒经典怀旧服诺森德史诗礼包",
	[-1000247] = "可口可乐活动",
	[-1000256] = "无来源",
});
localize(L.HEADER_DESCRIPTIONS, {
