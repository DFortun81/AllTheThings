...
p(250,{b=1,itemID=49912,petTypeID=5,q=3,spellID=70613,u=33})}})}}),
...
s(179823,51978,{b=1,f=6,loc=45,q=3,u=33}),
s(179813,51968,{b=1,f=4,loc=45,q=3,u=33}),
s(179809,51964,{b=1,f=5,loc=45,q=3,u=33})}}),
...
i(52001,{awp=30300,b=1,description="Rewarded for completing a random dungeon in the level 36-45 range.",q=3,rwp=70305,u=33,g={
...
s(179822,51977,{b=1,f=6,loc=45,q=3,u=33}),
s(179816,51971,{b=1,f=4,loc=45,q=3,u=33}),
s(179830,51985,{b=1,f=7,loc=45,q=3,u=33}),
s(179804,51959,{b=1,f=5,loc=45,q=3,u=33})}})}}),
