...
localize(L.HEADER_NAMES, {
	...
	[-1000178] = "Minigames",
	[-1000181] = "Shooting Gallery",
	[-1000182] = "Whack-a-Gnoll",
	...
	[-1000212] = select(2,GetAchievementInfo(5512)),
	[-1000213] = select(2,GetAchievementInfo(5863)),
	[-1000214] = select(2,GetAchievementInfo(6131)),
	...
	[-1000259] = SCROLL_OF_RESURRECTION,
...
localize(L.HEADER_DESCRIPTIONS, {
	...
	[-1000171] = "Requires Archaeology (225+) to activate. Activate all 4 of the artifacts to spawn the boss. If the boss you want doesn't spawn, do NOT kill the one that did. Instead, zone out and wait for 30 minutes. Once you zone back, there will sometimes be a new boss waiting for you.",
	[-1000178] = "The following minigames cost one Darkmoon Game Token to play and have a daily quest that grants you prize tickets as well as a number of associated achievements.",
	[-1000181] = "In order to maximize your score, wait for the current mark to disappear then aim towards the middle target. As soon as any green mark appear, press 1 immediately and during the short cast time, move your gun to point at the left or right target if necessary.",
	[-1000182] = "Located near the entrance, guests receive a mallet to whack some stuffed gnolls that pop out of nine barrels in the area. Players will have 60 seconds to earn 30 points. The gnolls come in three types: normal, Hogger, and baby, awarding 1 point, 3 points, or a knockdown, respectively.",
	...
	[-1000241] = "These rewards were made available to anyone who purchased a Collector's Edition of Diablo III.",
	...
	[-1000259] = "The following item sets were implemented as boosted character rewards for recipients of the Scroll of Resurrection.\n\nThey were later added to vendors in Mount Hyjal and Vash'jir once the Scroll of Resurrection Service was retired.",
...
localize(L.HEADER_ICONS, {
	...
	[-1000171] = "Interface/Icons/TRADE_ARCHAEOLOGY",
	...
	[-1000178] = "Interface/Icons/inv_misc_ticket_darkmoon_01",
	[-1000181] = "Interface/Icons/inv_weapon_rifle_01",
	[-1000182] = "Interface/Icons/inv_hammer_32",
	...
	[-1000259] = _.asset("Promotion_Scroll_of_Rez"),
	[-1000260] = "Interface/Icons/inv_jewelry_amulet_03",
	[-1000261] = "Interface/Icons/ACHIEVEMENT_GUILDPERK_LADYLUCK",
...
localize(L.HEADER_NAMES, {
	...
	[-1000181] = "Galería de tiro",
	[-1000182] = "Golpea al gnoll",
...
localize(L.HEADER_NAMES, {
	...
	[-1000171] = "L'antre de la Folie",
	[-1000177] = "Foire de Sombrelune",
	[-1000181] = "Stand de tir",
	[-1000182] = "Cogne-Gnoll",
...
localize(L.HEADER_NAMES, {
	...
	[-1000181] = "Tiro a Segno",
	[-1000182] = "Pesta-lo-Gnoll",
...
localize(L.HEADER_NAMES, {
	...
	[-1000181] = "Galeria de tiro",
	[-1000182] = "Pancada-no-Gnoll",
