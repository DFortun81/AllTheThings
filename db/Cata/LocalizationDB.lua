...
localize(L.HEADER_NAMES, {
	...
	[-1000194] = "Minigames",
	[-1000197] = "Shooting Gallery",
	[-1000198] = "Whack-a-Gnoll",
	...
	[-1000226] = select(2,GetAchievementInfo(5512)),
	[-1000227] = select(2,GetAchievementInfo(5863)),
	[-1000228] = select(2,GetAchievementInfo(6131)),
	...
	[-1000275] = SCROLL_OF_RESURRECTION,
...
localize(L.HEADER_DESCRIPTIONS, {
	...
	[-1000187] = "Requires Archaeology (225+) to activate. Activate all 4 of the artifacts to spawn the boss. If the boss you want doesn't spawn, do NOT kill the one that did. Instead, zone out and wait for 30 minutes. Once you zone back, there will sometimes be a new boss waiting for you.",
	[-1000194] = "The following minigames cost one Darkmoon Game Token to play and have a daily quest that grants you prize tickets as well as a number of associated achievements.",
	[-1000197] = "In order to maximize your score, wait for the current mark to disappear then aim towards the middle target. As soon as any green mark appear, press 1 immediately and during the short cast time, move your gun to point at the left or right target if necessary.",
	[-1000198] = "Located near the entrance, guests receive a mallet to whack some stuffed gnolls that pop out of nine barrels in the area. Players will have 60 seconds to earn 30 points. The gnolls come in three types: normal, Hogger, and baby, awarding 1 point, 3 points, or a knockdown, respectively.",
	...
	[-1000261] = "These rewards were made available to anyone who purchased a Collector's Edition of Diablo III.",
	...
	[-1000275] = "The following item sets were implemented as boosted character rewards for recipients of the Scroll of Resurrection.\n\nThey were later added to vendors in Mount Hyjal and Vash'jir once the Scroll of Resurrection Service was retired.",
...
localize(L.HEADER_ICONS, {
	...
	[-1000187] = "Interface/Icons/TRADE_ARCHAEOLOGY",
	...
	[-1000194] = "Interface/Icons/inv_misc_ticket_darkmoon_01",
	[-1000197] = "Interface/Icons/inv_weapon_rifle_01",
	[-1000198] = "Interface/Icons/inv_hammer_32",
	...
	[-1000261] = "Interface/Icons/DiabloAnniversary_HoradricCube",
	...
	[-1000275] = _.asset("Promotion_Scroll_of_Rez"),
...
localize(L.HEADER_NAMES, {
	...
	[-1000197] = "Galería de tiro",
	[-1000198] = "Golpea al gnoll",
...
localize(L.HEADER_NAMES, {
	...
	[-1000187] = "L'antre de la Folie",
	[-1000193] = "Foire de Sombrelune",
	[-1000197] = "Stand de tir",
	[-1000198] = "Cogne-Gnoll",
...
localize(L.HEADER_NAMES, {
	...
	[-1000197] = "Tiro a Segno",
	[-1000198] = "Pesta-lo-Gnoll",
...
localize(L.HEADER_NAMES, {
	...
	[-1000197] = "Galeria de tiro",
	[-1000198] = "Pancada-no-Gnoll",
