...
localize(L.HEADER_NAMES, {
	...
	[-1000195] = "Minigames",
	[-1000198] = "Shooting Gallery",
	[-1000199] = "Whack-a-Gnoll",
	...
	[-1000227] = select(2,GetAchievementInfo(5512)),
	[-1000228] = select(2,GetAchievementInfo(5863)),
	[-1000229] = select(2,GetAchievementInfo(6131)),
	...
	[-1000276] = SCROLL_OF_RESURRECTION,
...
localize(L.HEADER_DESCRIPTIONS, {
	...
	[-1000188] = "Requires Archaeology (225+) to activate. Activate all 4 of the artifacts to spawn the boss. If the boss you want doesn't spawn, do NOT kill the one that did. Instead, zone out and wait for 30 minutes. Once you zone back, there will sometimes be a new boss waiting for you.",
	[-1000195] = "The following minigames cost one Darkmoon Game Token to play and have a daily quest that grants you prize tickets as well as a number of associated achievements.",
	[-1000198] = "In order to maximize your score, wait for the current mark to disappear then aim towards the middle target. As soon as any green mark appear, press 1 immediately and during the short cast time, move your gun to point at the left or right target if necessary.",
	[-1000199] = "Located near the entrance, guests receive a mallet to whack some stuffed gnolls that pop out of nine barrels in the area. Players will have 60 seconds to earn 30 points. The gnolls come in three types: normal, Hogger, and baby, awarding 1 point, 3 points, or a knockdown, respectively.",
	...
	[-1000262] = "These rewards were made available to anyone who purchased a Collector's Edition of Diablo III.",
	...
	[-1000276] = "The following item sets were implemented as boosted character rewards for recipients of the Scroll of Resurrection.\n\nThey were later added to vendors in Mount Hyjal and Vash'jir once the Scroll of Resurrection Service was retired.",
...
localize(L.HEADER_ICONS, {
	...
	[-1000188] = "Interface/Icons/TRADE_ARCHAEOLOGY",
	...
	[-1000195] = "Interface/Icons/inv_misc_ticket_darkmoon_01",
	[-1000198] = "Interface/Icons/inv_weapon_rifle_01",
	[-1000199] = "Interface/Icons/inv_hammer_32",
	...
	[-1000262] = "Interface/Icons/DiabloAnniversary_HoradricCube",
	...
	[-1000276] = _.asset("Promotion_Scroll_of_Rez"),
	[-1000277] = "Interface/Icons/inv_jewelry_amulet_03",
	[-1000278] = "Interface/Icons/ACHIEVEMENT_GUILDPERK_LADYLUCK",
...
localize(L.HEADER_NAMES, {
	...
	[-1000198] = "Galería de tiro",
	[-1000199] = "Golpea al gnoll",
...
localize(L.HEADER_NAMES, {
	...
	[-1000188] = "L'antre de la Folie",
	[-1000194] = "Foire de Sombrelune",
	[-1000198] = "Stand de tir",
	[-1000199] = "Cogne-Gnoll",
...
localize(L.HEADER_NAMES, {
	...
	[-1000198] = "Tiro a Segno",
	[-1000199] = "Pesta-lo-Gnoll",
...
localize(L.HEADER_NAMES, {
	...
	[-1000198] = "Galeria de tiro",
	[-1000199] = "Pancada-no-Gnoll",
