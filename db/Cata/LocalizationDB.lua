...
localize(L.HEADER_NAMES, {
	...
	[-1000206] = select(2,GetAchievementInfo(5512)),
	[-1000207] = select(2,GetAchievementInfo(5863)),
	[-1000208] = select(2,GetAchievementInfo(6131)),
	...
	[-1000253] = SCROLL_OF_RESURRECTION,
...
localize(L.HEADER_DESCRIPTIONS, {
	...
	[-1000235] = "These rewards were made available to anyone who purchased a Collector's Edition of Diablo III.",
	...
	[-1000253] = "The following item sets were implemented as boosted character rewards for recipients of the Scroll of Resurrection.\n\nThey were later added to vendors in Mount Hyjal and Vash'jir once the Scroll of Resurrection Service was retired.",
...
localize(L.HEADER_ICONS, {
	...
	[-1000253] = _.asset("Promotion_Scroll_of_Rez"),
	[-1000254] = "Interface/Icons/inv_jewelry_amulet_03",
	[-1000255] = "Interface/Icons/ACHIEVEMENT_GUILDPERK_LADYLUCK",
