...
localize(L.HEADER_NAMES, {
	...
	[-1000177] = "Minigames",
	[-1000180] = "Shooting Gallery",
	[-1000181] = "Whack-a-Gnoll",
	...
	[-1000210] = select(2,GetAchievementInfo(5512)),
	[-1000211] = select(2,GetAchievementInfo(5863)),
	[-1000212] = select(2,GetAchievementInfo(6131)),
	...
	[-1000257] = SCROLL_OF_RESURRECTION,
...
localize(L.HEADER_DESCRIPTIONS, {
	...
	[-1000177] = "The following minigames cost one Darkmoon Game Token to play and have a daily quest that grants you prize tickets as well as a number of associated achievements.",
	[-1000180] = "In order to maximize your score, wait for the current mark to disappear then aim towards the middle target. As soon as any green mark appear, press 1 immediately and during the short cast time, move your gun to point at the left or right target if necessary.",
	[-1000181] = "Located near the entrance, guests receive a mallet to whack some stuffed gnolls that pop out of nine barrels in the area. Players will have 60 seconds to earn 30 points. The gnolls come in three types: normal, Hogger, and baby, awarding 1 point, 3 points, or a knockdown, respectively.",
	...
	[-1000257] = "The following item sets were implemented as boosted character rewards for recipients of the Scroll of Resurrection.\n\nThey were later added to vendors in Mount Hyjal and Vash'jir once the Scroll of Resurrection Service was retired.",
...
localize(L.HEADER_ICONS, {
	...
	[-1000177] = "Interface/Icons/inv_misc_ticket_darkmoon_01",
	[-1000180] = "Interface/Icons/inv_weapon_rifle_01",
	[-1000181] = "Interface/Icons/inv_hammer_32",
	...
	[-1000257] = _.asset("Promotion_Scroll_of_Rez"),
	[-1000258] = "Interface/Icons/inv_jewelry_amulet_03",
	[-1000259] = "Interface/Icons/ACHIEVEMENT_GUILDPERK_LADYLUCK",
...
localize(L.HEADER_NAMES, {
	...
	[-1000180] = "Galería de tiro",
	[-1000181] = "Golpea al gnoll",
...
localize(L.HEADER_NAMES, {
	...
	[-1000180] = "Tiro a Segno",
	[-1000181] = "Pesta-lo-Gnoll",
...
localize(L.HEADER_NAMES, {
	...
	[-1000180] = "Galeria de tiro",
	[-1000181] = "Pancada-no-Gnoll",
