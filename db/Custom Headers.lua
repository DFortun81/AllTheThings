...
for key,value in pairs({
	...
	[-1000086] = "Interface/Icons/diabloanniversary_achievement",
...
for key,value in pairs({
	...
	[-1000085] = "Diablo Events",
	[-1000086] = "Diablo 20th Anniversary",
	[-1000087] = C_PetJournal.GetPetInfoBySpeciesID(179),
}) do a[key] = value; end
...
for key,value in pairs({
	...
	[-1000087] = "This is a Battlegrounds-based event that coincides with the beginning of the Summer Olympic games. The only time this was celebrated was in 2008 to correspond to the Beijing Olympics, and although there appeared to be the intention to repeat this event, it never returned.",
}) do a[key] = value; end
...
for key,value in pairs({
	...
	[-1000086] = "20. Geburtstag von Diablo",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000086] = "20e anniversaire de Diablo",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000085] = "События Diablo",
	[-1000086] = "20-ая годовщина Diablo",
}) do a[key] = value; end
end
