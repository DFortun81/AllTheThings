...
_.HeaderConstants = {
	...
	BREWFEST_HEADER = -1000245,
	BUILDINGS = -1000085,
	CALL_OF_THE_SCARAB_HEADER = -1000246,
	CHILDRENS_WEEK_HEADER = -1000247,
	COMMON_BOSS_DROPS = -1000009,
	COMMON_DUNGEON_DROP = -1000011,
	COMMON_VENDOR_ITEMS = -1000012,
	CRAFTED_ITEMS = -1000013,
	DARKMOON_FAIRE_HEADER = -1000248,
	DAY_OF_THE_DEAD_HEADER = -1000249,
	DISCOVERY = -1000015,
	DROPS = -1000016,
	EMISSARY_QUESTS = -1000017,
	FACTIONS = -1000019,
	FEAST_OF_WINTER_VEIL_HEADER = -1000250,
	FLIGHT_PATHS = -1000020,
	FOLLOWERS = -1000021,
	FREE_T_SHIRT_DAY_HEADER = -1000251,
	HALLOWS_END_HEADER = -1000252,
	HARVEST_FESTIVAL_HEADER = -1000253,
	HOLIDAYS = -1000023,
	HONOR_TITLES = -1000130,
	IN_GAME_SHOP = -1000089,
	KALIMDOR_CUP_HEADER = -1000254,
	LEGENDARIES = -1000098,
	LOVE_IS_IN_THE_AIR_HEADER = -1000256,
	LUNAR_FESTIVAL_HEADER = -1000257,
	MARCH_OF_THE_TADPOLES_HEADER = -1000258,
	MIDSUMMER_FIRE_FESTIVAL_HEADER = -1000259,
	NOBLEGARDEN_HEADER = -1000260,
	PET_BATTLE = -1000027,
	PILGRIMS_BOUNTY_HEADER = -1000261,
	PIRATES_DAY_HEADER = -1000262,
	PROFESSIONS = -1000028,
	PVP = -1000132,
	...
	REWARDS = -1000031,
	SECRETS = -1000033,
	SECRETS_OF_AZEROTH_HEADER = -1000263,
	SPECIAL = -1000035,
	THE_GREAT_GNOMEREGAN_RUN_HEADER = -1000265,
	THOUSAND_BOAT_BASH_HEADER = -1000266,
	TREASURES = -1000036,
	TRIAL_OF_STYLE_HEADER = -1000268,
	VENDORS = -1000037,
	WARFRONT = -1000074,
	WEAPONS = -1000071,
...
for key,value in pairs({
	...
	[-1000245] = _.asset("Holiday_brewfest"),
	[-1000246] = _.asset("Holiday_call_of_the_scarab"),
	[-1000247] = _.asset("Holiday_Children"),
	[-1000248] = _.asset("Event_dmf"),
	[-1000249] = _.asset("Holiday_Day_of_the_Dead"),
	[-1000250] = _.asset("Holiday_winter_veil"),
	[-1000251] = _.asset("Holiday_Tshirt"),
	[-1000252] = _.asset("Holiday_hallows_end"),
	[-1000253] = _.asset("Holiday_Harvestfest"),
	[-1000254] = "Interface/Icons/misc_arrowrightcalendar_kalimdorcupstart",
	[-1000255] = "Interface/Icons/inv_fishingpole_03",
	[-1000256] = _.asset("Holiday_love"),
	[-1000257] = _.asset("Holiday_Lunar"),
	[-1000258] = _.asset("Holiday_Marchofmurloc"),
	[-1000259] = _.asset("Holiday_Midsummer"),
	[-1000260] = _.asset("Holiday_noblegarden"),
	[-1000261] = _.asset("Holiday_Pilgrim"),
	[-1000262] = _.asset("Holiday_Pirate"),
	[-1000263] = "Interface/Icons/calendar_secretsofazerothstart",
	[-1000264] = "Interface/Icons/inv_misc_fish_06",
	[-1000265] = "236445",
	[-1000267] = _.asset("Difficulty_Timewalking"),
	[-1000268] = _.asset("Holiday_Trialofstyle"),
...
for key,value in pairs({
	...
	[-1000243] = "Ensembles",
	[-1000244] = "Arsenals",
	[-1000245] = select(1,GetCategoryInfo(162)),
	[-1000246] = "Call of the Scarab",
	[-1000247] = select(1,GetCategoryInfo(163)),
	[-1000248] = "Darkmoon Faire",
	[-1000249] = "Day of the Dead",
	[-1000250] = GetSpellInfo(21953),
	[-1000251] = "Free T-Shirt Day",
	[-1000252] = select(1,GetCategoryInfo(158)),
	[-1000253] = "Harvest Festival",
	[-1000254] = "Kalimdor Cup",
	[-1000255] = "Kalu'ak Fishing Derby",
	[-1000256] = select(1,GetCategoryInfo(187)),
	[-1000257] = select(1,GetCategoryInfo(160)),
	[-1000258] = "March of the Tadpoles",
	[-1000259] = "Midsummer Fire Festival",
	[-1000260] = select(1,GetCategoryInfo(159)),
	[-1000261] = select(1,GetCategoryInfo(14981)),
	[-1000262] = "Pirates' Day",
	[-1000263] = "Secrets of Azeroth",
	[-1000264] = "Stranglethorn Fishing Extravaganza",
	[-1000265] = "The Great Gnomeregan Run",
	[-1000266] = "Thousand Boat Bash",
	[-1000267] = GetDifficultyInfo(24),
	[-1000268] = "Trial of Style",
	[-1000269] = "WoW's Anniversary",
	[-1000270] = select(2,GetAchievementInfo(2398)),
	[-1000271] = select(2,GetAchievementInfo(4400)),
	[-1000272] = select(2,GetAchievementInfo(5512)),
	[-1000273] = select(2,GetAchievementInfo(5863)),
	[-1000274] = select(2,GetAchievementInfo(6131)),
	[-1000275] = select(2,GetAchievementInfo(7853)),
	[-1000276] = select(2,GetAchievementInfo(8820)),
	[-1000277] = select(2,GetAchievementInfo(10058)),
	[-1000278] = select(2,GetAchievementInfo(10741)),
	[-1000279] = select(2,GetAchievementInfo(11848)),
	[-1000280] = select(2,GetAchievementInfo(12827)),
	[-1000281] = select(2,GetAchievementInfo(13917)),
	[-1000282] = select(2,GetAchievementInfo(14271)),
	[-1000283] = select(2,GetAchievementInfo(14942)),
	[-1000284] = select(2,GetAchievementInfo(15218)),
}) do a[key] = value; end
...
for key,value in pairs({
	...
	[-1000249] = "Tag der Toten",
	[-1000255] = "Angelwettstreit der Kalu'ak",
	[-1000259] = "Sonnenwendfest",
	[-1000262] = "Piratentag",
...
for key,value in pairs({
	...
	[-1000249] = "Festividad de los Muertos",
	[-1000255] = "Competición de pesca Kalu'ak",
	[-1000259] = "Festival del Fuego del Solsticio de Verano",
	[-1000262] = "Día de los Piratas",
...
for key,value in pairs({
	...
	[-1000249] = "Jour des morts",
	[-1000255] = "Le tournoi de pêche kalu'ak",
	[-1000259] = "Fête du Feu du solstice d’été",
	[-1000262] = "Jour des pirates",
...
for key,value in pairs({
	...
	[-1000249] = "Giorno dei Morti",
	[-1000255] = "La gara di pesca dei Kalu'ak",
	[-1000259] = "Fuochi di Mezza Estate",
	[-1000262] = "Giorno dei Pirati",
...
for key,value in pairs({
	...
	[-1000249] = "Dia dos Mortos",
	[-1000255] = "Campeonato de Pesca dos Kalu'ak",
	[-1000259] = "Festival do Fogo do Solstício",
	[-1000262] = "Dia dos Piratas",
...
for key,value in pairs({
	...
	[-1000249] = "День мертвых",
	[-1000255] = "Калуакское рыбоборье",
	[-1000259] = "Огненный Солнцеворот",
	[-1000262] = "День пирата",
