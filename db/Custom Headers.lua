...
_.HeaderConstants = {
	...
	BREWFEST_HEADER = -1000242,
	BUILDINGS = -1000085,
	CALL_OF_THE_SCARAB_HEADER = -1000243,
	CHILDRENS_WEEK_HEADER = -1000244,
	...
	DAY_OF_THE_DEAD_HEADER = -1000246,
	DISCOVERY = -1000015,
	DROPS = -1000016,
	EMISSARY_QUESTS = -1000017,
	FACTIONS = -1000019,
	FEAST_OF_WINTER_VEIL_HEADER = -1000247,
	FLIGHT_PATHS = -1000020,
	FOLLOWERS = -1000021,
	FREE_T_SHIRT_DAY_HEADER = -1000248,
	HALLOWS_END_HEADER = -1000249,
	HARVEST_FESTIVAL_HEADER = -1000250,
	HOLIDAYS = -1000023,
	HONOR_TITLES = -1000130,
	IN_GAME_SHOP = -1000089,
	KALIMDOR_CUP_HEADER = -1000251,
	LEGENDARIES = -1000098,
	LOVE_IS_IN_THE_AIR_HEADER = -1000253,
	LUNAR_FESTIVAL_HEADER = -1000254,
	MARCH_OF_THE_TADPOLES_HEADER = -1000255,
	MIDSUMMER_FIRE_FESTIVAL_HEADER = -1000256,
	NOBLEGARDEN_HEADER = -1000257,
	PET_BATTLE = -1000027,
	PILGRIMS_BOUNTY_HEADER = -1000258,
	PIRATES_DAY_HEADER = -1000259,
	PROFESSIONS = -1000028,
	PVP = -1000132,
	...
	REWARDS = -1000031,
	SECRETS = -1000033,
	SECRETS_OF_AZEROTH_HEADER = -1000260,
	SPECIAL = -1000035,
	THE_GREAT_GNOMEREGAN_RUN_HEADER = -1000262,
	THOUSAND_BOAT_BASH_HEADER = -1000263,
	TREASURES = -1000036,
...
for key,value in pairs({
	...
	[-1000210] = "Interface/Icons/ability_bossmagistrix_timewarp1",
	...
	[-1000242] = _.asset("Holiday_brewfest"),
	[-1000243] = _.asset("Holiday_call_of_the_scarab"),
	[-1000244] = _.asset("Holiday_Children"),
	[-1000245] = _.asset("Event_dmf"),
	[-1000246] = _.asset("Holiday_Day_of_the_Dead"),
	[-1000247] = _.asset("Holiday_winter_veil"),
	[-1000248] = _.asset("Holiday_Tshirt"),
	[-1000249] = _.asset("Holiday_hallows_end"),
	[-1000250] = _.asset("Holiday_Harvestfest"),
	[-1000251] = "Interface/Icons/misc_arrowrightcalendar_kalimdorcupstart",
	[-1000252] = "Interface/Icons/inv_fishingpole_03",
	[-1000253] = _.asset("Holiday_love"),
	[-1000254] = _.asset("Holiday_Lunar"),
	[-1000255] = _.asset("Holiday_Marchofmurloc"),
	[-1000256] = _.asset("Holiday_Midsummer"),
	[-1000257] = _.asset("Holiday_noblegarden"),
	[-1000258] = _.asset("Holiday_Pilgrim"),
	[-1000259] = _.asset("Holiday_Pirate"),
	[-1000260] = "Interface/Icons/calendar_secretsofazerothstart",
	[-1000261] = "Interface/Icons/inv_misc_fish_06",
	[-1000262] = "236445",
	[-1000264] = _.asset("Difficulty_Timewalking"),
...
for key,value in pairs({
	...
	[-1000242] = select(1,GetCategoryInfo(162)),
	[-1000243] = "Call of the Scarab",
	[-1000244] = select(1,GetCategoryInfo(163)),
	[-1000245] = "Darkmoon Faire",
	[-1000246] = "Day of the Dead",
	[-1000247] = GetSpellInfo(21953),
	[-1000248] = "Free T-Shirt Day",
	[-1000249] = select(1,GetCategoryInfo(158)),
	[-1000250] = "Harvest Festival",
	[-1000251] = "Kalimdor Cup",
	[-1000252] = "Kalu'ak Fishing Derby",
	[-1000253] = select(1,GetCategoryInfo(187)),
	[-1000254] = select(1,GetCategoryInfo(160)),
	[-1000255] = "March of the Tadpoles",
	[-1000256] = "Midsummer Fire Festival",
	[-1000257] = select(1,GetCategoryInfo(159)),
	[-1000258] = select(1,GetCategoryInfo(14981)),
	[-1000259] = "Pirates' Day",
	[-1000260] = "Secrets of Azeroth",
	[-1000261] = "Stranglethorn Fishing Extravaganza",
	[-1000262] = "The Great Gnomeregan Run",
	[-1000263] = "Thousand Boat Bash",
	[-1000264] = GetDifficultyInfo(24),
	[-1000265] = "Trial of Style",
	[-1000266] = "WoW's Anniversary",
	[-1000267] = select(2,GetAchievementInfo(2398)),
	[-1000268] = select(2,GetAchievementInfo(4400)),
	[-1000269] = select(2,GetAchievementInfo(5512)),
	[-1000270] = select(2,GetAchievementInfo(5863)),
	[-1000271] = select(2,GetAchievementInfo(6131)),
	[-1000272] = select(2,GetAchievementInfo(7853)),
	[-1000273] = select(2,GetAchievementInfo(8820)),
	[-1000274] = select(2,GetAchievementInfo(10058)),
	[-1000275] = select(2,GetAchievementInfo(10741)),
	[-1000276] = select(2,GetAchievementInfo(11848)),
	[-1000277] = select(2,GetAchievementInfo(12827)),
	[-1000278] = select(2,GetAchievementInfo(13917)),
	[-1000279] = select(2,GetAchievementInfo(14271)),
	[-1000280] = select(2,GetAchievementInfo(14942)),
	[-1000281] = select(2,GetAchievementInfo(15218)),
}) do a[key] = value; end
...
for key,value in pairs({
	...
	[-1000212] = "These promotions happened during the time Dragonflight was the most recent content between 25th October 2022 & 12th November 2024.\n\nThey are listed in the order of their first appearance.",
...
for key,value in pairs({
	...
	[-1000246] = "Tag der Toten",
	[-1000252] = "Angelwettstreit der Kalu'ak",
	[-1000256] = "Sonnenwendfest",
	[-1000259] = "Piratentag",
	[-1000261] = "Anglerwettbewerb im Schlingendorntal",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000246] = "Festividad de los Muertos",
	[-1000252] = "Competición de pesca Kalu'ak",
	[-1000256] = "Festival del Fuego del Solsticio de Verano",
	[-1000259] = "Día de los Piratas",
	[-1000261] = "Gran espectáculo de pesca de Tuercespina",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000246] = "Jour des morts",
	[-1000252] = "Le tournoi de pêche kalu'ak",
	[-1000256] = "Fête du Feu du solstice d’été",
	[-1000259] = "Jour des pirates",
	[-1000261] = "Concours de pêche de Strangleronce",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000246] = "Giorno dei Morti",
	[-1000252] = "La gara di pesca dei Kalu'ak",
	[-1000256] = "Fuochi di Mezza Estate",
	[-1000259] = "Giorno dei Pirati",
	[-1000261] = "Gara di Pesca a Rovotorto",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000246] = "Dia dos Mortos",
	[-1000252] = "Campeonato de Pesca dos Kalu'ak",
	[-1000256] = "Festival do Fogo do Solstício",
	[-1000259] = "Dia dos Piratas",
	[-1000261] = "Festerê de Pesca da Selva do Espinhaço",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000246] = "День мертвых",
	[-1000252] = "Калуакское рыбоборье",
	[-1000256] = "Огненный Солнцеворот",
	[-1000259] = "День пирата",
	[-1000261] = "Рыбомания Тернистой долины",
}) do a[key] = value; end
end
