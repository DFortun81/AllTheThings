...
_.HeaderConstants = {
	...
	BREWFEST_HEADER = -1000246,
	BUILDINGS = -1000085,
	CALL_OF_THE_SCARAB_HEADER = -1000247,
	...
	DARKMOON_FAIRE_HEADER = -1000249,
	DAY_OF_THE_DEAD_HEADER = -1000255,
	DISCOVERY = -1000015,
	DROPS = -1000016,
	EMISSARY_QUESTS = -1000017,
	FACTIONS = -1000019,
	FEAST_OF_WINTER_VEIL_HEADER = -1000256,
	FLIGHT_PATHS = -1000020,
	FOLLOWERS = -1000021,
	FREE_T_SHIRT_DAY_HEADER = -1000257,
	HALLOWS_END_HEADER = -1000258,
	HARVEST_FESTIVAL_HEADER = -1000259,
	HOLIDAYS = -1000023,
	HONOR_TITLES = -1000130,
	IN_GAME_SHOP = -1000089,
	KALIMDOR_CUP_HEADER = -1000260,
	LEGENDARIES = -1000098,
	LOVE_IS_IN_THE_AIR_HEADER = -1000262,
	LUNAR_FESTIVAL_HEADER = -1000263,
	MARCH_OF_THE_TADPOLES_HEADER = -1000264,
	MIDSUMMER_FIRE_FESTIVAL_HEADER = -1000265,
	NOBLEGARDEN_HEADER = -1000266,
	PET_BATTLE = -1000027,
	PILGRIMS_BOUNTY_HEADER = -1000267,
	PIRATES_DAY_HEADER = -1000268,
	PROFESSIONS = -1000028,
	PVP = -1000132,
	...
	REWARDS = -1000031,
	SECRETS = -1000033,
	SECRETS_OF_AZEROTH_HEADER = -1000269,
	SPECIAL = -1000035,
	THE_GREAT_GNOMEREGAN_RUN_HEADER = -1000271,
	THOUSAND_BOAT_BASH_HEADER = -1000272,
	TREASURES = -1000036,
	TRIAL_OF_STYLE_HEADER = -1000274,
	VENDORS = -1000037,
	WARFRONT = -1000074,
	WEAPONS = -1000071,
...
for key,value in pairs({
	...
	[-1000210] = "Interface/Icons/inv_misc_toy_03",
	[-1000211] = "Interface/Icons/ability_bossmagistrix_timewarp1",
	[-1000212] = _.asset("Expansion_SL"),
	[-1000213] = _.asset("Expansion_DF"),
	[-1000214] = "136101",
	[-1000215] = _.asset("Promotion_Blizzcon"),
	[-1000216] = _.asset("Promotion_Collector"),
	[-1000218] = "Interface/Icons/DiabloAnniversary_HoradricCube",
	[-1000219] = "Interface/Icons/DiabloAnniversary_HoradricCube",
	[-1000220] = "Interface/Icons/DiabloAnniversary_HoradricCube",
	[-1000221] = "Interface/Icons/inv_pet_babywinston",
	[-1000222] = "Interface/Icons/Inv_sigil_thorim",
	[-1000223] = "Interface/Icons/Ability_pet_baneling",
	[-1000224] = "Interface/Icons/inv_archonpet",
	[-1000225] = _.asset("Expansion_TBC"),
	[-1000226] = "Interface/Icons/INV_Mace_1H_Doomhammer",
	[-1000228] = _.asset("Expansion_WOTLK"),
	[-1000229] = _.asset("Expansion_CLASSIC"),
	[-1000230] = "Interface/Icons/DiabloAnniversary_HoradricCube",
	[-1000231] = "Interface/Icons/diabloanniversary_achievement",
	[-1000232] = "Interface/Icons/inv_misc_bag_horadricsatchel",
	[-1000233] = "Interface/Icons/Inv_misc_rune_01",
	[-1000234] = "Interface/Icons/Inv_misc_rune_01",
	[-1000235] = "Interface/Icons/ability_shaman_stormstrike",
	[-1000236] = "Interface/Icons/INV_Drink_33_BloodRedAle",
	[-1000237] = "Interface/Icons/Spell_Misc_Drink",
	[-1000238] = "Interface/Icons/achievement_reputation_08",
	[-1000239] = _.asset("Promotion_Scroll_of_Rez"),
	[-1000240] = "Interface/Icons/inv_jewelry_amulet_03",
	[-1000241] = "Interface/Icons/ACHIEVEMENT_GUILDPERK_LADYLUCK",
	[-1000242] = "Interface/Icons/INV_MISC_FILM_01",
	...
	[-1000246] = _.asset("Holiday_brewfest"),
	[-1000247] = _.asset("Holiday_call_of_the_scarab"),
	[-1000248] = _.asset("Holiday_Children"),
	[-1000249] = _.asset("Event_dmf"),
	[-1000250] = "Interface/Icons/inv_misc_ticket_darkmoon_01",
	[-1000251] = "Interface/Icons/spell_lifegivingspeed",
	[-1000252] = "Interface/Icons/inv_shoulder_leather_firelandsdruid_d_01",
	[-1000253] = "Interface/Icons/inv_weapon_rifle_01",
	[-1000254] = "Interface/Icons/inv_hammer_32",
	[-1000255] = _.asset("Holiday_Day_of_the_Dead"),
	[-1000256] = _.asset("Holiday_winter_veil"),
	[-1000257] = _.asset("Holiday_Tshirt"),
	[-1000258] = _.asset("Holiday_hallows_end"),
	[-1000259] = _.asset("Holiday_Harvestfest"),
	[-1000260] = "Interface/Icons/misc_arrowrightcalendar_kalimdorcupstart",
	[-1000261] = "Interface/Icons/inv_fishingpole_03",
	[-1000262] = _.asset("Holiday_love"),
	[-1000263] = _.asset("Holiday_Lunar"),
	[-1000264] = _.asset("Holiday_Marchofmurloc"),
	[-1000265] = _.asset("Holiday_Midsummer"),
	[-1000266] = _.asset("Holiday_noblegarden"),
	[-1000267] = _.asset("Holiday_Pilgrim"),
	[-1000268] = _.asset("Holiday_Pirate"),
	[-1000269] = "Interface/Icons/calendar_secretsofazerothstart",
	[-1000270] = "Interface/Icons/inv_misc_fish_06",
	[-1000271] = "236445",
	[-1000273] = _.asset("Difficulty_Timewalking"),
	[-1000274] = _.asset("Holiday_Trialofstyle"),
...
for key,value in pairs({
	...
	[-1000210] = "Uuna's World Tour",
	[-1000211] = "Gear Update",
	[-1000212] = "Shadowlands Seasonal Promotions",
	[-1000213] = "Dragonflight Seasonal Promotions",
	[-1000214] = "Amazon Prime Gaming",
	[-1000215] = "BlizzCon",
	[-1000216] = "Collector's Edition",
	[-1000218] = "Diablo III",
	[-1000219] = "Diablo III: Reaper of Souls",
	[-1000220] = "Diablo IV",
	[-1000221] = "Overwatch: Origins",
	[-1000222] = "Starcraft II: Wings of Liberty",
	[-1000223] = "Starcraft II: Heart of the Swarm",
	[-1000224] = "Starcraft II: Legacy of the Void",
	[-1000225] = "TBC Classic Deluxe Edition",
	[-1000226] = "Warcraft III Spoils of War Edition",
	[-1000228] = "WotLK Classic Northrend Epic Upgrade",
	[-1000229] = "WoW 15th Anniversary Collector's Edition",
	[-1000230] = "Diablo Events",
	[-1000231] = "Diablo 20th Anniversary",
	[-1000232] = "A Greedy Emissary",
	[-1000233] = "Hearthstone",
	[-1000234] = "Hearthstone Mercenaries",
	[-1000235] = "Heroes of the Storm",
	[-1000236] = "iCoke",
	[-1000237] =  AUCTION_CATEGORY_MISCELLANEOUS,
	[-1000238] = REFER_A_FRIEND,
	[-1000239] = SCROLL_OF_RESURRECTION,
	[-1000240] = C_PetJournal.GetPetInfoBySpeciesID(179),
	[-1000241] = BATTLE_PET_SOURCE_9,
	[-1000242] = "Warcraft Movie",
	[-1000243] = "Ensembles",
	[-1000244] = "Arsenals",
	[-1000245] = "Sourceless",
	[-1000246] = select(1,GetCategoryInfo(162)),
	[-1000247] = "Call of the Scarab",
	[-1000248] = select(1,GetCategoryInfo(163)),
	[-1000249] = "Darkmoon Faire",
	[-1000250] = "Minigames",
	[-1000251] = "Darkmoon Dance",
	[-1000252] = "Firebird's Challenge",
	[-1000253] = "Shooting Gallery",
	[-1000254] = "Whack-a-Gnoll",
	[-1000255] = "Day of the Dead",
	[-1000256] = GetSpellInfo(21953),
	[-1000257] = "Free T-Shirt Day",
	[-1000258] = select(1,GetCategoryInfo(158)),
	[-1000259] = "Harvest Festival",
	[-1000260] = "Kalimdor Cup",
	[-1000261] = "Kalu'ak Fishing Derby",
	[-1000262] = select(1,GetCategoryInfo(187)),
	[-1000263] = select(1,GetCategoryInfo(160)),
	[-1000264] = "March of the Tadpoles",
	[-1000265] = "Midsummer Fire Festival",
	[-1000266] = select(1,GetCategoryInfo(159)),
	[-1000267] = select(1,GetCategoryInfo(14981)),
	[-1000268] = "Pirates' Day",
	[-1000269] = "Secrets of Azeroth",
	[-1000270] = "Stranglethorn Fishing Extravaganza",
	[-1000271] = "The Great Gnomeregan Run",
	[-1000272] = "Thousand Boat Bash",
	[-1000273] = GetDifficultyInfo(24),
	[-1000274] = "Trial of Style",
	[-1000275] = "WoW's Anniversary",
	[-1000276] = select(2,GetAchievementInfo(2398)),
	[-1000277] = select(2,GetAchievementInfo(4400)),
	[-1000278] = select(2,GetAchievementInfo(5512)),
	[-1000279] = select(2,GetAchievementInfo(5863)),
	[-1000280] = select(2,GetAchievementInfo(6131)),
	[-1000281] = select(2,GetAchievementInfo(7853)),
	[-1000282] = select(2,GetAchievementInfo(8820)),
	[-1000283] = select(2,GetAchievementInfo(10058)),
	[-1000284] = select(2,GetAchievementInfo(10741)),
	[-1000285] = select(2,GetAchievementInfo(11848)),
	[-1000286] = select(2,GetAchievementInfo(12827)),
	[-1000287] = select(2,GetAchievementInfo(13917)),
	[-1000288] = select(2,GetAchievementInfo(14271)),
	[-1000289] = select(2,GetAchievementInfo(14942)),
	[-1000290] = select(2,GetAchievementInfo(15218)),
}) do a[key] = value; end
...
for key,value in pairs({
	...
	[-1000210] = "Congrats on making it this far!  Now it's time to take your favorite li'l ghost on a world tour.",
	[-1000212] = "These promotions happened during the time Shadowlands was the most recent content between 13th October 2020 & 25th October 2022.\n\nThey are listed in the order of their first appearance.",
	[-1000213] = "These promotions happened during the time Dragonflight was the most recent content between 25th October 2022 & 12th November 2024.\n\nThey are listed in the order of their first appearance.",
	[-1000214] = "Amazon Prime Gaming offers in-game content for World of Warcraft Retail. Depending on your country, Amazon Prime (which includes Gaming) costs between 4-16 $/€ per month with the occasional monthly free trial available.\n\nCreate a Twitch account & connect it with your Prime Account. Next connect your B.Net Account with your Twitch Account. Lastly claim your monthly reward under 'gaming.amazon.com/loot/wow'.\n\nAmazon Prime also comes with a free Twitch subscription which you can use to support AllTheThings.\n\nTwitch.tv/Crieve\nTwitch.tv/Goldenshacal",
	[-1000218] = "These rewards were made available to anyone who purchased a Collector's Edition of Diablo III.",
	[-1000219] = "These rewards were made available to anyone who purchased the Collector's Edition of the Reaper of Souls expansion for Diablo III.",
	[-1000220] = "Granted to owners of Diablo IV Base Version.",
	[-1000221] = "These rewards are available to anyone who purchases the Collector's Edition for Overwatch: Origins.",
	[-1000222] = "These rewards are available to anyone who purchased the Collector's Edition for Starcraft II: Wings of Liberty.",
	[-1000223] = "These rewards are available to anyone who purchased the Collector's Edition for Starcraft II: Heart of the Swarm.",
	[-1000224] = "These rewards are available to anyone who purchased the Collector's Edition for Starcraft II: Legacy of the Void.",
	[-1000225] = "These rewards were made available to anyone who purchased a Deluxe Edition of TBC Classic. (not to be confused with the original Burning Crusade Collector's Edition)",
	[-1000226] = "These rewards are available to anyone who purchased the Spoils of War Edition of Warcraft III: Reforged.",
	...
	[-1000229] = "These rewards were made available to anyone who purchased a World of Warcraft 15th Anniversary Collector's Edition.",
	[-1000233] = "Win 3 games in Hearthstone to qualify for these rewards.\n\nThe game is free, go get it!\n\nNOTE: You can thank IceQ1337 for this!",
	[-1000234] = "Complete the Mercenaries Mode tutorial in Hearthstone and send your party on a mission in order to receive this reward.",
	...
	[-1000239] = "The following item sets were implemented as boosted character rewards for recipients of the Scroll of Resurrection.\n\nThey were later added to vendors in Mount Hyjal and Vash'jir once the Scroll of Resurrection Service was retired.",
	[-1000240] = "This is a Battlegrounds-based event that coincides with the beginning of the Summer Olympic games. The only time this was celebrated was in 2008 to correspond to the Beijing Olympics, and although there appeared to be the intention to repeat this event, it never returned.",
	[-1000242] = "These were rewarded for logging in at least once per faction while the Warcraft movie was still in theaters.",
	[-1000245] = "This Category contains Things that probably exist in the game but no known source.",
	[-1000250] = "The following minigames cost one Darkmoon Game Token to play and have a daily quest that grants you prize tickets as well as a number of associated achievements.",
	[-1000251] = "To play the Darkmoon Faire Dance game, talk to Simon Sezdans in front of the South Pavillion. Each attempt at the Darkmoon Faire Dance game costs one Darkmoon Game Token. Talking to Simon will also set the difficulty for your dance game:\n  Just something fun and easygoing! (Easy)\n  I'd like a little challenge! (Medium)\n  Show me your moves, don't hold back! (Hard)\n\nDarkmoon Dance Master is not a rhythm game like most dance games are, but a memory game instead. You will have a dancer next to you in the dancing arena, who will start a sequence of moves highlighted by runes in front of him. Easy games will have a sequence of 3 runes at a time, Medium games 4 runes, and Hard games 5 runes.\n\nThere are three possible runes: Chicken Dance (Yellow), Power Spin (Purple) and Fist Pump (Blue). Once the opponent finishes their sequence, you have 5 seconds to match the exact sequence used by the dancer. There is no punishment for taking your time to complete the sequence, as long as you do it in time and don't miss any steps.\n\nThe game ends after 5 rounds (if you complete all steps successfully), but can end prematurely if you miss too many steps. Missing no steps will grant you a perfect score.",
	[-1000252] = "Roughly 60 floating rings appear all over the island, but most are not over the Faire area proper and are found in the woods. Players start with ten seconds of flight time and flying through a ring will refresh the buff. Work out a route in such a way that the next ring is always within 10 seconds of the one that is getting flown through, as there are many ways to get cut off.",
	[-1000253] = "In order to maximize your score, wait for the current mark to disappear then aim towards the middle target. As soon as any green mark appear, press 1 immediately and during the short cast time, move your gun to point at the left or right target if necessary.",
	[-1000254] = "Located near the entrance, guests receive a mallet to whack some stuffed gnolls that pop out of nine barrels in the area. Players will have 60 seconds to earn 30 points. The gnolls come in three types: normal, Hogger, and baby, awarding 1 point, 3 points, or a knockdown, respectively.",
	[-1000273] = "Timewalking difficulties needlessly create new Source IDs for items despite having the exact same name, appearance, and display in the Collections Tab.\n\nA plea to the Blizzard Devs: Please clean up the Source ID database and have your Timewalking / Titanforged item variants use the same Source ID as their base assuming the appearances and names are exactly the same. Not only will this make your database much cleaner, but it will also make Completionists excited for rather than dreading the introduction of more Timewalking content.\n\n - Crieve, the Very Bitter Account Completionist that had 99% Ulduar completion and now only has 64% because your team duplicated the Source IDs rather than reuse the existing one.",
	[-1000275] = "This is a yearly recurring event that occurs between the beginning of November and the end of the year.",
}) do a[key] = value; end
...
for key,value in pairs({
	...
	[-1000231] = "20. Geburtstag von Diablo",
	[-1000232] = "Ein gieriger Abgesandter",
	[-1000234] = "Hearthstone Söldner",
	[-1000249] = "Dunkelmond-Jahrmarkt",
	[-1000251] = "Dunkelmond-Jahrmarkt Tanzspiel",
	[-1000252] = "Herausforderung des Feuervogels",
	[-1000253] = "Schießbude",
	[-1000254] = "Hau-den-Gnoll",
	[-1000255] = "Tag der Toten",
	[-1000261] = "Angelwettstreit der Kalu'ak",
	[-1000265] = "Sonnenwendfest",
	[-1000268] = "Piratentag",
	[-1000270] = "Anglerwettbewerb im Schlingendorntal",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000232] = "Un Emisario Codicioso",
	[-1000234] = "Hearthstone Mercenarios",
	[-1000249] = "Feria de la Luna Negra",
	[-1000251] = "Feria de la Luna Negra Juego de Baile",
	[-1000252] = "El desafío del pájaro de fuego",
	[-1000253] = "Galería de tiro",
	[-1000254] = "Golpea al gnoll",
	[-1000255] = "Festividad de los Muertos",
	[-1000261] = "Competición de pesca Kalu'ak",
	[-1000265] = "Festival del Fuego del Solsticio de Verano",
	[-1000268] = "Día de los Piratas",
	[-1000270] = "Gran espectáculo de pesca de Tuercespina",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000210] = "Tour du monde d’Uuna",
	[-1000216] = "Edition Collector",
	[-1000225] = "Édition BC Classic Deluxe",
	[-1000231] = "20e anniversaire de Diablo",
	[-1000232] = "Émissaire cupide",
	[-1000234] = "Hearthstone Mercenaires",
	[-1000249] = "Foire de Sombrelune",
	[-1000251] = "Foire de Sombrelune Jeu de Danse",
	[-1000252] = "Défi de l’Oiseau de feu",
	[-1000253] = "Stand de tir",
	[-1000254] = "Cogne-Gnoll",
	[-1000255] = "Jour des morts",
	[-1000261] = "Le tournoi de pêche kalu'ak",
	[-1000265] = "Fête du Feu du solstice d’été",
	[-1000268] = "Jour des pirates",
	[-1000270] = "Concours de pêche de Strangleronce",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000232] = "Un emissario avido",
	[-1000234] = "Hearthstone Mercenari",
	[-1000249] = "Fiera di Lunacupa",
	[-1000251] = "Fiera di Lunacupa Gioco della Danza",
	[-1000252] = "Sfida dell'Uccello di Fuoco",
	[-1000253] = "Tiro a Segno",
	[-1000254] = "Pesta-lo-Gnoll",
	[-1000255] = "Giorno dei Morti",
	[-1000261] = "La gara di pesca dei Kalu'ak",
	[-1000265] = "Fuochi di Mezza Estate",
	[-1000268] = "Giorno dei Pirati",
	[-1000270] = "Gara di Pesca a Rovotorto",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000232] = "Um Emissário Ganancioso",
	[-1000234] = "Hearthstone Mercenários",
	[-1000249] = "Feira de Negraluna",
	[-1000251] = "Feira de Negraluna Jogo da Dança",
	[-1000252] = "Desafio da Ave Flamejante",
	[-1000253] = "Galeria de tiro",
	[-1000254] = "Pancada-no-Gnoll",
	[-1000255] = "Dia dos Mortos",
	[-1000261] = "Campeonato de Pesca dos Kalu'ak",
	[-1000265] = "Festival do Fogo do Solstício",
	[-1000268] = "Dia dos Piratas",
	[-1000270] = "Festerê de Pesca da Selva do Espinhaço",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000210] = "Приключения с Ууной",
	[-1000212] = "Промо Shadowlands",
	[-1000213] = "Промо Dragonflight",
	[-1000216] = "Коллекционное издание",
	[-1000230] = "События Diablo",
	[-1000231] = "20-ая годовщина Diablo",
	[-1000232] = "Алчный посланец",
	[-1000234] = "Hearthstone Наемники",
	[-1000245] = "Без Источника",
	[-1000249] = "Ярмарка Новолуния",
	[-1000251] = "Ярмарка Новолуния состязании танцоров",
	[-1000252] = "Вызов огнекрыла",
	[-1000253] = "Тир",
	[-1000254] = "Гноллобой",
	[-1000255] = "День мертвых",
	[-1000261] = "Калуакское рыбоборье",
	[-1000265] = "Огненный Солнцеворот",
	[-1000268] = "День пирата",
	[-1000270] = "Рыбомания Тернистой долины",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000216] = "典藏版",
	[-1000218] = "暗黑破坏神III",
	[-1000219] = "暗黑破坏神III：夺魂之镰",
	[-1000220] = "暗黑破坏神IV",
	[-1000221] = "守望先锋：起源",
	[-1000222] = "星际争霸II：自由之翼",
	[-1000223] = "星际争霸II：虫群之心",
	[-1000224] = "星际争霸II：虚空之遗",
	[-1000225] = "燃烧的远征经典怀旧服典藏包",
	[-1000226] = "魔兽争霸III战争嘉奖版",
	[-1000228] = "巫妖王之怒经典怀旧服诺森德史诗礼包",
	[-1000231] = "暗黑破坏神20周年庆",
	[-1000232] = "贪婪的特使",
	[-1000233] = "炉石传说",
	[-1000234] = "炉石传说佣兵战纪",
