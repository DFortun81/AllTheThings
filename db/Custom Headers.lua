...
_.HeaderConstants = {
	...
	DAY_OF_THE_DEAD_HEADER = -1000252,
	DISCOVERY = -1000015,
	DROPS = -1000016,
	EMISSARY_QUESTS = -1000017,
	FACTIONS = -1000019,
	FEAST_OF_WINTER_VEIL_HEADER = -1000253,
	FLIGHT_PATHS = -1000020,
	FOLLOWERS = -1000021,
	FREE_T_SHIRT_DAY_HEADER = -1000254,
	HALLOWS_END_HEADER = -1000255,
	HARVEST_FESTIVAL_HEADER = -1000256,
	HOLIDAYS = -1000023,
	HONOR_TITLES = -1000130,
	IN_GAME_SHOP = -1000089,
	KALIMDOR_CUP_HEADER = -1000257,
	LEGENDARIES = -1000098,
	LOVE_IS_IN_THE_AIR_HEADER = -1000259,
	LUNAR_FESTIVAL_HEADER = -1000260,
	MARCH_OF_THE_TADPOLES_HEADER = -1000261,
	MIDSUMMER_FIRE_FESTIVAL_HEADER = -1000262,
	NOBLEGARDEN_HEADER = -1000263,
	PET_BATTLE = -1000027,
	PILGRIMS_BOUNTY_HEADER = -1000264,
	PIRATES_DAY_HEADER = -1000265,
	PROFESSIONS = -1000028,
	PVP = -1000132,
	...
	REWARDS = -1000031,
	SECRETS = -1000033,
	SECRETS_OF_AZEROTH_HEADER = -1000266,
	SPECIAL = -1000035,
	THE_GREAT_GNOMEREGAN_RUN_HEADER = -1000268,
	THOUSAND_BOAT_BASH_HEADER = -1000269,
	TREASURES = -1000036,
	TRIAL_OF_STYLE_HEADER = -1000271,
	VENDORS = -1000037,
	WARFRONT = -1000074,
	WEAPONS = -1000071,
...
for key,value in pairs({
	...
	[-1000250] = "Interface/Icons/spell_lifegivingspeed",
	[-1000251] = "Interface/Icons/inv_misc_ticket_darkmoon_01",
	[-1000252] = _.asset("Holiday_Day_of_the_Dead"),
	[-1000253] = _.asset("Holiday_winter_veil"),
	[-1000254] = _.asset("Holiday_Tshirt"),
	[-1000255] = _.asset("Holiday_hallows_end"),
	[-1000256] = _.asset("Holiday_Harvestfest"),
	[-1000257] = "Interface/Icons/misc_arrowrightcalendar_kalimdorcupstart",
	[-1000258] = "Interface/Icons/inv_fishingpole_03",
	[-1000259] = _.asset("Holiday_love"),
	[-1000260] = _.asset("Holiday_Lunar"),
	[-1000261] = _.asset("Holiday_Marchofmurloc"),
	[-1000262] = _.asset("Holiday_Midsummer"),
	[-1000263] = _.asset("Holiday_noblegarden"),
	[-1000264] = _.asset("Holiday_Pilgrim"),
	[-1000265] = _.asset("Holiday_Pirate"),
	[-1000266] = "Interface/Icons/calendar_secretsofazerothstart",
	[-1000267] = "Interface/Icons/inv_misc_fish_06",
	[-1000268] = "236445",
	[-1000270] = _.asset("Difficulty_Timewalking"),
	[-1000271] = _.asset("Holiday_Trialofstyle"),
...
for key,value in pairs({
	...
	[-1000250] = "Darkmoon Faire Dance",
	[-1000251] = "Minigames",
	[-1000252] = "Day of the Dead",
	[-1000253] = GetSpellInfo(21953),
	[-1000254] = "Free T-Shirt Day",
	[-1000255] = select(1,GetCategoryInfo(158)),
	[-1000256] = "Harvest Festival",
	[-1000257] = "Kalimdor Cup",
	[-1000258] = "Kalu'ak Fishing Derby",
	[-1000259] = select(1,GetCategoryInfo(187)),
	[-1000260] = select(1,GetCategoryInfo(160)),
	[-1000261] = "March of the Tadpoles",
	[-1000262] = "Midsummer Fire Festival",
	[-1000263] = select(1,GetCategoryInfo(159)),
	[-1000264] = select(1,GetCategoryInfo(14981)),
	[-1000265] = "Pirates' Day",
	[-1000266] = "Secrets of Azeroth",
	[-1000267] = "Stranglethorn Fishing Extravaganza",
	[-1000268] = "The Great Gnomeregan Run",
	[-1000269] = "Thousand Boat Bash",
	[-1000270] = GetDifficultyInfo(24),
	[-1000271] = "Trial of Style",
	[-1000272] = "WoW's Anniversary",
	[-1000273] = select(2,GetAchievementInfo(2398)),
	[-1000274] = select(2,GetAchievementInfo(4400)),
	[-1000275] = select(2,GetAchievementInfo(5512)),
	[-1000276] = select(2,GetAchievementInfo(5863)),
	[-1000277] = select(2,GetAchievementInfo(6131)),
	[-1000278] = select(2,GetAchievementInfo(7853)),
	[-1000279] = select(2,GetAchievementInfo(8820)),
	[-1000280] = select(2,GetAchievementInfo(10058)),
	[-1000281] = select(2,GetAchievementInfo(10741)),
	[-1000282] = select(2,GetAchievementInfo(11848)),
	[-1000283] = select(2,GetAchievementInfo(12827)),
	[-1000284] = select(2,GetAchievementInfo(13917)),
	[-1000285] = select(2,GetAchievementInfo(14271)),
	[-1000286] = select(2,GetAchievementInfo(14942)),
	[-1000287] = select(2,GetAchievementInfo(15218)),
}) do a[key] = value; end
...
for key,value in pairs({
	...
	[-1000250] = "Dunkelmond-Jahrmarkt Tanzspiel",
	[-1000252] = "Tag der Toten",
	[-1000258] = "Angelwettstreit der Kalu'ak",
	[-1000262] = "Sonnenwendfest",
	[-1000265] = "Piratentag",
	[-1000267] = "Anglerwettbewerb im Schlingendorntal",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000250] = "Feria de la Luna Negra Juego de Baile",
	[-1000252] = "Festividad de los Muertos",
	[-1000258] = "Competición de pesca Kalu'ak",
	[-1000262] = "Festival del Fuego del Solsticio de Verano",
	[-1000265] = "Día de los Piratas",
	[-1000267] = "Gran espectáculo de pesca de Tuercespina",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000250] = "Foire de Sombrelune Jeu de Danse",
	[-1000252] = "Jour des morts",
	[-1000258] = "Le tournoi de pêche kalu'ak",
	[-1000262] = "Fête du Feu du solstice d’été",
	[-1000265] = "Jour des pirates",
	[-1000267] = "Concours de pêche de Strangleronce",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000250] = "Fiera di Lunacupa Gioco della Danza",
	[-1000252] = "Giorno dei Morti",
	[-1000258] = "La gara di pesca dei Kalu'ak",
	[-1000262] = "Fuochi di Mezza Estate",
	[-1000265] = "Giorno dei Pirati",
	[-1000267] = "Gara di Pesca a Rovotorto",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000232] = "탐욕의 사절",
	[-1000249] = "다크문 유랑단",
	[-1000250] = "다크문 유랑단 춤 게임",
	[-1000252] = "망자의 날",
	[-1000258] = "칼루아크 낚시 대회",
	[-1000262] = "한여름 불꽃축제",
	[-1000265] = "해적의 날",
	[-1000267] = "가시덤불 골짜기 낚시왕 선발대회",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000250] = "Feira de Negraluna Jogo da Dança",
	[-1000252] = "Dia dos Mortos",
	[-1000258] = "Campeonato de Pesca dos Kalu'ak",
	[-1000262] = "Festival do Fogo do Solstício",
	[-1000265] = "Dia dos Piratas",
	[-1000267] = "Festerê de Pesca da Selva do Espinhaço",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000250] = "Ярмарка Новолуния состязании танцоров",
	[-1000252] = "День мертвых",
	[-1000258] = "Калуакское рыбоборье",
	[-1000262] = "Огненный Солнцеворот",
	[-1000265] = "День пирата",
	[-1000267] = "Рыбомания Тернистой долины",
}) do a[key] = value; end
end
