...
_.HeaderConstants = {
	...
	DAY_OF_THE_DEAD_HEADER = -1000250,
	DISCOVERY = -1000015,
	DROPS = -1000016,
	EMISSARY_QUESTS = -1000017,
	FACTIONS = -1000019,
	FEAST_OF_WINTER_VEIL_HEADER = -1000251,
	FLIGHT_PATHS = -1000020,
	FOLLOWERS = -1000021,
	FREE_T_SHIRT_DAY_HEADER = -1000252,
	HALLOWS_END_HEADER = -1000253,
	HARVEST_FESTIVAL_HEADER = -1000254,
	HOLIDAYS = -1000023,
	HONOR_TITLES = -1000130,
	IN_GAME_SHOP = -1000089,
	KALIMDOR_CUP_HEADER = -1000255,
	LEGENDARIES = -1000098,
	LOVE_IS_IN_THE_AIR_HEADER = -1000257,
	LUNAR_FESTIVAL_HEADER = -1000258,
	MARCH_OF_THE_TADPOLES_HEADER = -1000259,
	MIDSUMMER_FIRE_FESTIVAL_HEADER = -1000260,
	NOBLEGARDEN_HEADER = -1000261,
	PET_BATTLE = -1000027,
	PILGRIMS_BOUNTY_HEADER = -1000262,
	PIRATES_DAY_HEADER = -1000263,
	PROFESSIONS = -1000028,
	PVP = -1000132,
	...
	REWARDS = -1000031,
	SECRETS = -1000033,
	SECRETS_OF_AZEROTH_HEADER = -1000264,
	SPECIAL = -1000035,
	THE_GREAT_GNOMEREGAN_RUN_HEADER = -1000266,
	THOUSAND_BOAT_BASH_HEADER = -1000267,
	TREASURES = -1000036,
	TRIAL_OF_STYLE_HEADER = -1000269,
	VENDORS = -1000037,
	WARFRONT = -1000074,
	WEAPONS = -1000071,
...
for key,value in pairs({
	...
	[-1000250] = _.asset("Holiday_Day_of_the_Dead"),
	[-1000251] = _.asset("Holiday_winter_veil"),
	[-1000252] = _.asset("Holiday_Tshirt"),
	[-1000253] = _.asset("Holiday_hallows_end"),
	[-1000254] = _.asset("Holiday_Harvestfest"),
	[-1000255] = "Interface/Icons/misc_arrowrightcalendar_kalimdorcupstart",
	[-1000256] = "Interface/Icons/inv_fishingpole_03",
	[-1000257] = _.asset("Holiday_love"),
	[-1000258] = _.asset("Holiday_Lunar"),
	[-1000259] = _.asset("Holiday_Marchofmurloc"),
	[-1000260] = _.asset("Holiday_Midsummer"),
	[-1000261] = _.asset("Holiday_noblegarden"),
	[-1000262] = _.asset("Holiday_Pilgrim"),
	[-1000263] = _.asset("Holiday_Pirate"),
	[-1000264] = "Interface/Icons/calendar_secretsofazerothstart",
	[-1000265] = "Interface/Icons/inv_misc_fish_06",
	[-1000266] = "236445",
	[-1000268] = _.asset("Difficulty_Timewalking"),
	[-1000269] = _.asset("Holiday_Trialofstyle"),
...
for key,value in pairs({
	...
	[-1000250] = "Day of the Dead",
	[-1000251] = GetSpellInfo(21953),
	[-1000252] = "Free T-Shirt Day",
	[-1000253] = select(1,GetCategoryInfo(158)),
	[-1000254] = "Harvest Festival",
	[-1000255] = "Kalimdor Cup",
	[-1000256] = "Kalu'ak Fishing Derby",
	[-1000257] = select(1,GetCategoryInfo(187)),
	[-1000258] = select(1,GetCategoryInfo(160)),
	[-1000259] = "March of the Tadpoles",
	[-1000260] = "Midsummer Fire Festival",
	[-1000261] = select(1,GetCategoryInfo(159)),
	[-1000262] = select(1,GetCategoryInfo(14981)),
	[-1000263] = "Pirates' Day",
	[-1000264] = "Secrets of Azeroth",
	[-1000265] = "Stranglethorn Fishing Extravaganza",
	[-1000266] = "The Great Gnomeregan Run",
	[-1000267] = "Thousand Boat Bash",
	[-1000268] = GetDifficultyInfo(24),
	[-1000269] = "Trial of Style",
	[-1000270] = "WoW's Anniversary",
	[-1000271] = select(2,GetAchievementInfo(2398)),
	[-1000272] = select(2,GetAchievementInfo(4400)),
	[-1000273] = select(2,GetAchievementInfo(5512)),
	[-1000274] = select(2,GetAchievementInfo(5863)),
	[-1000275] = select(2,GetAchievementInfo(6131)),
	[-1000276] = select(2,GetAchievementInfo(7853)),
	[-1000277] = select(2,GetAchievementInfo(8820)),
	[-1000278] = select(2,GetAchievementInfo(10058)),
	[-1000279] = select(2,GetAchievementInfo(10741)),
	[-1000280] = select(2,GetAchievementInfo(11848)),
	[-1000281] = select(2,GetAchievementInfo(12827)),
	[-1000282] = select(2,GetAchievementInfo(13917)),
	[-1000283] = select(2,GetAchievementInfo(14271)),
	[-1000284] = select(2,GetAchievementInfo(14942)),
	[-1000285] = select(2,GetAchievementInfo(15218)),
}) do a[key] = value; end
...
for key,value in pairs({
	...
	[-1000250] = "Tag der Toten",
	[-1000256] = "Angelwettstreit der Kalu'ak",
	[-1000260] = "Sonnenwendfest",
	[-1000263] = "Piratentag",
	[-1000265] = "Anglerwettbewerb im Schlingendorntal",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000250] = "Festividad de los Muertos",
	[-1000256] = "Competición de pesca Kalu'ak",
	[-1000260] = "Festival del Fuego del Solsticio de Verano",
	[-1000263] = "Día de los Piratas",
	[-1000265] = "Gran espectáculo de pesca de Tuercespina",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000250] = "Jour des morts",
	[-1000256] = "Le tournoi de pêche kalu'ak",
	[-1000260] = "Fête du Feu du solstice d’été",
	[-1000263] = "Jour des pirates",
	[-1000265] = "Concours de pêche de Strangleronce",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000250] = "Giorno dei Morti",
	[-1000256] = "La gara di pesca dei Kalu'ak",
	[-1000260] = "Fuochi di Mezza Estate",
	[-1000263] = "Giorno dei Pirati",
	[-1000265] = "Gara di Pesca a Rovotorto",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000250] = "Dia dos Mortos",
	[-1000256] = "Campeonato de Pesca dos Kalu'ak",
	[-1000260] = "Festival do Fogo do Solstício",
	[-1000263] = "Dia dos Piratas",
	[-1000265] = "Festerê de Pesca da Selva do Espinhaço",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000250] = "День мертвых",
	[-1000256] = "Калуакское рыбоборье",
	[-1000260] = "Огненный Солнцеворот",
	[-1000263] = "День пирата",
	[-1000265] = "Рыбомания Тернистой долины",
}) do a[key] = value; end
end
