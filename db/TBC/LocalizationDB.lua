...
localize(L.HEADER_NAMES, {
	...
	[-1000211] = "The Opening of the Dark Portal",
	...
	[-1000221] = "Dark Portal Pass",
	[-1000229] = "TBC Classic Deluxe Edition",
	[-1000231] = "WotLK Classic Northrend Heroic Upgrade",
	[-1000232] = "WotLK Classic Northrend Epic Upgrade",
	[-1000237] = "iCoke",
	[-1000238] =  AUCTION_CATEGORY_MISCELLANEOUS,
	[-1000239] = REFER_A_FRIEND,
	[-1000241] = "Spirit of Competition",
	[-1000242] = BATTLE_PET_SOURCE_9,
	[-1000244] = "Ensembles",
	[-1000245] = "Arsenals",
	[-1000246] = "Sourceless",
});
localize(L.HEADER_DESCRIPTIONS, {
	...
	[-1000221] = "These rewards were made available to anyone who purchased a Dark Portal Pass for TBC Classic.\n\nThe act of adding items for real money to the In-Game Shop in Classic has widely been frowned upon.",
	...
	[-1000231] = "These rewards were made available to anyone who purchased a Northrend Heroic Upgrade for WotLK Classic. (not to be confused with the original Wrath of the Lich King Collector's Edition)",
	...
	[-1000241] = "This is a Battlegrounds-based event that coincides with the beginning of the Summer Olympic games. The only time this was celebrated was in 2008 to correspond to the Beijing Olympics, and although there appeared to be the intention to repeat this event, it never returned.",
...
localize(L.HEADER_ICONS, {
	...
	[-1000231] = _.asset("Expansion_WOTLK"),
	[-1000232] = _.asset("Expansion_WOTLK"),
	[-1000237] = "Interface/Icons/Inv_drink_10",
	[-1000238] = "Interface/Icons/Spell_Misc_Drink",
	[-1000239] = _.asset("achievement_reputation_08"),
	[-1000241] = "Interface/Icons/inv_jewelry_amulet_03",
	[-1000242] = "Interface/Icons/inv_misc_ticket_tarot_stack_01",
...
localize(L.HEADER_NAMES, {
	...
	[-1000211] = "Die Öffnung des Dunklen Portals",
	[-1000212] = "Das Szepter der Sandstürme",
	[-1000221] = "Pass zum Dunklen Portal",
});
localize(L.HEADER_DESCRIPTIONS, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000211] = "La apertura del Portal Oscuro",
	[-1000212] = "El cetro del Mar de Dunas",
	[-1000221] = "Pase para el Portal Oscuro",
});
localize(L.HEADER_DESCRIPTIONS, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000211] = "L'ouverture de la Porte des ténèbres",
	[-1000212] = "Le Sceptre des Sables changeants",
	[-1000220] = "Edition Collector",
	[-1000221] = "Passe Porte des ténèbres",
...
localize(L.HEADER_NAMES, {
	...
	[-1000211] = "L'apertura del Portale Oscuro",
...
localize(L.HEADER_NAMES, {
	...
	[-1000211] = "A abertura do Portal Negro",
	[-1000212] = "Cetro das Areias Cambiantes",
	[-1000221] = "Passe do Portal Negro",
});
localize(L.HEADER_DESCRIPTIONS, {
