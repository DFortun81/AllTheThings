...
localize(L.HEADER_NAMES, {
	...
	[-1000222] = "Dark Portal Pass",
	[-1000230] = "TBC Classic Deluxe Edition",
	[-1000232] = "WotLK Classic Northrend Heroic Upgrade",
	[-1000233] = "WotLK Classic Northrend Epic Upgrade",
	[-1000238] = "iCoke",
	[-1000239] =  AUCTION_CATEGORY_MISCELLANEOUS,
	[-1000240] = REFER_A_FRIEND,
	[-1000242] = "Spirit of Competition",
	[-1000243] = BATTLE_PET_SOURCE_9,
	[-1000245] = "Ensembles",
	[-1000246] = "Arsenals",
	[-1000247] = "Sourceless",
});
localize(L.HEADER_DESCRIPTIONS, {
	...
	[-1000222] = "These rewards were made available to anyone who purchased a Dark Portal Pass for TBC Classic.\n\nThe act of adding items for real money to the In-Game Shop in Classic has widely been frowned upon.",
	...
	[-1000242] = "This is a Battlegrounds-based event that coincides with the beginning of the Summer Olympic games. The only time this was celebrated was in 2008 to correspond to the Beijing Olympics, and although there appeared to be the intention to repeat this event, it never returned.",
...
localize(L.HEADER_ICONS, {
	...
	[-1000240] = _.asset("achievement_reputation_08"),
	[-1000242] = "Interface/Icons/inv_jewelry_amulet_03",
	[-1000243] = "Interface/Icons/inv_misc_ticket_tarot_stack_01",
...
localize(L.HEADER_NAMES, {
	...
	[-1000222] = "Pass zum Dunklen Portal",
});
localize(L.HEADER_DESCRIPTIONS, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000222] = "Pase para el Portal Oscuro",
});
localize(L.HEADER_DESCRIPTIONS, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000222] = "Passe Porte des ténèbres",
...
localize(L.HEADER_NAMES, {
	...
	[-1000222] = "Пропуск Темного портала",
