...
localize(L.HEADER_NAMES, {
	...
	[-1000190] = "Speak to Brother Romulus",
	[-1000192] = "Children's Week",
	[-1000193] = "Darkmoon Faire",
	[-1000207] = GetSpellInfo(21953),
	[-1000209] = "Hallow's End",
	[-1000210] = "Harvest Festival",
	[-1000212] = "Love is in the Air",
	[-1000213] = "Lunar Festival",
	[-1000215] = "Midsummer Fire Festival",
	[-1000216] = "Noblegarden",
	[-1000219] = "Stranglethorn Fishing Extravaganza",
	[-1000226] = "The Ahn'Qiraj War Effort",
	[-1000227] = "The Opening of the Dark Portal",
	[-1000228] = "The Scepter of the Shifting Sands",
	[-1000229] = "The Scourge Invasion",
	[-1000230] = "The Silithyst Must Flow",
	[-1000235] = "BlizzCon",
	[-1000236] = "Collector's Edition",
	[-1000255] = "iCoke",
	[-1000256] =  AUCTION_CATEGORY_MISCELLANEOUS,
	[-1000262] = "Ensembles",
	[-1000263] = "Arsenals",
	[-1000264] = "Sourceless",
	[-1000265] = "Season of Discovery",
...
localize(L.HEADER_DESCRIPTIONS, {
	...
	[-1000169] = "Also known as 'Upper' Blackrock Spire.",
	...
	[-1000265] = "This Season brings an initial level cap of 25 and a new level-25 endgame, including a 10-player Blackfathom Deeps raid with new mechanics, new and reimagined bosses to challenge player tactics and strategies, and fresh rewards.",
	[-1000267] = "Rune Engraving is a new class system for Season of Discovery. It allows each class to tailor their gameplay experience by unlocking new unique abilities!",
	[-1000268] = "Waylaid Supplies quest items drop from mobs of level 6 and above all over Azeroth. These quests request delivery of the Waylaid Supplies to an organization representative in return for a few silver, experience, and Reputation. Of course, there are items missing from the supply shipment, and you can supplement it for greater reputation rewards.",
});
...
localize(L.HEADER_ICONS, {
	...
	[-1000166] = _.asset("Achievement_Zone_Blackrock_01"),
	...
	[-1000170] = "Interface/Icons/Spell_Shadow_SummonImp",
	[-1000171] = "Interface/Icons/inv_axe_10",
	...
	[-1000190] = "Interface/CURSOR/Speak",
	...
	[-1000226] = "Interface/Icons/inv_box_01",
	[-1000227] = "Interface/Icons/achievement_dungeon_outland_dungeonmaster",
	[-1000228] = "Interface/Icons/Inv_hammer_25",
	[-1000229] = "Interface/Icons/inv_stone_02",
	[-1000230] = "Interface/Icons/spell_holiday_tow_spicecloud",
	[-1000235] = _.asset("Promotion_Blizzcon"),
	[-1000236] = _.asset("Promotion_Collector"),
...
localize(L.HEADER_NAMES, {
	...
	[-1000179] = "Kathedrale",
	[-1000190] = "Sprich mit Bruder Romulus",
	[-1000193] = "Dunkelmond-Jahrmarkt",
	[-1000215] = "Sonnenwendfest",
	[-1000219] = "Anglerwettbewerb im Schlingendorntal",
	[-1000227] = "Die Öffnung des Dunklen Portals",
	[-1000228] = "Das Szepter der Sandstürme",
	[-1000265] = "Saison der Entdeckungen",
	[-1000266] = "Monsterjagd",
	[-1000267] = "Runenschnitzen",
	[-1000268] = "Weggelegte Vorräte",
});
localize(L.HEADER_DESCRIPTIONS, {
	...
	[-1000265] = "Diese Saison bringt eine anfängliche Levelobergrenze von 25 und ein neues Level-25-Endspiel, einschließlich eines Blackfathom Deeps-Raids für 10 Spieler mit neuen Mechaniken, neuen und neu gestalteten Bossen, die die Taktiken und Strategien der Spieler herausfordern, und neuen Belohnungen.",
	[-1000267] = "Runengravur ist ein neues System, das kürzlich für Season of Discovery angekündigt wurde. Es ermöglicht jeder Klasse, ihr Spielerlebnis individuell anzupassen, indem sie neue einzigartige Fähigkeiten freischaltet!",
	[-1000268] = "Questgegenstände für „Weggelegte Vorräte“ fallen von Mobs der Stufe 6 und höher in ganz Azeroth. Diese Quests erfordern die Lieferung der Waylaid-Vorräte an einen Vertreter der Organisation als Gegenleistung für ein paar Silbermünzen, Erfahrung und Ansehen. Natürlich fehlen in der Versorgungslieferung Gegenstände, und Sie können sie ergänzen, um höhere Reputationsbelohnungen zu erhalten.",
});
...
localize(L.HEADER_NAMES, {
	...
	[-1000190] = "Habla con el Hermano Romulus",
	...
	[-1000227] = "La apertura del Portal Oscuro",
	[-1000228] = "El cetro del Mar de Dunas",
	[-1000265] = "Temporada de Descubrimiento",
	[-1000266] = "Caza de Monstruos",
	[-1000267] = "Grabado",
	[-1000268] = "Suministros asaltados",
});
localize(L.HEADER_DESCRIPTIONS, {
	...
	[-1000265] = "Esta temporada trae un límite de nivel inicial de 25 y un nuevo final de nivel 25, que incluye una incursión de 10 jugadores en Blackfathom Deeps con nuevas mecánicas, jefes nuevos y reinventados para desafiar las tácticas y estrategias de los jugadores, y nuevas recompensas.",
	[-1000267] = "El grabado es un nuevo sistema anunciado recientemente para Season of Discovery. ¡Permite que cada clase adapte su experiencia de juego desbloqueando nuevas habilidades únicas!",
	[-1000268] = "Los objetos de misión de Suministros Waylaid caen de mobs de nivel 6 y, sobre todo, en Azeroth. Estas misiones requieren la entrega de suministros Waylaid a un representante de la organización a cambio de algo de plata, experiencia y reputación. Por supuesto, faltan elementos en el envío de suministros y puedes complementarlos para obtener mayores recompensas de reputación.",
});
localize(_.ObjectNames, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000190] = "Parlez à Frère Romulus",
	[-1000193] = "Foire de Sombrelune",
	[-1000215] = "Fête du Feu du solstice d’été",
	[-1000219] = "Concours de pêche de Strangleronce",
	[-1000226] = "Effort de guerre d’Ahn'Qiraj",
	[-1000227] = "L'ouverture de la Porte des ténèbres",
	[-1000228] = "Le Sceptre des Sables changeants",
	[-1000236] = "Edition Collector",
	[-1000265] = "Saison de Découverte",
	[-1000266] = "Chasse aux Monstres",
	[-1000267] = "Gravure",
	[-1000268] = "Fournitures isolées",
});
localize(L.HEADER_DESCRIPTIONS, {
	...
	[-1000265] = "Cette saison apporte un niveau maximum initial de 25 et une nouvelle fin de partie de niveau 25, comprenant un raid Blackfathom Deeps à 10 joueurs avec de nouvelles mécaniques, des boss nouveaux et réinventés pour défier les tactiques et stratégies des joueurs, et de nouvelles récompenses.",
	[-1000267] = "La gravure de runes est un nouveau système récemment annoncé pour Season of Discovery. Il permet à chaque classe d'adapter son expérience de jeu en débloquant de nouvelles capacités uniques!",
	[-1000268] = "Les objets de quête Waylaid Supplies proviennent des foules de niveau 6 et surtout partout en Azeroth. Ces quêtes nécessitent la livraison des fournitures Waylaid à un représentant de l'organisation en échange de quelques pièces d'argent, d'expérience et de réputation. Bien sûr, il manque des articles dans la livraison de fournitures, et vous pouvez les compléter pour obtenir de plus grandes récompenses de réputation.",
});
localize(_.ObjectNames, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000190] = "Parla con Fratello Romulus",
	[-1000193] = "Fiera di Lunacupa",
	[-1000215] = "Fuochi di Mezza Estate",
	[-1000219] = "Gara di Pesca a Rovotorto",
	[-1000227] = "L'apertura del Portale Oscuro",
	[-1000228] = "Scettro delle Sabbie Mutevoli",
	[-1000265] = "La Stagione delle Scoperte",
	[-1000266] = "Caccia ai Mostri",
	[-1000267] = "Rune Engraving",
	[-1000268] = "Forniture Waylaid",
});
localize(L.HEADER_DESCRIPTIONS, {
	[-1000265] = "Questa stagione porta un limite di livello iniziale di 25 e un nuovo gioco finale di livello 25, incluso un raid di Blackfathom Deeps per 10 giocatori con nuove meccaniche, boss nuovi e reinventati per sfidare le tattiche e le strategie dei giocatori e nuove ricompense.",
	[-1000267] = "L'incisione delle rune è un nuovo sistema recentemente annunciato per la Stagione delle Scoperte. Permette a ogni classe di personalizzare la propria esperienza di gioco sbloccando nuove abilità uniche!",
	[-1000268] = "Gli oggetti della missione Waylaid Supplies vengono rilasciati dai mob di livello 6 e soprattutto su Azeroth. Queste missioni richiedono la consegna delle Forniture Waylaid a un rappresentante dell'organizzazione in cambio di argento, esperienza e reputazione. Naturalmente, ci sono degli articoli mancanti nella spedizione di rifornimenti e puoi integrarli per ottenere maggiori ricompense in termini di reputazione.",
});
localize(_.ObjectNames, {
...
localize(L.HEADER_DESCRIPTIONS, {
	...
	[-1000265] = "이번 시즌에는 새로운 메커니즘이 포함된 10인 Blackfathom Deeps 레이드, 플레이어 전술과 전략에 도전할 수 있는 새롭고 재구성된 보스, 새로운 보상을 포함하여 초기 레벨 상한이 25이고 새로운 레벨 25 최종 게임이 제공됩니다.",
	[-1000267] = "룬 각인은 최근 발견의 시즌에 발표된 새로운 시스템입니다. 이를 통해 각 클래스는 새로운 고유 능력을 잠금 해제하여 게임 플레이 경험을 맞춤화할 수 있습니다!",
	[-1000268] = "길레이드 보급품 퀘스트 아이템은 아제로스 전역의 6레벨 이상의 몹에게서 드롭됩니다. 이 퀘스트는 약간의 은화, 경험치, 평판을 대가로 조직 대표에게 Waylaid 보급품을 전달하도록 요청합니다. 물론, 보급품 배송에 누락된 품목이 있으며, 이를 보완하여 더 큰 평판 보상을 받을 수 있습니다.",
});
localize(_.ObjectNames, {
	[31] = "오래된 사자상",
	[32] = "가라앉은 상자",
...
localize(L.HEADER_NAMES, {
	...
	[-1000190] = "Fale com o Irmão Romulus",
	[-1000193] = "Feira de Negraluna",
	[-1000215] = "Festival do Fogo do Solstício",
	[-1000219] = "Festerê de Pesca da Selva do Espinhaço",
	[-1000227] = "A abertura do Portal Negro",
	[-1000228] = "Cetro das Areias Cambiantes",
	[-1000265] = "Temporada de Descoberta",
	[-1000266] = "Caça aos Monstros",
	[-1000267] = "Gravura",
	[-1000268] = "Suprimentos emboscados",
});
localize(L.HEADER_DESCRIPTIONS, {
	...
	[-1000265] = "Esta temporada traz um limite de nível inicial de 25 e um novo jogo final de nível 25, incluindo um ataque Blackfathom Deeps para 10 jogadores com novas mecânicas, chefes novos e reimaginados para desafiar as táticas e estratégias dos jogadores e novas recompensas.",
	[-1000267] = "A gravação de runas é um novo sistema anunciado recentemente para a Temporada de Descobertas. Ele permite que cada classe personalize sua experiência de jogo, desbloqueando novas habilidades únicas!",
	[-1000268] = "Itens de missão Waylaid Supplies são obtidos de mobs de nível 6 e acima de Azeroth. Essas missões exigem a entrega dos Suprimentos Waylaid a um representante da organização em troca de um pouco de prata, experiência e reputação. É claro que faltam itens na remessa de suprimentos e você pode complementá-los para obter maiores recompensas de reputação.",
});
localize(_.ObjectNames, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000190] = "Поговорите с Брат Ромул",
	[-1000193] = "Ярмарка Новолуния",
	[-1000210] = "Неделя урожая",
	[-1000215] = "Огненный Солнцеворот",
	[-1000219] = "Рыбомания Тернистой долины",
	[-1000226] = "Война в Ан'Кираже",
	[-1000227] = "Открытие Темного портала",
	[-1000228] = "Скипетр Зыбучих песков",
	[-1000229] = "Вторжение Плети",
	[-1000236] = "Коллекционное издание",
	[-1000264] = "Без Источника",
	[-1000265] = "Сезон открытий",
	[-1000266] = "Охота на монстров",
	[-1000267] = "Гравировка",
	[-1000268] = "Подстерегающие припасы",
});
localize(L.HEADER_DESCRIPTIONS, {
	...
	[-1000265] = "В этом сезоне начальный максимальный уровень равен 25, а также новый финал для 25-го уровня, включающий рейд в Непроглядную Пучину для 10 игроков с новой механикой, новыми и переосмысленными боссами, которые бросят вызов тактике и стратегии игроков, а также свежими наградами.",
	[-1000267] = "Гравировка рун — это новая система, недавно анонсированная в сезоне «Открытие». Это позволяет каждому классу адаптировать свой игровой процесс, открывая новые уникальные способности!",
	[-1000268] = "Квестовые предметы Waylaid Supplies падают с мобов 6-го уровня и выше по всему Азероту. Эти квесты требуют доставки Запасных припасов представителю организации в обмен на немного серебра, опыта и репутации. Конечно, в поставке припасов отсутствуют предметы, и вы можете дополнить их, чтобы получить больше репутации.",
});
localize(_.ObjectNames, {
...
localize(L.HEADER_DESCRIPTIONS, {
	...
	[-1000265] = "本赛季带来了 25 级的初始等级上限和新的 25 级终局游戏，包括 10 名玩家的 Blackfathom Deeps 突袭，其中包含新的机制、新的和重新设计的 Boss 来挑战玩家的战术和策略，以及新鲜的奖励。",
	[-1000267] = "符文雕刻是最近在发现季节宣布的一个新系统。它允许每个班级通过解锁新的独特能力来定制他们的游戏体验！",
	[-1000268] = "伏击补给品任务物品从艾泽拉斯 6 级及以上的小怪中掉落。这些任务要求将路障补给品交付给组织代表，以换取一些银币、经验和声望。当然，补给中也有缺少的物品，你可以补充以获得更大的声望奖励。",
});
localize(_.ObjectNames, {
	[31] = "陈旧的石狮子",
	[32] = "沉没的箱子",
