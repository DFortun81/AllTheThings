...
_.HeaderConstants = {
	...
	EXPLORATION = -1000018,
	FACTIONS = -1000019,
	FEAST_OF_WINTER_VEIL_HEADER = -1000188,
	FLIGHT_PATHS = -1000020,
	HALLOWS_END_HEADER = -1000190,
	HARVEST_FESTIVAL_HEADER = -1000191,
	HOLIDAYS = -1000023,
	HONOR_TITLES = -1000138,
	LOVE_IS_IN_THE_AIR_HEADER = -1000193,
	LUNAR_FESTIVAL_HEADER = -1000194,
	MIDSUMMER_FIRE_FESTIVAL_HEADER = -1000196,
	NOBLEGARDEN_HEADER = -1000197,
	PROFESSIONS = -1000028,
	PVP = -1000140,
	QUESTS = -1000029,
	RARES = -1000030,
...
localize(L.HEADER_NAMES, {
	...
	[-1000188] = GetSpellInfo(21953),
	[-1000190] = "Hallow's End",
	[-1000191] = "Harvest Festival",
	[-1000193] = "Love is in the Air",
	[-1000194] = "Lunar Festival",
	[-1000196] = "Midsummer Fire Festival",
	[-1000197] = "Noblegarden",
	[-1000202] = "Stranglethorn Fishing Extravaganza",
	...
	[-1000218] = "BlizzCon",
	[-1000219] = "Collector's Edition",
	[-1000236] = "iCoke",
	[-1000237] =  AUCTION_CATEGORY_MISCELLANEOUS,
	[-1000242] = "Ensembles",
	[-1000243] = "Arsenals",
	[-1000244] = "Sourceless",
});
localize(L.HEADER_DESCRIPTIONS, {
	...
	[-1000236] = "These were only available through the 2006 iCoke Promotion (China Only)",
	[-1000237] = "This section is for miscellaneous promotions that took place in the real world or something to do with account management.",
	[-1000244] = "This Category contains Things that probably exist in the game but no known source.",
});
...
localize(L.HEADER_ICONS, {
	...
	[-1000188] = _.asset("Holiday_winter_veil"),
	[-1000190] = _.asset("Holiday_hallows_end"),
	[-1000191] = _.asset("Holiday_Harvestfest"),
	[-1000193] = _.asset("Holiday_love"),
	[-1000194] = _.asset("Holiday_Lunar"),
	[-1000196] = _.asset("Holiday_Midsummer"),
	[-1000197] = _.asset("Holiday_noblegarden"),
	[-1000202] = "Interface/Icons/inv_misc_fish_06",
	...
	[-1000218] = _.asset("Promotion_Blizzcon"),
	[-1000219] = _.asset("Promotion_Collector"),
	[-1000236] = "Interface/Icons/Inv_drink_10",
	[-1000237] = "Interface/Icons/Spell_Misc_Drink",
	[-1000242] = "Interface/Icons/inv_chest_leather_08",
	[-1000243] = "Interface/Icons/inv_mace_1h_bastionquest_b_02",
	[-1000244] = "Interface/Icons/inv_misc_questionmark",
});
...
localize(L.HEADER_NAMES, {
	...
	[-1000196] = "Sonnenwendfest",
	[-1000202] = "Anglerwettbewerb im Schlingendorntal",
...
localize(L.HEADER_NAMES, {
	...
	[-1000196] = "Festival del Fuego del Solsticio de Verano",
	[-1000202] = "Gran espectáculo de pesca de Tuercespina",
...
localize(L.HEADER_NAMES, {
	...
	[-1000196] = "Fête du Feu du solstice d’été",
	[-1000202] = "Concours de pêche de Strangleronce",
	[-1000209] = "Effort de guerre d’Ahn'Qiraj",
	[-1000211] = "Le Sceptre des Sables changeants",
	[-1000219] = "Edition Collector",
});
localize(L.HEADER_DESCRIPTIONS, {
...
localize(L.HEADER_NAMES, {
	...
	[-1000196] = "Fuochi di Mezza Estate",
	[-1000202] = "Gara di Pesca a Rovotorto",
...
localize(L.HEADER_NAMES, {
	...
	[-1000196] = "Festival do Fogo do Solstício",
	[-1000202] = "Festerê de Pesca da Selva do Espinhaço",
...
localize(L.HEADER_NAMES, {
	...
	[-1000196] = "Огненный Солнцеворот",
	[-1000202] = "Рыбомания Тернистой долины",
	[-1000209] = "Война в Ан'Кираже",
	[-1000211] = "Скипетр Зыбучих песков",
	[-1000212] = "Вторжение Плети",
	[-1000219] = "Коллекционное издание",
	[-1000244] = "Без Источника",
});
localize(L.HEADER_DESCRIPTIONS, {
