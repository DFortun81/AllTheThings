...
_.OnTooltipDB=
{
	["DesolaceCentaurs"] = function(t, tooltipInfo)
		...
		if reputation > 0 and reputation < 9000 then
			_.Modules.FactionData.AddReputationTooltipInfo(tooltipInfo, reputation, "Kill Centaurs to Honored.", 20, 9000);
		end
	end,
	...
	if reputation < 42000 then
		...
		if reputation < 8999 then
			addRepInfo(tooltipInfo, reputation, "Kill Deadwood or Winterfall Furbolgs (Stops at Honored)", 5, 8999, -3000);
		end
	...
	if reputation >= 0 and reputation < 42000 then
		...
		if reputation < 9000 then
			...
			addRepInfo(tooltipInfo, reputation, "  Defeat a Lieutenant (To Honored)", 200, 9000);
			addRepInfo(tooltipInfo, reputation, "  Win the Battle (To Honored)", 600, 9000);
		end
	end
end,
