			...
			if numSpecializations and numSpecializations > 0 then
				...
				if encounterID then
					...
					if encounterCache then
						...
						print("HOORAH", reference.text, #itemList);
						...
						if specs and #specs > 0 then
							...
							if bestSpecID then
								...
								print(chance .. "% (" .. (chance / 5) .. "%) |T" .. icon .. ":0|t " .. name .. " (" .. (C_Loot.IsLegacyLootModeEnabled() and "Bonus Roll" or "Personal Loot") .. ")");
							end
							if C_Loot.IsLegacyLootModeEnabled() then
								...
								if legacyMatchChance > legacyNoMatchChance then
									local id, name, description, icon = GetSpecializationInfoByID(bestSpecID);
									print(legacyMatchChance .. "% |T" .. icon .. ":0|t " .. name .. " (Legacy Loot)");
								else
									local id, name, description, icon = GetSpecializationInfoByID(bestLegacySpecID);
									print(legacyNoMatchChance .. "% |T" .. icon .. ":0|t " .. name .. " (Legacy Loot)");
								end
							end
						elseif C_Loot.IsLegacyLootModeEnabled() then
							...
							if bestSpecID then
								...
								print(((1 / (totalItems - specHits[id])) * 100) .. "% |T" .. icon .. ":0|t " .. name .. " (Legacy Loot)");
							end
						end
					end
				end
