			...
			n(-9955, { -- General
				["groups"] = {
					...
					ach(2136, {	-- Glory of the Hero
						...
						crit(19),	-- Share The Love
						crit(20),	-- Less-rabi
						crit(21),	-- Snakes. Why'd It Have To Be Snakes?
						crit(22),	-- Good Grief
						crit(23),	-- Brann Spankin' New
						crit(24),	-- Abuse the Ooze
						crit(25),	-- Timely Death
						crit(26),	-- Lightning Struck
						crit(27),	-- Shatter Resistant
						crit(28),	-- The Culling of Time
						crit(29),	-- Zombiefest!
						crit(30),	-- The Incredible Hulk
						crit(31),	-- Lodi Dodi We Loves the Skadi
						crit(32),	-- My Girl Loves to Skadi All the Time
						crit(33),	-- King's Bane
						crit(34),	-- Experienced Drake Rider
						crit(35),	-- Make It Count
						crit(36),	-- Ruby Void
						crit(37),	-- Emerald Void
						crit(38),	-- Amber Void
					}),
