...
_.Achievements = 
{
	n(-9960, { -- Professions
		["groups"] = {
			n(-9971, { -- Cooking
				["groups"] = {
					ach(10589, {	-- Legion Cook (800)
						ach(9500),	-- Draenor Cook (700)
						ach(6365),	-- Zen Master Cook (600)
						ach(4916),	-- Illustrious Grand Master Cook (525)
						ach(125),	-- Grand Master Cook (450)
						ach(124),	-- Master Cook (375),
						ach(123),	-- Artisan Cook (300)
						ach(122),	-- Expert Cook (225)
						ach(121),	-- Journeyman Cook (150)
					}),
					...
					ach(1785, {	-- Dinner Impossible
						...
						crit(4),	-- Strand of the Ancients
						crit(5),	-- Eye of the Storm
					}),
