			...
			n(-9982, { -- Legion
				["groups"] = {
					...
					ach(11546, {	-- Breaching the Tomb (Broken Shore)
						...
						crit(12),		-- Relieved of Their Valuables
					...
					ach(11738, {	-- It'll Nether Happen (Broken Shore)
						ach(11737),		-- Disrupting the Nether
					}),
					ach(10756, {	-- Leyline Bling (Suramar)
						crit(1),		-- Anora Hollow
						crit(2),		-- Elor'shan
						crit(3),		-- Kel'balor
					...
					ach(11232, {	-- Lock, Stock and Two Smoking Goblins (Stormheim)
						title(343),		-- the Gullible
					}),
					ach(12073, {	-- Locked and Loaded
						crit(1),		-- Light's Judgment
					...
					ach(11125),		-- Now You're Thinking With Portals (Suramar)
