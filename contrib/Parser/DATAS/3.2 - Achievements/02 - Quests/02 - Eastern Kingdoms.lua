			...
			n(-9975, { -- Eastern Kingdoms
				["groups"] = {
					...
					ach(1676, {	-- Loremaster of Eastern Kingdoms
						crit(1),	-- Arathi Highlands Quests
						crit(2),	-- Badlands Quests
						crit(3),	-- Blasted Lands Quests
						crit(4),	-- Burning Steppes Quests
						crit(5),	-- Cape of Stranglethorn Quests
						crit(6),	-- Eastern Plaguelands Quests
						crit(7),	-- Hinterlands Quests
						crit(8),	-- Northern Stranglethorn Quests
						crit(9),	-- Searing Gorge Quests
						crit(10),	-- Swamp of Sorrows Quests
						crit(11),	-- Western Plaguelands Quests
						crit(12),	-- Westfall + Duskwood / Silverpine
						crit(13),	-- Redridge / Hillsbrad
						crit(14),	-- Loch Modan + Wetlands / Ghostlands
					}),
