...
_.Achievements = 
{
	n(-9955, { -- General
		["groups"] = {
			...
			ach(9707, {	-- Savagely Superior (ilvl 608)
				crit(1),	-- Head
				crit(2),	-- Neck
				crit(3),	-- Shoulder
				crit(4),	-- Chest
				...
				ach(5373, {	-- Cataclysmically Superior (ilvl 333)
					crit(1),	-- Head
					crit(2),	-- Neck
					crit(3),	-- Shoulder
					crit(4),	-- Chest
			...
			ach(10764, {	-- Brokenly Superior (ilvl 790)
				crit(1),	-- Head
				crit(2),	-- Neck
				crit(3),	-- Shoulder
				crit(4),	-- Chest
			...
			ach(9708, {	-- Savagely Epic (ilvl 640)
				crit(1),	-- Head
				crit(2),	-- Neck
				crit(3),	-- Shoulder
				crit(4),	-- Chest
				...
				ach(5372, {	-- Cataclysmically Epic (ilvl 359)
					crit(1),	-- Head
					crit(2),	-- Neck
					crit(3),	-- Shoulder
					crit(4),	-- Chest
			...
			ach(10765, {	-- Brokenly Epic (ilvl 840)
				crit(1),	-- Head
				crit(2),	-- Neck
				crit(3),	-- Shoulder
				crit(4),	-- Chest
