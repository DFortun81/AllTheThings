			...
			inst(752, { 	-- Sunwell Plateau
				["groups"] = {
					...
					e(1591, {	-- Kalecgos
						...
						-- ["creatureID"] = 24850,	-- Kalecgos
						["creatureID"] = 24892,	-- Sathrovarr the Corruptor
					}),
					e(1592, {	-- Brutallus
						["groups"] = {
					...
					e(1593, {	-- Felmyst
						["groups"] = {
							...
							i(34857, {	-- Boots of the Forgotten Protector
								...
								i(33896),	-- Vindicator's Linked Sabtons
					...
					e(1594, {	-- The Eredar Twins
						...
						--["creatureID"] = 25165,	-- Sacrolash
						["creatureID"] = 25166,	-- Alythess
					}),
					e(1595, {	-- M'uru
						["groups"] = {
							i( 34664),	-- Sunmote
						...
						["creatureID"] = 25840,	-- Entropius
						--["creatureID"] = 25741,	-- M'uru
					}),
					e(1596, {	-- Kil'jaeden
						["groups"] = {
