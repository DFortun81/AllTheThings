				...
				["groups"] = {
					n(0, {				-- Zone Drop
						...
						n(11666, { -- Firewalker
							...
							dr(0.2, i(16802)),	-- Arcanist Belt (Mage)
							dr(0.2, i(16830)),	-- Cenarion Bracers (Druid)
							dr(0.2, i(16838)),	-- Earthfury Belt (Shaman)
							dr(0.2, i(16806)),	-- Felheart Belt (Warlock)
							dr(0.2, i(16850)),	-- Giantstalker's Bracers (Hunter)
							dr(0.2, i(16857)),	-- Lawbringer Bracers (Paladin)
							dr(0.2, i(16825)),	-- Nightslayer Bracelets (Rogue)
						...
						n(11667, { -- Flameguard
							...
							dr(0.2, i(16838)),	-- Earthfury Belt (Shaman)
							dr(0.2, i(16804)),	-- Felheart Bracers (Warlock)
							dr(0.2, i(16850)),	-- Giantstalker's Bracers (Hunter)
							dr(0.2, i(16827)),	-- Nightslayer Belt (Rogue)
							dr(0.2, i(16825)),	-- Nightslayer Bracelets (Rogue)
						...
						n(12100, { -- Lava Reaver
							...
							dr(0.2, i(16838)),	-- Earthfury Belt (Shaman)
							dr(0.2, i(16804)),	-- Felheart Bracers (Warlock)
							dr(0.2, i(16851)),	-- Giantstalker's Belt (Hunter)
							dr(0.2, i(16857)),	-- Lawbringer Bracers (Paladin)
							dr(0.2, i(16827)),	-- Nightslayer Belt (Rogue)
							dr(0.19, i(16840)),	-- Earthfury Bracers (Shaman)
