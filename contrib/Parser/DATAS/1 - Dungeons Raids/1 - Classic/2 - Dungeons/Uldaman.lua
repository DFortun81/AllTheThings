			...
			inst(239, { 	-- Uldaman
				["groups"] = {
					...
					o(141979, {	-- Ancient Treasure (No Localization)
						["groups"] = {
							dr(4, i(4063)),		-- Imperial Leather Gloves
							dr(4, i(7475)),		-- Regal Cuffs
							dr(3, i(866)),		-- Monk's Staff
							dr(3, i(1640)),		-- Monstrous War Axe
							dr(3, i(15244)),	-- Razor Blade
							dr(3, i(3430)),		-- Sniper Rifle
							dr(3, i(4087)),		-- Trueshot Bow
							dr(2, i(8196)),		-- Ebon Scimitar
							dr(2, i(5215)),		-- Ember Wand
							dr(2, i(15251)),	-- Headstriker Sword
							dr(2, i(10301, { 	-- Pattern: White Bandit Mask
								i(10008), 			-- White Bandit Mask
							})),		
							dr(2, i(3187)),		-- Sacrificial Kris
							...
							dr(1, i(6423)),		-- Blackforge Greaves
							dr(1, i(6411)),		-- Chief Brigadier Armor
							dr(1, i(6432)),		-- Imperial Cloak
							dr(1, i(4061)),		-- Imperial Leather Bracers
							dr(1, i(6428)),		-- Mistscape Gloves
							dr(1, i(4734)),		-- Mistscape Mantle
							dr(1, i(6429)),		-- Mistscape Wizard Hat
							dr(1, i(10302, {	-- Pattern: Red Mageweave Pants 
								i(10009),  			-- Red Mageweave Pants
							})),	
							dr(1, i(7990, {		-- Plans: Heavy Mithril Helm 
								i(7934), 			-- Heavy Mithril Helm
							})),	
							dr(1, i(7471)),		-- Regal Gloves
							dr(1, i(9906)),		-- Royal Sash
							dr(1, i(10604, { 	-- Plans: Heavy Mithril Helm
								i(10510),  			-- Heavy Mithril Helm
							})),
							dr(1, i(9920)),		-- Tracker's Gloves
							dr(1, i(9925)),		-- Tracker's Wristguards
							dr(1, i(8385, {		-- Pattern: Turtle Scale Gloves 
