					...
					d(16, {		-- Mythic
						["g"] = {
							...
							{	-- Taloc [1]
								...
								["g"] = {
									{	-- Mythic: Taloc
										["achievementID"] = 12524,	-- Mythic: Taloc
									},
									{	-- Taloc
									...
									{	-- Elevator Music
										["achievementID"] = 12937,	-- Elevator Music
									},
							...
							{	-- MOTHER [2]
								...
								["g"] = {
									{	-- Mythic: MOTHER
										["achievementID"] = 12526,	-- Mythic: MOTHER
									},
									{	-- MOTHER
										["achievementID"] = 12521,	-- Halls of Containment
										["criteriaID"] = 2,			-- MOTHER
									...
									{	-- Parental Controls
										["achievementID"] = 12938,	-- Parental Controls
									},
							...
							{	-- Fetid Devourer [3]
								...
								["g"] = {
									{	-- Mythic: Fetid Devourer
										["achievementID"] = 12530,	-- Mythic: Fetid Devourer
									},
									{	--  Fetid Devourer
									...
									{	-- Thrash Mouth - All Stars
										["achievementID"] = 12823,	-- Thrash Mouth - All Stars
									},
							...
							{	-- Zek'voz, Herald of N'zoth [4]
								...
								["g"] = {
									{	-- Mythic: Zek'voz, Herald of N'zoth
										["achievementID"] = 12527,	-- Mythic: Zek'voz, Herald of N'zoth
									},
									...
									{	-- What's in the Box?
										["achievementID"] = 12828,	-- What's in the Box?
									},
									{	-- Void-Binder
							...
							{	-- Vectis [5]
								...
								["g"] = {
									{	-- Mythic: Vectis
										["achievementID"] = 12529,	-- Mythic: Vectis
									},
									{	--  Vectis
										["achievementID"] = 12522,	-- Crimson Descent
										["criteriaID"] = 1,			-- Vectis
									...
									{	--  Now We Got Bad Blood
										["achievementID"] = 12772,	--  Now We Got Bad Blood
									},
							...
							{	-- Mythrax the Unraveler [7]
								...
								["g"] = {
									...
									{	-- Existential Crisis
										["achievementID"] = 12836,	-- Existential Crisis
									},
							...
							{	-- G'huun
								...
								["g"] = {
									...
									{	-- Double Dribble
										["achievementID"] = 12551,	-- Double Dribble
									},
