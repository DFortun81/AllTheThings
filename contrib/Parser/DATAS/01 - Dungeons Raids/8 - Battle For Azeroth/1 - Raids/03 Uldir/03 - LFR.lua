							...
							{	-- Zone Drops
								...
								["g"] = {
									...
									{	-- Spellbound Specimen Handlers
										["itemID"] = 160612,	-- Spellbound Specimen Handlers
									},
									{	-- Antiseptic Specimen Handlers
										["itemID"] = 161075,	-- Antiseptic Specimen Handlers
									},
									{	-- Splatterguards
										["itemID"] = 161072,	-- Splatterguards
									},
									{	-- Iron-Grip Specimen Handlers
										["itemID"] = 161076,	-- Iron-Grip Specimen Handlers
									},
									{	-- Reinforced Test Subject Shackles
										["itemID"] = 161073,	-- Reinforced Test Subject Shackles
									},
									{	-- Crushproof Vambraces
										["itemID"] = 161074,	-- Crushproof Vambraces
									},
									{	-- Fluid-Resistant Specimen Handlers
										["itemID"] = 161077,	-- Fluid-Resistant Specimen Handlers
									},
								},
							},
							{	-- Halls of Containment
								...
								["g"] = {
									...
									{	-- Zek'voz, Herald of N'zoth
										["encounterID"] = 2169,	-- Zek'voz, Herald of N'zoth
										["crs"] = {
