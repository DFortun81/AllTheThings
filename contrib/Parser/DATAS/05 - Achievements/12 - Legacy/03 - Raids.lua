		...
		["groups"] = {
			n(-10044, { -- Raids
				["groups"] = {
					...
					un(12, ach(3819, {	-- A Tribute to Insanity (25 player)
						un(12, ach(3818)),	-- A Tribute to Mad Skill (25 player)
						un(12, ach(3817)),	-- A Tribute to Skill (25 player)
					})),
					un(12, ach(3159, {	-- Alone in the Darkness (10 player)
						un(12, ach(3158)),	-- One Light in the Darkness (10 player)
						un(12, ach(3141)),	-- Two Lights in the Darkness (10 player)
						un(12, ach(3157)),	-- Three Lights in the Darkness (10 player)
					})),
					un(12, ach(3164, {	-- Alone in the Darkness (25 player)
						un(12, ach(3163)),	-- One Light in the Darkness (25 player)
						un(12, ach(3162)),	-- Two Lights in the Darkness (25 player)
						un(12, ach(3161)),	-- Three Lights in the Darkness (25 player)
					})),
					un(12, ach(2945)),	-- But I'm On Your Side (10 player)
					un(12, ach(2946)),	-- But I'm On Your Side (25 player)
					...
					un(12, ach(2985)),	-- Deforestation (10 player)
					un(12, ach(2984)),	-- Deforestation (25 player)
					un(12, ach(2953)),	-- Disarmed (10 player)
					un(12, ach(2954)),	-- Disarmed (25 player)
					un(12, ach(2971)),	-- Don't Stand in the Lightning (10 player)
					un(12, ach(2972)),	-- Don't Stand in the Lightning (25 player)
					un(12, ach(3008)),	-- Drive Me Crazy (10 player)
					un(12, ach(3010)),	-- Drive Me Crazy (25 player)
					un(12, ach(3097)),	-- Dwarfageddon (10 player)
					un(12, ach(3098)),	-- Dwarfageddon (25 player)
					un(12, ach(3180)),	-- Firefighter (10 player)
					un(12, ach(3189)),	-- Firefighter (25 player)
					un(12, ach(2982)),	-- Getting Back to Nature (10 player)
					un(12, ach(2983)),	-- Getting Back to Nature (25 player)
					un(12, ach(2967)),	-- Getting Cold in Here (10 player)
					un(12, ach(2968)),	-- Getting Cold in Here (25 player)
					...
					un(12, ach(3058)),	-- Heartbreaker (10 player)
					un(12, ach(3059)),	-- Heartbreaker (25 player)
					un(12, ach(2927)),	-- Hot Pocket (10 player)
					un(12, ach(2928)),	-- Hot Pocket (25 player)
					un(12, ach(2939)),	-- I Choose You, Runemaster Molgeim (10 player)
					un(12, ach(2942)),	-- I Choose You, Runemaster Molgeim (25 player)
					un(12, ach(2941)),	-- I Choose You, Steelbreaker (10 player)
					un(12, ach(2944)),	-- I Choose You, Steelbreaker (25 player)
					un(12, ach(2940)),	-- I Choose You, Stormcaller Brundir (10 player)
					un(12, ach(2943)),	-- I Choose You, Stormcaller Brundir (25 player)
					un(12, ach(3182)),	-- I Could Say That This Cache Was Rare (10 player)
					un(12, ach(3184)),	-- I Could Say That This Cache Was Rare (25 player)
					un(12, ach(2963)),	-- I Have the Coolest Friends (10 player)
					un(12, ach(2965)),	-- I Have the Coolest Friends (25 player)
					un(12, ach(3181)),	-- I Love the Smell of Saronite in the Morning (10 player)
					un(12, ach(3188)),	-- I Love the Smell of Saronite in the Morning (25 player)
					un(12, ach(2973)),	-- I'll Take You All On (10 player)
					un(12, ach(2974)),	-- I'll Take You All On (25 player)
					un(12, ach(2955)),	-- If Looks Could Kill (10 player)
					un(12, ach(2956)),	-- If Looks Could Kill (25 player)
					un(12, ach(3015)),	-- In His House He Waits Dreaming (10 player)
					un(12, ach(3016)),	-- In His House He Waits Dreaming (25 player)
					...
					un(12, ach(3183, {	-- Lose Your Illusion (25 player)
						un(12, ach(2978)),	-- Siffed (25 player)
					})),
					un(12, ach(2979)),	-- Lumberjacked (10 player)
					un(12, ach(3118)),	-- Lumberjacked (25 player)
					un(12, ach(2937)),	-- Must Deconstruct Faster (10 player)
					un(12, ach(2938)),	-- Must Deconstruct Faster (25 player)
					un(12, ach(2931)),	-- Nerf Engineering (10 player)
					un(12, ach(2932)),	-- Nerf Engineering (25 player)
					un(12, ach(2934)),	-- Nerf Gravity Bombs (10 player)
					un(12, ach(2936)),	-- Nerf Gravity Bombs (25 player)
					un(12, ach(2933)),	-- Nerf Scrapbots (10 player)
					un(12, ach(2935)),	-- Nerf Scrapbots (25 player)
