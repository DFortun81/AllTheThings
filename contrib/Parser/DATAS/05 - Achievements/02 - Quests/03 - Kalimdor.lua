			...
			n(-9976, {	-- Kalimdor
				["groups"] = {
					...
					ach(1678, {		-- Loremaster of Kalimdor
						crit(1),		-- Ashenvale
						crit(2),		-- Bloodmyst/North Barrens
						crit(3),		-- Darkshore/Azshara
						crit(4),		-- Desolace Quests
						crit(5),		-- Dustwallow Marsh
						crit(6),		-- Felwood Quests
						crit(7),		-- Feralas
						crit(8),		-- Silithus Quests
						crit(9),		-- Southern Barrens
						crit(10),		-- Stonetalon Mountains
						crit(11),		-- Tanaris Quests
						crit(12),		-- Thousand Needles Quests
						crit(13),		-- Un'Goro Crater Quests
						crit(14),		-- Winterspring Quests
					}),
