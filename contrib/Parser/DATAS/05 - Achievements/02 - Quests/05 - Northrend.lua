			...
			n(-9978, {	-- Northrend
				["groups"] = {
					...
					ach(41, {		-- Loremaster of Northrend
						crit(1),		-- Nothing Boring About Borean
						crit(2),		-- I've Toured the Fjord
						crit(3),		-- Might of Dragonblight
						crit(4),		-- Fo' Grizzle My Shizzle
						crit(5),		-- The Empire of Zul'Drak
						crit(6),		-- Into the Basin
						crit(7),		-- The Summit of Storm Peaks
						crit(8),		-- Icecrown: The Final Goal
					}),
					a(ach(35, {		-- Might of Dragonblight (Alliance)
					...
					h(ach(1359, {	-- Might of Dragonblight (Horde)
						crit(1),		-- The Taunka
