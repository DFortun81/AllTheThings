			...
			n(-10056, {	-- Island Expeditions
				...
				["g"] = {
					...
					ach(13122, {	-- Island Conqueror
						...
						crit(9),	-- Mythic: Havenswood
						crit(8),	-- Mythic: Jorundall
					...
					ach(13141, {	-- Island Slayer
						crit(6),	-- Bane of the Chain
						crit(5),	-- Clash at the Cay
						crit(9),	-- Havenswood Hero
						crit(8),	-- Jorundall Justice
						crit(4),	-- Mire Marauder
						crit(1),	-- Reef Madness
						crit(7),	-- Ruined the Ruins
						crit(3),	-- Skittering Smashed
						crit(2),	-- War for the Wilds
					}),
