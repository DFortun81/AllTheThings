		...
		["groups"] = bubbleDown({["u"] = 21}, {
			n(-10019, {	-- Midsummer
				["groups"] = {
					...
					ach(13342, {	-- Extinguishing Kul Tiras (Horde)
						["races"] = HORDE_ONLY,
						["g"] = {
					...
					ach(13343, {	-- Extinguishing Zandalar (Alliance)
						["races"] = ALLIANCE_ONLY,
						["g"] = {
							crit(1),		-- Zuldazar
							crit(2),		-- Nazmir
					...
					ach(13340, {	-- Flame Keeper of Zandalar (Horde)
						["races"] = HORDE_ONLY,
						["g"] = {
							crit(1),		-- Zuldazar
							crit(2),		-- Nazmir
					...
					ach(13341, {	-- Flame Warden of Kul Tiras (Alliance)
						["races"] = ALLIANCE_ONLY,
						["g"] = {
							crit(1),		-- Tiragarde Sound
							crit(2),		-- Stormsong Valley
