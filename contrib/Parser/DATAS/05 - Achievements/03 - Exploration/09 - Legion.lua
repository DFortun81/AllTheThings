			...
			n(-9982, {	-- Legion
				["groups"] = {
					...
					ach(11190, {	-- Broken Isles Pathfinder, Part One
						crit(1),		-- Broken Isles Explorer
						crit(2),		-- Loremaster of Legion
						crit(3),		-- Variety is the Spice of Life
						crit(4),		-- Broken Isles Diplomat
						crit(5),		-- A Glorious Campaign
						ach(11446, {	-- Broken Isles Pathfinder, Part Two
							crit(1),		-- Broken Isles Pathfinder, Part One
					...
					ach(12028, {	-- Envision Invasion Eradication
						crit(1),		-- Mazgoroth
						crit(2),		-- Gorgoloth
						crit(3),		-- Dread Knight Zak'gal
						crit(4),		-- Fel Lord Kaz'ral
						crit(5),		-- Flamecaller Vezrah
						crit(6),		-- Flameweaver Verathix
						crit(7),		-- Harbinger Drel'nathar
						crit(8),		-- Dreadbringer Valus
						crit(9),		-- Malphazel
						crit(10),		-- Vogrethar the Defiled
						crit(11),		-- Vel'thrak the Punisher
						crit(12),		-- Flamebringer Az'rothel
						crit(13),		-- Baldrazar
					}),
