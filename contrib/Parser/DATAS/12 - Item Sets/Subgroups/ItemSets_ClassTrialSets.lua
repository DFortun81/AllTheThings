...
_.GearSets = 
{
	n(-5350, { -- Class Trial Item Sets
		n(-138, {	-- Class Trial Level 100 Sets
			["description"] = "These are gained by creating a Level 100 Trial of that particular class.  Each class has one default spec.  Shamans and Druids have two specs available and both are needed to 100% each category.",
		...
		n(-154, {	-- Class Trial Level 110 Sets
