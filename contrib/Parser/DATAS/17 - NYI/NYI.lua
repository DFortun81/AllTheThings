...
_.NeverImplemented = 
{
	...
	un(1, i(41736)),	-- Design: Radiant Forest Emerald (used version is 41819)
	un(1, i(41782)),	-- Design: Lightning Forest Emerald (used version is 41696)
	un(1, i(41785)),	-- Design: Glinting Twilight Opal (used version is 41582)
	un(1, i(41796)),	-- Design: Glinting Twilight Opal (used version is 41582)
	un(1, i(41792)),	-- Design: Deft Monarch Topaz (used version is 41687)
	un(1, i(46900)),	-- Design: Purified Dreadstone (used version is 46937)
	un(1, i(46903)),	-- Design: Purified Dreadstone (used version is 46937)
	un(1, i(46947)),	-- Design: Purified Dreadstone (used version is 46937)
	un(1, i(46907)),	-- Design: Lightning Eye of Zul (used version is 46909)
	un(1, i(46908)),	-- Design: Radiant Eye of Zul (used version is 46911)
	un(1, i(46910)),	-- Design: Energized Eye of Zul (used version is 46912)
	un(1, i(46914)),	-- Design: Turbid Eye of Zul (used version is 46915)
	un(1, i(46919)),	-- Design: Delicate Cardinal Ruby (used version is 46918)
	un(1, i(46921)),	-- Design: Smooth King's Amber (used version is 46929)
	un(1, i(46927)),	-- Design: Sparkling Majestic Zircon (used version is 46925)
	un(1, i(46930)),	-- Design: Brilliant Cardinal Ruby (used version is 46916)
	un(1, i(46931)),	-- Design: Subtle King's Amber (used version is 46922)
	un(1, i(46934)),	-- Design: Shifting Dreadstone (used version is 46938)
	un(1, i(46936)),	-- Design: Timeless Dreadstone (used version is 46902)
	un(1, i(46939)),	-- Design: Purified Dreadstone (used version is 46937)
	un(1, i(46945)),	-- Design: Glinting Dreadstone (used version is 46956)
	un(1, i(46946)),	-- Design: Glinting Dreadstone (used version is 46956)
	un(1, i(47008)),	-- Design: Glinting Dreadstone (used version is 46956)
