...
_.WorldEvents =
{
	n(-496, { -- Bizmo's Brawlpub
		["groups"] = {	
			n(-2, {	-- Vendors
				a(n(68363, {	-- Quackenbush <Bizmo's Brawlpub Quartermaster>
					["groups"]	= {
			...
			a(ach(9176, {		-- Deck Your Collection (Season 2) - According to Wowhead this achievement AND the shirt it rewards ARE still obtainable in Legion. You just have to defeat the bosses listed.
				["groups"] = {
					i(98543),		-- Wraps of the Blood-Soaked Brawler
				},
			...
			i(143763, {		-- Bag of Chipped Dice
				...
				na(68255, {		-- Dippy (and Doopy, but seriously I don't care about Doopy.)
				...
				na(71081, {		-- Mecha-Bruce
					i(151230, {		-- Croc-Skin Brawler's Purse
						i(98085),		-- Brucehide Jersey
					}),
				}),
				na(70616, {		-- Mingus Diggs
					i(151235, {		-- Filthy Brawler's Purse
						i(98092),		-- Digmaster's Bodysleeve
					}),
				}),
				na(71085, {		-- Razorgrin <Terror of the High Seas>
				...
				na(68250, {		-- Unguloxx <The Murderaffe>
