							...
							["groups"] = {
								i(149752, {	-- Keg-Shaped Treasure Box [Uncommon Quality]
									["groups"] = {
										...
										un(24, i(37863)),	-- Direbrew's Remote
									},
									["lvl"] = 46,
								}),
								i(117393, {	-- Keg-Shaped Treasure Chest [Epic Quality]
									["groups"] = {
										...
										un(24, i(117378)), 	-- Direbrew's Bloodied Shanker [Level 100+]
										
										un(24, i(150922)), 	-- Terrific Tankard O'Terror [Level 100+]
										
										un(2, i(71332)), 	-- Tremendous Tankard O'Terror [Level 85]
										un(2, i(107218)), 	-- Tremendous Tankard O'Terror [Level 90]
										un(24, i(117379)), 	-- Tremendous Tankard O'Terror [Level 100+]
