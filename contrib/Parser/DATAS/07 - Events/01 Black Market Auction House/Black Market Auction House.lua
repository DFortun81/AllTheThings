			...
			i(141995, { --  Unclaimed Black Market Container
				["groups"] = {
					...
					{	-- Grimoire of the Four Winds
						...
						["description"] = "Maybe possible to loot from the Container. Doesnt appear normally anymore since 7.3.5",
						--Note!! Drops from container still.  Do not mark removed at all! -- Only from Container, if at all
					},
					un(29, i(118572)), 	-- Illusion: Flame of Ragnaros **
					{	-- Kor'kron Shaman's Treasure
						["groups"] = {
