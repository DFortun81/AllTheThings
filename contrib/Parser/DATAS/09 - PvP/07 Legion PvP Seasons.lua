		...
		n(-682, {	-- Vindictive Gladiator: Legion Season 1
			n(-9914, {	-- Alliance
				n(-660, {	-- Aspirant / Combatant PvP Gear
					...
					n(-384,	{	-- Neck
						un(2, i(135907)),	-- Vindictive Combatant Necklace (A)
						un(2, i(135911)),	-- Vindictive Combatant Pendant (A)
						un(2, i(135915)),	-- Vindictive Combatant Choker (A)
					}),
					n(-385,	{	-- Finger
						un(2, i(135912)),	-- Vindictive Combatant's Band (A)
						un(2, i(135908)),	-- Vindictive Combatant's Ring (A)
						un(2, i(135916)),	-- Vindictive Combatant's Signet (A)
					}),
					n(-386,	{	-- Trinket
						un(2, i(135917)),	-- Vindictive Combatant's Badge of Conquest (A)
						un(2, i(135918)),	-- Vindictive Combatant's Accolade of Conquest (A)
						un(2, i(135919)),	-- Vindictive Combatant's Insignia of Conquest (A)
						un(2, i(135920)),	-- Vindictive Combatant's Emblem of Cruelty (A)
						un(2, i(135921)),	-- Vindictive Combatant's Emblem of Tenacity (A)
						un(2, i(135922)),	-- Vindictive Combatant's Emblem of Meditation (A)
						un(2, i(135923)),	-- Vindictive Combatant's Badge of Dominance (A)
						un(2, i(135924)),	-- Vindictive Combatant's Accolade of Dominance (A)
						un(2, i(135925)),	-- Vindictive Combatant's Insignia of Dominance (A)
						un(2, i(135926)),	-- Vindictive Combatant's Badge of Victory (A)
						un(2, i(135927)),	-- Vindictive Combatant's Accolade of Victory (A)
						un(2, i(135928)),	-- Vindictive Combatant's Insignia of Victory (A)
						un(2, i(135929)),	-- Vindictive Combatant's Badge of Adaptation (A)
					}),
				}),
				n(-661, {	-- Gladiator PvP Gear
					...
					n(-384,	{	-- Neck
						un(2, i(135681)),	-- Vindictive Gladiator's Necklace (A)
						un(2, i(135685)),	-- Vindictive Gladiator's Pendant (A)
						un(2, i(135689)),	-- Vindictive Gladiator's Choker (A)
					}),
					n(-385,	{	-- Finger
						un(2, i(135686)),	-- Vindictive Gladiator's Band (A)
						un(2, i(135682)),	-- Vindictive Gladiator's Ring (A)
						un(2, i(135690)),	-- Vindictive Gladiator's Signet (A)
					}),
					n(-386,	{	-- Trinket
						un(2, i(135691)),	-- Vindictive Gladiator's Badge of Conquest (A)
						un(2, i(135692)),	-- Vindictive Gladiator's Accolade of Conquest (A)
						un(2, i(135693)),	-- Vindictive Gladiator's Insignia of Conquest (A)
						un(2, i(135694)),	-- Vindictive Gladiator's Emblem of Cruelty (A)
						un(2, i(135695)),	-- Vindictive Gladiator's Emblem of Tenacity (A)
						un(2, i(135696)),	-- Vindictive Gladiator's Emblem of Meditation (A)
						un(2, i(135697)),	-- Vindictive Gladiator's Badge of Dominance (A)
						un(2, i(135698)),	-- Vindictive Gladiator's Accolade of Dominance (A)
						un(2, i(135699)),	-- Vindictive Gladiator's Insignia of Dominance (A)
						un(2, i(135700)),	-- Vindictive Gladiator's Badge of Victory (A)
						un(2, i(135701)),	-- Vindictive Gladiator's Accolade of Victory (A)
						un(2, i(135702)),	-- Vindictive Gladiator's Insignia of Victory (A)
						un(2, i(135703)),	-- Vindictive Gladiator's Badge of Adaptation (A)
					}),
				}),
				n(-662, {	-- Elite PvP Gear
					...
					n(-384,	{	-- Neck
						...
						un(2, i(136137)),	-- Vindictive Gladiator's Pendant (A)
						un(2, i(136141)),	-- Vindictive Gladiator's Choker (A)
					}),
					n(-385,	{	-- Finger
						un(2, i(136138)),	-- Vindictive Gladiator's Band (A)
						un(2, i(136134)),	-- Vindictive Gladiator's Ring (A)
						un(2, i(136142)),	-- Vindictive Gladiator's Signet (A)
					}),
					n(-386,	{	-- Trinket
						un(2, i(136143)),	-- Vindictive Gladiator's Badge of Conquest (A)
						un(2, i(136144)),	-- Vindictive Gladiator's Accolade of Conquest (A)
						un(2, i(136145)),	-- Vindictive Gladiator's Insignia of Conquest (A)
						un(2, i(136146)),	-- Vindictive Gladiator's Emblem of Cruelty (A)
						un(2, i(136147)),	-- Vindictive Gladiator's Emblem of Tenacity (A)
						un(2, i(136148)),	-- Vindictive Gladiator's Emblem of Meditation (A)
						un(2, i(136149)),	-- Vindictive Gladiator's Badge of Dominance (A)
						un(2, i(136150)),	-- Vindictive Gladiator's Accolade of Dominance (A)
						un(2, i(136151)),	-- Vindictive Gladiator's Insignia of Dominance (A)
						un(2, i(136152)),	-- Vindictive Gladiator's Badge of Victory (A)
						un(2, i(136153)),	-- Vindictive Gladiator's Accolade of Victory (A)
						un(2, i(136154)),	-- Vindictive Gladiator's Insignia of Victory (A)
						un(2, i(136155)),	-- Vindictive Gladiator's Badge of Adaptation (A)
					}),
				}),
			}),
			n(-9913, {	-- Horde
				n(-660, {	-- Aspirant / Combatant PvP Gear
					...
					n(-384,	{	-- Neck
						un(2, i(136020)),	-- Vindictive Combatant Necklace (H)
						un(2, i(136024)),	-- Vindictive Combatant Pendant (H)
						un(2, i(136028)),	-- Vindictive Combatant Choker (H)
					}),
					n(-385,	{	-- Finger
						un(2, i(136025)),	-- Vindictive Combatant's Band (H)
						un(2, i(136021)),	-- Vindictive Combatant's Ring (H)
						un(2, i(136029)),	-- Vindictive Combatant's Signet (H)
					}),
					n(-386,	{	-- Trinket
						un(2, i(136030)),	-- Vindictive Combatant's Badge of Conquest (H)
						un(2, i(136031)),	-- Vindictive Combatant's Accolade of Conquest (H)
						un(2, i(136032)),	-- Vindictive Combatant's Insignia of Conquest (H)
						un(2, i(136033)),	-- Vindictive Combatant's Emblem of Cruelty (H)
						un(2, i(136034)),	-- Vindictive Combatant's Emblem of Tenacity (H)
						un(2, i(136035)),	-- Vindictive Combatant's Emblem of Meditation (H)
						un(2, i(136036)),	-- Vindictive Combatant's Badge of Dominance (H)
						un(2, i(136037)),	-- Vindictive Combatant's Accolade of Dominance (H)
						un(2, i(136038)),	-- Vindictive Combatant's Insignia of Dominance (H)
						un(2, i(136039)),	-- Vindictive Combatant's Badge of Victory (H)
						un(2, i(136040)),	-- Vindictive Combatant's Accolade of Victory (H)
						un(2, i(136041)),	-- Vindictive Combatant's Insignia of Victory (H)
						un(2, i(136042)),	-- Vindictive Combatant's Badge of Adaptation (H)
					}),
				}),
				n(-661, {	-- Gladiator PvP Gear
					cl(6, {	-- Death Knight
					...
					n(-384,	{	-- Neck
						un(2, i(135794)),	-- Vindictive Gladiator's Necklace (H)
						un(2, i(135798)),	-- Vindictive Gladiator's Pendant (H)
						un(2, i(135802)),	-- Vindictive Gladiator's Choker (H)
					}),
					n(-385,	{	-- Finger
						un(2, i(135799)),	-- Vindictive Gladiator's Band (H)
						un(2, i(135795)),	-- Vindictive Gladiator's Ring (H)
						un(2, i(135803)),	-- Vindictive Gladiator's Signet (H)
					}),
					n(-386,	{	-- Trinket
						un(2, i(135804)),	-- Vindictive Gladiator's Badge of Conquest (H)
						un(2, i(135805)),	-- Vindictive Gladiator's Accolade of Conquest (H)
						un(2, i(135806)),	-- Vindictive Gladiator's Insignia of Conquest (H)
						un(2, i(135807)),	-- Vindictive Gladiator's Emblem of Cruelty (H)
						un(2, i(135808)),	-- Vindictive Gladiator's Emblem of Tenacity (H)
						un(2, i(135809)),	-- Vindictive Gladiator's Emblem of Meditation (H)
						un(2, i(135810)),	-- Vindictive Gladiator's Badge of Dominance (H)
						un(2, i(135811)),	-- Vindictive Gladiator's Accolade of Dominance (H)
						un(2, i(135812)),	-- Vindictive Gladiator's Insignia of Dominance (H)
						un(2, i(135813)),	-- Vindictive Gladiator's Badge of Victory (H)
						un(2, i(135814)),	-- Vindictive Gladiator's Accolade of Victory (H)
						un(2, i(135815)),	-- Vindictive Gladiator's Insignia of Victory (H)
						un(2, i(135816)),	-- Vindictive Gladiator's Badge of Adaptation (H)
					}),
				}),
				n(-662, {	-- Elite PvP Gear
					cl(6, {	-- Death Knight
					...
					n(-384,	{	-- Neck
						un(2, i(136246)),	-- Vindictive Gladiator's Necklace (H)
						un(2, i(136250)),	-- Vindictive Gladiator's Pendant (H)
						un(2, i(136254)),	-- Vindictive Gladiator's Choker (H)
					}),
					n(-385,	{	-- Finger
						un(2, i(136251)),	-- Vindictive Gladiator's Band (H)
						un(2, i(136247)),	-- Vindictive Gladiator's Ring (H)
						un(2, i(136255)),	-- Vindictive Gladiator's Signet (H)
					}),
					n(-386,	{	-- Trinket
						un(2, i(136256)),	-- Vindictive Gladiator's Badge of Conquest (H)	
						un(2, i(136257)),	-- Vindictive Gladiator's Accolade of Conquest (H)	
						un(2, i(136258)),	-- Vindictive Gladiator's Insignia of Conquest (H)	
						un(2, i(136259)),	-- Vindictive Gladiator's Emblem of Cruelty (H)	
						un(2, i(136260)),	-- Vindictive Gladiator's Emblem of Tenacity (H)	
						un(2, i(136261)),	-- Vindictive Gladiator's Emblem of Meditation (H)	
						un(2, i(136262)),	-- Vindictive Gladiator's Badge of Dominance (H)	
						un(2, i(136263)),	-- Vindictive Gladiator's Accolade of Dominance (H)	
						un(2, i(136264)),	-- Vindictive Gladiator's Insignia of Dominance (H)	
						un(2, i(136265)),	-- Vindictive Gladiator's Badge of Victory (H)	
						un(2, i(136266)),	-- Vindictive Gladiator's Accolade of Victory (H)	
						un(2, i(136267)),	-- Vindictive Gladiator's Insignia of Victory (H)	
						un(2, i(136268)),	-- Vindictive Gladiator's Badge of Adaptation (H)	
					}),
				}),
			}),
		}),
		n(-683, {	-- Fearless Gladiator: Legion Season 2
			n(-9914, {	-- Alliance
				n(-660, {	-- Aspirant / Combatant PvP Gear
					...
					n(-385,	{	-- Finger
						un(2, i(142877)),	-- Fearless Combatant's Ring (A)
						un(2, i(142881)),	-- Fearless Combatant's Band (A)
						un(2, i(142885)),	-- Fearless Combatant's Signet (A)
					}),
					n(-386,	{	-- Trinket
						un(2, i(142886)),	-- Fearless Combatant's Badge of Conquest (A)
						un(2, i(142887)),	-- Fearless Combatant's Accolade of Conquest (A)
						un(2, i(142888)),	-- Fearless Combatant's Insignia of Conquest (A)
						un(2, i(142889)),	-- Fearless Combatant's Emblem of Cruelty (A)
						un(2, i(142890)),	-- Fearless Combatant's Emblem of Tenacity (A)
						un(2, i(142891)),	-- Fearless Combatant's Emblem of Meditation (A)
						un(2, i(142892)),	-- Fearless Combatant's Badge of Dominance (A)
						un(2, i(142893)),	-- Fearless Combatant's Accolade of Dominance (A)
						un(2, i(142894)),	-- Fearless Combatant's Insignia of Dominance (A)
						un(2, i(142895)),	-- Fearless Combatant's Badge of Victory (A)
						un(2, i(142896)),	-- Fearless Combatant's Accolade of Victory (A)
						un(2, i(142897)),	-- Fearless Combatant's Insignia of Victory (A)
						un(2, i(142898)),	-- Fearless Combatant's Badge of Adaptation (A)
					}),
				}),
				n(-661, {	-- Gladiator PvP Gear
					cl(6, {	-- Death Knight
					...
					n(-385,	{	-- Finger
						un(2, i(142651)),	-- Fearless Gladiator's Ring (A)
						un(2, i(142655)),	-- Fearless Gladiator's Band (A)
						un(2, i(142659)),	-- Fearless Gladiator's Signet (A)
					}),
					n(-386,	{	-- Trinket
						un(2, i(142660)),	-- Fearless Gladiator's Badge of Conquest (A)
						un(2, i(142661)),	-- Fearless Gladiator's Accolade of Conquest (A)
						un(2, i(142662)),	-- Fearless Gladiator's Insignia of Conquest (A)
						un(2, i(142663)),	-- Fearless Gladiator's Emblem of Cruelty (A)
						un(2, i(142664)),	-- Fearless Gladiator's Emblem of Tenacity (A)
						un(2, i(142665)),	-- Fearless Gladiator's Emblem of Meditation (A)
						un(2, i(142666)),	-- Fearless Gladiator's Badge of Dominance (A)
						un(2, i(142667)),	-- Fearless Gladiator's Accolade of Dominance (A)
						un(2, i(142668)),	-- Fearless Gladiator's Insignia of Dominance (A)
						un(2, i(142669)),	-- Fearless Gladiator's Badge of Victory (A)
						un(2, i(142670)),	-- Fearless Gladiator's Accolade of Victory (A)
						un(2, i(142671)),	-- Fearless Gladiator's Insignia of Victory (A)
						un(2, i(142672)),	-- Fearless Gladiator's Badge of Adaptation (A)
					}),
				}),
				n(-662, {	-- Elite PvP Gear
					cl(6, {	-- Death Knight
					...
					cl(11, {	-- Druid
						un(14, i(143026)),	-- Fearless Gladiator's Dragonhide Belt (H)
						un(14, i(143104)),	-- Fearless Gladiator's Dragonhide Cloak (H)
						un(14, i(143021)),	-- Fearless Gladiator's Dragonhide Gloves (H)
						un(14, i(143022)),	-- Fearless Gladiator's Dragonhide Helm (H)
						un(14, i(143023)),	-- Fearless Gladiator's Dragonhide Legguards (H)
						un(14, i(143020)),	-- Fearless Gladiator's Dragonhide Moccasins (H)
						un(14, i(143025)),	-- Fearless Gladiator's Dragonhide Spaulders (H)
						un(14, i(143024)),	-- Fearless Gladiator's Dragonhide Tunic (H)
						un(14, i(143027)),	-- Fearless Gladiator's Dragonhide Wristguards (H)
					}),
					cl(3, {	-- Hunter
					...
					n(-385,	{	-- Finger
						un(2, i(143103)),	-- Fearless Gladiator's Ring (A)
						un(2, i(143107)),	-- Fearless Gladiator's Band (A)
						un(2, i(143111)),	-- Fearless Gladiator's Signet (A)
					}),
					n(-386,	{	-- Trinket
						un(2, i(143112)),	-- Fearless Gladiator's Badge of Conquest (A)
						un(2, i(143113)),	-- Fearless Gladiator's Accolade of Conquest (A)
						un(2, i(143114)),	-- Fearless Gladiator's Insignia of Conquest (A)
						un(2, i(143115)),	-- Fearless Gladiator's Emblem of Cruelty (A)
						un(2, i(143116)),	-- Fearless Gladiator's Emblem of Tenacity (A)
						un(2, i(143117)),	-- Fearless Gladiator's Emblem of Meditation (A)
						un(2, i(143118)),	-- Fearless Gladiator's Badge of Dominance (A)
						un(2, i(143119)),	-- Fearless Gladiator's Accolade of Dominance (A)
						un(2, i(143120)),	-- Fearless Gladiator's Insignia of Dominance (A)
						un(2, i(143121)),	-- Fearless Gladiator's Badge of Victory (A)
						un(2, i(143122)),	-- Fearless Gladiator's Accolade of Victory (A)
						un(2, i(143123)),	-- Fearless Gladiator's Insignia of Victory (A)
						un(2, i(143124)),	-- Fearless Gladiator's Badge of Adaptation (A)
					}),
				}),
			}),
			n(-9913, {	-- Horde
				n(-660, {	-- Aspirant / Combatant PvP Gear
					...
					n(-385,	{	-- Finger
						un(2, i(142990)),	-- Fearless Combatant's Ring (H)
						un(2, i(142994)),	-- Fearless Combatant's Band (H)
						un(2, i(142998)),	-- Fearless Combatant's Signet (H)
					}),
					n(-386,	{	-- Trinket
						un(2, i(142999)),	-- Fearless Combatant's Badge of Conquest (H)
						un(2, i(143000)),	-- Fearless Combatant's Accolade of Conquest (H)
						un(2, i(143001)),	-- Fearless Combatant's Insignia of Conquest (H)
						un(2, i(143002)),	-- Fearless Combatant's Emblem of Cruelty (H)
						un(2, i(143003)),	-- Fearless Combatant's Emblem of Tenacity (H)
						un(2, i(143004)),	-- Fearless Combatant's Emblem of Meditation (H)
						un(2, i(143005)),	-- Fearless Combatant's Badge of Dominance (H)
						un(2, i(143006)),	-- Fearless Combatant's Accolade of Dominance (H)
						un(2, i(143007)),	-- Fearless Combatant's Insignia of Dominance (H)
						un(2, i(143008)),	-- Fearless Combatant's Badge of Victory (H)
						un(2, i(143009)),	-- Fearless Combatant's Accolade of Victory (H)
						un(2, i(143010)),	-- Fearless Combatant's Insignia of Victory (H)
						un(2, i(143011)),	-- Fearless Combatant's Badge of Adaptation (H)
					}),
				}),
				n(-661, {	-- Gladiator PvP Gear
					cl(6, {	-- Death Knight
					...
					n(-385,	{	-- Finger
						un(2, i(142764)),	-- Fearless Gladiator's Ring (H)
						un(2, i(142768)),	-- Fearless Gladiator's Band (H)
						un(2, i(142772)),	-- Fearless Gladiator's Signet (H)
					}),
					n(-386,	{	-- Trinket
						un(2, i(142773)),	-- Fearless Gladiator's Badge of Conquest (H)
						un(2, i(142774)),	-- Fearless Gladiator's Accolade of Conquest (H)
						un(2, i(142775)),	-- Fearless Gladiator's Insignia of Conquest (H)
						un(2, i(142776)),	-- Fearless Gladiator's Emblem of Cruelty (H)
						un(2, i(142777)),	-- Fearless Gladiator's Emblem of Tenacity (H)
						un(2, i(142778)),	-- Fearless Gladiator's Emblem of Meditation (H)
						un(2, i(142779)),	-- Fearless Gladiator's Badge of Dominance (H)
						un(2, i(142780)),	-- Fearless Gladiator's Accolade of Dominance (H)
						un(2, i(142781)),	-- Fearless Gladiator's Insignia of Dominance (H)
						un(2, i(142782)),	-- Fearless Gladiator's Badge of Victory (H)
						un(2, i(142783)),	-- Fearless Gladiator's Accolade of Victory (H)
						un(2, i(142784)),	-- Fearless Gladiator's Insignia of Victory (H)
						un(2, i(142785)),	-- Fearless Gladiator's Badge of Adaptation (H)
					}),
				}),
				n(-662, {	-- Elite PvP Gear
					cl(6, {	-- Death Knight
					...
					n(-385,	{	-- Finger
						un(2, i(143216)),	-- Fearless Gladiator's Ring (H)
						un(2, i(143220)),	-- Fearless Gladiator's Band (H)
						un(2, i(143224)),	-- Fearless Gladiator's Signet (H)
					}),
					n(-386,	{	-- Trinket
						un(2, i(143225)),	-- Fearless Gladiator's Badge of Conquest (H)
						un(2, i(143226)),	-- Fearless Gladiator's Accolade of Conquest (H)
						un(2, i(143227)),	-- Fearless Gladiator's Insignia of Conquest (H)
						un(2, i(143228)),	-- Fearless Gladiator's Emblem of Cruelty (H)
						un(2, i(143229)),	-- Fearless Gladiator's Emblem of Tenacity (H)
						un(2, i(143230)),	-- Fearless Gladiator's Emblem of Meditation (H)
						un(2, i(143231)),	-- Fearless Gladiator's Badge of Dominance (H)
						un(2, i(143232)),	-- Fearless Gladiator's Accolade of Dominance (H)
						un(2, i(143233)),	-- Fearless Gladiator's Insignia of Dominance (H)
						un(2, i(143234)),	-- Fearless Gladiator's Badge of Victory (H)
						un(2, i(143235)),	-- Fearless Gladiator's Accolade of Victory (H)
						un(2, i(143236)),	-- Fearless Gladiator's Insignia of Victory (H)
						un(2, i(143237)),	-- Fearless Gladiator's Badge of Adaptation (H)
					}),
				}),
			}),
		}),
		n(-684, {	-- Cruel Gladiator: Legion Season 3
			n(-9914, {	-- Alliance
				n(-660, {	-- Aspirant / Combatant PvP Gear
					...
					n(-385,	{	-- Finger
						un(2, i(145184)),	-- Cruel Combatant's Ring (A)
						un(2, i(145186)),	-- Cruel Combatant's Band (A)
						un(2, i(145188)),	-- Cruel Combatant's Signet (A)
					}),
					n(-386,	{	-- Trinket
						un(2, i(145222)),	-- Cruel Combatant's Badge of Conquest (A)	
						un(2, i(145224)),	-- Cruel Combatant's Accolade of Conquest (A)	
						un(2, i(145226)),	-- Cruel Combatant's Insignia of Conquest (A)	
						un(2, i(145228)),	-- Cruel Combatant's Badge of Dominance (A)	
						un(2, i(145230)),	-- Cruel Combatant's Accolade of Dominance (A)	
						un(2, i(145232)),	-- Cruel Combatant's Insignia of Dominance (A)	
						un(2, i(145234)),	-- Cruel Combatant's Badge of Victory (A)	
						un(2, i(145236)),	-- Cruel Combatant's Accolade of Victory (A)	
						un(2, i(145238)),	-- Cruel Combatant's Insignia of Victory (A)
					}),
					n(-387, {	-- Relic	
						un(2, i(144512)),	-- Alliance of Convenience
						un(2, i(144531)),	-- Battering Tempest
						un(2, i(144522)),	-- Battle-Tempered Hilt
						un(2, i(144513)),	-- Blaze of Glory
						un(2, i(144528)),	-- Blindside Approach
						un(2, i(144520)),	-- Brilliant Sunstone
						un(2, i(144525)),	-- "Borrowed Soul" Essence
						un(2, i(144519)),	-- Clarity of Conviction
						un(2, i(144518)),	-- Cold Sweat
						un(2, i(144516)),	-- Conscience of the Victorious
						un(2, i(144530)),	-- Dead Man's Tale
						un(2, i(144505)),	-- Exhaustive Research
						un(2, i(144510)),	-- Fel-Loaded Dice
						un(2, i(144514)),	-- Flame of the Fallen
						un(2, i(144507)),	-- Grisly Souvenir
						un(2, i(144511)),	-- Performance Enhancing Curio
						un(2, i(144527)),	-- Petrified Ancient's Thumb
						un(2, i(144529)),	-- Polished Shadowstone
						un(2, i(144521)),	-- Radiance of Dawn
						un(2, i(144504)),	-- Reactive Intuition
						un(2, i(144533)),	-- Roar of the Crowd
						un(2, i(144524)),	-- Steadfast Conviction
						un(2, i(144517)),	-- Superiority's Contempt
						un(2, i(144506)),	-- Taboo Knowledge
						un(2, i(144508)),	-- Thirsty Bloodstone
						un(2, i(144509)),	-- Thrill of Battle
						un(2, i(144532)),	-- Thundering Impact
						un(2, i(144526)),	-- Tombweed Bloom
						un(2, i(144515)),	-- Torch of Competition
						un(2, i(144523)),	-- Unflinching Grit
					}),
				}),
				n(-661, {	-- Gladiator PvP Gear
					cl(6, {	-- Death Knight
					...
					n(-385,	{	-- Finger
						un(2, i(144692)),	-- Cruel Gladiator's Ring (A)
						un(2, i(144694)),	-- Cruel Gladiator's Band (A)
						un(2, i(144696)),	-- Cruel Gladiator's Signet (A)
					}),
					n(-386,	{	-- Trinket
						un(2, i(144730)),	-- Cruel Gladiator's Badge of Conquest (A)
						un(2, i(144732)),	-- Cruel Gladiator's Accolade of Conquest (A)
						un(2, i(144734)),	-- Cruel Gladiator's Insignia of Conquest (A)
						un(2, i(144736)),	-- Cruel Gladiator's Badge of Dominance (A)
						un(2, i(144738)),	-- Cruel Gladiator's Accolade of Dominance (A)
						un(2, i(144740)),	-- Cruel Gladiator's Insignia of Dominance (A)
						un(2, i(144742)),	-- Cruel Gladiator's Badge of Victory (A)
						un(2, i(144744)),	-- Cruel Gladiator's Accolade of Victory (A)
						un(2, i(144746)),	-- Cruel Gladiator's Insignia of Victory (A)
					}),
				}),
				n(-662, {	-- Elite PvP Gear
					cl(6, {	-- Death Knight
					...
					n(-385,	{	-- Finger
						un(2, i(144938)),	-- Cruel Gladiator's Ring (A)
						un(2, i(144940)),	-- Cruel Gladiator's Band (A)
						un(2, i(144942)),	-- Cruel Gladiator's Signet (A)
					}),
					n(-386,	{	-- Trinket
						un(2, i(144976)),	-- Cruel Gladiator's Badge of Conquest (A)
						un(2, i(144978)),	-- Cruel Gladiator's Accolade of Conquest (A)
						un(2, i(144980)),	-- Cruel Gladiator's Insignia of Conquest (A)
						un(2, i(144982)),	-- Cruel Gladiator's Badge of Dominance (A)
						un(2, i(144984)),	-- Cruel Gladiator's Accolade of Dominance (A)
						un(2, i(144986)),	-- Cruel Gladiator's Insignia of Dominance (A)
						un(2, i(144988)),	-- Cruel Gladiator's Badge of Victory (A)
						un(2, i(144990)),	-- Cruel Gladiator's Accolade of Victory (A)
						un(2, i(144992)),	-- Cruel Gladiator's Insignia of Victory (A)
					}),
				}),
			}),
			n(-9913, {	-- Horde
				n(-660, {	-- Aspirant / Combatant PvP Gear
					...
					n(-385,	{	-- Finger
						un(2, i(145185)),	-- Cruel Combatant's Ring (H)
						un(2, i(145187)),	-- Cruel Combatant's Band (H)
						un(2, i(145189)),	-- Cruel Combatant's Signet (H)
					}),
					n(-386,	{	-- Trinket
						un(2, i(145223)),	-- Cruel Combatant's Badge of Conquest (H)	
						un(2, i(145225)),	-- Cruel Combatant's Accolade of Conquest (H)	
						un(2, i(145227)),	-- Cruel Combatant's Insignia of Conquest (H)	
						un(2, i(145229)),	-- Cruel Combatant's Badge of Dominance (H)	
						un(2, i(145231)),	-- Cruel Combatant's Accolade of Dominance (H)	
						un(2, i(145233)),	-- Cruel Combatant's Insignia of Dominance (H)	
						un(2, i(145235)),	-- Cruel Combatant's Badge of Victory (H)	
						un(2, i(145237)),	-- Cruel Combatant's Accolade of Victory (H)	
						un(2, i(145239)),	-- Cruel Combatant's Insignia of Victory (H)
					}),
					n(-387, {	-- Relic
						un(2, i(144512)),	-- Alliance of Convenience
						un(2, i(144531)),	-- Battering Tempest
				...
				n(-661, {	-- Gladiator PvP Gear
					...
					n(-385,	{	-- Finger
						un(2, i(144693)),	-- Cruel Gladiator's Ring (H)
						un(2, i(144695)),	-- Cruel Gladiator's Band (H)
						un(2, i(144697)),	-- Cruel Gladiator's Signet (H)
					}),
					n(-386,	{	-- Trinket
						un(2, i(144731)),	-- Cruel Gladiator's Badge of Conquest (H)
						un(2, i(144733)),	-- Cruel Gladiator's Accolade of Conquest (H)
						un(2, i(144735)),	-- Cruel Gladiator's Insignia of Conquest (H)
						un(2, i(144737)),	-- Cruel Gladiator's Badge of Dominance (H)
						un(2, i(144739)),	-- Cruel Gladiator's Accolade of Dominance (H)
						un(2, i(144741)),	-- Cruel Gladiator's Insignia of Dominance (H)
						un(2, i(144743)),	-- Cruel Gladiator's Badge of Victory (H)
						un(2, i(144745)),	-- Cruel Gladiator's Accolade of Victory (H)
						un(2, i(144747)),	-- Cruel Gladiator's Insignia of Victory (H)
					}),
				}),
				n(-662, {	-- Elite PvP Gear
					cl(6, {	-- Death Knight
					...
					n(-385,	{	-- Finger
						un(2, i(144939)),	-- Cruel Gladiator's Ring (H)
						un(2, i(144941)),	-- Cruel Gladiator's Band (H)
						un(2, i(144943)),	-- Cruel Gladiator's Signet (H)
					}),
					n(-386,	{	-- Trinket
						un(2, i(144977)),	-- Cruel Gladiator's Badge of Conquest (H)
						un(2, i(144979)),	-- Cruel Gladiator's Accolade of Conquest (H)
						un(2, i(144981)),	-- Cruel Gladiator's Insignia of Conquest (H)
						un(2, i(144983)),	-- Cruel Gladiator's Badge of Dominance (H)
						un(2, i(144985)),	-- Cruel Gladiator's Accolade of Dominance (H)
						un(2, i(144987)),	-- Cruel Gladiator's Insignia of Dominance (H)
						un(2, i(144989)),	-- Cruel Gladiator's Badge of Victory (H)
						un(2, i(144991)),	-- Cruel Gladiator's Accolade of Victory (H)
						un(2, i(144993)),	-- Cruel Gladiator's Insignia of Victory (H)
					}),
				}),
			}),
		}),
		n(-685, {	-- Ferocious Gladiator: Legion Season 4
			n(-9914, {	-- Alliance
				n(-660, {	-- Aspirant / Combatant PvP Gear
					...
					n(-385,	{	-- Finger
						un(2, i(146026)), -- Ferocious Combatant's Ring (A)
						un(2, i(146028)), -- Ferocious Combatant's Band (A)
						un(2, i(146030)), -- Ferocious Combatant's Signet (A)
					}),
					n(-386,	{	-- Trinket
						un(2, i(146064)), -- Ferocious Combatant's Badge of Conquest (A)
						un(2, i(146066)), -- Ferocious Combatant's Accolade of Conquest (A)
						un(2, i(146068)), -- Ferocious Combatant's Insignia of Conquest (A)
						un(2, i(146070)), -- Ferocious Combatant's Badge of Dominance (A)
						un(2, i(146072)), -- Ferocious Combatant's Accolade of Dominance (A)
						un(2, i(146074)), -- Ferocious Combatant's Insignia of Dominance (A)
						un(2, i(146076)), -- Ferocious Combatant's Badge of Victory (A)
						un(2, i(146078)), -- Ferocious Combatant's Accolade of Victory (A)
						un(2, i(146080)), -- Ferocious Combatant's Insignia of Victory (A)
					}),
					n(-387, {	-- Relic
						un(2, i(145354)),	-- Alliance of Convenience
						un(2, i(145373)),	-- Battering Tempest
						un(2, i(145364)),	-- Battle-Tempered Hilt
						un(2, i(145355)),	-- Blaze of Glory
						un(2, i(145370)),	-- Blindside Approach
						un(2, i(145362)),	-- Brilliant Sunstone
						un(2, i(145367)),	-- "Borrowed Soul" Essence
						un(2, i(145361)),	-- Clarity of Conviction
						un(2, i(145360)),	-- Cold Sweat
						un(2, i(145358)),	-- Conscience of the Victorious
						un(2, i(145372)),	-- Dead Man's Tale
						un(2, i(145347)),	-- Exhaustive Research
						un(2, i(145352)),	-- Fel-Loaded Dice
						un(2, i(145356)),	-- Flame of the Fallen
						un(2, i(145349)),	-- Grisly Souvenir
						un(2, i(145353)),	-- Performance Enhancing Curio
						un(2, i(145369)),	-- Petrified Ancient's Thumb
						un(2, i(145371)),	-- Polished Shadowstone
						un(2, i(145363)),	-- Radiance of Dawn
						un(2, i(145346)),	-- Reactive Intuition
						un(2, i(145375)),	-- Roar of the Crowd
						un(2, i(145366)),	-- Steadfast Conviction
						un(2, i(145359)),	-- Superiority's Contempt
						un(2, i(145348)),	-- Taboo Knowledge
						un(2, i(145350)),	-- Thirsty Bloodstone
						un(2, i(145351)),	-- Thrill of Battle
						un(2, i(145374)),	-- Thundering Impact
						un(2, i(145368)),	-- Tombweed Bloom
						un(2, i(145357)),	-- Torch of Competition
						un(2, i(145365)),	-- Unflinching Grit
					}),
				}),
				n(-661, {	-- Gladiator PvP Gear
					cl(6, {	-- Death Knight
					...
					n(-385,	{	-- Finger
						un(2, i(145534)), -- Ferocious Gladiator's Ring (A)
						un(2, i(145536)), -- Ferocious Gladiator's Band (A)
						un(2, i(145538)), -- Ferocious Gladiator's Signet (A)
					}),
					n(-386,	{	-- Trinket
						un(2, i(145572)), -- Ferocious Gladiator's Badge of Conquest (A)
						un(2, i(145574)), -- Ferocious Gladiator's Accolade of Conquest (A)
						un(2, i(145576)), -- Ferocious Gladiator's Insignia of Conquest (A)
						un(2, i(145578)), -- Ferocious Gladiator's Badge of Dominance (A)
						un(2, i(145580)), -- Ferocious Gladiator's Accolade of Dominance (A)
						un(2, i(145582)), -- Ferocious Gladiator's Insignia of Dominance (A)
						un(2, i(145584)), -- Ferocious Gladiator's Badge of Victory (A)
						un(2, i(145586)), -- Ferocious Gladiator's Accolade of Victory (A)
						un(2, i(145588)), -- Ferocious Gladiator's Insignia of Victory (A)
					}),
					n(-387, {	-- Relic
						un(2, i(151502)),	-- Alliance of Convenience
						un(2, i(151521)),	-- Battering Tempest
						un(2, i(151512)),	-- Battle-Tempered Hilt
						un(2, i(151503)),	-- Blaze of Glory
						un(2, i(151518)),	-- Blindside Approach
						un(2, i(151510)),	-- Brilliant Sunstone
						un(2, i(151515)),	-- "Borrowed Soul" Essence
						un(2, i(151509)),	-- Clarity of Conviction
						un(2, i(151508)),	-- Cold Sweat
						un(2, i(151506)),	-- Conscience of the Victorious
						un(2, i(151520)),	-- Dead Man's Tale
						un(2, i(151495)),	-- Exhaustive Research
						un(2, i(151500)),	-- Fel-Loaded Dice
						un(2, i(151504)),	-- Flame of the Fallen
						un(2, i(151497)),	-- Grisly Souvenir
						un(2, i(151501)),	-- Performance Enhancing Curio
						un(2, i(151517)),	-- Petrified Ancient's Thumb
						un(2, i(151519)),	-- Polished Shadowstone
						un(2, i(151511)),	-- Radiance of Dawn
						un(2, i(151494)),	-- Reactive Intuition
						un(2, i(151523)),	-- Roar of the Crowd
						un(2, i(151514)),	-- Steadfast Conviction
						un(2, i(151507)),	-- Superiority's Contempt
						un(2, i(151496)),	-- Taboo Knowledge
						un(2, i(151498)),	-- Thirsty Bloodstone
						un(2, i(151499)),	-- Thrill of Battle
						un(2, i(151522)),	-- Thundering Impact
						un(2, i(151516)),	-- Tombweed Bloom
						un(2, i(151505)),	-- Torch of Competition
						un(2, i(151513)),	-- Unflinching Grit
					}),
				}),
				n(-662, {	-- Elite PvP Gear
					cl(6, {	-- Death Knight
					...
					n(-385,	{	-- Finger
						un(2, i(145780)), -- Ferocious Gladiator's Ring (A)
						un(2, i(145782)), -- Ferocious Gladiator's Band (A)
						un(2, i(145784)), -- Ferocious Gladiator's Signet (A)
					}),
					n(-386,	{	-- Trinket
						un(2, i(145818)), -- Ferocious Gladiator's Badge of Conquest (A)
						un(2, i(145820)), -- Ferocious Gladiator's Accolade of Conquest (A)
						un(2, i(145822)), -- Ferocious Gladiator's Insignia of Conquest (A)
						un(2, i(145824)), -- Ferocious Gladiator's Badge of Dominance (A)
						un(2, i(145826)), -- Ferocious Gladiator's Accolade of Dominance (A)
						un(2, i(145828)), -- Ferocious Gladiator's Insignia of Dominance (A)
						un(2, i(145830)), -- Ferocious Gladiator's Badge of Victory (A)
						un(2, i(145832)), -- Ferocious Gladiator's Accolade of Victory (A)
						un(2, i(145834)), -- Ferocious Gladiator's Insignia of Victory (A)
					}),
				}),
			}),
			n(-9913, {	-- Horde
				n(-660, {	-- Aspirant / Combatant PvP Gear
					...
					n(-385,	{	-- Finger
						un(2, i(146027)), -- Ferocious Combatant's Ring (H)
						un(2, i(146029)), -- Ferocious Combatant's Band (H)
						un(2, i(146031)), -- Ferocious Combatant's Signet (H)
					}),
					n(-386,	{	-- Trinket
						un(2, i(146067)), -- Ferocious Combatant's Accolade of Conquest (H)
						un(2, i(146069)), -- Ferocious Combatant's Insignia of Conquest (H)
						un(2, i(146071)), -- Ferocious Combatant's Badge of Dominance (H)
						un(2, i(146073)), -- Ferocious Combatant's Accolade of Dominance (H)
						un(2, i(146075)), -- Ferocious Combatant's Insignia of Dominance (H)
						un(2, i(146077)), -- Ferocious Combatant's Badge of Victory (H)
						un(2, i(146079)), -- Ferocious Combatant's Accolade of Victory (H)
						un(2, i(146081)), -- Ferocious Combatant's Insignia of Victory (H)
						un(2, i(146065)), -- Ferocious Combatant's Badge of Conquest (H)
					}),
					n(-387, {	-- Relic
						un(2, i(145354)),	-- Alliance of Convenience
						un(2, i(145373)),	-- Battering Tempest
				...
				n(-661, {	-- Gladiator PvP Gear
					...
					n(-385,	{	-- Finger
						un(2, i(145535)), -- Ferocious Gladiator's Ring (H)
						un(2, i(145537)), -- Ferocious Gladiator's Band (H)
						un(2, i(145539)), -- Ferocious Gladiator's Signet (H)
					}),
					n(-386,	{	-- Trinket
						un(2, i(145573)), -- Ferocious Gladiator's Badge of Conquest (H)
						un(2, i(145575)), -- Ferocious Gladiator's Accolade of Conquest (H)
						un(2, i(145577)), -- Ferocious Gladiator's Insignia of Conquest (H)
						un(2, i(145579)), -- Ferocious Gladiator's Badge of Dominance (H)
						un(2, i(145581)), -- Ferocious Gladiator's Accolade of Dominance (H)
						un(2, i(145583)), -- Ferocious Gladiator's Insignia of Dominance (H)
						un(2, i(145585)), -- Ferocious Gladiator's Badge of Victory (H)
						un(2, i(145587)), -- Ferocious Gladiator's Accolade of Victory (H)
						un(2, i(145589)), -- Ferocious Gladiator's Insignia of Victory (H)
					}),
					n(-387, {	-- Relic
						un(2, i(151502)),	-- Alliance of Convenience
						un(2, i(151521)),	-- Battering Tempest
				...
				n(-662, {	-- Elite PvP Gear
					...
					n(-385,	{	-- Finger
						un(2, i(145781)), -- Ferocious Gladiator's Ring (H)
						un(2, i(145783)), -- Ferocious Gladiator's Band (H)
						un(2, i(145785)), -- Ferocious Gladiator's Signet (H)
					}),
					n(-386,	{	-- Trinket
						un(2, i(145819)), -- Ferocious Gladiator's Badge of Conquest (H)
						un(2, i(145821)), -- Ferocious Gladiator's Accolade of Conquest (H)
						un(2, i(145823)), -- Ferocious Gladiator's Insignia of Conquest (H)
						un(2, i(145825)), -- Ferocious Gladiator's Badge of Dominance (H)
						un(2, i(145827)), -- Ferocious Gladiator's Accolade of Dominance (H)
						un(2, i(145829)), -- Ferocious Gladiator's Insignia of Dominance (H)
						un(2, i(145831)), -- Ferocious Gladiator's Badge of Victory (H)
						un(2, i(145833)), -- Ferocious Gladiator's Accolade of Victory (H)
						un(2, i(145835)), -- Ferocious Gladiator's Insignia of Victory (H)
					}),
				}),
			}),
		}),
		n(-686, {	-- Fierce Gladiator: Legion Season 5
			n(-9914, {	-- Alliance
				n(-660, {	-- Aspirant / Combatant PvP Gear
					...
					n(-385,	{	-- Finger
						un(2, i(149664)), -- Fierce Combatant's Ring (A)
						un(2, i(149666)), -- Fierce Combatant's Band (A)
						un(2, i(149668)), -- Fierce Combatant's Signet (A)
					}),
					n(-386,	{	-- Trinket
						un(2, i(149702)), -- Fierce Combatant's Badge of Conquest (A)
						un(2, i(149704)), -- Fierce Combatant's Accolade of Conquest (A)
						un(2, i(149706)), -- Fierce Combatant's Insignia of Conquest (A)
						un(2, i(149708)), -- Fierce Combatant's Badge of Dominance (A)
						un(2, i(149710)), -- Fierce Combatant's Accolade of Dominance (A)
						un(2, i(149712)), -- Fierce Combatant's Insignia of Dominance (A)
						un(2, i(149714)), -- Fierce Combatant's Badge of Victory (A)
						un(2, i(149716)), -- Fierce Combatant's Accolade of Victory (A)
						un(2, i(149718)), -- Fierce Combatant's Insignia of Victory (A)
					}),
					n(-387, {	-- Relic
						un(2, i(150282)),	-- Alliance of Convenience
						un(2, i(150351)),	-- Battering Tempest
						un(2, i(150292)),	-- Battle-Tempered Hilt
						un(2, i(150283)),	-- Blaze of Glory
						un(2, i(150348)),	-- Blindside Approach
						un(2, i(150290)),	-- Brilliant Sunstone
						un(2, i(150295)),	-- "Borrowed Soul" Essence
						un(2, i(150289)),	-- Clarity of Conviction
						un(2, i(150288)),	-- Cold Sweat
						un(2, i(150286)),	-- Conscience of the Victorious
						un(2, i(150350)),	-- Dead Man's Tale
						un(2, i(150275)),	-- Exhaustive Research
						un(2, i(150280)),	-- Fel-Loaded Dice
						un(2, i(150284)),	-- Flame of the Fallen
						un(2, i(150277)),	-- Grisly Souvenir
						un(2, i(150281)),	-- Performance Enhancing Curio
						un(2, i(150297)),	-- Petrified Ancient's Thumb
						un(2, i(150349)),	-- Polished Shadowstone
						un(2, i(150291)),	-- Radiance of Dawn
						un(2, i(150274)),	-- Reactive Intuition
						un(2, i(150353)),	-- Roar of the Crowd
						un(2, i(150294)),	-- Steadfast Conviction
						un(2, i(150287)),	-- Superiority's Contempt
						un(2, i(150276)),	-- Taboo Knowledge
						un(2, i(150278)),	-- Thirsty Bloodstone
						un(2, i(150279)),	-- Thrill of Battle
						un(2, i(150352)),	-- Thundering Impact
						un(2, i(150296)),	-- Tombweed Bloom
						un(2, i(150285)),	-- Torch of Competition
						un(2, i(150293)),	-- Unflinching Grit
					}),
				}),
				n(-661, {	-- Gladiator PvP Gear
					cl(6, {	-- Death Knight
					...
					n(-385,	{	-- Finger
						un(2, i(148067)), -- Fierce Gladiator's Ring (A)
						un(2, i(148069)), -- Fierce Gladiator's Band (A)
						un(2, i(148071)), -- Fierce Gladiator's Signet (A)
					}),
					n(-386,	{	-- Trinket
						un(2, i(148105)), -- Fierce Gladiator's Badge of Conquest (A)
						un(2, i(148107)), -- Fierce Gladiator's Accolade of Conquest (A)
						un(2, i(148109)), -- Fierce Gladiator's Insignia of Conquest (A)
						un(2, i(148111)), -- Fierce Gladiator's Badge of Dominance (A)
						un(2, i(148113)), -- Fierce Gladiator's Accolade of Dominance (A)
						un(2, i(148115)), -- Fierce Gladiator's Insignia of Dominance (A)
						un(2, i(148117)), -- Fierce Gladiator's Badge of Victory (A)
						un(2, i(148119)), -- Fierce Gladiator's Accolade of Victory (A)
						un(2, i(148121)), -- Fierce Gladiator's Insignia of Victory (A)
					}),
				}),
				n(-662, {	-- Elite PvP Gear
					cl(6, {	-- Death Knight
					...
					n(-385,	{	-- Finger
						un(2, i(148313)), -- Fierce Gladiator's Ring (A)
						un(2, i(148315)), -- Fierce Gladiator's Band (A)
						un(2, i(148317)), -- Fierce Gladiator's Signet (A)
					}),
					n(-386,	{	-- Trinket
						un(2, i(148351)), -- Fierce Gladiator's Badge of Conquest (A)
						un(2, i(148353)), -- Fierce Gladiator's Accolade of Conquest (A)
						un(2, i(148355)), -- Fierce Gladiator's Insignia of Conquest (A)
						un(2, i(148357)), -- Fierce Gladiator's Badge of Dominance (A)
						un(2, i(148359)), -- Fierce Gladiator's Accolade of Dominance (A)
						un(2, i(148361)), -- Fierce Gladiator's Insignia of Dominance (A)
						un(2, i(148363)), -- Fierce Gladiator's Badge of Victory (A)
						un(2, i(148365)), -- Fierce Gladiator's Accolade of Victory (A)
						un(2, i(148367)), -- Fierce Gladiator's Insignia of Victory (A)
					}),
				}),
			}),
			n(-9913, {	-- Horde
				n(-660, {	-- Aspirant / Combatant PvP Gear
					...
					n(-385,	{	-- Finger
						un(2, i(149665)), -- Fierce Combatant's Ring (H)
						un(2, i(149667)), -- Fierce Combatant's Band (H)
						un(2, i(149669)), -- Fierce Combatant's Signet (H)
					}),
					n(-386,	{	-- Trinket
						un(2, i(149703)), -- Fierce Combatant's Badge of Conquest (H)
						un(2, i(149705)), -- Fierce Combatant's Accolade of Conquest (H)
						un(2, i(149707)), -- Fierce Combatant's Insignia of Conquest (H)
						un(2, i(149709)), -- Fierce Combatant's Badge of Dominance (H)
						un(2, i(149711)), -- Fierce Combatant's Accolade of Dominance (H)
						un(2, i(149713)), -- Fierce Combatant's Insignia of Dominance (H)
						un(2, i(149715)), -- Fierce Combatant's Badge of Victory (H)
						un(2, i(149717)), -- Fierce Combatant's Accolade of Victory (H)
						un(2, i(149719)), -- Fierce Combatant's Insignia of Victory (H)
					}),
					n(-387, {	-- Relic
						un(2, i(150282)),	-- Alliance of Convenience
						un(2, i(150351)),	-- Battering Tempest
				...
				n(-661, {	-- Gladiator PvP Gear
					...
					n(-385,	{	-- Finger
						un(2, i(148068)), -- Fierce Gladiator's Ring (H)
						un(2, i(148070)), -- Fierce Gladiator's Band (H)
						un(2, i(148072)), -- Fierce Gladiator's Signet (H)
					}),
					n(-386,	{	-- Trinket
						un(2, i(148106)), -- Fierce Gladiator's Badge of Conquest (H)
						un(2, i(148108)), -- Fierce Gladiator's Accolade of Conquest (H)
						un(2, i(148110)), -- Fierce Gladiator's Insignia of Conquest (H)
						un(2, i(148112)), -- Fierce Gladiator's Badge of Dominance (H)
						un(2, i(148114)), -- Fierce Gladiator's Accolade of Dominance (H)
						un(2, i(148116)), -- Fierce Gladiator's Insignia of Dominance (H)
						un(2, i(148118)), -- Fierce Gladiator's Badge of Victory (H)
						un(2, i(148120)), -- Fierce Gladiator's Accolade of Victory (H)
						un(2, i(148122)), -- Fierce Gladiator's Insignia of Victory (H)
					}),
				}),
				n(-662, {	-- Elite PvP Gear
					cl(6, {	-- Death Knight
					...
					n(-385,	{	-- Finger
						un(2, i(148314)), -- Fierce Gladiator's Ring (H)
						un(2, i(148316)), -- Fierce Gladiator's Band (H)
						un(2, i(148318)), -- Fierce Gladiator's Signet (H)
					}),
					n(-386,	{	-- Trinket
						un(2, i(148352)), -- Fierce Gladiator's Badge of Conquest (H)
						un(2, i(148354)), -- Fierce Gladiator's Accolade of Conquest (H)
						un(2, i(148356)), -- Fierce Gladiator's Insignia of Conquest (H)
						un(2, i(148358)), -- Fierce Gladiator's Badge of Dominance (H)
						un(2, i(148360)), -- Fierce Gladiator's Accolade of Dominance (H)
						un(2, i(148362)), -- Fierce Gladiator's Insignia of Dominance (H)
						un(2, i(148364)), -- Fierce Gladiator's Badge of Victory (H)
						un(2, i(148366)), -- Fierce Gladiator's Accolade of Victory (H)
						un(2, i(148368)), -- Fierce Gladiator's Insignia of Victory (H)
					}),
				}),
			}),
		}),
			...
			n(-9914, {	-- Alliance
				n(-660, {	-- Aspirant / Combatant PvP Gear
					...
					n(-384,	{	-- Neck
						...
						un(2, i(149878)), -- Dominant Combatant's Pendant (A)
						un(2, i(149880)), -- Dominant Combatant's Choker (A)
					}),
					n(-385,	{	-- Finger
						un(2, i(149914)), -- Dominant Combatant's Ring (A)
						un(2, i(149916)), -- Dominant Combatant's Band (A)
						un(2, i(149918)), -- Dominant Combatant's Signet (A)
					}),
					n(-386,	{	-- Trinket
						un(2, i(149952)), -- Dominant Combatant's Badge of Conquest (A)
						un(2, i(149954)), -- Dominant Combatant's Accolade of Conquest (A)
						un(2, i(149956)), -- Dominant Combatant's Insignia of Conquest (A)
						un(2, i(149958)), -- Dominant Combatant's Badge of Dominance (A)
						un(2, i(149960)), -- Dominant Combatant's Accolade of Dominance (A)
						un(2, i(149962)), -- Dominant Combatant's Insignia of Dominance (A)
						un(2, i(149964)), -- Dominant Combatant's Badge of Victory (A)
						un(2, i(149966)), -- Dominant Combatant's Accolade of Victory (A)
						un(2, i(149968)), -- Dominant Combatant's Insignia of Victory (A)
					}),
					n(-387, {	-- Relic	
						un(2, i(150306)),	-- Alliance of Convenience
						un(2, i(150357)),	-- Battering Tempest
						un(2, i(150316)),	-- Battle-Tempered Hilt
						un(2, i(150307)),	-- Blaze of Glory
						un(2, i(150354)),	-- Blindside Approach
						un(2, i(150314)),	-- Brilliant Sunstone
						un(2, i(150319)),	-- "Borrowed Soul" Essence
						un(2, i(150313)),	-- Clarity of Conviction
						un(2, i(150312)),	-- Cold Sweat
						un(2, i(150310)),	-- Conscience of the Victorious
						un(2, i(150356)),	-- Dead Man's Tale
						un(2, i(150299)),	-- Exhaustive Research
						un(2, i(150304)),	-- Fel-Loaded Dice
						un(2, i(150308)),	-- Flame of the Fallen
						un(2, i(150301)),	-- Grisly Souvenir
						un(2, i(150305)),	-- Performance Enhancing Curio
						un(2, i(150321)),	-- Petrified Ancient's Thumb
						un(2, i(150355)),	-- Polished Shadowstone
						un(2, i(150315)),	-- Radiance of Dawn
						un(2, i(150298)),	-- Reactive Intuition
						un(2, i(150359)),	-- Roar of the Crowd
						un(2, i(150318)),	-- Steadfast Conviction
						un(2, i(150311)),	-- Superiority's Contempt
						un(2, i(150300)),	-- Taboo Knowledge
						un(2, i(150302)),	-- Thirsty Bloodstone
						un(2, i(150303)),	-- Thrill of Battle
						un(2, i(150358)),	-- Thundering Impact
						un(2, i(150320)),	-- Tombweed Bloom
						un(2, i(150309)),	-- Torch of Competition
						un(2, i(150317)),	-- Unflinching Grit
					}),
				}),
				n(-661, {	-- Gladiator PvP Gear
					cl(6, {	-- Death Knight
					...
					n(-384,	{	-- Neck
						...
						un(2, i(148524)), -- Dominant Gladiator's Pendant (A)
						un(2, i(148526)), -- Dominant Gladiator's Choker (A)
					}),
					n(-385,	{	-- Finger
						un(2, i(148560)), -- Dominant Gladiator's Ring (A)
						un(2, i(148562)), -- Dominant Gladiator's Band (A)
						un(2, i(148564)), -- Dominant Gladiator's Signet (A)
					}),
					n(-386,	{	-- Trinket
						un(2, i(148600)), -- Dominant Gladiator's Accolade of Conquest (A)
						un(2, i(148602)), -- Dominant Gladiator's Insignia of Conquest (A)
						un(2, i(148604)), -- Dominant Gladiator's Badge of Dominance (A)
						un(2, i(148606)), -- Dominant Gladiator's Accolade of Dominance (A)
						un(2, i(148608)), -- Dominant Gladiator's Insignia of Dominance (A)
						un(2, i(148610)), -- Dominant Gladiator's Badge of Victory (A)
						un(2, i(148612)), -- Dominant Gladiator's Accolade of Victory (A)
						un(2, i(148614)), -- Dominant Gladiator's Insignia of Victory (A)
						un(2, i(148598)), -- Dominant Gladiator's Badge of Conquest (A)
					}),
					n(-387, {	-- Relic
						un(2, i(154060)),	-- Alliance of Convenience
						un(2, i(154079)),	-- Battering Tempest
						un(2, i(154070)),	-- Battle-Tempered Hilt
						un(2, i(154061)),	-- Blaze of Glory
						un(2, i(154076)),	-- Blindside Approach
						un(2, i(154068)),	-- Brilliant Sunstone
						un(2, i(154073)),	-- "Borrowed Soul" Essence
						un(2, i(154067)),	-- Clarity of Conviction
						un(2, i(154066)),	-- Cold Sweat
						un(2, i(154064)),	-- Conscience of the Victorious
						un(2, i(154078)),	-- Dead Man's Tale
						un(2, i(154053)),	-- Exhaustive Research
						un(2, i(154058)),	-- Fel-Loaded Dice
						un(2, i(154062)),	-- Flame of the Fallen
						un(2, i(154055)),	-- Grisly Souvenir
						un(2, i(154059)),	-- Performance Enhancing Curio
						un(2, i(154075)),	-- Petrified Ancient's Thumb
						un(2, i(154077)),	-- Polished Shadowstone
						un(2, i(154069)),	-- Radiance of Dawn
						un(2, i(154052)),	-- Reactive Intuition
						un(2, i(154081)),	-- Roar of the Crowd
						un(2, i(154072)),	-- Steadfast Conviction
						un(2, i(154065)),	-- Superiority's Contempt
						un(2, i(154054)),	-- Taboo Knowledge
						un(2, i(154056)),	-- Thirsty Bloodstone
						un(2, i(154057)),	-- Thrill of Battle
						un(2, i(154080)),	-- Thundering Impact
						un(2, i(154074)),	-- Tombweed Bloom
						un(2, i(154063)),	-- Torch of Competition
						un(2, i(154071)),	-- Unflinching Grit
					}),
				}),
				n(-662, {	-- Elite PvP Gear
					cl(6, {	-- Death Knight
					...
					n(-384,	{	-- Neck
						...
						un(2, i(148770)), -- Dominant Gladiator's Pendant (A)
						un(2, i(148772)), -- Dominant Gladiator's Choker (A)
					}),
					n(-385,	{	-- Finger
						un(2, i(148806)), -- Dominant Gladiator's Ring (A)
						un(2, i(148808)), -- Dominant Gladiator's Band (A)
						un(2, i(148810)), -- Dominant Gladiator's Signet (A)
					}),
					n(-386,	{	-- Trinket
						un(2, i(148844)), -- Dominant Gladiator's Badge of Conquest (A)
						un(2, i(148846)), -- Dominant Gladiator's Accolade of Conquest (A)
						un(2, i(148848)), -- Dominant Gladiator's Insignia of Conquest (A)
						un(2, i(148850)), -- Dominant Gladiator's Badge of Dominance (A)
						un(2, i(148852)), -- Dominant Gladiator's Accolade of Dominance (A)
						un(2, i(148854)), -- Dominant Gladiator's Insignia of Dominance (A)
						un(2, i(148856)), -- Dominant Gladiator's Badge of Victory (A)
						un(2, i(148858)), -- Dominant Gladiator's Accolade of Victory (A)
						un(2, i(148860)), -- Dominant Gladiator's Insignia of Victory (A)
					}),
					n(-387, {	-- Relic
						un(2, i(155716)),	-- "Borrowed Soul" Essence
						un(2, i(155703)),	-- Alliance of Convenience
						un(2, i(155722)),	-- Battering Tempest
						un(2, i(155713)),	-- Battle-Tempered Hilt
						un(2, i(155704)),	-- Blaze of Glory
						un(2, i(155719)),	-- Blindside Approach
						un(2, i(155711)),	-- Brilliant Sunstone
						un(2, i(155710)),	-- Clarity of Conviction
						un(2, i(155709)),	-- Cold Sweat
						un(2, i(155707)),	-- Conscience of the Victorious
						un(2, i(155721)),	-- Dead Man's Tale
						un(2, i(155696)),	-- Exhaustive Research
						un(2, i(155701)),	-- Fel-Loaded Dice
						un(2, i(155705)),	-- Flame of the Fallen
						un(2, i(155698)),	-- Grisly Souvenir
						un(2, i(155702)),	-- Performance Enhancing Curio
						un(2, i(155718)),	-- Petrified Ancient's Thumb
						un(2, i(155720)),	-- Polished Shadowstone
						un(2, i(155712)),	-- Radiance of Dawn
						un(2, i(155695)),	-- Reactive Intuition
						un(2, i(155724)),	-- Roar of the Crowd
						un(2, i(155715)),	-- Steadfast Conviction
						un(2, i(155708)),	-- Superiority's Contempt
						un(2, i(155697)),	-- Taboo Knowledge
						un(2, i(155699)),	-- Thirsty Bloodstone
						un(2, i(155700)),	-- Thrill of Battle
						un(2, i(155723)),	-- Thundering Impact
						un(2, i(155717)),	-- Tombweed Bloom
						un(2, i(155706)),	-- Torch of Competition
						un(2, i(155714)),	-- Unflinching Grit
					}),
				}),
			}),
			n(-9913, {	-- Horde
				n(-660, {	-- Aspirant / Combatant PvP Gear
					...
					n(-384,	{	-- Neck
						...
						un(2, i(149879)), -- Dominant Combatant's Pendant (H)
						un(2, i(149881)), -- Dominant Combatant's Choker (H)
					}),
					n(-385,	{	-- Finger
						un(2, i(149915)), -- Dominant Combatant's Ring (H)
						un(2, i(149917)), -- Dominant Combatant's Band (H)
						un(2, i(149919)), -- Dominant Combatant's Signet (H)
					}),
					n(-386,	{	-- Trinket
						un(2, i(149953)), -- Dominant Combatant's Badge of Conquest (H)
						un(2, i(149955)), -- Dominant Combatant's Accolade of Conquest (H)
						un(2, i(149957)), -- Dominant Combatant's Insignia of Conquest (H)
						un(2, i(149959)), -- Dominant Combatant's Badge of Dominance (H)
						un(2, i(149961)), -- Dominant Combatant's Accolade of Dominance (H)
						un(2, i(149963)), -- Dominant Combatant's Insignia of Dominance (H)
						un(2, i(149965)), -- Dominant Combatant's Badge of Victory (H)
						un(2, i(149967)), -- Dominant Combatant's Accolade of Victory (H)
						un(2, i(149969)), -- Dominant Combatant's Insignia of Victory (H)
					}),
					n(-387, {	-- Relic
						un(2, i(150306)),	-- Alliance of Convenience
						un(2, i(150357)),	-- Battering Tempest
				...
				n(-661, {	-- Gladiator PvP Gear
					...
					n(-384,	{	-- Neck
						...
						un(2, i(148525)), -- Dominant Gladiator's Pendant (H)
						un(2, i(148527)), -- Dominant Gladiator's Choker (H)
					}),
					n(-385,	{	-- Finger
						un(2, i(148561)), -- Dominant Gladiator's Ring (H)
						un(2, i(148563)), -- Dominant Gladiator's Band (H)
						un(2, i(148565)), -- Dominant Gladiator's Signet (H)
					}),
					n(-386,	{	-- Trinket
						un(2, i(148599)), -- Dominant Gladiator's Badge of Conquest (H)
						un(2, i(148601)), -- Dominant Gladiator's Accolade of Conquest (H)
						un(2, i(148603)), -- Dominant Gladiator's Insignia of Conquest (H)
						un(2, i(148605)), -- Dominant Gladiator's Badge of Dominance (H)
						un(2, i(148607)), -- Dominant Gladiator's Accolade of Dominance (H)
						un(2, i(148609)), -- Dominant Gladiator's Insignia of Dominance (H)
						un(2, i(148611)), -- Dominant Gladiator's Badge of Victory (H)
						un(2, i(148613)), -- Dominant Gladiator's Accolade of Victory (H)
						un(2, i(148615)), -- Dominant Gladiator's Insignia of Victory (H)
					}),
					n(-387, {	-- Relic
						un(2, i(154060)),	-- Alliance of Convenience
						un(2, i(154079)),	-- Battering Tempest
				...
				n(-662, {	-- Elite PvP Gear
					...
					n(-384,	{	-- Neck
						...
						un(2, i(148771)), -- Dominant Gladiator's Pendant (H)
						un(2, i(148773)), -- Dominant Gladiator's Choker (H)
					}),
					n(-385,	{	-- Finger
						un(2, i(148807)), -- Dominant Gladiator's Ring (H)
						un(2, i(148809)), -- Dominant Gladiator's Band (H)
						un(2, i(148811)), -- Dominant Gladiator's Signet (H)
					}),
					n(-386,	{	-- Trinket
						un(2, i(148845)), -- Dominant Gladiator's Badge of Conquest (H)
						un(2, i(148847)), -- Dominant Gladiator's Accolade of Conquest (H)
						un(2, i(148849)), -- Dominant Gladiator's Insignia of Conquest (H)
						un(2, i(148851)), -- Dominant Gladiator's Badge of Dominance (H)
						un(2, i(148853)), -- Dominant Gladiator's Accolade of Dominance (H)
						un(2, i(148855)), -- Dominant Gladiator's Insignia of Dominance (H)
						un(2, i(148857)), -- Dominant Gladiator's Badge of Victory (H)
						un(2, i(148859)), -- Dominant Gladiator's Accolade of Victory (H)
						un(2, i(148861)), -- Dominant Gladiator's Insignia of Victory (H)
					}),
					n(-387, {	-- Relic
						un(2, i(155703)),	-- Alliance of Convenience
						un(2, i(155722)),	-- Battering Tempest
			...
			n(-9914, {	-- Alliance
				...
				n(-662, {	-- Elite PvP Gear
					...
					n(-384,	{	-- Neck
						...
						un(2, i(149262)), -- Demonic Gladiator's Pendant (A)
						un(2, i(149264)), -- Demonic Gladiator's Choker (A)
					}),
					n(-385,	{	-- Finger
						un(2, i(149298)), -- Demonic Gladiator's Ring (A)
						un(2, i(149300)), -- Demonic Gladiator's Band (A)
						un(2, i(149302)), -- Demonic Gladiator's Signet (A)
					}),
					n(-386,	{	-- Trinket
						un(2, i(149336)), -- Demonic Gladiator's Badge of Conquest (A)
						un(2, i(149338)), -- Demonic Gladiator's Accolade of Conquest (A)
						un(2, i(149340)), -- Demonic Gladiator's Insignia of Conquest (A)
						un(2, i(149342)), -- Demonic Gladiator's Badge of Dominance (A)
						un(2, i(149344)), -- Demonic Gladiator's Accolade of Dominance (A)
						un(2, i(149346)), -- Demonic Gladiator's Insignia of Dominance (A)
						un(2, i(149348)), -- Demonic Gladiator's Badge of Victory (A)
						un(2, i(149350)), -- Demonic Gladiator's Accolade of Victory (A)
						un(2, i(149352)), -- Demonic Gladiator's Insignia of Victory (A)
					}),
					n(-387, {	-- Relic
						un(2, i(155733)),	-- Alliance of Convenience
						un(2, i(155752)),	-- Battering Tempest
						un(2, i(155743)),	-- Battle-Tempered Hilt
						un(2, i(155734)),	-- Blaze of Glory
						un(2, i(155749)),	-- Blindside Approach
						un(2, i(155741)),	-- Brilliant Sunstone
						un(2, i(155746)),	-- "Borrowed Soul" Essence
						un(2, i(155740)),	-- Clarity of Conviction
						un(2, i(155739)),	-- Cold Sweat
						un(2, i(155737)),	-- Conscience of the Victorious
						un(2, i(155751)),	-- Dead Man's Tale
						un(2, i(155726)),	-- Exhaustive Research
						un(2, i(155731)),	-- Fel-Loaded Dice
						un(2, i(155735)),	-- Flame of the Fallen
						un(2, i(155728)),	-- Grisly Souvenir
						un(2, i(155732)),	-- Performance Enhancing Curio
						un(2, i(155748)),	-- Petrified Ancient's Thumb
						un(2, i(155750)),	-- Polished Shadowstone
						un(2, i(155742)),	-- Radiance of Dawn
						un(2, i(155725)),	-- Reactive Intuition
						un(2, i(155754)),	-- Roar of the Crowd
						un(2, i(155745)),	-- Steadfast Conviction
						un(2, i(155738)),	-- Superiority's Contempt
						un(2, i(155727)),	-- Taboo Knowledge
						un(2, i(155729)),	-- Thirsty Bloodstone
						un(2, i(155730)),	-- Thrill of Battle
						un(2, i(155753)),	-- Thundering Impact
						un(2, i(155747)),	-- Tombweed Bloom
						un(2, i(155736)),	-- Torch of Competition
						un(2, i(155744)),	-- Unflinching Grit
					}),
				}),
			}),
			n(-9913, {	-- Horde
				...
				n(-662, {	-- Elite PvP Gear
					...
					n(-384,	{	-- Neck
						...
						un(2, i(149263)), -- Demonic Gladiator's Pendant (H)
						un(2, i(149265)), -- Demonic Gladiator's Choker (H)
					}),
					n(-385,	{	-- Finger
						un(2, i(149299)), -- Demonic Gladiator's Ring (H)
						un(2, i(149301)), -- Demonic Gladiator's Band (H)
						un(2, i(149303)), -- Demonic Gladiator's Signet (H)
					}),
					n(-386,	{	-- Trinket
						un(2, i(149337)), -- Demonic Gladiator's Badge of Conquest (H)
						un(2, i(149339)), -- Demonic Gladiator's Accolade of Conquest (H)
						un(2, i(149341)), -- Demonic Gladiator's Insignia of Conquest (H)
						un(2, i(149343)), -- Demonic Gladiator's Badge of Dominance (H)
						un(2, i(149345)), -- Demonic Gladiator's Accolade of Dominance (H)
						un(2, i(149347)), -- Demonic Gladiator's Insignia of Dominance (H)
						un(2, i(149349)), -- Demonic Gladiator's Badge of Victory (H)
						un(2, i(149351)), -- Demonic Gladiator's Accolade of Victory (H)
						un(2, i(149353)), -- Demonic Gladiator's Insignia of Victory (H)
					}),
					n(-387, {	-- Relic
						un(2, i(155733)),	-- Alliance of Convenience
						un(2, i(155752)),	-- Battering Tempest
