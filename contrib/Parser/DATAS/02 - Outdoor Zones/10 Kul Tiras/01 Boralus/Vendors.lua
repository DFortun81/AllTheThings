					...
					["groups"] = {
						...
						{	-- Leedan Gustaf <Profession Liason> [NOTE: PvP Craftable Recipes]
							...
							["g"] = {
								...
								{	-- Recipe: Honorable Combatant's Staff of Intuition [Rank 2]
									["itemID"] = 163024,	-- Recipe: Honorable Combatant's Staff of Intuition [Rank 2]
								},
								{	-- Recipe: Honorable Combatant's Staff of Intuition [Rank 3]
									["itemID"] = 163025,	-- Recipe: Honorable Combatant's Staff of Intuition [Rank 3]
								},
								{	-- Recipe: Potion of the Unveiling Eye [Rank 2]
									["itemID"] = 166272,	-- Recipe: Potion of the Unveiling Eye [Rank 2]
								},
								{	-- Recipe: Potion of the Unveiling Eye [Rank 3]
									["itemID"] = 166271,	-- Recipe: Potion of the Unveiling Eye [Rank 3]
								},
								...
								{	-- Recipe: Sinister Combatant's Shield [Rank 2]
									["itemID"] = 165284,	-- Recipe: Sinister Combatant's Shield [Rank 2]
								},
								{	-- Recipe: Sinister Combatant's Shield [Rank 3]
									["itemID"] = 165285,	-- Recipe: Sinister Combatant's Shield [Rank 3]
								},
