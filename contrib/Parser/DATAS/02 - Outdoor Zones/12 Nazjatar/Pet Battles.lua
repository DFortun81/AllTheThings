		...
		["g"] = {
			{	-- Pet Battle
				...
				["g"] = {
					...
					{	-- Abyssal Slitherling
						["speciesID"] = 2678,	-- Abyssal Slitherling
						["crs"] = { 154814 },	-- Abyssal Slitherling
					},
					{	-- Bloodseeker
						["speciesID"] = 2652,	-- Bloodseeker
						["crs"] = { 154714 },	-- Bloodseeker
					},
					{	-- Chitterspine Skitterling
						["speciesID"] = 2648,	-- Chitterspine Skitterling
						["crs"] = { 154706 },	-- Chitterspine Skitterling
					},
					{	-- Deeptide Fingerling
						["speciesID"] = 2651,	-- Deeptide Fingerling
						["crs"] = { 154712 },	-- Deeptide Fingerling
					},
					{	-- Glimmershell Scuttler
						["speciesID"] = 2647,	-- Glimmershell Scuttler
