	...
	m(12, {	-- Kalimdor
		m(106, {	-- Bloodmyst Isle
			n(-17, {	-- Quests
				...
				q(9549, {	-- Artifacts of the Blacksilt -- aa
				...
				q(9741, {	-- Critters of the Void -- aa
				...
				q(10063, {	-- Explorers' League, Is That Something for Gnomes? -- aa
					["qg"] = 18804,	-- Prospector Nachlan
					["coord"] = { 56.3, 54.2, 106 },
					["races"] = ALLIANCE_ONLY,
				}),
				q(10067, {	-- Fouled Water Spirits -- aam
					["coord"] = { 30.7, 46.8, 106 },
					["races"] = ALLIANCE_ONLY,
					["qgs"] = {
				...
				q(9641, {	-- Irradiated Crystal Shards -- aa
					["qg"] = 17684,	-- Vindicator Boros
					["coord"] = { 55.4, 55.2, 106 },
					["races"] = ALLIANCE_ONLY,
				}),
				q(9567, {	-- Know Thine Enemy -- aa
					["qg"] = 17433,	-- Vindicator Aalesia
					["coord"] = { 55.0, 57.9, 106 },
					["races"] = ALLIANCE_ONLY,
				}),
				q(9581, {	-- Learning from the Crystals -- aa
				...
				q(9648, {	-- Mac'Aree Mushroom Menagerie -- aa
				...
				q(10066, {	-- Oh, the Tangled Webs They Weave -- aa
					["coord"] = { 30.7, 46.8, 106 },
					["races"] = ALLIANCE_ONLY,
					["qgs"] = {
						17986,	-- Vindicator Corin
				...
				q(9578, {	-- Searching for Galaen -- aa
					["qg"] = 17434,	-- Morae
					["coord"] = { 53.2, 57.7, 106 },
					["races"] = ALLIANCE_ONLY,
				}),
				q(10064, {	-- Talk to the Hand -- aa
					["qg"] = 17423,	-- Harbinger Mikolaas
					["coord"] = { 52.5, 53.2, 106 },
					["races"] = ALLIANCE_ONLY,
				}),
				q(9580, {	-- The Bear Necessities -- aa
					["qg"] = 17642,	-- Tracker Lyceon
					["coord"] = { 55.8, 56.9, 106 },
					["races"] = ALLIANCE_ONLY,
				}),
				...
				q(9663, {	-- The Kessel Run -- aa
					["qg"] = 17649,	-- Kessel
					["coord"] = { 62.9, 87.5, 106 },
					["races"] = ALLIANCE_ONLY,
				}),
				q(9669, {	-- The Missing Expedition -- aa
					["qg"] = 17676,	-- Achelus
					["coord"] = { 53.2, 57.0, 106 },
					["races"] = ALLIANCE_ONLY,
				}),
				...
				q(9693, {	-- What Argus Means to Me -- aa
					["qg"] = 17658,	-- Exarch Admetius
					["coord"] = { 52.6, 53.2, 106 },
					["races"] = ALLIANCE_ONLY,
				}),
