			...
			["groups"] = {
				n(-17,  {	-- Quests
					["groups"] = {
						h(ach(12478, {	-- Secrets in the Sands
							...
							crit(5, {	-- Storming the Spire
								["groups"] = {
									...
									o(278447, {	-- Faithless Trapper's Spear
										["groups"] = {
							...
							crit(6, {	-- Atul'Aman
								["groups"] = {
									q(50751, {	-- Sanctuary Under Siege -- after storming the spire
										["qg"] = 138519,	-- Vorrik
										["coord"] = { 52.0, 27.7 },
						...
						--
						q(50755, {	-- A Meal for Birds -- seen while doing Secrets in the Sand, Searching for Survivors and Knickknack Takeback
							["qg"] = 137629,	-- Mekaru
							["coord"] = { 54.7, 42.3 },
							--["sourceQuests"] = { },	-- need to confirm
						}),
						q(47322, {	-- Aided Escape -- seen while doing Secrets in the Sand, Searching for Survivors and Knickknack Takeback
							["groups"] = {
						...
						--
						q(50739, {	-- Missing Business -- vulpera hideaway, possibly available any time? First seen upon entering the subzone
							["groups"] = {
								i(158464),	-- Poda
							},
							["qg"] = 135012,	-- Vivi
							["coord"] = { 55.1, 48.4 },
							--["sourceQuests"] = { },	-- need to confirm if this quest has sources or not
						}),
						-- the next 5 are all related to Ranah, which are optional quests
						o(291143, {	-- Ranah's Wrench -- not available if any of Ranah's quests are in your log or have been completed
							["groups"] = {
						...
						q(48553, {	-- Let it Flow
							["qg"] = 126814,	-- Ranah
							["coord"] = { 53.8, 69.3 },
							["sourceQuests"] = { 51829 },	-- Ranah's Wrench (breadcrumb)
						}),
						...
						i(158909, {	-- Beastbreaker Cage Key
							...
							["coord"] = { 49.1, 38.3 },
							["description"] = "Can be found inside a cave near Vorrik's Sanctum",
						}),
						--
						q(50596, {	-- Exterminate the Vermin
							["qg"] = 134408,	-- Foreman Jethek
							["coord"] = { 49.7, 74.9 },
							["sourceQuests"] = { 50770 },	-- Effective Antivenom -- need to confirm this
						}),
						q(50536, {	-- Magic Decoder Device -- first became visible after completing Effective Antivenom
							["qg"] = 134148,	-- Maaz
							["coord"] = { 47.3, 72.7 },
							["sourceQuests"] = { 50770 },	-- Effective Antivenom -- need to confirm this
						}),
						...
						o(287441, {	-- Wanted: Sandscout Vesarik
							["groups"] = {
						...
						q(50703, {	-- Informing the Horde
							...
							["coord"] = { 27.0, 52.5 },
							["sourceQuests"] = { 50702 },	-- Defeat Jakra'zet
							["description"] = "This version is given if Vul'dun is the first zone you select.",
						}),
