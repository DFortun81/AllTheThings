						...
						{	-- Azeroth at War: After Lordaron
							...
							["g"] = {
								...
								{	-- Exorcising Dun Garok	
									...
									["g"] = {	
										{	-- Exorcising Dun Garok	
											["currencyID"] = 1595,	-- Talanji's Expedition Commendation	
										},	
									},	
								},
								{	-- Gilnean Assault	
								...
								{	-- Mounted Resistance	
									...
									["g"] = {	
										{	-- Mounted Resistance	
											["currencyID"] = 1596,	-- Voldunai Commendation	
										},	
									},	
								},
								{	-- Rebuilding Alterac	
									...
									["g"] = {	
										{	-- Rebuilding Alterac	
											["currencyID"] = 1597,	-- Zandalari Empire Commendation	
										},	
									},	
								},
								{	-- Shadowfang Plague	
						...
						{	-- Azeroth at War: Kalimdor on Fire
							...
							["g"] = {
								...
								{	-- Investigate Stardust Spire	
									...
									["g"] = {	
										{	-- Investigate Stardust Spire	
											["currencyID"] = 1600,	-- Honorbound Commendation	
										},	
									},	
								},
								{	-- Out of your Depth	
