...
--]]					
				n(-16, { 	-- Rares
					...
					n(127706, { -- Rezira the Seer
						...
						["description"] = "In order to reach this boss you must either use the |cFFFFD700Observer's Locus Resonator|r purchaseable from Orix the All-Seer or use someone else's portal.",
						["questID"] = 48971,
					}),
