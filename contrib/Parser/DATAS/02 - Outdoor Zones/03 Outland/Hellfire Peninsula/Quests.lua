	...
	m(101, {	-- Outland
		m(100, {	-- Hellfire Peninsula
			n(-17, {  	-- Quests
				ach(1271, {	-- To Hellfire and Back [Horde Version]
					...
					["g"] = {
						crit(1, {	-- Disrupt the Burning Legion
							...
							q(10208, {	-- Disrupt Their Reinforcements
								["groups"] = {
							...
							q(10129, {	-- Mission: Gateways Murketh and Shaadraz
								["groups"] = {
						...
						crit(5, {	-- The Mag'har
							...
							q(9406, {	-- The Mag'har
								...
								["provider"] = { "n", 16845 },	-- Gorkan Bloodfist
								["races"] = HORDE_ONLY,
				...
				ach(1189, {	-- To Hellfire and Back [Alliance Version]
					...
					["g"] = {
						crit(1, {	-- Disrupt the Burning Legion
							...
							q(10144, {	-- Disrupt Their Reinforcements
								["groups"] = {
									i(29932),	-- Arcane Ringed Tunic
									i(29939),	-- Flayer-Hide Leggings
									i(29935),	-- Fore Scarred Breastplate
							...
							q(10146, {	-- Mission: Gateways Murketh and Shaadraz
								["groups"] = {
									i(29942),	-- Battle Scarred Leggings
									i(29937),	-- Helm of Infinite Visions
									i(29944),	-- Protectorate Breastplate
				...
				q(29689, {	-- Advancing the Campaign
					["races"] = ALLIANCE_ONLY,
				}),
				q(29688, {	-- Advancing the Campaign
					["races"] = HORDE_ONLY,
				}),
				...
				q(10106, {	-- Hellfire Fortifications
					["races"] = ALLIANCE_ONLY,
				}),
				q(13410, {	-- Hellfire Fortifications
					["races"] = ALLIANCE_ONLY,
				}),
				q(13408, {	-- Hellfire Fortifications
					["races"] = ALLIANCE_ONLY,
					["g"] = {
						i(40476),	-- Insignia of the Alliance
					},
				}),
				q(13409, {	-- Hellfire Fortifications
				...
				q(10110, {	-- Hellfire Fortifications
					["provider"] = { "n", 18267 },	-- Battlecryer Blackeye
					["races"] = HORDE_ONLY,
					["sourceQuests"] = { 13409 },	-- Hellfire Fortifications
				}),
				q(10443, {	-- Helping the Cenarion Post
					["races"] = ALLIANCE_ONLY,
				}),
				q(10442, {	-- Helping the Cenarion Post
				...
				q(29542, {	-- Invading the Citadel
					["races"] = HORDE_ONLY,
				}),
				q(29543, {	-- Invading the Citadel
					["races"] = ALLIANCE_ONLY,
				}),
				...
				q(10163, {	-- Mission: The Abyssal Shelf
				...
				q(10162, {	-- Mission: The Abyssal Shelf
					["provider"] = { "n", 19273 },	-- Forwarad Commander To'arch
					["races"] = HORDE_ONLY,
					["sourceQuests"] = { 10129 },	-- Mission: Gatewayas Murketh and Shaadraz
					["g"] = {
				...
				q(10346, {	-- Return to the Abyssal Shelf
					["races"] = ALLIANCE_ONLY,
				}),
				q(10347, {	-- Return to the Abyssal Shelf
					["races"] = HORDE_ONLY,
				}),
				...
				q(11003, {	-- The Fall of Magtheridon
					["races"] = HORDE_ONLY,
					["g"] = {
				...
				q(11002, {	-- The Fall of Magtheridon
					["races"] = ALLIANCE_ONLY,
					["g"] = {
						i(28792),	-- A'dal's Signet of Defense
						i(28793),	-- Band of Crimson Fury
