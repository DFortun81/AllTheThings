			...
			n(-17,  {	-- Quests
					...
					crit(6,	{	-- Threats to Nagrand
						...
						o(182392, {	--	Garadar Bulletin Board
							...
							["g"] = {
								...
								q(9939, {	-- WANTED: Zorbo the Advisor
									["coord"] = { 55.7, 38.0, 107 },
									["races"] = HORDE_ONLY,
								}),
							},
				...
				a(ach(1192, {	-- Nagrand Slam (Alliance)
					...
					crit(5,	{	-- The Murkblood
						...
						i(24559, {	-- Murkblood Invasion Plans (Alliance Version)
							["races"] = ALLIANCE_ONLY,
							["g"] = {
					...
					crit(6,	{	-- Threats to Nagrand
						...
						o(182393, {	--	Telaar Bulletin Board
							...
							["g"] = {
								...
								q(9940, {	-- WANTED: Zorbo the Advisor
									["coord"] = { 54.7, 70.8, 107 },
									["races"] = ALLIANCE_ONLY,
								}),
							},
				...
				i(24558, {	-- Murkblood Invasion Plans (Horde Version)
					["races"] = HORDE_ONLY,
					["g"] = {
