...
--[[					
					...
					n(-2,   {	-- Vendors
						["lvl"] = 120,
						["g"] = {
							n(161349, {	-- Blacktalon Quartermaster
								["coord"] = { 52.8, 41.7, 1473 },
								["g"] = { -- TODO:: Update names in future builds
									i(173845, {	-- Cloth Headdress
										["cost"] = {
											{ "i", 174046, 2 },	-- Orb of Visions
											{ "c", 1755, 100 },	-- Echoes of Oblivion
										},
									}),
									i(173812, {	-- Cloth Belt
										["cost"] = {
									...
									i(173468, {	-- Leather Leggings
										["cost"] = {
											{ "i", 174046, 2 },	-- Orb of Visions
											{ "c", 1755, 100 },	-- Echoes of Oblivion
										},
									}),
									i(173443, {	-- Leather Shoulderpads
										["cost"] = {
											{ "i", 174046, 2 },	-- Orb of Visions
											{ "c", 1755, 100 },	-- Echoes of Oblivion
										},
									...
									i(173467, {	-- Cloth Legwraps
										["cost"] = {
											{ "i", 174046, 6 },	-- Orb of Visions
											{ "c", 1755, 100 },	-- Echoes of Oblivion
										},
									}),
									i(173433, {	-- Cloth Headdress
										["cost"] = {
											{ "i", 174046, 6 },	-- Orb of Visions
											{ "c", 1755, 100 },	-- Echoes of Oblivion
										},
									}),
									i(173438, {	-- Leather Wraps
										["cost"] = {
											{ "i", 174046, 6 },	-- Orb of Visions
											{ "c", 1755, 100 },	-- Echoes of Oblivion
										},
									}),
									i(173480, {	-- Leather Bindings
										["cost"] = {
											{ "i", 174046, 6 },	-- Orb of Visions
											{ "c", 1755, 100 },	-- Echoes of Oblivion
										},
									}),
									i(173485, {	-- Mail Trousers
										["cost"] = {
											{ "i", 174046, 6 },	-- Orb of Visions
											{ "c", 1755, 100 },	-- Echoes of Oblivion
										},
									}),
									i(173838, {	-- Mail Shoulderguards
										["cost"] = {
											{ "i", 174046, 6 },	-- Orb of Visions
											{ "c", 1755, 100 },	-- Echoes of Oblivion
										},
									}),
									i(173822, {	-- Plate Greatbelt
										["cost"] = {
											{ "i", 174046, 6 },	-- Orb of Visions
											{ "c", 1755, 100 },	-- Echoes of Oblivion
										},
									}),
									i(173518, {	-- Plate Waders
										["cost"] = {
											{ "i", 174046, 6 },	-- Orb of Visions
											{ "c", 1755, 100 },	-- Echoes of Oblivion
										},
									}),
									i(173490, {	-- Cloth Bracelets
										["cost"] = {
											{ "i", 174047, 4 },	-- Orb of Darkest Visions
											{ "i", 174046, 2 },	-- Orb of Visions
											{ "c", 1755, 100 },	-- Echoes of Oblivion
										},
									}),
									...
									i(173511, {	-- Cloth Belt
										["cost"] = {
											{ "i", 174048, 12 },	-- Orb of Madness
											{ "i", 174047, 4 },	-- Orb of Darkest Visions
											{ "c", 1755, 100 },	-- Echoes of Oblivion
										},
									}),
									i(173515, {	-- Cloth Slippers
										["cost"] = {
											{ "i", 174048, 12 },	-- Orb of Madness
											{ "i", 174047, 4 },	-- Orb of Darkest Visions
											{ "c", 1755, 100 },	-- Echoes of Oblivion
