				...
				["g"] = {
					n(-2, {		-- Vendors
						{	-- Eldara Dawnrunner <Shattered Sun Quartermaster>
							["npcID"] = 25032,	-- Eldara Dawnrunner <Shattered Sun Quartermaster>
							["coords"] = {
								{ 47.26, 30.72 },
							},
							["g"] = {
								...
								{	-- Bombadier's Blade
									["itemID"] = 34665,	-- Bombadier's Blade
								},
								{	-- Inuuro's Blade
								...
								{	-- Formula: Enchant Chest - Dodge
									["itemID"] = 35500,	-- Formula: Enchant Chest - Dodge
								},
						...
						{	-- Karynna <Exotic Gear Purveyor>
							["npcID"] = 26090,	-- Karynna <Exotic Gear Purveyor>
							["coords"] = {
								{ 49.69, 40.53 },
							},
							["g"] = {
