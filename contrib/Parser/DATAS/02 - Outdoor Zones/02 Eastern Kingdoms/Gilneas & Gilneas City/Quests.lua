					...
					{	-- Quests
						...
						["g"] = {
							...
							{	-- As the Land Shatters
								["questID"] = 14396,	-- As the Land Shatters
							...
							{	-- Leader of the Pack
								...
								["g"] = {
									{	-- Dark Ranger's Hauberk
										["itemID"] = 131355,		-- Dark Ranger's Hauberk
										["ignoreSource"] = true,	-- White Item
									},
									{	-- Dark Ranger's Vest
										["itemID"] = 55007,			-- Dark Ranger's Vest
										["ignoreSource"] = true,	-- White Item
									},
									{	-- Leader's Boots
										["itemID"] = 55008,			-- Leader's Boots
										["ignoreSource"] = true,	-- White Item
									},
								},
							},
							...
							{	-- Save the Children!
								...
								["sourceQuests"] = {
									14367,	-- The Allen's Storm Caller
								},
								["coords"] = {
									{ 28.93, 64.04, 179 },
								},
								...
								["g"] = {
									{	-- Caregiver's Leggings
										["itemID"] = 54981,			-- Caregiver's Leggings
										["ignoreSource"] = true,	-- White Item
									},
									{	-- Gloves of Protection
										["itemID"] = 54982,			-- Gloves of Protection
										["ignoreSource"] = true,	-- White Item
									},
