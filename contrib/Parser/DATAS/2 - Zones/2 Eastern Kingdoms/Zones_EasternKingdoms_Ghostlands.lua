...
--					qh( 9877),	-- A Restorative Draught (LEGACY)
					qh( 9488, {	-- A Simple Robe (UNTESTED, don't know if there are add'l prereqs)
						...
						["races"] = {10}, -- Blood Elf
						["classes"] = {8}, -- Mage
						["sourceQuestID"] = { 9487 },	-- Arcane Reavers
					}),
					...
					qh( 9164, {	-- Captives at Deatholme
						...
						["sourceQuestID"] = { 9176 },	-- The Twin Ziggurats
					}),
					...
					qh( 9169, {	-- Deactivate An'owyn
						...
						["sourceQuestID"] = { 9166 },	-- Deliver the Plans to An'telas
					}),
					...
					qh( 9166, {	-- Deliver the Plans to An'telas
						...
						["sourceQuestID"] = { 9163 },	-- Into Occupied Territory
					}),
					...
					o(181150, {	-- Dusty Journal
						...
						["sourceQuestID"] = { 9161 },	-- The Traitor's Shadow
					}),
					...
					qh( 9180, {	-- Journey to Undercity
						...
						["races"] = { 10 }, -- Blood Elf
						["sourceQuestID"] = { 9175 },	-- The Lady's Necklace
					}),
					qr(qh( 9217, {	-- More Rotting Hearts
						["groups"] = {
						},
						["qg"] = 16205,	-- Magistrix Aminel
						["sourceQuestID"] = { 9216 },	-- Rotting Hearts
					})),
					qr(qh( 9219, {	-- More Spinal Dust
						["groups"] = {
						},
						["qg"] = 16205,	-- Magistrix Aminel
						["sourceQuestID"] = { 9218 },	-- Spinal Dust
					})),
					...
					qh( 9172, {	-- Report to Magister Kaendris
						...
						["qg"] = 16203,	-- Ranger Vynna
						["sourceQuestID"] = { 9162 },	-- Hints of the Past
					}),
					...
					qh( 9282, {	-- The Farstrider Enclave
						...
						["qg"] = 16239,	-- Magister Kaendris
						["sourceQuestID"] = { 9151 },	-- The Sanctum of the Sun
					}),
					...
					qh( 9151, {	-- The Sanctum of the Sun
						...
						["qg"] = 16199,	-- Magister Darenis
						["Lvl"] = 20,
--						["sourceQuestID"] = {  },	-- UNKNOWN - requires unknown progression in zone.  Could not pick up on 110 who had done no quests.  Needs more testing.
					}),
--[[				qh( 9529, {	-- The Stone (LEGACY?  no information on where to pick up and most recent wowhead comment speculates it has been removed)
					...
					qh( 9161, {	-- The Traitor's Shadow
						...
						["qg"] = 16203,	-- Ranger Vynna
						["sourceQuestID"] = { 9282 },	-- The Farstrider Enclave
					}),
					qh( 9176, {	-- The Twin Ziggurats
						...
						["qg"] = 16239,	-- Magister Kaendris
						["sourceQuestID"] = { 9172 },	-- Report to Master Kaendris
					}),
