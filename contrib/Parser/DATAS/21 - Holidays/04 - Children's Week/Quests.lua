		...
		["g"] = {
			{	-- Quests
				...
				["g"] = {
					...
					-- HORDE QUESTS - ZANDALARI ORPHAN
					qh(53965, {	-- Children's Week
						["qg"] = 131346,	-- Caretaker Padae
						["coord"] = { 54.6, 84.6, 1165 },
						["maps"] = { 1165 },	-- Dazar'alor
					}),
					qh(53966, {	-- Loa of Winds
						["qg"] = 145463,	-- Azala
						["sourceQuest"] = 53965,	-- Children's Week
						["maps"] = { 1165 },	-- Dazar'alor
					}),
					qh(53967, {	-- The Frogmarsh
						["qg"] = 145463,	-- Azala
						["sourceQuest"] = 53965,	-- Children's Week
						["maps"] = { 1165 },	-- Dazar'alor
						
					}),
					qh(53968, {	-- The Shifting Pack					
						["qg"] = 145463,	-- Azala
						["sourceQuest"] = 53965,	-- Children's Week
						["maps"] = { 1165 },	-- Dazar'alor
					}),
					qh(53969, {	-- Hunting for Gold
						["qg"] = 145463,	-- Azala
						["coords"] = {
							{ 70.7, 49.2, 862 },	-- Loa of Winds
							{ 48.3, 32.1, 862 },	-- The Frogmarsh
							{ 75.4, 56.4, 863 },	-- The Shifting Pac
						},
						["sourceQuests"] = {
							53966,	-- Loa of Winds
							53967,	-- The Frogmarsh
					...
					qh(53971, {	-- Return to the Hall of Castes
						["qg"] = 145463,	-- Azala
						["coords"] = {
							{ 28.7, 88.8, 864 },	-- Hunting for Gold
							{ 27.1, 52.6, 864 },	-- The Sethrak Queen
						},
						["sourceQuests"] = {
