	...
	holiday(235474, {	-- Midsummer Fire Festival
		n(-4,   {	-- Achievements
					...
					ach(1034, {	-- The Fires of Azeroth
						...
						["g"] = {
							ach(1022,  {	-- Flame Warden of Eastern Kingdoms
								["g"] = bubbleDown({["achievementID"] = 1022}, {	-- Flame Warden of Eastern Kingdoms [Achievement]
									crit(1, {	-- Arathi Highlands [Criteria]
							...
							ach(1023,  {	-- Flame Warden of Kalimdor
								["g"] = bubbleDown({["achievementID"] = 1023}, {	-- Flame Warden of Kalimdor [Achievement]
									{
							...
							ach(1024,  {	-- Flame Warden of Outland
								["g"] = bubbleDown({["achievementID"] = 1024}, {	-- Flame Warden of Outland [Achievement]
									{
							...
							ach(6008,  {	-- Flame Warden of Northrend
								["g"] = bubbleDown({["achievementID"] = 6008}, {	-- Flame Warden of Northrend [Achievement]
									{
							...
							ach(6011,  {	-- Flame Warden of Cataclysm
								["g"] = bubbleDown({["achievementID"] = 6011}, {	-- Flame Warden of Cataclysm [Achievement]
									{
					...
					ach(1035, {	-- Desecration of the Horde
						...
						["g"] = {
							ach(1028, {	-- Extinguishing Eastern Kingdoms
								["g"] = bubbleDown({["achievementID"] = 1028}, {	-- Extinguishing Eastern Kingdoms [Achievement]
									{
							...
							ach(1029, {	-- Extinguishing Kalimdor
								["g"] = bubbleDown({["achievementID"] = 1029}, {	-- Extinguishing Kalimdor [Achievement]
									{
										["criteriaID"] = 1,			-- Ashenvale [Criteria]
										["maps"] = { 63 },			-- Ashenvale
										["races"] = ALLIANCE_ONLY,
							...
							ach(1030, {	-- Extinguishing Outland
								["g"] = bubbleDown({["achievementID"] = 1030}, {	-- Extinguishing Outland [Achievement]
									{
										["criteriaID"] = 1,			-- Blade's Edge Mountains [Criteria]
										["maps"] = { 105 },			-- Blade's Edge Mountains
										["races"] = ALLIANCE_ONLY,
							...
							ach(6007, {	-- Extinguishing Northrend
								["g"] = bubbleDown({["achievementID"] = 6007}, {	-- Extinguishing Northrend [Achievement]
									{
							...
							ach(6013, {	-- Extinguishing the Cataclysm
								["g"] = bubbleDown({["achievementID"] = 6013}, {	-- Extinguishing the Cataclysm [Achievement]
									{
			...
			ach(8045,  {	-- Flame Warden of Pandaria
				["g"] = bubbleDown({["achievementID"] = 8045}, {	-- Flame Warden of Pandaria [Achievement]
					{
			...
			ach(11283, {	-- Flame Warden of Draenor
				["g"] = bubbleDown({["achievementID"] = 11283}, {	-- Flame Warden of Draenor [Achievement]
					{
			...
			ach(11280, {	-- Flame Warden of the Broken Isles
				["races"] = ALLIANCE_ONLY,
				["g"] = bubbleDown({["achievementID"] = 11280}, {	-- Flame Warden of the Broken Isles [Achievement]
					{
			...
			ach(13341, {	-- Flame Warden of Kul Tiras
				["races"] = ALLIANCE_ONLY,
				["g"] = bubbleDown({["achievementID"] = 13341}, {	-- Flame Warden of Kul Tiras
				...
				["g"] = {
					...
					ach(1036, {	-- The Fires of Azeroth
						ach(1025, {	-- Flame Keeper of Eastern Kingdoms
							["g"] = bubbleDown({["achievementID"] = 1025}, {	-- Flame Keeper of Eastern Kingdoms [Achievement]
								{
									["criteriaID"] = 1,			-- Arathi Highlands [Criteria]
						...
						ach(1026, {	-- Flame Keeper of Kalimdor
							["g"] = bubbleDown({["achievementID"] = 1026}, {	-- Flame Keeper of Kalimdor [Achievement]
								{
									["criteriaID"] = 1,			-- Ashenvale [Criteria]
						...
						ach(1027, {	-- Flame Keeper of Outland
							["g"] = bubbleDown({["achievementID"] = 1027}, {	-- Flame Keeper of Outland [Achievement]
								{
									["criteriaID"] = 1,			-- Blade's Edge Mountains [Criteria]
						...
						ach(6009, {	-- Flame Keeper of Northrend
							["g"] = bubbleDown({["achievementID"] = 6009}, {	-- Flame Keeper of Northrend [Achievement]
								{
									["criteriaID"] = 1,			-- Dragonblight [Criteria]
						...
						ach(6012, {	-- Flame Keeper of Cataclysm
							["g"] = bubbleDown({["achievementID"] = 6012}, {	-- Flame Keeper of Cataclysm [Achievement]
								{
					...
					ach(1037, {	-- Desecration of the Alliance
						["g"] = {
							ach(1031, {	-- Extinguishing Eastern Kingdoms
								["g"] = bubbleDown({["achievementID"] = 1031}, {	-- Extinguishing Eastern Kingdoms [Achievement]
									{
										["criteriaID"] = 1,			-- Arathi Highlands [Criteria]
										["maps"] = { 14 }, 			-- Arathi Highlands
										["races"] = HORDE_ONLY,
							...
							ach(1032, {	-- Extinguishing Kalimdor
								["g"] = bubbleDown({["achievementID"] = 1032}, {	-- Extinguishing Kalimdor [Achievement]
									{
										["criteriaID"] = 1,			-- Ashenvale [Criteria]
										["maps"] = { 63 },			-- Ashenvale
										["races"] = HORDE_ONLY,
							...
							ach(1033, {	-- Extinguishing Outland
								["g"] = bubbleDown({["achievementID"] = 1033}, {	-- Extinguishing Outland [Achievement]
									{
										["criteriaID"] = 1,			-- Blade's Edge Mountains [Criteria]
										["maps"] = { 105 },			-- Blade's Edge Mountains
										["races"] = HORDE_ONLY,
							...
							ach(6010, {	-- Extinguishing Northrend
								["g"] = bubbleDown({["achievementID"] = 6010}, {	-- Extinguishing Northrend [Achievement]
									{
										["criteriaID"] = 1,			-- Dragonblight [Criteria]
										["maps"] = { 115 },			-- Dragonblight
										["races"] = HORDE_ONLY,
							...
							ach(6014, {	-- Extinguishing the Cataclysm
								["g"] = bubbleDown({["achievementID"] = 6014}, {	-- Extinguishing the Cataclysm [Achievement]
									{
										["criteriaID"] = 1,			-- Twilight Highlands [Criteria]
										["maps"] = { 241 },			-- Twilight Highlands
										["races"] = HORDE_ONLY,
			...
			ach(8044,  {	-- Flame Keeper of Pandaria
				["g"] = bubbleDown({["achievementID"] = 8044}, {	-- Flame Keeper of Pandaria [Achievement]
					{
						["criteriaID"] = 1,			-- Dread Wastes [Criteria]
						["questID"] = 32497,		-- Honor the Flame [Dread Wastes]
						["qg"] = 69522,				-- Dread Wastes Flame Guardian
			...
			ach(11284, {	-- Flame Keeper of Draenor
				["g"] = bubbleDown({["achievementID"] = 11284}, {	-- Flame Keeper of Draenor [Achievement]
					{
						["criteriaID"] = 1,			-- Spires of Arak [Criteria]
						["questID"] = 44570,		-- Honor the Flame [Spires of Arak]
						["qg"] = 114488,			-- Spires of Arak Flame Guardian
			...
			ach(11282, {	-- Flame Keeper of the Broken Isles
				["g"] = bubbleDown({["achievementID"] = 11282}, {	-- Flame Keeper of the Broken Isles [Achievement]
					{
						["criteriaID"] = 1,			-- Azsuna [Criteria]
						["questID"] = 44574,		-- Honor the Flame [Azsuna]
						["qg"] = 114492,			-- Azsuna Flame Guardian
