...
profession(197, { -- Tailoring
	n(-26, {	-- Drop	-- TODO: Add the drop locations
		-- HOLIDAY DROPS
		un(7, i(21722)),	-- Pattern: Festival Dress [REMOVED FROM GAME - OLD VERSION]
		un(17, i(44916)),	-- Pattern: Festival Dress [Lunar Festival]
		un(7, i(21723)),	-- Pattern: Festival Suit [REMOVED FROM GAME - OLD VERSION]
		un(17, i(44917)),	-- Pattern: Festival Suit [Lunar Festival]
		un(29, i(17724)),	-- Pattern: Green Holiday Shirt [Winter Veil - Holiday Gift Box]
		un(29, i(34261)),	-- Pattern: Green Winter Clothes [Winter Veil - Holiday Gift Box]
		un(29, i(34319)),	-- Pattern: Red Winter Clothes [Winter Veil - Holiday Gift Box]
		
		-- CLASSIC DROPS
		-- i(10318),-- Pattern: Admiral's Hat [1 VENDOR - DONE]
		--i(19216),	-- Pattern: Argent Boots [3 VENDORS - DONE]
		--i(19217),	-- Pattern: Argent Shoulders [3 VENDORS - DONE]
		i(7085),	-- Pattern: Azure Shoulders [WORLD DROP]
		-- i(7089),	-- Pattern: Azure Silk Cloak [1 VENDOR - DONE]
		-- i(7114),	-- Pattern: Azure Silk Gloves [2 VENDORS - DONE]
		un(7, i(18414)),-- Pattern: Belt of the Archmage [1 DROP - DONE]
		-- i(5775),	-- Pattern: Black Silk Pack [1 VENDOR - DONE]
		-- i(10728), -- Pattern: Black Swashbuckler's Shirt [1 VENDOR - DONE]
		un(2, i(19766)),	-- Pattern: Bloodvine Boots [ZANDALARI TRIBE - DONE]
		un(2, i(19765)),	-- Pattern: Bloodvine Leggings [ZANDALARI TRIBE - DONE]
		un(2, i(19764)),	-- Pattern: Bloodvine Vest [ZANDALARI TRIBE - DONE]
		-- i(6272),	-- Pattern: Blue Linen Robe [5 VENDORS - DONE]
		...
		-- i(22310),-- Pattern: Cenarion Herb Bag [1 VENDOR - DONE]
		-- i(14482),-- Pattern: Cindercloth Cloak [1 DROP - DONE]
		-- i(14476),-- Pattern: Cindercloth Gloves [1 DROP - DONE]
		-- i(14490),-- Pattern: Cindercloth Pants [1 DROP - DONE]
		-- i(14471),-- Pattern: Cindercloth Vest [1 DROP - DONE]
		-- i(14486),-- Pattern: Cloak of Fire [1 DROP - DONE]
		un(2, i(18418)),	-- Pattern: Cloak of Warding [DIRE MAUL - DROP - DONE]
		i(10316),	-- Pattern: Colorful Kilt [WORLD DROP]
		-- i(21371),-- Pattern: Core Felcloth Bag [Molten Core - DONE]
		-- i(7087), -- Pattern: Crimson Silk Cloak [1 VENDOR - DONE]
		i(7088),	-- Pattern: Crimson Silk Robe [1 VENDOR - DONE]
		i(7084),	-- Pattern: Crimson Silk Shoulders [WORLD DROP]
		-- i(6401),	-- Pattern: Dark Silk Shirt [3 VENDORS - DONE]
		-- i(37915),-- Pattern: Dress Shoes [1 VENDOR - DONE]
		i(7086),	-- Pattern: Earthen Silk Belt [WORLD DROP]
		-- i(22307),-- Pattern: Enchanted Mageweave Pouch [31 VENDERS - Really, Blizzard? - DONE]
		-- i(22308),-- Pattern: Enchanted Runecloth Bag [1 VENDOR - DONE]
		-- i(14630),-- Pattern: Enchanter's Cowl [1 VENDOR - DONE]
		-- i(14483),-- Pattern: Felcloth Pants [1 VENDOR - DONE]
		un(2, i(18415)),	-- Pattern: Felcloth Gloves [DIRE MAUL - DROP - DONE]
		-- i(17018),-- Pattern: Flarecore Gloves [1 VENDOR - DONE]
		-- i(19220),-- Pattern: Flarecore Leggings [1 VENDOR - DONE]
		-- i(17017),-- Pattern: Flarecore Mantle [1 VENDOR - DONE]
		-- i(19219),-- Pattern: Flarecore Robe [1 VENDOR - DONE]
		-- i(18265),-- Pattern: Flarecore Wraps [MOLTEN CORE - DONE]
		i(14467),	-- Pattern: Frostweave Robe [WORLD DROP]
		-- i(22683),	-- Pattern: Gaea's Embrace [1 VENDOR - DONE]
		un(2, i(22685)), -- Pattern: Glacial Cloak [1 VENDOR - DONE - REMOVED FROM GAME]
		un(2, i(22684)), -- Pattern: Glacial Gloves [1 VENDOR - DONE - REMOVED FROM GAME]
		un(2, i(22686)), -- Pattern: Glacial Vest [1 VENDOR - DONE - REMOVED FROM GAME]
		un(2, i(22687)), -- Pattern: Glacial Wrists [1 VENDOR - DONE - REMOVED FROM GAME]
		i(14511),	-- Pattern: Gloves of Spell Mastery [WORLD DROP]
		i(2601),	-- Pattern: Gray Woolen Robe [WORLD DROP]
		-- i(6275),	-- Pattern: Greater Adept's Robe [6 VENDORS - DONE]
		i(7090),	-- Pattern: Green Silk Armor [WORLD DROP]
		i(5774),	-- Pattern: Green Silk Pack [WORLD DROP]
		i(4292),	-- Pattern: Green Woolen Bag [WORLD DROP]
		-- i(38327),-- Pattern: Haliscan Jacket [1 VENDOR - DONE]
		-- i(38328),-- Pattern: Haliscan Pantaloons [1 VENDOR - DONE]
		i(7092),	-- Pattern: Hands of Darkness [WORLD DROP]
		i(4346),	-- Pattern: Heavy Woolen Cloak [WORLD DROP]
		-- i(4355),	-- Pattern: Icy Cloak [1 VENDOR - DONE]
		un(2, i(18416)),	-- Pattern: Inferno Gloves [DIRE MAUL - DROP - DONE]
		-- i(10314),-- Pattern: Lavender Mageweave Shirt [4 VENDORS - DONE]
		-- i(19218),	-- Pattern: Mantle of the Timbermaw [1 VENDOR - DONE]
		-- i(14526),-- Pattern: Mooncloth [1 VENDOR - DONE]
		i(14499),	-- Pattern: Mooncloth Bag [WORLD DROP]
		i(14509),	-- Pattern: Mooncloth Circlet [Nefarian + World Drop - DONE]
		un(2, i(18417)),	-- Pattern: Mooncloth Gloves [DIRE MAUL - DROP - DONE]
		i(14497),	-- Pattern: Mooncloth Leggings [Nefarian + World Drop - DONE]
		-- i(18487),-- Pattern: Mooncloth Robe [1 VENDOR - DONE]
		i(14507),	-- Pattern: Mooncloth Shoulders [Nefarian + World Drop - DONE]
		i(14501),	-- Pattern: Mooncloth Vest [Nefarian + World Drop - DONE]
		-- i(10311),-- Pattern: Orange Martial Shirt [2 VENDORS - DONE]
		i(4348),	-- Pattern: Phoenix Gloves [WORLD DROP]
		i(4349),	-- Pattern: Phoenix Pants [WORLD DROP]
		i(10317),	-- Pattern: Pink Mageweave Shirt [4 VENDORS - DONE]
		-- i(5771),	-- Pattern: Red Linen Bag [4 VENDORS - DONE]
		i(2598),	-- Pattern: Red Linen Robe [WORLD DROP]
		i(6271),	-- Pattern: Red Linen Vest [WORLD DROP]
		i(10312),	-- Pattern: Red Mageweave Gloves [WORLD DROP]
		i(10320),	-- Pattern: Red Mageweave Headband [WORLD DROP]
		i(10302),	-- Pattern: Red Mageweave Pants [WORLD DROP]
		i(10315),	-- Pattern: Red Mageweave Shoulders [WORLD DROP]
		i(10300),	-- Pattern: Red Mageweave Vest [WORLD DROP]
		-- i(5772),	-- Pattern: Red Woolen Bag [10 VENDORS - DONE]
		i(4345),	-- Pattern: Red Woolen Boots [WORLD DROP]
		i(4347),	-- Pattern: Reinforced Woolen Shoulders [WORLD DROP]
		i(4354),	-- Pattern: Rich Purple Silk Shirt [WORLD DROP]
		un(7, i(5773)),	-- Pattern: Robes of Arcana [WORLD DROP - Darkshore, Duskwood, and Thousand Needles - UNOBTAINABLE]
		un(2, i(14493)),-- Pattern: Robe of Winter Night [1 DROP - DONE]
		-- i(14513),	-- Pattern: Robe of the Archmage [1 DROP - DONE]
		un(7, i(14514)),-- Pattern: Robe of the Void [SCHOLO - DROP - REMOVED FROM GAME]
		-- i(14468),-- Pattern: Runecloth Bag [1 VENDOR - DONE]
		-- i(20547), -- Pattern: Runed Stygian Boots [TRUE BELIEVERS - SILITHUS - DONE]
		-- i(20548), -- Pattern: Runed Stygian Belt [TRUE BELIEVERS - SILITHUS - DONE]
		-- i(20546), -- Pattern: Runed Stygian Leggings [TRUE BELIEVERS - SILITHUS - DONE]
		-- i(22312),	-- Pattern: Satchel of Cenarius [1 VENDOR - DONE]
		i(4351),	-- Pattern: Shadow Hood [WORLD DROP]
		-- i(10463),-- Pattern: Shadoweave Mask [1 DROP - DONE]
		-- i(21358),-- Pattern: Soul Pouch [1 VENDOR - DONE]
		i(4353),	-- Pattern: Spider Belt [WORLD DROP]
		i(4350),	-- Pattern: Spider Silk Slippers [WORLD DROP]
		i(4356),	-- Pattern: Star Belt [WORLD DROP]
		i(6390),	-- Pattern: Stylish Blue Shirt [WORLD DROP]
		i(6391),	-- Pattern: Stylish Green Shirt [WORLD DROP]
		-- i(22773),-- Pattern: Sylvan Crown [1 VENDOR - DONE]
		-- i(22772),-- Pattern: Sylvan Shoulders [1 VENDOR - DONE]
		-- i(22774),-- Pattern: Sylvan Vest [1 VENDOR - DONE]
		-- i(10326), -- Pattern: Tuxedo Jacket [2 VENDORS - DONE]
		-- i(10323), -- Pattern: Tuxedo Pants [2 VENDORS - DONE]
		-- i(10321), -- Pattern: Tuxedo Shirt [2 VENDORS - DONE]
		i(7091),	-- Pattern: Truefaith Gloves [WORLD DROP]
		-- i(14512),-- Pattern: Truefaith Vestments [1 DROP - DONE]
		i(10301),	-- Pattern: White Bandit Mask [WORLD DROP]
		-- i(10325),-- Pattern: White Wedding Dress [2 VENDORS - DONE]
	...
	n(-15, { 	-- Recipes
		n(-3, { 	-- Holiday
			...
			un(29, recipe(21945)),	-- Green Holiday Shirt
			un(29, recipe(44950)),	-- Green Winter Clothes
			un(29, recipe(44958)),	-- Red Winter Clothes
		}),
		tier(1, {	-- Classic
			recipe(12081),	-- Admiral's Hat
			recipe(23664),	-- Argent Boots
			recipe(23665),	-- Argent Shoulders
			recipe(8795),	-- Azure Shoulders
			recipe(8766),	-- Azure Silk Belt
			recipe(8786),	-- Azure Silk Cloak
			recipe(3854),	-- Azure Silk Gloves
			recipe(8760),	-- Azure Silk Hood
			recipe(8758),	-- Azure Silk Pants
			recipe(3859),	-- Azure Silk Vest
			recipe(2395),	-- Barbaric Linen Vest
			un(7, recipe(22866)),	-- Belt of the Archmage
			recipe(27660),	-- Big Bag of Enchantment
			...
			recipe(6695),	-- Black Silk Pack
			recipe(3873),	-- Black Swashbuckler's Shirt
			un(2, recipe(24093)),	-- Bloodvine Boots
			un(2, recipe(24092)),	-- Bloodvine Leggings
			un(2, recipe(24091)),	-- Bloodvine Vest
			recipe(7633),	-- Blue Linen Robe
			recipe(2394),	-- Blue Linen Shirt
			recipe(7630),	-- Blue Linen Vest
			recipe(7639),	-- Blue Overalls
			recipe(2963),	-- Bolt of Linen Cloth
			recipe(3865),	-- Bolt of Mageweave
			recipe(18401),	-- Bolt of Runecloth
			recipe(3839),	-- Bolt of Silk Cloth
			recipe(2964),	-- Bolt of Woolen Cloth
			recipe(3860),	-- Boots of the Enchanter
			recipe(18455),	-- Bottomless Bag
			recipe(3869),	-- Bright Yellow Shirt
			recipe(18420),	-- Brightcloth Cloak
			recipe(18415),	-- Brightcloth Gloves
			recipe(18439),	-- Brightcloth Pants
			recipe(18414),	-- Brightcloth Robe
			recipe(3914),	-- Brown Linen Pants
			recipe(7623),	-- Brown Linen Robe
			recipe(3915),	-- Brown Linen Shirt
			recipe(2385),	-- Brown Linen Vest
			recipe(27724),	-- Cenarion Herb Bag
			recipe(12088),	-- Cindercloth Boots
			recipe(18418),	-- Cindercloth Cloak
			recipe(18412),	-- Cindercloth Gloves
			recipe(18434),	-- Cindercloth Pants
			recipe(12069),	-- Cindercloth Robe
			recipe(18408),	-- Cindercloth Vest
			recipe(18422),	-- Cloak of Fire
			un(2, recipe(22870)),	-- Cloak of Warding
			recipe(12047),	-- Colorful Kilt
			recipe(26087),	-- Core Felcloth Bag
			recipe(8772),	-- Crimson Silk Belt
			recipe(8789),	-- Crimson Silk Cloak
			recipe(8804),	-- Crimson Silk Gloves
			recipe(8799),	-- Crimson Silk Pantaloons
			recipe(8802),	-- Crimson Silk Robe
			recipe(8793),	-- Crimson Silk Shoulders
			recipe(8791),	-- Crimson Silk Vest
			recipe(3870),	-- Dark Silk Shirt
			...
			recipe(49677),	-- Dress Shoes
			recipe(8797),	-- Earthen Silk Belt
			recipe(8764),	-- Earthen Vest
			recipe(27658),	-- Enchanted Mageweave Pouch
			recipe(27659),	-- Enchanted Runecloth Bag
			recipe(3857),	-- Enchanter's Cowl
			un(2, recipe(26086)),	-- Felcloth Bag
			recipe(18437),	-- Felcloth Boots
			un(2, recipe(22867)),	-- Felcloth Gloves
			recipe(18442),	-- Felcloth Hood
			recipe(18419),	-- Felcloth Pants
			recipe(18451),	-- Felcloth Robe
			recipe(18453),	-- Felcloth Shoulders
			recipe(20849),	-- Flarecore Gloves
			recipe(23667),	-- Flarecore Leggings
			recipe(20848),	-- Flarecore Mantle
			recipe(23666),	-- Flarecore Robe
			recipe(22759),	-- Flarecore Wraps
			recipe(3871),	-- Formal White Shirt
			recipe(18411),	-- Frostweave Gloves
			recipe(18424),	-- Frostweave Pants
			recipe(18404),	-- Frostweave Robe
			recipe(18403),	-- Frostweave Tunic
			recipe(28210),	-- Gaea's Embrace
			recipe(18410),	-- Ghostweave Belt
			recipe(18413),	-- Ghostweave Gloves
			recipe(18441),	-- Ghostweave Pants
			recipe(18416),	-- Ghostweave Vest
			un(7, recipe(28208)),	-- Glacial Cloak
			un(7, recipe(28205)),	-- Glacial Gloves
			un(7, recipe(28207)),	-- Glacial Vest
			un(7, recipe(28209)), 	-- Glacial Wrists
			recipe(3852),	-- Gloves of Meditation
			recipe(18454),	-- Gloves of Spell Mastery
			un(2, recipe(22813)),	-- Gordok Ogre Suit
			recipe(2403),	-- Gray Woolen Robe
			recipe(2406),	-- Gray Woolen Shirt
			recipe(7643),	-- Greater Adept's Robe
			recipe(3841),	-- Green Linen Bracers
			recipe(2396),	-- Green Linen Shirt
			recipe(8784),	-- Green Silk Armor
			recipe(6693),	-- Green Silk Pack
			recipe(8774),	-- Green Silken Shoulders
			recipe(3758),	-- Green Woolen Bag
			recipe(2399),	-- Green Woolen Vest
			recipe(50644),	-- Haliscan Jacket
			recipe(50647),	-- Haliscan Pantaloons
			recipe(3842),	-- Handstitched Linen Britches
			recipe(8780),	-- Hands of Darkness
			recipe(3840),	-- Heavy Linen Gloves
			recipe(3844),	-- Heavy Woolen Cloak
			recipe(3843),	-- Heavy Woolen Gloves
			recipe(3850),	-- Heavy Woolen Pants
			recipe(3862),	-- Icy Cloak
			un(2, recipe(22868)),	-- Inferno Gloves
			recipe(12075),	-- Lavender Mageweave Shirt
			recipe(6690),	-- Lesser Wizard's Robe
			recipe(3755),	-- Linen Bag
			recipe(8776),	-- Linen Belt
			recipe(2386),	-- Linen Boots
			recipe(2387),	-- Linen Cloak
			recipe(3861),	-- Long Silken Cloak
			recipe(12065),	-- Mageweave Bag
			recipe(23663),	-- Mantle of the Timbermaw
			recipe(18560),	-- Mooncloth
			recipe(18445),	-- Mooncloth Bag
			recipe(19435),	-- Mooncloth Boots
			recipe(18452),	-- Mooncloth Circlet
			un(2, recipe(22869)),	-- Mooncloth Gloves
			recipe(18440),	-- Mooncloth Leggings
			recipe(22902),	-- Mooncloth Robe
			recipe(18448),	-- Mooncloth Shoulders
			recipe(18447),	-- Mooncloth Vest
			recipe(12061),	-- Orange Mageweave Shirt
			recipe(12064),	-- Orange Martial Shirt
			recipe(6521),	-- Pearl-clasped Cloak
			recipe(3868),	-- Phoenix Gloves
			recipe(3851),	-- Phoenix Pants
			recipe(12080),	-- Pink Mageweave Shirt
			recipe(6686),	-- Red Linen Bag
			recipe(2389),	-- Red Linen Robe
			recipe(2392),	-- Red Linen Shirt
			recipe(7629),	-- Red Linen Vest
			recipe(12079),	-- Red Mageweave Bag
			recipe(12066),	-- Red Mageweave Gloves
			recipe(12084),	-- Red Mageweave Headband
			recipe(12060),	-- Red Mageweave Pants
			recipe(12078),	-- Red Mageweave Shoulders
			recipe(12056),	-- Red Mageweave Vest
			recipe(8489),	-- Red Swashbuckler's Shirt
			recipe(6688),	-- Red Woolen Bag
			recipe(3847),	-- Red Woolen Boots
			recipe(2397),	-- Reinforced Linen Cape
			recipe(3849),	-- Reinforced Woolen Shoulders
			recipe(3872),	-- Rich Purple Silk Shirt
			un(7, recipe(6692)),	-- Robes of Arcana [UNOBTAINABLE?!]
			recipe(8770),	-- Robe of Power
			recipe(18457),	-- Robe of the Archmage
			recipe(18458),	-- Robe of the Void
			un(2, recipe(18436)),	-- Robe of Winter Night [UNOBTAINABLE?!]
			recipe(18405),	-- Runecloth Bag
			...
			recipe(24902),	-- Runed Stygian Belt
			recipe(24903),	-- Runed Stygian Boots
			recipe(24901),	-- Runed Stygian Leggings
			recipe(27725),	-- Satchel of Cenarius
			recipe(3858),	-- Shadow Hood
			recipe(12082),	-- Shadoweave Boots
			recipe(12071),	-- Shadoweave Gloves
			desc(recipe(12086), "Required for the |cff3399ffLucid Nightmare|r riddle mount."),	-- Shadoweave Mask
			recipe(12052),	-- Shadoweave Pants
			recipe(12055),	-- Shadoweave Robe
			recipe(12076),	-- Shadoweave Shoulders
			recipe(8762),	-- Silk Headband
			recipe(12077),	-- Simple Black Dress
			recipe(8465),	-- Simple Dress
			recipe(12046),	-- Simple Kilt
			recipe(12045),	-- Simple Linen Boots
			recipe(12044),	-- Simple Linen Pants
			recipe(3813),	-- Small Silk Pack
			recipe(3845),	-- Soft-soled Linen Boots
			recipe(26085),	-- Soul Pouch
			recipe(3863),	-- Spider Belt
			recipe(3856),	-- Spider Silk Slippers
			recipe(3855),	-- Spidersilk Boots
			recipe(63742),	-- Spidersilk Drape
			recipe(3864),	-- Star Belt
			recipe(7892),	-- Stylish Blue Shirt
			recipe(7893),	-- Stylish Green Shirt
			recipe(3866),	-- Stylish Red Shirt
			recipe(28481),	-- Sylvan Crown
			recipe(28482),	-- Sylvan Shoulders
			recipe(28480),	-- Sylvan Vest
			recipe(8782),	-- Truefaith Gloves
			recipe(18456),	-- Truefaith Vestments
			recipe(12093),	-- Tuxedo Jacket
			recipe(12089),	-- Tuxedo Pants
			recipe(12085),	-- Tuxedo Shirt
			recipe(12059),	-- White Bandit Mask
			recipe(7624),	-- White Linen Robe
			recipe(2393),	-- White Linen Shirt
			recipe(8483),	-- White Swashbuckler's Shirt
			recipe(12091),	-- White Wedding Dress
			recipe(8467),	-- White Woolen Dress
			recipe(23662),	-- Wisdom of the Timbermaw
			recipe(18421),	-- Wizardweave Leggings
			recipe(18446),	-- Wizardweave Robe
			recipe(18450),	-- Wizardweave Turban
			recipe(3757),	-- Woolen Bag
			recipe(2401),	-- Woolen Boots
		...
		tier(6, {	-- WoD
			...
			recipe(168850),	-- Creeping Carpet
			recipe(168849),	-- Elekk Plushie
			recipe(168848),	-- Hexweave Bag
			recipe(168844),	-- Hexweave Belt
			recipe(168842),	-- Hexweave Bracers
			recipe(168835),	-- Hexweave Cloth
			recipe(168838),	-- Hexweave Cowl
			recipe(168836),	-- Hexweave Embroidery
			recipe(168855),	-- Hexweave Essence
			recipe(168840),	-- Hexweave Gloves
			recipe(168839),	-- Hexweave Leggings
			recipe(168837),	-- Hexweave Mantle
			recipe(168841),	-- Hexweave Robe
			recipe(168843),	-- Hexweave Slippers
			recipe(187492),	-- Mighty Hexweave Essence
			recipe(168846),	-- Nimble Hexweave Cloak
			recipe(168845),	-- Powerful Hexweave Cloak
			recipe(182123),	-- Primal Weaving
			recipe(187516),	-- Savage Hexweave Essence
			recipe(176058),	-- Secrets of Draenor Tailoring
			recipe(168852),	-- Sumptuous Cowl
			recipe(168854),	-- Sumptuous Leggings
			recipe(168853),	-- Sumptuous Robes
		...
		tier(7, {	-- Legion
			...
			recipe(185955),	-- Imbued Silkweave Cinch [Rank 3]
			
			recipe(186112),	-- Imbued Silkweave Cover [Rank 1]
			recipe(186113),	-- Imbued Silkweave Cover [Rank 2]
			recipe(186114),	-- Imbued Silkweave Cover [Rank 3]
			
			recipe(186115),	-- Imbued Silkweave Drape [Rank 1]
			recipe(186116),	-- Imbued Silkweave Drape [Rank 2]
			recipe(186117),	-- Imbued Silkweave Drape [Rank 3]
			
			recipe(185928),	-- Imbued Silkweave Epaulets [Rank 1]
			recipe(185948),	-- Imbued Silkweave Epaulets [Rank 2]
			recipe(185956),	-- Imbued Silkweave Epaulets [Rank 3]
			
			recipe(186109),	-- Imbued Silkweave Flourish [Rank 1]
			recipe(186110),	-- Imbued Silkweave Flourish [Rank 2]
			recipe(186111),	-- Imbued Silkweave Flourish [Rank 3]
			
			recipe(185931),	-- Imbued Silkweave Gloves [Rank 1]
			recipe(185951),	-- Imbued Silkweave Gloves [Rank 2]
			recipe(185959),	-- Imbued Silkweave Gloves [Rank 3]
			
			recipe(185930),	-- Imbued Silkweave Hood [Rank 1]
			recipe(185950),	-- Imbued Silkweave Hood [Rank 2]
			recipe(185958),	-- Imbued Silkweave Hood [Rank 3]
			
			recipe(185929),	-- Imbued Silkweave Pantaloons [Rank 1]
			recipe(185949),	-- Imbued Silkweave Pantaloons [Rank 2]
			recipe(185957),	-- Imbued Silkweave Pantaloons [Rank 3]
			
			recipe(185933),	-- Imbued Silkweave Robe [Rank 1]
			recipe(185953),	-- Imbued Silkweave Robe [Rank 2]
			recipe(185961),	-- Imbued Silkweave Robe [Rank 3]
			
			recipe(186106),	-- Imbued Silkweave Shade [Rank 1]
			recipe(186107),	-- Imbued Silkweave Shade [Rank 2]
			recipe(186108),	-- Imbued Silkweave Shade [Rank 3]
			
			recipe(185932),	-- Imbued Silkweave Slippers [Rank 1]
			recipe(185952),	-- Imbued Silkweave Slippers [Rank 2]
			recipe(185960),	-- Imbued Silkweave Slippers [Rank 3]
			
			recipe(247807),	-- Lightweave Breeches [Rank 1]
			recipe(247808),	-- Lightweave Breeches [Rank 2]
			recipe(247809),	-- Lightweave Breeches [Rank 3]
			...
			recipe(185934),	-- Silkweave Bracers [Rank 2]
			recipe(185942),	-- Silkweave Bracers [Rank 3]
			
			recipe(185919),	-- Silkweave Cinch [Rank 1]
			recipe(185935),	-- Silkweave Cinch [Rank 2]
			recipe(185943),	-- Silkweave Cinch [Rank 3]
			
			recipe(185920),	-- Silkweave Epaulets [Rank 1]
			recipe(185936),	-- Silkweave Epaulets [Rank 2]
			recipe(185944),	-- Silkweave Epaulets [Rank 3]
			
			recipe(185923),	-- Silkweave Gloves [Rank 1]
			recipe(185939),	-- Silkweave Gloves [Rank 2]
			recipe(208350),	-- Silkweave Gloves [Rank 3]
			
			recipe(185922),	-- Silkweave Hood [Rank 1]
			recipe(185938),	-- Silkweave Hood [Rank 2]
			recipe(208351),	-- Silkweave Hood [Rank 3]
			
			recipe(185921),	-- Silkweave Pantaloons [Rank 1]
			recipe(185937),	-- Silkweave Pantaloons [Rank 2]
			recipe(208353),	-- Silkweave Pantaloons [Rank 3]
			
			recipe(185925),	-- Silkweave Robe [Rank 1]
			recipe(185941),	-- Silkweave Robe [Rank 2]
			recipe(185945),	-- Silkweave Robe [Rank 3]
