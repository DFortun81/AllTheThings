...
profession(197, { -- Tailoring
	n(-26, {	-- Drop	-- TODO: Add the drop locations
		...
		un(8, i(22685)), -- Pattern: Glacial Cloak [1 VENDOR - DONE - REMOVED FROM GAME]
		un(8, i(22684)), -- Pattern: Glacial Gloves [1 VENDOR - DONE - REMOVED FROM GAME]
		un(8, i(22686)), -- Pattern: Glacial Vest [1 VENDOR - DONE - REMOVED FROM GAME]
		un(8, i(22687)), -- Pattern: Glacial Wrists [1 VENDOR - DONE - REMOVED FROM GAME]
