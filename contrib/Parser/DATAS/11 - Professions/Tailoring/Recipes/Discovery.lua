				...
				n(-37, {    -- Discovery
					["g"] = {
						{	-- Embroidered Deep Sea Gloves
							...
							["g"] = {
								{	-- Pattern: Imbued Deep Sea Gloves
									["itemID"] = 162507,	-- Pattern: Imbued Deep Sea Gloves
								},
								{	-- Imbued Deep Sea Gloves
									["spellID"] = 257120,	-- Imbued Deep Sea Gloves
									["g"] = {
										{	-- Pattern: Emblazoned Deep Sea Gloves
											["itemID"] = 162508,	-- Pattern: Emblazoned Deep Sea Gloves
										},
									},
								},
							},
						...
						{	-- Embroidered Deep Sea Breeches
							...
							["g"] = {
								{	-- Pattern: Imbued Deep Sea Breeches
									["itemID"] = 162509,	-- Pattern: Imbued Deep Sea Breeches
								},
								{	-- Imbued Deep Sea Breeches
									["spellID"] = 257123,	-- Imbued Deep Sea Breeches
									["g"] = {
										{	-- Pattern: Emblazoned Deep Sea Breeches
											["itemID"] = 162510,	-- Pattern: Emblazoned Deep Sea Breeches
										},
									},
								},
							},
						...
						{	-- Enhanced Deep Sea Gloves
							...
							["g"] = {
								{	-- Pattern: Fortified Deep Sea Gloves
									["itemID"] = 165652,	-- Pattern: Fortified Deep Sea Gloves
								},
								{	-- Fortified Deep Sea Gloves
									["spellID"] = 285086,	-- Fortified Deep Sea Gloves
									["g"] = {
										{	-- Pattern: Tempered Deep Sea Gloves
											["itemID"] = 165653,	-- Pattern: Tempered Deep Sea Gloves
										},
									},
								},
							},
						...
						{	-- Enhanced Deep Sea Breeches
							...
							["g"] = {
								{	-- Pattern: Fortified Deep Sea Breeches
									["itemID"] = 165655,	-- Pattern: Fortified Deep Sea Breeches
								},
								{	-- Fortified Deep Sea Breeches
									["spellID"] = 285085,	-- Fortified Deep Sea Breeches
									["g"] = {
										{	-- Pattern: Tempered Deep Sea Breeches
											["itemID"] = 165654,	-- Pattern: Tempered Deep Sea Breeches
										},
									},
								},
							},
