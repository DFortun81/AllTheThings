...
profession(773, { -- Inscription
	...
	n(-100002, { -- PLACE_HOLDER
		...
		i(141592),	-- Technique: Codex of the Tranquil Mind
		...
		i(141061),	-- Technique: Glyph of the Abyssal
		...
		i(162023),	-- Technique: Glyph of the Dolphin
		i(147118),	-- Technique: Glyph of the Fel Succubus
		...
		i(141065),	-- Technique: Glyph of the Terrorguard
		...
		i(118608),	-- Technique: Greater Weapon Crystal
		...
		i(122548),	-- Technique: Powerful Ensorcelled Tarot
		i(122553),	-- Technique: Powerful Weapon Crystal
		i(137745),	-- Technique: Prophecy Tarot
		i(137746),	-- Technique: Prophecy Tarot
