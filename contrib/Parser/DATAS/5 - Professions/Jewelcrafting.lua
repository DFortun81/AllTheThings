...
profession(755, { -- Jewelcrafting
	...
	n(-100002, { -- PLACE_HOLDER
		...
		i(137855),	-- Design: Ancient Maelstrom Amulet
		...
		i(137848),	-- Design: Blessed Dawnlight Medallion
		i(33159),	-- Design: Blood of Amber
		i(23131),	-- Design: Bold Blood Garnet
		...
		i(137800),	-- Design: Dawnlight Band
		i(137825),	-- Design: Dawnlight Band
		i(137846),	-- Design: Dawnlight Band
		...
		i(151724),	-- Design: Empyrial Cosmic Crown
		i(151725),	-- Design: Empyrial Cosmic Crown
		i(151726),	-- Design: Empyrial Cosmic Crown
		i(151727),	-- Design: Empyrial Deep Crown
		i(151728),	-- Design: Empyrial Deep Crown
		i(151729),	-- Design: Empyrial Deep Crown
		i(151730),	-- Design: Empyrial Elemental Crown
		i(151731),	-- Design: Empyrial Elemental Crown
		i(151732),	-- Design: Empyrial Elemental Crown
		i(151733),	-- Design: Empyrial Titan Crown
		i(151734),	-- Design: Empyrial Titan Crown
		i(151735),	-- Design: Empyrial Titan Crown
		...
		i(23137),	-- Design: Glinting Shadow Draenite
		...
		i(137858),	-- Design: Grim Furystone Gorget
		...
		i(23135),	-- Design: Inscribed Flame Spessarite
		...
		i(137854),	-- Design: Intrepid Necklace of Prophecy
		...
		i(23141),	-- Design: Jagged Deep Peridot
		...
		i(137799),	-- Design: Maelstrom Band
		i(137824),	-- Design: Maelstrom Band
		i(137845),	-- Design: Maelstrom Band
		...
		i(137798),	-- Design: Prophetic Band
		i(137823),	-- Design: Prophetic Band
		i(137844),	-- Design: Prophetic Band
		...
		i(23140),	-- Design: Radiant Deep Peridot
		...
		i(137857),	-- Design: Raging Furystone Gorget
		...
		i(137856),	-- Design: Righteous Dawnlight Medallion
		...
		i(137864),	-- Design: Shadowruby Band
		i(137867),	-- Design: Shadowruby Band
		...
		i(137839),	-- Design: Skystone Loop
		i(137842),	-- Design: Skystone Pendant
		...
		i(23152),	-- Design: Solid Azure Moonstone
		...
		i(137826),	-- Design: Sorcerous Shadowruby Pendant
		i(137847),	-- Design: Sorcerous Shadowruby Pendant
		...
		i(137850),	-- Design: Subtle Shadowruby Pendant
		...
		i(137853),	-- Design: Sylvan Maelstrom Amulet
		...
		i(137851),	-- Design: Tranquil Necklace of Prophecy
		...
		i(137852),	-- Design: Vindictive Pandemonite Choker
		...
		i(163024),	-- Recipe: Honorable Combatant's Staff of Intuition
		i(163025),	-- Recipe: Honorable Combatant's Staff of Intuition
		i(116098),	-- Recipe: Mastery Taladite
		i(127726),	-- Recipe: Mighty Taladite Amplifier
		i(122551),	-- Recipe: Powerful Taladite Amplifier
