...
_.Mounts =
{
	...
	nld({	-- Legacy
		...
		ach(9239, {		-- Gladiator: Warlords Season 1
			un(2, i(128277)),		-- Primal Gladiator's Felblood Gronnling
		}),
		ach(10098, {	-- Gladiator: Warlords Season 2
			un(2, i(128281)),		-- Wild Gladiator's Felblood Gronnling
		}),
		ach(10110, {	-- Gladiator: Warlords Season 3
