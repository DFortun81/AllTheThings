...
ShoutoutText:SetPoint("BOTTOMLEFT", settings, "BOTTOMLEFT", 8, 8);
ShoutoutText:SetPoint("BOTTOMRIGHT", settings, "BOTTOMRIGHT", -8, 8);
ShoutoutText:SetJustifyH("LEFT");
ShoutoutText:SetText("Additional Contributors: (in order of joining the team)\nDaktar, Lucetia, Slumber, Gold, Avella, Aiue, Dead Serious, Oiche, Oxlotus, Eiltherune, Blueyleader, Iyanden, Pr3vention, BigBlaris, Talonzor, Eckhardt, Boohyaka, Sadidorf and the rest of the ALL THE THINGS Discord!\n\nSpecial Shoutout to AmiYuy (CanIMogIt) and Caerdon (Caerdon Wardrobe).\nIf you don't have either of these addons, you should absolutely download both!");
ShoutoutText:Show();
