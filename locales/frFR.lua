...
-- Big new chunk from AllTheThings.lua
	...
	L.CLASSIC_TIER_DESC = "Quatre ans après la bataille du Mont Hyjal, les tensions entre l'Alliance et la Horde recommencent à se manifester. Désireuse de coloniser la région aride de Durotar, la nouvelle Horde de Thrall a élargi ses rangs, invitant les morts-vivants réprouvé à rejoindre les orcs, les taurens et les trolls. Pendant ce temps, les nains, les gnomes et les anciens elfes de la nuit ont juré fidélité à une Alliance revigorée, guidée par le royaume humain de Stormwind. Après que le roi de Stormwind, Varian Wrynn, ait mystérieusement disparu, le seigneur Bolvar Fordragon a servi de régent, mais son service a été gâché par les manipulations et le contrôle mental d'Onyxia, qui régnait déguisée en femme de la noblesse humaine. Alors que les héros enquêtaient sur les manipulations d'Onyxia, d'anciens ennemis refaisaient surface dans les terres du monde entier pour menacer la Horde et l'Alliance.";
	...
	L.SL_TIER_DESC = "Shadowlands est la 8ème extension. What lies beyond the world you know? The Shadowlands, resting place for every mortal soul—virtuous or vile—that has ever lived.";
	...
	L.COMPLETED_MONTHLY = "Peut être réalisé uniquement chaque année.";
...
for key,value in pairs({
	...
	[181083] = "Possessions de Sothos et Jarien",	-- Sothos and Jarien's Heirlooms
	...
	[9999908] = "|cFFFFFFFFStep 1:|r Rassemblez les consommables.",	-- |cFFFFFFFFStep 1:|r Gather Consumables.
