...
local ACC_WIDE_DEFAULT = "Par défaut, suivi sur "..app.ccColors.Account.."l’ensemble du compte|R.";
...
-- Settings.lua
	...
	-- General tab
		...
		L.MINIMAP_BUTTON_STYLE_CHECKBOX_TOOLTIP = "Certaines personnes n’aiment pas le nouveau bouton de la mini-carte…\n\nCes personnes ont tort !\n\nSi vous ne l’aimez pas, voici une option pour revenir à l’ancien style.";
		...
		L.FILTER_THINGS_BY_LEVEL_CHECKBOX = app.ccColors.Insane .. "Aucune restriction de niveau";
		...
		L.SHOW_BOE_CHECKBOX = app.ccColors.Insane .. "Objets LqE / LaC";
	...
	-- Interface tab
		...
		L.COORDINATES_CHECKBOX = "Coordonnées";
		L.COORDINATES_CHECKBOX_TOOLTIP = "Activez cette option si vous souhaitez afficher les coordonnées dans l’infobulle lorsque vous survolez une entrée dans la mini-liste.";
		L.DESCRIPTIONS_CHECKBOX = "Descriptions";
		L.DESCRIPTIONS_CHECKBOX_TOOLTIP = "Activez cette option pour si vous souhaitez afficher les descriptions dans l’infobulle. Il peut s’agir d’un texte descriptif ajouté par un contributeur qui a jugé nécessaire d’ajouter des informations supplémentaires.\n\nIl peut être utile de garder cette option activée.";
		L.LORE_CHECKBOX = "Lore";
		L.LORE_CHECKBOX_TOOLTIP = "Activez cette option si vous souhaitez afficher le texte descriptif dans l’infobulle. Il peut s’agir d'un texte descriptif fourni par le Guide de l’aventurier ou d’un texte fourni par un contributeur.";
		...
		L.LEVELREQ_CHECKBOX_TOOLTIP = "Activez cette option si vous souhaitez afficher les exigences de niveau dans l’infobulle.";
		L.CLASSES_CHECKBOX = "Classes";
		L.CLASSES_CHECKBOX_TOOLTIP = "Activez cette option si vous souhaitez afficher la liste complète des exigences de la classe dans l'infobulle.";
		L.RACES_CHECKBOX_TOOLTIP = "Activez cette option si vous souhaitez afficher la liste complète des exigences de la race dans l'infobulle.";
	...
	-- About tab
		...
		L.ABOUT_2 = "Contributeurs actifs : |CFFFFFFFF(pas d’ordre particulier)\nGold, Dead Serious, Sanctuari, Molkree, Runawaynow, Braghe, Myrhial, Darkal, Tag, Jezartroz, Pr3vention, AlexSoft, Jenstonedart, Klep et tous les autres membres du serveur Discord All The Things !|r";
