...
-- Settings.lua
	...
	-- General tab
		...
		L.SHOW_ALL_SEASONAL = app.ccColors.Insane .. "Tous les événements saisonniers";
		L.SHOW_ALL_SEASONAL_TOOLTIP = "Activer ce paramètre pour afficher tous les événements saisonniers, au lieu des événements saisonniers actuellement actifs.";
