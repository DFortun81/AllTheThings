...
local L = {
	...
	["ADDED_WITH_PATCH_FORMAT"] = "Added in patch %s";
	["WAS_ADDED_WITH_PATCH_FORMAT"] = "NEW: Added in patch %s";
	["ADDED_BACK_WITH_PATCH_FORMAT"] = "Returned in patch %s";
	["WAS_ADDED_BACK_WITH_PATCH_FORMAT"] = "NEW: Returned in patch %s";
	["REMOVED_WITH_PATCH_FORMAT"] = "Will be removed in patch %s";
