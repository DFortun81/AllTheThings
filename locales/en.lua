...
--		["Dragonriding Cup %> "] = "",
		...
		["Mini World Events"] = C_Spell.GetSpellName(57055),
	...
	-- Outposts in Draenor
		[-357] = C_Spell.GetSpellName(171866),											-- Sparring Arena Outpost
		[-358] = C_Spell.GetSpellName(164028),											-- Lumber Mill Outpost
		[-360] = select(2,GetAchievementInfo(8987)),							-- Arcane Sanctum
		[-361] = C_Spell.GetSpellName(182108).." Tower",								-- Artillery Tower
	-- Pre Class Hall Monk
	...
	-- Toys
		[-798] = C_Spell.GetSpellName(181765),											-- S.E.L.F.I.E. Camera
	-- Secret Header
		[-807] = C_Spell.GetSpellName(261395),											-- The Hivemind
	-- Chests
		[-851] = "Black Empire Cache",											-- Black Empire Cache (Is a placeholder since no ObjectID are assigned to chests!)
	-- Shadowlands Header
		[-901] = C_Spell.GetSpellName(339041),											-- Covenant Callings
		[-902] = COVENANT_SANCTUM_TAB_RENOWN,									-- Renown
	--	[-902] = "Renown Rewards",												-- Renown Rewards
		[-905] = C_Spell.GetSpellName(280630),											-- Command Table
		...
		[-981] = C_Spell.GetSpellName(348869),											-- Conduits
		-- SL Maldraxxus/Necrolord
		[-920] = C_Spell.GetSpellName(321078),											-- Necrolord
	...
	-- Dragonflight
		...
		[-1111] = C_Spell.GetSpellName(365311),												-- Rock Climbing
		[-1112] = C_Spell.GetSpellName(381284),												-- Cataloging
		[-1113] = C_Spell.GetSpellName(386485),												-- Ancient Waygates
		[-1114] = C_Spell.GetSpellName(382288),												-- Cartographer's Flag
		[-1120] = "Maruuk Centaur",													-- Maruuk Centaur
		[-1130] = "Iskaara Tuskarr",												-- Iskaara Tuskarr
		[-1142] = C_Spell.GetSpellName(400433),												-- Dragonriding Racing
	...
	["CUSTOM_COLLECTS_REASONS"] = {
		...
		["SL_COV_KYR"] = { icon = "|T"..("Interface\\Icons\\ui_sigil_kyrian")..":0|t", color = "ff516bfe", text = C_Spell.GetSpellName(321076) },
		["SL_COV_NEC"] = { icon = "|T"..("Interface\\Icons\\ui_sigil_necrolord")..":0|t", color = "ff40bf40", text = C_Spell.GetSpellName(321078) },
		["SL_COV_NFA"] = { icon = "|T"..("Interface\\Icons\\ui_sigil_nightfae")..":0|t", color = "ffA330C9", text = C_Spell.GetSpellName(321077) },
		["SL_COV_VEN"] = { icon = "|T"..("Interface\\Icons\\ui_sigil_venthyr")..":0|t", color = "fffe040f", text = C_Spell.GetSpellName(321079) },
	};
}) do
	L[key] = value;
end