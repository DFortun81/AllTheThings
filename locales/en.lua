...
app.L = {
	...
	["BATTLE_PET_QUALITY_CHECKBOX"] = "Show Pet Battle Quality";
	["BATTLE_PET_QUALITY_TOOLTIP"] = "Enable this option if you want to see the different pet qualities you have collected. \n\nRequires to have all pet families and sources selected in the pet battle journal to work properly";
