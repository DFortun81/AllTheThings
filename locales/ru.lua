...
-- Settings.lua
	...
	-- General tab
		...
		L.STRANGER_THINGS_LABEL = "Странные Штучки";
	...
	-- Interface tab
		...
		L.RESET_TOOLTIP = "Сбор цветовых настроек для всех окон ATT.";
		L.CLASS_BORDER = "Использовать цвет класса для рамки";
		L.CLASS_BORDER_TOOLTIP = "Использовать цвет вашего класса для рамки. Цвет так же обновляется когда вы на другом классе.";
