...
-- Settings.lua
	...
	-- Features tab
		...
		L.ICON_LEGEND_TEXT = app.ccColors.White .. "|TInterface\\AddOns\\AllTheThings\\assets\\status-unobtainable:0|t " .. "Недоступно" .. "\n|TInterface\\AddOns\\AllTheThings\\assets\\status-prerequisites:0|t " .. "Доступно с условием" .. "\n|TInterface\\AddOns\\AllTheThings\\assets\\status-seasonal-available:0|t " .. "Доступная Праздничная Штучка" .. "\n|TInterface\\AddOns\\AllTheThings\\assets\\status-seasonal-unavailable:0|t " .. "Недоступная Праздничная Штучка" .. "\n|TInterface\\FriendsFrame\\StatusIcon-Offline:0|t " .. "Недоступно на текущем персонаже";
