...
TRACK_ACC_WIDE = color.Account.."тслеживать на весь аккаунт|R";
ACC_WIDE_DEFAULT = "Отслеживается на "..color.Account.."Весь Аккаунт|R по умолчанию.";
...
-- Settings.lua
	...
	-- General tab
		-- Mode Title
			...
			L.TITLE_ACCOUNT = color.Account.."Учётная Запись|R ";
			L.TITLE_MAIN_ONLY = " (Основной Персонаж)";
			L.TITLE_NONE_THINGS = "Без Штучек ";
			L.TITLE_ONLY = "";
			L.TITLE_INSANE = color.Insane.."Безумный|R ";
		...
		L.MODE_EXPLAIN_LABEL = "|cffFFFFFFЗдесь кратко изложено то, что Вы собираете. Включите все "..color.Insane.."цветные параметры|cffFFFFFF, чтобы разблокировать "..color.Insane.."Безумный Режим|cffFFFFFF.";	-- "|cffFFFFFFWhat you collect is summarized as a specific Mode. Enable all " .. color.Insane .. "colored options|cffFFFFFF to unlock ".. color.Insane .. "Insane Mode|cffFFFFFF.";
		...
		L.ACCOUNT_MODE = color.Account.."Режим Аккаунта";
		...
		L.FLIGHT_PATHS_CHECKBOX = color.Insane .. "Полёты & Паромные Станции";
		...
		L.HEIRLOOMS_UPGRADES_CHECKBOX = color.Insane .. "+Улучшения";
		...
		L.ILLUSIONS_CHECKBOX = color.Insane..WEAPON_ENCHANTMENT;
		...
		L.MUSIC_ROLLS_SELFIE_FILTERS_CHECKBOX = "|T"..app.asset("Expansion_WOD")..":0|t " .. color.Insane .. "Мелодии & Фильтры селфи";
		...
		L.QUESTS_LOCKED_CHECKBOX = color.Insane.."+Ограниченные";
		...
		L.REPUTATIONS_CHECKBOX = color.Insane .. "Репутации";
		...
		L.RUNEFORGELEGENDARIES_CHECKBOX = "|T"..app.asset("Expansion_SL")..":0|t "..color.Insane.."Легендарки ТЗ";
		...
		L.FILTER_THINGS_BY_LEVEL_CHECKBOX = color.Insane.."Без Фильтра по Уровню";
		...
		L.SHOW_BOE_CHECKBOX = color.Insane.."БоЕ/БоА Предметы";
	...
	-- Filters tab
		L.ITEM_EXPLAIN_LABEL = "|cffFFFFFFЭти предметы всегда видимы в "..color.Account.."Режиме Аккаунта|cffFFFFFF.|r";
		...
		L.CUSTOM_FILTERS_EXPLAIN_LABEL = "|CFFFFFFFFЭти Штучки всегда показываются, если они доступны текущему персонажу или в "..color.Account.."Режиме Аккаунта|cffFFFFFF.|r";
