...
for key,value in pairs({
	...
	-- General Content
		...
		FILTER_THINGS_BY_LEVEL_CHECKBOX = app.ccColors.Insane.."Без Фильтра по Уровню";
		...
		SHOW_BOE_CHECKBOX = app.ccColors.Insane.."БоЕ/БоА Предметы";
		...
		SHOW_ALL_SEASONAL = "|T"..app.asset("Category_Holidays")..":0|t " .. app.ccColors.Insane .. "Все праздничные события";
		...
		TODO: APPEARANCES_CHECKBOX = "Внешний вид";
