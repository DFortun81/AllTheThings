...
app.L = {
	...
	["FACTION_MODE_TOOLTIP"] = "Turn this setting on if you want to see Account Mode data for all classes of your current faction.";
	...
	["NPC_ID_ICONS"] = {
		...
		[-372] = app.asset("Difficulty_Normal"),											-- 10 Player
		[-373] = app.asset("Difficulty_Normal"),											-- 25 Player
		[-374] = app.asset("Difficulty_Heroic"),											-- 10 Player Heroic
		[-375] = app.asset("Difficulty_Heroic"),											-- 25 Player Heroic
		[-376] = app.asset("Difficulty_Normal"),											-- Normal
		[-377] = app.asset("Difficulty_Heroic"),											-- Heroic
		[-378] = app.asset("Difficulty_LFR"),												-- Raid Finder
		[-379] = "Interface\\Icons\\inv_misc_blizzcon09_graphicscard",						-- Junkyard
		[-380] = "Interface\\Icons\\inv_misc_key_06",										-- Workshop
		[-381] = app.asset("Difficulty_Mythic"),											-- Mythic
