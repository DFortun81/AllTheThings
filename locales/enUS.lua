...
--		[-542] = -- Battlefield: Barrens
		...
		[-583] = "Interface\\Icons\\inv_tabard_a_76arakkoaoutcast",				-- Arakkoa (Archaeology)
		[-584] = "Interface\\Icons\\tooltip_crystallizedfel",					-- Demonic (Archaeology)
		[-585] = "Interface\\Icons\\achievement_character_draenei_male", 		-- Draenei (Archaeology)
		[-586] = "Interface\\Icons\\achievement_character_orc_male_brn",		-- Draenor Clans (Archaeology)
		[-587] = "Interface\\Icons\\inv_misc_questionmark",						-- Drustvar (Archaeology) (PH)
		[-588] = "Interface\\Icons\\achievement_character_dwarf_male",			-- Dwarf (Archaeology)
		[-589] = "Interface\\Icons\\trade_archaeology_fossil_fern",				-- Fossil (Archaeology)
		[-590] = "Interface\\Icons\\inv_archaeology_70_highborne_prewartapestry", -- Highborne (Archaeology)
		[-591] = "Interface\\Icons\\achievement_alliedrace_highmountaintauren", -- Highmountain Tauren (Archaeology)
		[-592] = "Interface\\Icons\\achievement_raid_mantidraid03", 			-- Mantid (Archaeology)
		[-593] = "Interface\\Icons\\archaeology_5_0_keystone_mogu", 			-- Mogu (Archaeology)
		[-594] = "Interface\\Icons\\achievement_dungeon_azjoluppercity_normal", -- Nerubian (Archaeology)
		[-595] = "Interface\\Icons\\achievement_character_nightelf_male", 		-- Night Elf (Archaeology)
		[-596] = "Interface\\Icons\\achievement_reputation_ogre", 				-- Ogre (Archaeology)
		[-597] = "Interface\\Icons\\race_orc_male", 							-- Orc (Archaeology)
		[-598] = "Interface\\Icons\\pandarenracial_innerpeace", 				-- Pandaren (Archaeology)
		[-599] = "Interface\\Icons\\trade_archaeology_aqir_artifactfragment", 	-- Tol'vir (Archaeology)
		[-600] = "Interface\\Icons\\achievement_character_troll_male", 			-- Troll (Archaeology)
		[-601] = "Interface\\Icons\\inv_misc_head_vrykul", 						-- Vrykul (Archaeology)
		[-602] = "Interface\\Icons\\inv_faction_zandalariempire", 				-- Zandalari (Archaeology)
...
-- Archaeology Sections
		[-583] = "Arakkoa",				                        				-- Arakkoa (Archaeology)
		[-584] = "Demonic",					                      				-- Demonic (Archaeology)
		[-585] = "Draenei", 						                  			-- Draenei (Archaeology)
		[-586] = "Draenor Clans",		                      					-- Draenor Clans (Archaeology)
		[-587] = "Drustvar",						                  			-- Drustvar (Archaeology) (PH)
		[-588] = "Dwarf",			                            				-- Dwarf (Archaeology)
		[-589] = "Fossil",				                        				-- Fossil (Archaeology)
		[-590] = "Highborne",                             						-- Highborne (Archaeology)
		[-591] = "Highmountain Tauren", 				          				-- Highmountain Tauren (Archaeology)
		[-592] = "Mantid", 			                          					-- Mantid (Archaeology)
		[-593] = "Mogu", 			                            				-- Mogu (Archaeology)
		[-594] = "Nerubian",                              						-- Nerubian (Archaeology)
		[-595] = "Night Elf", 						                			-- Night Elf (Archaeology)
		[-596] = "Ogre", 				                          				-- Ogre (Archaeology)
		[-597] = "Orc", 							                   			-- Orc (Archaeology)
		[-598] = "Pandaren", 						                  			-- Pandaren (Archaeology)
		[-599] = "Tol'vir", 	                            					-- Tol'vir (Archaeology)
		[-600] = "Troll", 							                  			-- Troll (Archaeology)
		[-601] = "Vrykul", 						                    			-- Vrykul (Archaeology)
		[-602] = "Zandalari", 				                    				-- Zandalari (Archaeology)
