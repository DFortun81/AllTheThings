...
-- PvP Header
	...
	-- Cataclysm PvP Seasons
		...
		[-654] = "Pre-Season Cataclysmic: Season 11",							-- Pre-Season Cataclysmic (S11)
...
--[[	-- If we ever need them they need a new number
	...
	["UNOBTAINABLE_ITEM_REASONS"] = {
		...
		{3, "|CFFFF0000This item requires PvP participation or a PvP related Currency to buy. |r", "Requires PvP (12)"}, -- There is Hope --, ""}, -- 12
