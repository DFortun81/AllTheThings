...
--[[	-- If we ever need them they need a new number
	...
	["UNOBTAINABLE_ITEM_REASONS"] = {
		...
		{0, "", ""}, -- 4
		{0, "", ""}, -- 5
		{1, "|CFFFF0000Item is included in Collector's Edition's, you can still find these for sale online in very low quantities.|r", "Collector's Edition (6)"}, -- Little Hope -- 6
		{0, "", ""}, -- 7
		{0, "", ""}, -- 8
		...
		{1, "|CFFFF0000These items require either attending Blizzcon or purchasing a virtual ticket.  You may also find codes on various sites for high prices.|r", "Blizzcon (16)"},--16
