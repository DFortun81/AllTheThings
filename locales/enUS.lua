...
app.L = {
	...
	["SCREENSHOT_COLLECTED_CHECKBOX"] = "Screenshot when Collect New Item";
	["SCREENSHOT_COLLECTED_CHECKBOX_TOOLTIP"] = " Enable this option if you want to take a screen shot for every item you collect";
