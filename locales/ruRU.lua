...
local L = app.L;
	...
	L.MARKS_OF_HONOR_DESC = "Печетные знаки должны быть рассмотрены во всплывающем окне, чтобы видеть всё их 'Содержимое'\n(Введите '/att' в чат и затем Шифт+Клик для ссылки на предмет)";
	...
	L.WRONG_FACTION = "Вы должны быть на другой фракции, чтобы видеть это.";
	L.ARTIFACT_INTRO_REWARD = "Выдаётся в награду за выполнение вводного задания для данного Артефакта.";
	L.WE_JUST_HATE_TIMEWALKING = "Путешествия во времени без надобности создают новые ID Источников для предметов, не смотря на то, что они имеют те же имена, облики и отображение в Коллекции.\n\nУбедительная просьба разработчикам Blizzard: Пожалуйста, почистите базу данных ID Источников и сделайте варианты предметы из Путешествий во времени/Кованые титанами с тем же ID Источника, что и оригинал, поскольку названия и облики абсолютно идентичны. Не только сделает вашу базу данных чище, но и сделает Собирателей относиться к новым Путешествиям во времени с воодушевлением, нежели с раздражением.\n\n - Crieve, Очень Огорченный Собиратель, у которого теперь всего-лишь 64% выполнение Ульдуара, когда было 99%, потому что Ваша команда продублировала ID Источников вместо использования уже имеющихся.";
	...
	L.FOLLOWERS_COLLECTION_DESC = "Соратники могут быть собраны на Весь Аккаунт. Разблокирование соратника на одном персонаже будет считаться на всех других в ATT.\n\nВы должны вручную обновить аддон через Shift+Левый Клик по заголовку, чтобы они засчитались.";
	...
	L.TITLES_DESC = "Звания отслежваются по всей учётной записи, однако, Ваши некоторые персонажи могут иметь определённые звания, доступные только им.";
	...
	L.UNIQUE_APPEARANCE_LABEL = "Уникальные Облики";
	...
	L.QUEST_CHAIN_REQ = "Требования для Чепочки Заданий";
	L.QUEST_CHAIN_REQ_DESC = "Следующие задания должны быть выполнены прежде, чем Вы сможете выполнить финальное задание.\n\n|cffff6512ВНИМАНИЕ: Отслеживание заданий на Весь Аккаунт может заставить это окно вести себя неправильно!|r";
	...
	L._WITH_ = " с ";
	L.MAXIMUM_STANDING = "Требуется отношение не более, чем";
	...
	L.PREREQUISITE_QUESTS = "Есть предшествующие задание, которые должны быть выполнены перед получением:";
	...
	L.BREADCRUMB_PARTYSYNC_2 = "Может быть получено при помощи Синхронизации группы с другим персонажем, который не выполнил любые из этих заданий:";
	...
	L.OGOM_THE_MANGLER_DESC = "|cffFF0000Огом Уничтожитель появляется только при выполнении ежедневного задания 'Штурм осадного лагеря Железной Орды'. Данное задание не было доступно начиная со старта Легиона, а приобретаемое в гарнизоне задание 'Донесение: Штурм осадного лагеря Железной Орды' тоже не помогает.|r";
	L.HOLYDAY_DESC = "Специфичный праздник может быть активен для Вас, чтобы выполнить упомянутые в данной секции Штучки.";
	L.DIFF_COMPLETED_1 = "Вы собрали всё из данной сложности. Переключаем на ";
	L.DIFF_COMPLETED_2 = " взамен.";
	L.MINI_LIST = "Мини Лист";
	...
	L.PERSONAL_LOOT_DESC = "Каэжый игрок имеет независимый шанс получить предмет, полезных для его класса...\n\n... Или хлам типа колец.\n\nКликните дважды, чтобы создать группу автоматически, если Вы сами по себе.";
	...
	L.SEARCH_EVERYTHING_BUTTON_OF_DOOM = "Нажмите эту Кнопку(...Марриаааааза) для поиска... ВСЕГО.";
	L.ACHIEVEMENT = "Достижения";
	L.ACHIEVEMENT_DESC = "Нажмите эту кнопку для выброа случайного достижения, основываясь на том, какие у Вас отсутствуют.";
	L.ITEM = "Предмет";
	L.ITEM_DESC = "Нажмите эту кнопку для выброа случайного предмета, основываясь на том, какие у Вас отсутствуют.";
	L.INSTANCE = "Подземелья и рейды";
	L.INSTANCE_DESC = "Нажмите эту кнопку для выброа случайного подземелья, включая сценарии, основываясь на том, какие у Вас отсутствуют.";
	L.DUNGEON = "Подземелье";
	L.DUNGEON_DESC = "Нажмите эту кнопку для выброа случайного подземелья, основываясь на том, какие у Вас отсутствуют.";
	L.RAID = "Рейд";
	L.RAID_DESC = "Нажмите эту кнопку для выброа случайного рейда, основываясь на том, какие у Вас отсутствуют.";
	L.MOUNT = "Средство передвижения";
	L.MOUNT_DESC = "Нажмите эту кнопку для выброа случайного средства передвижения, основываясь на том, какие у Вас отсутствуют.";
	L.PET = "Питомец";
	L.PET_DESC = "Нажмите эту кнопку для выброа случайного питомца, основываясь на том, какие у Вас отсутствуют.";
	L.QUEST = "Задание";
	L.QUEST_DESC = "Нажмите эту кнопку для выброа случайного задания, основываясь на том, какие у Вас отсутствуют.";
	L.TOY = "Игрушка";
	L.TOY_DESC = "Нажмите эту кнопку для выброа случайной игрушки, основываясь на том, какие у Вас отсутствуют.";
	L.ZONE = "Локация";
	L.ZONE_DESC = "Нажмите эту кнопку для выброа случайной локации, основываясь на том, какие у Вас отсутствуют.";
	...
	L.RECENTLY_MADE_OBTAINABLE = "|CFFFF0000Если это недавно выпало для Вас (везде, кроме Утиля/Ящиков), пожалуйста, напишите в Дискорде, где вы получили предмет!|r";
	...
	L.DEBUG_MODE_TOOLTIP = "Совершенно буквально... ВСЕ ШТУКИ В ИГРЕ. ОКОНЧАТЕЛЬНО. ТОЧКА. АГА, ВСЕ ОНИ. Даже Несобираемые штуки, как сумки, расходуемые, реагенты и прочие, появятся в списках. (Даже Вы сами! Нет, серьёзно. Смотрите.)\n\nДанный режим только для отладки. Не предназначен для отслеживания выполнения.\n\nЭтот режим игнорирует все фильтры, включая Несобираемые.";
	L.UNIQUE_MODE = "|CFFADD8E6Уникальные|r (Облики)";
	L.UNIQUE_MODE_TOOLTIP = "Включите данный режим, чтобы считать все Предметы с одинаковыми Обликами полученными, когда определённый Облик был получен.\n\nПредметы, 'Полученные' в этом режиме будет отмечены звёздочкой (*). Это означает, что Вы нет получили ещё данный Источник Облика.";
	...
	L.I_ONLY_CARE_ABOUT_MY_MAIN = "|cff3399ffМне только важен основной персонаж.|r";
	...
	L.PRECISION_SLIDER = "Класс Точности для Процентов";
	L.PRECISION_SLIDER_TOOLTIP = 'Используйте для установления желаемого класса точности для процентных рассчётов.\n\nПо умолчанию: 2';
	...
	L.TMOG_CHECKBOX_TOOLTIP = "Включите для отслеживания получения обликов.\n\nПримечание: Отключение данной опции также отключит все фанфары и рассчёты о получении. Вы можете отклюючить для избежания лагов во время занятия важным групповым контентом, но держите в уме, что рассчёты будут произведены при обратном включении.\n\nОтслиживается на Весь Аккаунт по умолчанию.";
	...
	L.FOLLOWERS_CHECKBOX = "Соратники / Чемпионы";
	L.FOLLOWERS_CHECKBOX_TOOLTIP = "Включите для отслеживания соратников и чемпионов.\n\nТо есть: Соратников в Гарнизоне, Чемпионы Оплота Класса в Легионе и Соратники Битвы за Азерот.";
	...
	L.HEIRLOOMS_UPGRADES_CHECKBOX_TOOLTIP = "Включите для отслеживания индивидуальных улучшений для Наследства.\n\nМы все знаем, что Blizzard любит высасывать Вашу золото и душу, так что следите за ними с данным переключателем.";
	L.ILLUSIONS_CHECKBOX = "Иллюзии";
	L.ILLUSIONS_CHECKBOX_TOOLTIP = "Включите для отслеживания иллюзий.\n\nЭто круто выглядящие эффекты, которые можно применить к Вашему оружию!\n\nПримечание: Вы не иллюзия, не взирая на то, как считают все Ночнорождённые.\n\nОтслиживается на Весь Аккаунт по умолчанию.";
	L.MOUNTS_CHECKBOX = "Средства Передвижения";
	L.MOUNTS_CHECKBOX_TOOLTIP = "Включите для отслеживания средств передвижения.\n\nВы можете ездить на них, чтобы перемещаться из точки А в точку Б быстрее, чем бегом. Кто бы мог подумать!\n\nОтслиживается на Весь Аккаунт по умолчанию.";
	...
	L.MINIMAP_BUTTON_CHECKBOX_TOOLTIP = "Включите данную опцию, если Вы хотите кнопку у миникарты. Эта кнопка позволяет Вам быстро открыть Основной лист, показать Ваш общий прогресс и открыть Меню Настроек по Правому Клику.\n\nНекоторые люди не любят захламленность. Альтернативно, Вы можете открыть Основной лист командой '/att' в чате. Оттуда Правым Кликом по заголовку открыть Меню Настроек.";
	...
	L.SHOW_COMPLETED_GROUPS_CHECKBOX_TOOLTIP = "Включите данную опцию, если Вы хотите видеть выполненные группы как заголовок с процентом выполнения. Если группа не имеет ничего важного для Вашего класса, эта настройка также отобразить такие группы в списке.\n\nМы рекомендуем Вам отключить эту настройку, поскольку будет занимать место в Мини листе и мешать быстро определить, что доступно в текущей зоне.";
	...
	L.IGNORE_FILTERS_FOR_BOES_CHECKBOX_TOOLTIP = "Включите данную опцию, если Вы хотите игнорировать требования по типу брони, оружия, расе, классу или профессии для БоЕ предметов.\n\nЕсли Вы стремитель собрать штучки для Ваших альтов через Аукцион, этот режим может быть полезен для Вас.";
	L.EXPAND_DIFFICULTY_CHECKBOX = "Расширить Текущую Сложность";
	L.EXPAND_DIFFICULTY_CHECKBOX_TOOLTIP = "Включите данную опцию, если Вы хотите автоматически минимизировать заголовки в мини листе, которые не активны, когда Вы входите в подземелье или рейд.\n\nПример: Минимизировать Героический заголовок, когда в Обычной сложности подземелья.";
	...
	L.REPORT_COLLECTED_THINGS_CHECKBOX_TOOLTIP = "Включите данную опцию, если Вы хотите видеть сообщение в чате, объясняющее, какаие предметы Вы получили или удалили из коллекции.\n\nПримечание: Эта настройка присутствует потому, что Blizzard бесшумно добавляет облики и другие собираемые предметы и не считает нужным оповещать Вас о дополнительных предметах, доступных Вам.\n\nМы рекомендуем оставить эту опцию включенной. Вы будете всё также слышать фанфары, если отключите её, если они включены.";
	L.REPORT_COMPLETED_QUESTS_CHECKBOX = "Сообщать о Заданиях";
	L.REPORT_COMPLETED_QUESTS_CHECKBOX_TOOLTIP = "Включите данную опцию, если Вы хотите видеть QuestID для каждого задание, которые Вы приняли или выполнили, сразу после этого. (Для сообщения об ошибках, для отслеживание и т.п)";
	...
	L.WITH_WRAPPING_CHECKBOX = "Сокращение Источноков";
	...
	L.ACCOUNT_WIDE_1_TOOLTIP = "Достижения обычно отслеживаются на всю учётную запись, но есть некоторые достижения, эксклюзивные для определённых классов или рас, которые Вы не сможете получить на основном персонаже.";
	...
	L.ACCOUNT_WIDE_6_TOOLTIP = "Соратники типично считаются по персонажу, но вы очень-очень хотите собирать 243 соратника в Таверне Гарнизоне по одному в неделю?\n\nСпасибо, не надо.";
	...
	L.ACCOUNT_WIDE_11_TOOLTIP = "Выполнение заданий отдельное на каждого персонажа, но это будет считать, будто КАЖДЫЙ персонаж выполнить каждое выполненное задание.";
	...
	L.COORDINATES_CHECKBOX_TOOLTIP = "Включите данную опцию, если Вы хотите видеть координаты в подсказке, когда наводите на элементы в мини листе.";
	L.DESCRIPTIONS_CHECKBOX = "Описания";
	L.DESCRIPTIONS_CHECKBOX_TOOLTIP = "Включите данную опцию, если Вы хотите видеть описания в подсказках. Может включать описывающий текст из Путеводителя или дополнительное описание, добавленное Участником, который решил, что дополнительная информация будет необходимой.\n\nВозможно, Вы захотите оставить опцию включенной.";
	...
	L.FOR_UNSORTED_CHECKBOX_TOOLTIP = "Включите данную опцию, если Вы хотите видеть Местонахождение Источников, которые не были полностью добавленны в базу данных.";
	L.MISC_LABEL = "Разное";
	...
	L.PERCENTAGES_CHECKBOX_TOOLTIP = "Включите данную опцию, если Вы хотите видеть процент завершения в каждом ряду.\n\nОкрашивание группы по завершению не затронуто.";
	L.MORE_COLORS_CHECKBOX = "Использовать Больше Цветов! |CFF4AA7FF[Beta]|R";
	L.MORE_COLORS_CHECKBOX_TOOLTIP = "Включите данную опцию, если Вы хотите видеть больше использованных цветов, помогающих различать дополнительные условия для Штучек в листах (то есть цвета классов, фракций и т.п.)";
	L.TOOLTIP_HELP_CHECKBOX = "Показать Помощь в Подсказке";
	L.TOOLTIP_HELP_CHECKBOX_TOOLTIP = "Включите данную опцию, если Вы хотите видеть вспомогательную информацию в подсказке над окнами ATT, показывающие различные комбинации клавиш для управления.\nЕсли Вы уже знаете все комбинации, вполне резонно отключить их, чтобы уменьшить размер подсказок.";
	L.SIZING_LABEL = "Масштаб";
	L.MAIN_LIST_SLIDER_LABEL = "Масштаб Основого Листа";
	L.MAIN_LIST_SCALE_TOOLTIP = 'Используйте для изменения масштаба Основного Листа.\n\nПо умолчанию: 1';
	L.MINI_LIST_SLIDER_LABEL = "Масштаб Мини/Других Листов";
	L.MINI_LIST_SCALE_TOOLTIP = 'Используйте для изменения масштаба Мини и Других Листов.\n\nПо умолчанию: 1';
	
	-- Features tab

	L.FEATURES_TAB = "Особенности";
	L.MODULES_LABEL = "Модули и Мини Листы";
	L.SKIP_CUTSCENES_CHECKBOX = "Автоматический Пропуск Сцен";
	...
	L.AUTO_BOUNTY_CHECKBOX = "Автоматички Открывать Лист Пропаж";
	...
	L.AUTO_MAIN_LIST_CHECKBOX = "Автоматички Открывать Основной Лист";
	L.AUTO_MAIN_LIST_CHECKBOX_TOOLTIP = "Включите данную опцию, если Вы хотите, чтобы ATT автоматически открывал Основной Лист при входе в игру.\n\nВы также можете назначить клавишу для данной настройки:\n\nНазначение Клавиш -> Модификации -> ALL THE THINGS -> Переключить Основной Лист\n\nБыстрая Команда: /att";
	L.AUTO_MINI_LIST_CHECKBOX = "Автоматички Открывать Мини Лист";
	L.AUTO_MINI_LIST_CHECKBOX_TOOLTIP = "Включите данную опцию, если Вы хотите видеть всё, что можно собрать в текущей локации. Этот лист будет автоматически изменяться при смене зоны. Некоторым людям не нравится данная особенность, но когда Вы играете соло, данная опция крайне полезна.\n\nВы также можете назначить клавишу для данной настройки:\n\nНазначение Клавиш -> Модификации -> ALL THE THINGS -> Переключить Мини Лист\n\nБыстрая Команда: /att mini";
	L.AUTO_PROF_LIST_CHECKBOX = "Автоматички Открывать Лист Профессии";
	L.AUTO_PROF_LIST_CHECKBOX_TOOLTIP = "Включите данную опцию, если Вы хотите, чтобы ATT автоматически открывал и обновлял лист профессии, когда Вы открываете Ваши профессии. Из-за навязанных ограничений API, аддоны могут взаимодействовать с профессиями только, когда они открыты. Этот лист будет автоматически переключаться, когда вы открываете другую профессию.\n\nМы не рекомедуем отключать данную опцию, поскольку она может предотватить некорректное отслеживание рецептов.\n\nВы также можете назначить клавишу для данной настройки (работает только если профессия открыта):\n\nНазначение Клавиш -> Модификации -> ALL THE THINGS -> Переключить Лист Профессии\n\nБыстрая Команда: /att prof";
	L.AUTO_RAID_ASSISTANT_CHECKBOX = "Автоматички Открывать Рейдового Помощника";
	L.AUTO_RAID_ASSISTANT_CHECKBOX_TOOLTIP = "Включите данную опцию, если Вы хотите, чтобы ATT автоматически открывал альтернативное окно для управления настройками группы/рейда под названием 'Рейдовый Помощник'. Лист автоматически обновляется когда настройки группы меняются.\n\nВы также можете назначить клавишу для данной настройки:\n\nНазначение Клавиш -> Модификации -> ALL THE THINGS -> Переключить Рейдового Помощника\n\nБыстрая Команда: /attra";
	L.AUTO_WQ_LIST_CHECKBOX = "Автоматички Открывать Локальные Задания";
	L.AUTO_WQ_LIST_CHECKBOX_TOOLTIP = "Включите данную опцию, если Вы хотите, чтобы ATT автоматически открывал Лист 'Локальных Заданий'. Этот лист автоматический обновляется, когда вы меняете локацию.\n\nВы также можете назначить клавишу для данной настройки:\n\nНазначение Клавиш -> Модификации -> ALL THE THINGS -> Переключить Локальные Задания\n\nБыстрая Команда: /attwq";
	...
	L.SORT_BY_PROGRESS_CHECKBOX_TOOLTIP = "Включите данную опцию, если Вы хотите операцию 'Сортирования' (Shift + Правый Клик) сортировать по общему прогрессу каждой группы (вместо 'по имени').";
	...
	L.WARN_REMOVED_CHECKBOX_TOOLTIP = "Включите данную опцию, если Вы хотите слышать предупреждающий звуковой эффект, когда Вы случайно продаёт обратно или передаёте предмет, который добавил Вам облик, который Вы потеряете из своей коллекции.\n\nМожет быть крайне полезно, если Вы продаёте торговцу предмет с таймером возврата. Аддон скажет Вам, что совершаете ошибку.";
	
	-- About tab
	
	L.ABOUT = "Об аддоне";
	L.ABOUT_1 = " |CFFFFFFFF- модификация для отслеживания коллекции, которая показывает Вам где и как получить всё в игре! У нас большое сообщество в Дискоре (ссылка внизу), где Вы можете спрашивать, оставлять предложения, а также сообщать об ошибках и пропавших предметах. Если Вы нашли предмет или задание, которые не задокументированы, Вы можете сказать нам в Дискорде, для более технически подкованных у нас Git, в котором вы можете участвовать.\n\nПока мы стремимся к выполнению, есть множество вещей, что добавляются в игру с каждым патчем, и если что-то отсутствует, пожалуйста, поймите, у нас небольшая команда, пытающаяся держать темп с изменениями, в то же время собирая Штучки. :D\n\nНе стесняйтесь спрашивать меня во время трансляций, даже если вопрос не связан напрямую с ATT (стандартное программирование аддонов WoWтоже).\nПримечание переводчика: на английском языке.\n\n- |r|Cffff8000Crieve|CFFFFFFFF\n\nPS: As a community, we're currently focusing on Legion Raid Transmog, so if you're interested in this, we form groups on Fridays and Saturdays at 3 PM Arizona Time. Search Premade Group finder for \"CRIEVE\" around this time and you'll likely find our group!\n\n\n\nМне продолжают задавать вопрос:\nДа, будет версия ATT для Classic. Это будет просто трекер добычи и заданий, поскольку там просто нет трансмога (и не должно быть).\n\nДа, я собираюсь играть в Classic, но между работой и разработкой двух версий аддона, не будет много времени для рейдов.\n\nНет, ATT не тот аддон, который ставит иконки в Ваших сумках. Это CanIMogIt and Caerdon Wardrobe!\n\nСайт для сравнения Коллекций будет Скоро™.|r";
	L.ABOUT_2 = "Дополнительные Участники: |CFFFFFFFF(в порядке присоединения к команде)\nDaktar, Lucetia, Slumber, Gold, Avella, Aiue, Dead Serious, Oiche, Oxlotus, Eiltherune, Blueyleader, Iyanden, Pr3vention, BigBlaris, Talonzor, Heallie, Eckhardt, Boohyaka, Sadidorf, Sanctuari, Runawaynow и весь остальной ALL THE THINGS Дискорд!\n\nОсобая Благодарнось AmiYuy (CanIMogIt) и Caerdon (Caerdon Wardrobe).|r  ";
	L.ABOUT_3 = "\n|CFFFFFFFFВы просто обязаны загрузить их аддоны, чтобы иконки коллекций в Ваших сумках!|r";	
	...
	L.MODULES = "Модули";
	L.TOGGLE_MAINLIST = "Переключить Основной Лист";
	L.TOGGLE_MINILIST = "Переключить Мини Лист";
	L.TOGGLE_PROFESSION_LIST = "Переключить Лист Профессии";
	...
	L.ITEM_ID_ADDED_MISSING = "%s (%d) добавлен в Вашу коллекцию. Не найден в базе данных. Пожалуйста, сообщите в Дискорде ATT!";
	L.ITEM_ID_ADDED_SHARED = "%s (%d) [+%d] были добавлены в Вашу коллекцию.";
	L.ITEM_ID_ADDED_SHARED_MISSING = "%s (%d) [+%d] были добавлены в Вашу коллекцию. Не найдены в базе данных. Пожалуйста, сообщите в Дискорде ATT!";
...
for key,value in pairs({
	...
	-- Commonly used
		...
		--[-40] = LFG_LIST_LEGACY,												-- Legacy (probably need to translate)
		[-41] = "Тайник Безумия",
-- Armor Types
		[-43] = GetItemSubClassInfo(4,1).." доспехи",				-- Cloth
		[-44] = GetItemSubClassInfo(4,2).." доспехи",				-- Leather
		[-45] = GetItemSubClassInfo(4,3).." доспехи",				-- Mail
		[-46] = GetItemSubClassInfo(4,4).." доспехи",				-- Plate
-- World Events
...
for key,value in pairs({
		...
		{0, "", ""}, -- 7
		{0, "", ""}, -- 8
		{3, "|CFFFF0000Источники для этого предмета были убраны и только доступны через Аукцион Черного Рынка.|r", "Аукцион Черного Рынка [BMAH] (9)"}, -- There is Hope -- 9
		...
		{0, "", ""}, -- 12
		{1, "|CFFFF0000Ваши соратники слишком высокого уровня и миссия с ящиком в награду больше не появится.|r", "Старинный ящик (13)"}, -- 13
		{3, "|CFFFF0000Эти предметы не могут быть приобретены, только если Вы не имеете необходимый ПвП Рейтинг или были не были в Верхних % этого сезона.|r", "ПвП Элита / Гладиатор (14)"}, -- 14
		{1, "|CFFFF0000Source ID этого предмета(Легендарные предметы Ока), но не могут быть изучены (тренировочные рецепты). |r", "Тренировочные Рецепты / Неизучаемые (15)"}, -- 15
		{0, "", ""},--16
		...
		{21, "|CFFFF0000Эти облики только доступны в течение недельного События Путешествия во времени.\nТолько подземелья, открытые в течение определенного дополнения будут доступны..|r", "Путешествия во времени (42)"}, -- 42
		{0, "", ""}, -- 43
		{0, "", ""}, -- 44
