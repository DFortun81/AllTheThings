...
for key,value in pairs({
	...
	[14] = {3, "|CFFFF0000Это больше нельзя будет купить или изучить, если у вас нет необходимого PvP титула или если вы не входили в топ % лучших в этом сезоне.|r", "ПвП Элита / Гладиатор"},
