...
local L = app.L;
	...
	L.FOLLOWERS_COLLECTION_DESC = "Спутники могут быть собраны на Весь Аккаунт. Разблокирую всех на одном персонаже будет считаться на всех других в ATT.\n\nВы должны вручную обновить аддон через Shift+Левый Клик по заголовку, чтобы они засчитались.";
