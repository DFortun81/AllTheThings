...
-- Settings.lua
	...
	-- General tab
		...
		L.BATTLE_PETS_CHECKBOX_TOOLTIP = "Enable this option to track battle pets and companions. These can be found in the open world or via boss drops in various Dungeons and Raids as well as from Vendors and Reputation.";	--TODO
...
for key,value in pairs({
	...
	-- General Content
		...
		--TODO: FILTER_THINGS_BY_LEVEL_CHECKBOX = app.ccColors.Insane .. "No Level Restrictions";
		...
		--TODO: SHOW_BOE_CHECKBOX = app.ccColors.Insane .. "BoE/BoA Items";
		...
		--TODO: SHOW_ALL_SEASONAL = "|T"..app.asset("Category_Holidays")..":0|t " .. app.ccColors.Insane .. "All Seasonal Events";
