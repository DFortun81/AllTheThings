...
L["UNOBTAINABLE_ITEM_REASONS"] = {
    ...
    {3, "|CFFFF0000此物品的获得方式已被移除，只能从黑市获得。|r", "黑市交易 (9)"}, -- There is Hope -- 9
    {3, "|CFFFF0000此物品通过TCG卡牌获得，卡牌不再发行，但网络上、黑市甚至交易行仍可能出现。国服也可能有积分兑换活动。|r", "TCG卡牌 (10)"}, -- There is Hope -- 10
    ...
    {2, "|CFFFF0000只能从限定时间的黑市中获得。|r", "限定时间的黑市 (44)"}, -- 44
