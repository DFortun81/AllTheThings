...
local L = app.L;
	...
	L.DELIST_GROUP = "群组除名";
	L.DELIST_GROUP_DESC = "单击此处将群组除名。如果您独自一人，它会轻松地离开该组，而不会将您从您所在的任何实例中移出。 ";
	L.LEAVE_GROUP = "离开队伍";
	...
	L.REROLL = "重新刷新";
	L.REROLL_DESC = "单击此按钮可使用活动过滤器重新刷新。";
	...
	L.RAID = "团队";
	L.RAID_DESC = "单击此按钮可根据缺少的内容选择随机团队。";
	L.MOUNT = "坐骑";
	...
	L.UPDATE_WORLD_QUESTS_DESC = "有时世界任务 API 很慢或无法返回新数据。如果希望在不更改区域的情况下强制刷新数据，请立即单击此按钮！\n\nAlt+单击以包括当前可用的事物，可能不受时间限制";
	...
	L.TWITCH_BUTTON_TOOLTIP = "单击按钮复制 URL 到我的 Twitch 频道。\n\n可以在我直播的时候问问题，我会尽力回答！";
	L.DISCORD_BUTTON_TOOLTIP = "单击按钮复制 URL 到All The Things Discord 服务器。\n\n可以与其他收藏家分享进步/挫折！";
	L.PATREON_BUTTON_TOOLTIP = "单击按钮复制 URL 以进入 All The Things Patreon 页面。\n\n在这里您可以看到如何在经济上支持插件！";
	L.MERCH_BUTTON_TOOLTIP = "单击按钮复制 URL 以进入 All The Things Merch 商店。\n\n在这里您可以在经济上支持插件并获得一些很酷的商品作为回报！ ";
	...
	-- L.AZERITE_ESSENCES_CHECKBOX = "|T"..app.asset("Expansion_BFA")..":0|t |cffADD8E6"..SPLASH_BATTLEFORAZEROTH_8_2_0_FEATURE2_TITLE;
	L.AZERITE_ESSENCES_CHECKBOX_TOOLTIP = "启用此选项以追踪艾泽里特精华。\n\n默认情况下每个角色都会被追踪。";
	-- L.BATTLE_PETS_CHECKBOX = "|cffADD8E6"..PETS;
	...
	-- L.FOLLOWERS_CHECKBOX = "|cffADD8E6"..GARRISON_FOLLOWERS.." / "..COVENANT_MISSIONS_FOLLOWERS;
	L.FOLLOWERS_CHECKBOX_TOOLTIP = "启用此选项可追踪随从。\n\n即：要塞随从，军团职业大厅随从，争霸艾泽拉斯随从，暗影国度随从。";
	-- L.HEIRLOOMS_CHECKBOX = "|cffADD8E6"..HEIRLOOMS;
	...
	-- L.MOUNTS_CHECKBOX = "|cffADD8E6"..MOUNTS;
	...
	-- L.QUESTS_CHECKBOX = "|cffADD8E6"..QUESTS_LABEL;
	...
	-- L.RECIPES_CHECKBOX = "|cffADD8E6"..AUCTION_CATEGORY_RECIPES;
	...
	-- L.SOULBINDCONDUITS_CHECKBOX = "|T"..app.asset("Expansion_SL")..":0|t |cffADD8E6"..GetSpellInfo(348869);
	L.SOULBINDCONDUITS_CHECKBOX_TOOLTIP = "启用此选项来追踪暗影国度灵魂羁绊的导灵器。";
	-- L.TITLES_CHECKBOX = "|cffADD8E6"..PAPERDOLL_SIDEBAR_TITLES;
	L.TITLES_CHECKBOX_TOOLTIP = "启用此选项可追踪头衔。\n\n这些可以让你的角色脱颖而出，看起来你已经玩了一段时间。通常只有新玩家没有称号。";
	-- L.TOYS_CHECKBOX = "|cffADD8E6"..TOY_BOX;
	...
	-- L.SHOW_PVP_CHECKBOX = "|T"..app.asset("Category_PvP")..":0|t |cffADD8E6"..PVP_OPTIONS;
	L.SHOW_PVP_CHECKBOX_TOOLTIP = "如果你想隐藏任何'可能'需要在游戏中进行 PvP 互动的内容，请启用此设置。";
	-- L.SHOW_PET_BATTLES_CHECKBOX = "|T"..app.asset("Category_PetBattles")..":0|t |cffADD8E6"..SHOW_PET_BATTLES_ON_MAP_TEXT;
	...
	-- Filters tab
	-- L.FILTERS_TAB = TRACKING;
	-- L.ITEM_FILTER_LABEL = AUCTION_CATEGORY_WEAPONS.." & "..ARMOR;
	...
	L.ENABLE_TOOLTIP_INFORMATION_CHECKBOX_TOOLTIP = "如果希望在鼠标提示中查看 ATT 提供的信息，请启用此选项。这包括其他玩家发送的物品链接，在拍卖行、在地下城助手、在你的包里、在世界、在NPC等等。\n\n如果你关闭了这个功能，就会严重降低你快速判断是否需要击杀BOSS或学习外观的能力。\n\n我们建议你保持此设置。";
	...
	-- About tab
	L.ABOUT = "关于";
	L.ABOUT_1 = " |CFFFFFFFF是一个收集追踪插件，告诉你在哪里以及如何获得游戏中的所有事物！ 在我们的Discord上有一个庞大的用户社区(链接在底部)，你可以在这里提出问题、提交建议以及报告错误或丢失的物品。如果你发现了一些可收藏的事物或没有记录，你可以在Discord上告诉我们，或者对于更懂技术的人来说，我们有一个Git，你可以直接贡献给我们。\n\n虽然我们力求完美，但每个补丁都会有很多事物加入到游戏中，所以如果我们可能遗漏了一些事物，请理解我们是一个试图跟上变化以及自己收集事物的小团队 :D\n\n欢迎在直播的时候向我提问，即使不是直接与 ATT 相关的问题，我也会尽力回答(常见的 WoW 插件编程也行)。\n\n- |r|Cffff8000Crieve|CFFFFFFFF\n\nPS：下载 ATT 怀旧服版本！\n\n是的，我打算玩 WoW 怀旧服，但在全职工作和开发两个版本的插件，不会有太多的时间去打团。\n\n不，ATT 不是将图标放在背包图标上的插件。那个是CanIMogIt和Caerdon Wardrobe！\n\n即将推出的比较收藏的网站.|r";	--TODO: add TBC Classic here and add "For online collection comparing check out DataForAzeroth.com from shoogen！"
	L.ABOUT_2 = "其他贡献者：|CFFFFFFFF(加入团队顺序)\nDaktar，Lucetia，Slumber，Gold，Avella，Aiue，Dead Serious，Oiche，Oxlotus，Eiltherune，Blueyleader，Iyanden，Pr3vention，BigBlaris，Talonzor，Mogwai，Heallie，Eckhardt，Boohyaka，Sadidorf，Sanctuari，Molkree，Runawaynow，Braghe，Myrhial，Darkal和其他 ATT Discord的人们！\n\n特别鸣谢 AmiYuy (CanIMogIt)和Caerdon (Caerdon Wardrobe).|r  ";	--TODO: change to "in no particular order"
...
for key,value in pairs({
	...
	[GROUP_FINDER] = "地下城和团队",	-- ["Dungeons & Raids"] = "D&R"
