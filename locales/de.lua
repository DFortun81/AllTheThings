...
-- Settings.lua
	...
	-- General tab
		-- Mode Title
			...
			L.TITLE_DEBUG = "Debug ";
			L.TITLE_ACCOUNT = color.Account.."Account|R ";
			L.TITLE_MAIN_ONLY = " (Nur Hauptcharakter)";
			L.TITLE_NONE_THINGS = "Keins der Dinge ";
			L.TITLE_ONLY = " Nur ";
			L.TITLE_INSANE = color.Insane.."Wahnsinn|R ";
		...
		L.ACCOUNT_MODE = color.Account.."Account Modus";
		...
		L.FLIGHT_PATHS_CHECKBOX = color.Insane .. "Flugpunkte & Fährstationen";
		...
		L.HEIRLOOMS_UPGRADES_CHECKBOX = color.Insane .. "+Aufwertungen";
		...
		L.REPUTATIONS_CHECKBOX = color.Insane.."Ruffraktionen";
