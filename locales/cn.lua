...
TRACK_ACC_WIDE = color.Account.."追踪帐号通用|R";
ACC_WIDE_DEFAULT = "默认情况下追踪"..color.Account.."账号通用|R。";
...
-- Settings.lua
	...
	-- General tab
		-- Mode Title
			...
			L.TITLE_DEBUG = "调试 ";
			L.TITLE_ACCOUNT = color.Account.."帐号|R ";
			L.TITLE_MAIN_ONLY = " （仅主要）";
			L.TITLE_NONE_THINGS = "一无所有 ";
			L.TITLE_ONLY = " 仅 ";
			L.TITLE_INSANE = color.Insane.."疯狂|R ";
		...
		L.ACCOUNT_MODE = color.Account.."帐号模式";
		...
		L.FLIGHT_PATHS_CHECKBOX = color.Insane .. "飞行路径 & 飞艇";
		...
		L.MUSIC_ROLLS_SELFIE_FILTERS_CHECKBOX = "|T"..app.asset("Expansion_WOD")..":0|t " .. color.Insane .. "乐谱&自拍滤镜";
		...
		L.QUESTS_LOCKED_CHECKBOX = color.Insane .. "+已锁定";
		...
		L.REPUTATIONS_CHECKBOX = color.Insane .. "声望";
		...
		L.FILTER_THINGS_BY_LEVEL_CHECKBOX = color.Insane.."无等级限制";
		L.FILTER_THINGS_BY_LEVEL_CHECKBOX_TOOLTIP = "如果只想查看当前级别角色可用的事物，请启用此设置。\n\n注意：这对新战网特别有用。";
		L.SHOW_BOE_CHECKBOX = color.Insane.."装备绑定/拾取绑定物品";
