...
--------------------------------------------------------------------------------
--						Espa\195\177ol  / ES y MX 				  --
--------------------------------------------------------------------------------
-- Maintained By Milotic https://worldofwarcraft.com/es-mx/character/drakkari/kancerberus		  --
--------------------------------------------------------------------------------
...
function AllTheThings.Locales.esES()
    AllTheThings.Locales.esALL()
end

function AllTheThings.Locales.esMX()
    AllTheThings.Locales.esALL()
end
...
AllTheThings.Locales.esALL() = {
	...
	["DESCRIPTION"] = "\"Tonto, has buscado tu propia muerte. Descaradamente has ignorado poderes más allá de tu comprensión. Has luchado duro para invadir el reino del Coleccionista. Ahora solo hay una salida: caminar por el camino solitario ... de los condenados.\"";
	["LOADING"] = "v%s Cargado correctamente.";
	["TITLE_OPTIONS"] = "All the Things";
	["FILTERS"] = "Filtros";
	["PREFERENCES"] = "Preferencias";

	-- Minimap Icon Text
	["MINIMAP_MOUSEOVER_TEXT"] = "click derecho para cambiar las configuraciones.\nclick izquierdo + arrastrar para mover.\nclick izquierdo para abrir la lista principal.\nCtrl + click izquierdo para abrir la minilista principal.\nShift + click izquierdo para refrescar las colecciones.";
	["OPEN_MAINLIST"] = "Abrir lista principal";
	["TOGGLE_MAINLIST"] = "I/O lista principal";
	["OPEN_MINILIST"] = "Abrir minilista";
	["OPEN_PROFESSIONMINILIST"] = "Abrir minilista de profesion";
	["TOGGLE_MINILIST"] = "I/O minilista";
	["TOGGLE_COMPLETIONIST_MODE"] = "I/O modo completionista";
	["TOGGLE_DEBUG_MODE"] = "I/O modo debug";

	-- Frame Text
	["LIST_FRAME_TITLE"] = "Coleccion de objetos";
	["REFRESH_BUTTON_TITLE"] = "REFRESCAR LAS COSAS";
	["CONGRATULATIONS"] = "FELICIDADES! Lo hiciste!";
	["INSTRUCTIONS"] = "Parece como si algo terrible hubiera pasado. Reinstala el addon!";
	...
	-- Error Text
	["ERROR_UNKNOWN"] = "Un desconocido error a ocurrido.";

	["ITEM_ID_ADDED"] = "%s (%d) fue agregado a tu coleccion.";
	["ITEM_ID_ADDED_MISSING"] = "%s (%d) fue agregado a tu coleccion. no fue encontrado en la base de datos. Por favor reporta al discord de ATT!";
	["ITEM_ID_ADDED_SHARED"] = "%s (%d) [+%d] fueron agregados a tu coleccion.";
	["ITEM_ID_ADDED_SHARED_MISSING"] = "%s (%d) [+%d] fueron agregados a tu coleccion. no fueron encontrados en la base de datos. Por favor reporta al discord de ATT!";
	["ITEM_ID_REMOVED"] = "%s (%d) fue removido de tu coleccion.";
	["ITEM_ID_REMOVED_SHARED"] = "%s (%d) [+%d] fueron removidos de tu coleccion.";

	-- Tooltip Text
	["TOP_ROW_INSTRUCTIONS"] = "|cff3399ffClick izquierdo y arrastrar para mover|r\n|cff3399ffClick derecho para abrir el menu de configuraciones|r\n|cff3399ffShift + Click para refrescar las colecciones|r";
	["OTHER_ROW_INSTRUCTIONS"] = "|cff3399ffClick izquierdo para expandir/reducir|r\n|cff3399ffClick derecho para sacar la minilista|r\n|cff3399ffShift + Click para refrescar las colecciones|r";
	["TOP_ROW_INSTRUCTIONS_AH"] = "|cff3399ffClick izquierdo y arrastrar para mover|r\n|cff3399ffClick derecho para abrir el menu de configuraciones|r\n|cff3399ffShift + Click para buscar en la casa de subasta|r";
	["OTHER_ROW_INSTRUCTIONS_AH"] = "|cff3399ffClick izquierdo para expandir o reducir|r\n|cff3399ffClick derecho para sacar la minilista|r\n|cff3399ffShift + Click para buscar en la casa de subasta|r";
	["ACHIEVEMENT"] = "Logro";
	["ACHIEVEMENT_ID"] = "Logro ID";
	["ARTIFACT"] = "Artefacto";
	["ARTIFACT_ID"] = "Artfacto ID";
	["CREATURE_ID"] = "Criatura ID";
	["DIFFICULTY"] = "Dificultad";
	["DIFFICULTY_ID"] = "Dificultad ID";
	["ENCOUNTER"] = "Encuentro";
	...
	["ITEM_ID"] = "Objeto ID";
	["ITEM_SLOT"] = "Ranura";
	["COMPANION_PETS"] = "Mascotas de compa\195\177ia";
	["DROP_RATE"] = "Ratio de despojo";
	["FACTION"] = "Faccion";
	["FACTION_ID"] = "Faccion ID";
	["MOUNT"] = "Montura";
	["MOUNTS"] = "Monturas";
	["MOUNT_ID"] = "Monturas ID";
	["MUSIC_ROLL"] = "Rollo de musica";
	["MUSIC_ROLLS"] = "Rollos de musica";
	["MUSIC_ROLL_ID"] = "Rollo de musica ID";
	["NPC"] = "NPC";
	["NPC_ID"] = "NPC ID";
	["OBJECT_ID"] = "Object ID";
	["PET"] = "Mascota";
	["QUEST"] = "Mision";
	["QUEST_ID"] = "Mision ID";
	["QUEST_GIVER"] = "Asignador de mision";
	["SET_ID"] = "Conjunto ID";
	["SPECIES_ID"] = "Especies ID";
	["SPELL_ID"] = "Hechizo ID";
	["TITLE_ID"] = "Titulo ID";
	["TOY"] = "Juguete";
	["TOY_ID"] = "Juguete ID";
	["ILLUSION_ID"] = "Ilusion ID";
	["VIGNETTE_ID"] = "Vi\195\177eta ID";
	["VISUAL_ID"] = "Visual ID";
	["LOGO_TINY"] = "Interface\\Addons\\AllTheThings\\assets\\logo_tiny";		-- Ganador del concurso del logo (Used to be "Interface\\Icons\\INV_Axe_106.blp")
	["LOGO_SMALL"] = "Interface\\Addons\\AllTheThings\\assets\\logo_tiny";		-- Ganador del concurso del logo (Used to be "Interface\\Icons\\INV_Axe_106.blp")
	["LOGO_LARGE"] = "Interface\\Addons\\AllTheThings\\assets\\Discord_2_128";		-- Ganador del concurso del logo (Used to be "Interface\\Icons\\INV_Axe_106.blp")
...
AllTheThings.Locales.Base = { __index = AllTheThings.Locales.esMX };