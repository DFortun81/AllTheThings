...
-- Settings.lua
	...
	-- Features tab
		...
		L.ICON_LEGEND_TEXT = app.ccColors.White .. "|TInterface\\AddOns\\AllTheThings\\assets\\status-unobtainable:0|t " .. "無法獲得" .. "\n|TInterface\\AddOns\\AllTheThings\\assets\\status-prerequisites:0|t " .. "僅在滿足先決條件的情况下獲得" .. "\n|TInterface\\AddOns\\AllTheThings\\assets\\status-seasonal-available:0|t " .. AVAILABLE .."季節性内容" .. "\n|TInterface\\AddOns\\AllTheThings\\assets\\status-seasonal-unavailable:0|t " .. UNAVAILABLE .. "季節性内容" .. "\n|TInterface\\FriendsFrame\\StatusIcon-Offline:0|t " .. "當前角色不可用";	--TODO: check (un)available seasonal content
