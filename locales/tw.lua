...
-- Big new chunk from AllTheThings.lua
	...
	L.FOLLOWERS_COLLECTION_DESC = "如果您在 ATT 中啟用此設置，則可以在整個帳號範圍内收集追隨者。\n\n必須通過 "..SHIFT_KEY_TEXT.."點擊標題手動刷新插件才能檢測到這一點。";
	...
	L.EXPANSION_DATA[4].lore = "浩劫與重生是第三個資料片。隨着死亡之翼的回歸，重做艾澤拉斯大陸的卡林多和東部王國，他從位於元素位面深處的巢穴中破土而出，將艾澤拉斯撕成碎片。大災變讓玩家們回到艾澤拉斯的兩大洲進行大部分的活動，開闢新的區域，如海加爾山、瓦斯琪爾、深岩之洲、奥丹姆和暮光高地。它包括兩個新的可玩的種族，狼人和哥布林。資料片將等級上限提高到85，增加了在卡林多和東部王國飛行的能力，引入考古學，並重做世界本身。";
	L.EXPANSION_DATA[5].lore = "潘達利亞之謎是第四個資料片。在潘達利亚意外重新發現之後，資料片主要重新集中在聯盟和部落之間的戰爭。冒險者重新發現了古老的熊猫人，他們的智慧將有助於引導他們走向新的命运; 熊猫人帝國的古代敵人螳螂妖; 和他們傳說中的压迫者神秘的魔古族。领土隨着時間的推移而變化，瓦里安烏瑞恩和加爾鲁什地獄吼之間的冲突逐漸升級。内戰席卷了部落，聯盟和部落中反對地獄吼的暴力起義聯合起來直接把戰爭带到地獄吼和被煞魔侵蚀的奧格瑪的盟友。";
	L.EXPANSION_DATA[6].lore = "德拉諾之霸是第五個資料片。在德拉諾的原始叢林和戰爭創伤的平原上，艾澤拉斯的英雄們將参與一场神話般的冲突，包括神秘的德萊尼冠軍和強大的獸人部落，以及在原始力量的頂峰與格罗玛什地獄吼、黑手和耐奥祖等。玩家需要在這片不受歡迎的土地上搜尋盟友，以幫助建立一個絕望的防御，對抗舊部落強大的统治，或者观看他們自己世界上血腥的、饱受戰爭蹂躏的历史重演。";
	L.EXPANSION_DATA[7].lore = "軍臨天下是第六個資料片。古爾丹被驅逐到艾澤拉斯，重新開放薩格拉斯之墓和阿古斯之門，開始第三次入侵燃燒軍團。在破碎海岸被擊败後，艾澤拉斯的卫士們寻找創造之柱，這是艾澤拉斯關閉萨墓中心巨大的惡魔之門的唯一希望。然而，破碎群岛也有自己的危險要克服，從萨维斯到神王斯科瓦德，到夜之子，再到潮汐之力艾萨拉。卡德加將達拉然迁移到這片土地的海岸，這座城市是英雄的中心枢纽。阿彻鲁斯的死亡騎士也將他們漂浮的墓地带到了群岛。艾澤拉斯的英雄們在戰鬥中寻找傳說中的神器，但也發現了伊利達雷的意外盟友。聯盟和部落之間正在發生的冲突導致了階級秩序的形成，特殊的指揮官搁置陣營纷爭來領導他們的隊伍参加對抗軍團的鬥爭。";
	L.EXPANSION_DATA[8].lore = "決戰艾澤拉斯是第七個資料片。艾澤拉斯為結束軍團十字軍的天启付出了慘重的代價，但即使世界上的創伤得到了修復，聯盟和部落之間破碎的信任也可能是最難弥补的。在艾澤拉斯戰役中，燃燒軍團的垮台引發了一系列灾難性事件，重新引發了魔獸世界中心的冲突。隨着一個新的戰爭時代的開始，艾澤拉斯的英雄們必須開始征募新的盟友，爭夺世界上最強大的資源，並在多條戰線上戰鬥，以確定部落或聯盟是否會带领艾澤拉斯進入不確定的未來。";
	L.EXPANSION_DATA[9].lore = "暗影國度是第八個資料片。你所知道的世界之外還有什麼? 暗影國度。每一個世俗的人(無論是邪惡的還是邪惡的)都曾居住過的地方。";
	L.EXPANSION_DATA[10].lore = "巨龍崛起是第九個資料片。艾澤拉斯的巨龙軍團已經回歸，他們响應了召唤，前去保护自己世代相傳的家园：巨龙群岛。巨龙群岛涌動着元素魔法和艾澤拉斯的生命能量，如今它已從睡梦中苏醒，原始的奇观和尘封已久的秘密正等待你去揭露。";
	L.EXPANSION_DATA[11].lore = "地心之戰是第十個資料片。也是世界之魂戰記三部曲的開端。穿越前所未見的地下世界，那里充滿了隱藏的奇跡和潜伏的危險，一直到蛛魔帝國的黑暗深處，那里邪惡的虚空先驅正在聚集蛛魔力量，試圖讓艾澤拉斯屈服。"
	...
	L.AH_SEARCH_NO_ITEMS_FOUND = "搜尋中找不到快取的物品。展開組並查看物品快取名稱，然後重試。使用此搜尋只能找到BOE物品。";
	L.AH_SEARCH_BOE_ONLY = "使用此搜尋只能找到裝備綁定物品。";
	L.TSM_WARNING_1 = "运行此命令可能會通過將物品重新分配到 ";
	L.TSM_WARNING_2 = " 預設。\n\n我們建議你在使用此功能時使用不同的設定檔。\n\n你還想繼續嗎?";
	L.PRESET_UPDATE_SUCCESS = "更新預設成功。";
	L.SHOPPING_OP_MISSING_1 = "預設缺少'购物'操作分配。";
	L.SHOPPING_OP_MISSING_2 = "鍵入'/tsm operations'創建或者分配一個。";
	L.AUCTIONATOR_GROUPS = "基於群組的搜尋只支援使用 Auctionator。";
	L.TSM4_ERROR = "TSM4 尚未與 ATT 兼容。如果你知道如何像我們以前在 TSM3 中那樣創建預設，請在 Discord 上告訴我！";
	L.QUEST_MAY_BE_REMOVED = "獲得任務資訊失败。這個任務可能已從遊戲中移除。";
	...
	L.RAID_ASSISTANT_DESC = "再也不要用錯誤的設置進入團隊了！检查一切是否正常！";
	L.LOOT_SPEC_UNKNOWN = "拾取專精未知";
	L.LOOT_SPEC = "拾取專精";
	L.LOOT_SPEC_DESC = "在個人拾取地城，副本和戶外事件中，此設置將決定哪些物品可供使用。\n\n點擊此行可立即更改！";
	L.DUNGEON_DIFF = "地城難度";
	...
	L.TELEPORT_TO_FROM_DUNGEON = "傳送到/出地城";
	...
	L.LOOT_SPEC_DESC_2 = "在個人拾取地城，副本和戶外事件中，此設置將決定哪些物品可供使用。\n\n點擊此行可返回團隊助手。";
	L.CURRENT_SPEC = "當前專精";
	L.CURRENT_SPEC_DESC = "如果你改變你的專精，你的戰利品就會隨之改變。";
	L.DUNGEON_DIFF_DESC_2 = "此設置允許自定義地城的難度。\n\n點擊此行可返回團隊助手。";
	L.CLICK_TO_CHANGE = "點擊立即更改。（如果可用）";
	L.RAID_DIFF_DESC_2 = "此設置允許自定義團隊難度。\n\n點擊此行可返回團隊助手。";
	L.LEGACY_RAID_DIFF_DESC_2 = "此設置允許自定義經典拾取團隊難度。（圍攻奧格瑪之前的）\n\n點擊此行可返回團隊助手。";
	L.REROLL = "重新刷新";
	...
	L.REROLL_2 = "重新刷新：";
	L.NOTHING_TO_SELECT_FROM = "沒有什麼可以隨意選擇的。如果在“設置”中啟用了“臨時更新”，則必須在使用此視窗之前更新主列表（/att）。";
	...
	L.REPORT_INACCURATE_QUEST = "錯誤任務資訊！（點擊回報）";
	L.NESTED_QUEST_REQUIREMENTS = "多重任務需要";
	L.MAIN_LIST_REQUIRES_REFRESH = "[打開主列表更新進度 ]";
	L.DOES_NOT_CONTRIBUTE_TO_PROGRESS = "|cffe08207該組及其内容不参與此視窗的進度，因為它來自另一個位置！|r";
	...
	-- Item Filter Window
		...
		L.ITEM_FILTER_BUTTON_TEXT = "設置物品篩選";
		L.ITEM_FILTER_BUTTON_DESCRIPTION = "點擊這個來改變你想在 ATT 内搜尋的物品篩選。";
		L.ITEM_FILTER_POPUP_TEXT = "你想搜尋哪個物品篩選？";

-- Instructional Text
	L.MINIMAP_MOUSEOVER_TEXT = "右鍵改變設置。\n左鍵打開主列表。\n"..CTRL_KEY_TEXT.."左鍵打開小列表。\n"..SHIFT_KEY_TEXT.."左鍵刷新收藏。";
	L.TOP_ROW_INSTRUCTIONS = "|cff3399ff按住並拖拽左鍵移動\n右鍵打開設置\n"..SHIFT_KEY_TEXT.."左鍵刷新收藏\n"..CTRL_KEY_TEXT.."左鍵展開/折叠列表\n"..SHIFT_KEY_TEXT.."右鍵單擊排序組/彈出列表|r";
	L.OTHER_ROW_INSTRUCTIONS = "|cff3399ff左鍵展開/折叠\n右鍵彈出小列表\n"..SHIFT_KEY_TEXT.."左鍵刷新收藏\n"..CTRL_KEY_TEXT.."左鍵展開/折叠列表\n"..SHIFT_KEY_TEXT.."右鍵單擊排序組/彈出列表\n"..ALT_KEY_TEXT.."右鍵設置路線點|r";
	L.TOP_ROW_INSTRUCTIONS_AH = "|cff3399ff按住並拖拽左鍵移動\n右鍵打開設置\n"..SHIFT_KEY_TEXT.."左鍵搜尋拍賣行|r";
	...
	L.SYM_ROW_INFORMATION = "右鍵單擊以查看來自其他位置的其它内容";
...
-- Settings.lua
	...
	-- General tab
		...
		L.MINIMAP_SLIDER_TOOLTIP = '使用此選項可自定義小地圖按鈕的大小。\n\n預設：36';
		L.EXTRA_THINGS_LABEL = "其他資源";
		L.MINIMAP_BUTTON_CHECKBOX = "顯示小地圖按鈕";
		L.MINIMAP_BUTTON_CHECKBOX_TOOLTIP = "如果要查看小地圖按鈕，請啟用此選項。使用此按鈕可以快速拜訪主列表，顯示總體收藏進度，並通過右鍵單擊拜訪設置菜單。\n\n有些人不喜歡混亂。或者，你可以通過在聊天框中鍵入'/att'來拜訪主列表。從那里，你可以右鍵單擊標題以進入設置菜單。";
		...
		L.KEYBINDINGS_TEXT = "可以在遊戲選項中設置 ATT 的按鍵綁定。";
	...
	-- Features tab
		...
		L.SKIP_CUTSCENES_CHECKBOX = "自動跳過场景動画";
		L.SKIP_CUTSCENES_CHECKBOX_TOOLTIP = "如果想讓 ATT 代表你自動跳過所有场景動画請啟用此選項。";
		L.AUTO_BOUNTY_CHECKBOX = "自動打開獎勵列表";
		L.AUTO_BOUNTY_CHECKBOX_TOOLTIP = "如果想查看具有傑出收藏獎勵的物品，請啟用此選項。如果設法抓住顯示在此列表中的物品之一，可以赚到一筆不錯的金幣。\n\n快捷命令：/attbounty";
		L.AUTO_MAIN_LIST_CHECKBOX = "自動打開主列表";
		L.AUTO_MAIN_LIST_CHECKBOX_TOOLTIP = "如果你想在登錄時自動打開主列表請啟用此選項。\n\n你也可以將此設置綁定到一個鍵上：\n\n按鍵設置 -> 插件 -> ALL THE THINGS -> 打開/關閉主列表\n\n快捷命令：/att";
		L.AUTO_MINI_LIST_CHECKBOX = "自動打開小列表";
		L.AUTO_MINI_LIST_CHECKBOX_TOOLTIP = "如果你想查看在當前區域内可以收藏的所有資訊請啟用此選項。當改變區域時列表將自動切換。有些人不喜歡這個功能，但是當你單刷的時候這個功能是非常有用的。\n\n你也可以將此設置綁定到一個按鍵上。\n\n按鍵設置 -> 插件 -> ALL THE THINGS -> 打開/關閉小列表\n\n快捷命令：/att mini";
		L.AUTO_PROF_LIST_CHECKBOX = "自動打開專業列表";
		L.AUTO_PROF_LIST_CHECKBOX_TOOLTIP = "如果你希望 ATT 在你打開專業技能時打開並刷新專業技能列表請啟用此選項。由於暴雪 API 限制，只有在打開專業技能介面時，插件才能與專業技能資料進行互動。當你換成其他專業時列表會自動切換。\n\n我們不建議禁用此選項，因為它可能會阻止配方的正確追蹤。\n\n你也可以將此設置綁定到一個按鍵上。（僅在打開專業技能時工作）\n\n按鍵設置 -> 插件 -> ALL THE THINGS -> 打開/關閉專業技能列表";
		L.AUTO_RAID_ASSISTANT_CHECKBOX = "自動打開團隊助手";
		L.AUTO_RAID_ASSISTANT_CHECKBOX_TOOLTIP = "如果你想看到一個名為'團隊助手'的替代組/隊伍/團隊設置管理器請啟用此選項。每當隊伍設置改變時列表會自動更新。\n\n你也可以將此設置綁定到一個按鍵上。\n\n按鍵設置 -> 插件 -> ALL THE THINGS -> 打開/關閉團隊助手\n\n快捷命令：/attra";
		L.AUTO_WQ_LIST_CHECKBOX = "自動打開世界任務列表";
		L.AUTO_WQ_LIST_CHECKBOX_TOOLTIP = "如果你想讓'世界任務'列表自動出現請啟用此選項。每當你切換區域時列表將自動更新。\n\n你也可以將此設置綁定到一個按鍵上。\n\n按鍵設置 -> 插件 -> ALL THE THINGS -> 打開/關閉世界任務列表\n\n快捷命令：/attwq";
	...
	-- Binding Localizations
		...
		L.TOGGLE_COMPLETEDTHINGS = "隱藏/顯示已完成組和項";
		L.TOGGLE_COMPLETEDGROUPS = "隱藏/顯示已完成組";
		L.TOGGLE_COLLECTEDTHINGS = "隱藏/顯示已收藏項";
...
if app.IsRetail then
	...
	-- Mists of Pandaria PvP Seasons
		...
		[-651] = "榮譽裝備骄矜賽季",									-- Honor Gear Prideful (S15)
	-- Shadowlands Header
	...
	-- Dragonflight
		...
		[-1102] = "怒西昂和萨贝里安",										-- Wrathion & Sabellian
...
for key,value in pairs({
	...
	-- General Page
		...
		ACCOUNT_MODE_TOOLTIP = "如果要追蹤所有角色的所有内容，而不考慮職業和種族篩選，請啟用此設置。\n\n不可獲得篩選仍然適用。";
		FACTION_MODE = "僅當前陣營";
		FACTION_MODE_TOOLTIP = "如果你想只看到你當前陣營的種族和職業的戰隊模式資料，請開啟此設置。";
		LOOT_MODE = "拾取模式";
	...
	-- General Content
		...
		SHOW_INCOMPLETE_THINGS_CHECKBOX_TOOLTIP = "如果想看到可以在遊戲中追蹤的物品、道具、NPC 等但不一定要被認為是'可收藏的'，請啟用此選項。\n\n如果你還沒有獲得博學者成就可以用這個來幫助你獲得它。\n\n注意：開啟此設置後，稀有刷新和事件也會出現在列表中。";
		SHOW_COMPLETED_GROUPS_CHECKBOX = "顯示完成的群組";
		SHOW_COMPLETED_GROUPS_CHECKBOX_TOOLTIP = "如果想在標題中看到已完成的組和完成百分比，請啟用此選項。如果一個組沒有與你職業相關的内容，這個設置也會讓這些組出現在列表中。\n\n我們建議你關閉此設置，因為它將節省小列表中的空間，並允許你快速查看區域中缺少的内容。";
		SHOW_COLLECTED_THINGS_CHECKBOX = "顯示已收藏事物";
		SHOW_COLLECTED_THINGS_CHECKBOX_TOOLTIP = "啟用此選項可以看到已經收藏事物。\n\n建議關閉此設置因為它可以節省小列表中的空間並允許快速查看在該區域遺漏的内容。";
		FILTER_THINGS_BY_LEVEL_CHECKBOX = "等級限制";
		FILTER_THINGS_BY_LEVEL_CHECKBOX_TOOLTIP = "如果只想查看當前級別角色可用的事物，請啟用此設置。\n\n注意：這對新戰隊特別有用。";
		SHOW_BOE_CHECKBOX = "裝備綁定/拾取綁定物品";
		FILTER_THINGS_BY_SKILL_LEVEL_CHECKBOX = "無技能等級限制";
		FILTER_THINGS_BY_SKILL_LEVEL_CHECKBOX_TOOLTIP = "如果您只想查看遊戲環境中可用的最高技能級別可用的内容，請禁用此設置。";
		SHOW_BOE_CHECKBOX_TOOLTIP = "如果要隱藏裝備綁定/拾取綁定物品，請啟用此設置。\n\n當你嘗試為角色完成經典舊世並且不想專門用於可以在小號或拍賣行上放置的物品時，此設置非常有用。\n\n即：不要因為毀滅之錘而擾亂你的思緒。";
		IGNORE_FILTERS_FOR_BOES_CHECKBOX = "忽略裝備綁定/拾取綁定的篩選";
		IGNORE_FILTERS_FOR_BOES_CHECKBOX_TOOLTIP = "如果要忽略裝備綁定/拾取綁定物品的裝備、武器、種族、等級或職業要求，請啟用此設置。\n\n如果你正試圖通過拍賣行掃描收藏你的物品，此模式可能對你有用。";
		SHOW_ALL_SEASONAL = "所有季節性事件";
		SHOW_ALL_SEASONAL_TOOLTIP = "啟用此設置可顯示所有季節性事件，而不是僅顯示當前活動的季節性事件。\n\n注意：季節性活動將提前7天自動顯示為活動狀態。";
		SHOW_PET_BATTLES_CHECKBOX_TOOLTIP = "如果您想在遊戲中顯示需要寵物對戰的内容，請啟用此設置。";
		SHOW_PVP_CHECKBOX_TOOLTIP = "如果你想隱藏任何'可能'需要在遊戲中進行 PvP 互動的内容，請啟用此設置。";
		SHOW_ALL_LEARNABLE_QUEST_REWARDS_CHECKBOX = "所有可學的任務獎勵";
		SHOW_ALL_LEARNABLE_QUEST_REWARDS_CHECKBOX_TOOLTIP = "禁用此選項可隱藏任務中列為“在個人拾取中不可用”的物品。\n\n這對於追蹤您的職業無法在世界掉落中使用的物品很有用，但仍會將任務標記為已完成。\n\n某些物品可能被錯誤標記：此設置將隱藏您可以獲得的物品！";
		...
		APPEARANCES_CHECKBOX_TOOLTIP = "啟用此選項可追蹤外觀獲得。\n\n注意: 禁用此選項也會禁用所有採集邏輯，你可以使用此切換來防止在執行重要組内容時出現延遲，請牢記，重新啟用後將需要進行計算。";
		...
		AZERITE_ESSENCES_CHECKBOX = "|T"..app.asset("Expansion_BFA")..":0|t 艾澤拉斯之心精華";
		...
		RUNEFORGELEGENDARIES_CHECKBOX_TOOLTIP = "啟用此選項以追蹤暗影國度的符文銘刻之力。";
		SOULBINDCONDUITS_CHECKBOX = "|T"..app.asset("Expansion_SL")..":0|t 導靈器";
		SOULBINDCONDUITS_CHECKBOX_TOOLTIP = "啟用此選項來追蹤暗影國度靈魂羈絆的導靈器。";

		CHARACTERUNLOCKS_CHECKBOX = "角色解鎖";
		CHARACTERUNLOCKS_CHECKBOX_TOOLTIP = "啟用此選項可追蹤角色解鎖。這些是基於角色的各種解鎖，無法明確歸類為其他類型（例如 妖術變體、變形術變體、獵人物種馴服解鎖、波可波克自定義等）。\n\n預設情况下按角色追蹤。";

		-- Account-Wide Checkboxes
		ACCOUNT_WIDE_ACHIEVEMENTS_TOOLTIP = "成就追蹤通常是在整個帳號通用内進行的，但有一些特定職業和種族的專属成就，你無法在你的主帳號上獲得。";
		ACCOUNT_WIDE_APPEARANCES_TOOLTIP = "幻化應該在整個帳號範圍内收集。某些物品並非每個職業都能學會，因此 ATT 將盡力只向您展示你當前角色可以收集的物品。";
		ACCOUNT_WIDE_AZERITE_ESSENCES_TOOLTIP = "艾澤拉斯精華在技術上不能在整個戰隊内收藏和使用，但如果你只關心收藏你的主角色那麼你可能更喜歡在整個戰隊上追蹤它們。";
		...
		ACCOUNT_WIDE_DEATHS_TOOLTIP = "死亡追蹤實際上只存在於巫妖王之怒懷舊服之前，當時沒有統計資料來了解這些資訊。成就實現後，此功能將直接從統計 API 獲得資料。您可以使用死亡追蹤器上的提示來查看";
		ACCOUNT_WIDE_EXPLORATION_TOOLTIP = "探索追蹤僅對每個角色都非常有用，但你真的想在所有50個角色上收藏它們嗎？";
		...
		ACCOUNT_WIDE_MUSIC_ROLLS_SELFIE_FILTERS_TOOLTIP = "在暴雪的資料庫中通常不會在帳號通用内追蹤“音樂卷軸和自拍篩選器”，但是我們可以做到這一點。\n\n注意：你只能使用自動點唱機玩具播放音樂或使用你在當前角色上收藏的自拍相機玩具自拍。";
		ACCOUNT_WIDE_QUESTS_TOOLTIP = "任務完成通常是每個角色的，但是如果任何一個角色完成了特定的任務，這個任務就會被認為是完成了。";
		ACCOUNT_WIDE_RECIPES_TOOLTIP = "在暴雪的資料庫中，圖紙通常不會被帳號通用追蹤，但我們可以這樣做。\n\n在一個角色上不可能收藏到所有的東西，所以有了這個，你就可以赋予你的小號和他們的專業以意義。";
	...
	-- General: Unobtainables Page
		...
		CUSTOM_FILTERS_GENERIC_TOOLTIP_FORMAT = "啟用此設置可強行顯示%s内容，即使該内容對當前角色不可用。";

	-- Interface Page
		TOOLTIP_LABEL = "鼠標提示";
		TOOLTIP_HELP_CHECKBOX = "顯示鼠標提示幫助";
		TOOLTIP_HELP_CHECKBOX_TOOLTIP = "如果你想在 ATT 視窗鼠標提示中看到幫助資訊，即顯示 ATT 視窗功能的各種鍵/點擊組合，請啟用此選項。\n如果你已經知道所有的鍵/點擊組合，你可能希望節省工具提示空間並禁用此選項。";
		ENABLE_TOOLTIP_INFORMATION_CHECKBOX = "啟用鼠標提示";
		ENABLE_TOOLTIP_INFORMATION_CHECKBOX_TOOLTIP = "如果希望在鼠標提示中查看 ATT 提供的資訊，請啟用此選項。這包括其他玩家發送的物品連接，在拍賣行、在地城助手、在你的背包裡、在世界、在 NPC 等等。\n\n如果你關閉了這個功能，就會嚴重降低你快速判斷是否需要擊殺首領或學習外觀的能力。\n\n我們建議你保持此設置。";
		DISPLAY_IN_COMBAT_CHECKBOX = "在戰鬥中";
		DISPLAY_IN_COMBAT_CHECKBOX_TOOLTIP = "如果要在戰鬥中呈現鼠標提示資訊，請啟用此選項。\n\n如果你正在同你的公會進行史詩/大秘境活動，你可能應該關閉這個設置以盡可能節省性能。\n\n當你在單刷時它可以很有用，可以立即知道你需要從首領那裡得到什麼。";
		TOOLTIP_MOD_LABEL = "修飾鍵";
		TOOLTIP_SHOW_LABEL = "顯示資訊";
		SHOW_COLLECTION_PROGRESS_CHECKBOX = "收藏進度";
		SHOW_COLLECTION_PROGRESS_CHECKBOX_TOOLTIP = "如果希望在鼠標提示的右上角看到收藏某個對象或完成某組對象的進度，請啟用此選項。\n\n我們建議你保持此設置處於打開狀態。";
		ICON_ONLY_CHECKBOX = "僅圖標";
		ICON_ONLY_CHECKBOX_TOOLTIP = "如果只想在右上角看到圖標而不是圖標和已收藏/未收藏的文本，請啟用此選項。\n\n有些人喜歡更小的鼠標提示…";
		KNOWN_BY_CHECKBOX = "已知";
		KNOWN_BY_CHECKBOX_TOOLTIP = "如果你想在鼠標提示中查看所有伺服器上已知此配方的完整角色列表，請啟用此選項。";
		COMPLETED_BY_CHECKBOX = "已完成";
		COMPLETED_BY_CHECKBOX_TOOLTIP = "如果你想在鼠標提示中查看所有伺服器上已完成任務的完整角色列表，請啟用此選項。";
		SHOW_CRAFTED_ITEMS_CHECKBOX = "顯示專業製作的物品";
		SHOW_CRAFTED_ITEMS_CHECKBOX_TOOLTIP = "如果您想在鼠標提示中看到任何角色可以使用某種材料製作的所有物品的列表，請啟用此選項。";
		SHOW_RECIPES_CHECKBOX = "顯示配方";
		SHOW_RECIPES_CHECKBOX_TOOLTIP = "如果您想在鼠標提示中看到任何角色可以用某種材料製作的所有配方列表，請啟用此選項。";
		...
		SHARED_APPEARANCES_CHECKBOX_TOOLTIP = "啟用該選項可以在鼠標提示中看到外觀相似的物品。\n\n注意：不符合裝備類型的物品會顯示在列表中。這是為了幫助你判斷收藏進度。\n\n如果你對此感到困惑，從 ATT v1.5.0 開始，你可以右鍵單擊物品，打開物品和它的共享外觀，進入它們自己的獨立小列表。";
		INCLUDE_ORIGINAL_CHECKBOX = "原始來源";
		INCLUDE_ORIGINAL_CHECKBOX_TOOLTIP = "如果你真的喜歡在鼠標提示中的共享外觀列表中看到原始來源資訊，請啟用此選項。";
		...
		SPEC_CHECKBOX = "專精";
		SPEC_CHECKBOX_TOOLTIP = "啟用該選項，可以在遊戲客戶端提供的物品鼠標提示中顯示物品的戰利品專精資訊。\n\n注意：無論該設置如何，這些圖標仍將出現在 ATT 小列表中。";
		SUMMARIZE_CHECKBOX = "總結事物";
		SUMMARIZE_CHECKBOX_TOOLTIP = "啟用該選項可在鼠標提示中總結事物。例如，如果一個事物可以變成另一個事物的商人，那麼在鼠標提示中顯示另一個事物，以提供其多種用途的可見性。如果一個事物作為許多其他事物的容器，這個選項將顯示該容器所包含的所有其他事物。\n\n我們建議你保持此設置開啟。";
		CONTAINS_SLIDER_TOOLTIP = '使用該功能可以自定義鼠標提示中顯示的摘要事項的數量。\n\n預設：25';
		SOURCE_LOCATIONS_CHECKBOX = "來源位置";
		SOURCE_LOCATIONS_CHECKBOX_TOOLTIP = "如果你想在鼠標提示中看到 ATT 資料庫中對象的完整來源位置路線，請啟用此選項。";
		LOCATIONS_SLIDER_TOOLTIP = '使用該功能可以自定義鼠標提示中顯示的來源位置數量。\n\n注意：這也會依據其他來源的多少來顯示“X”個數量，如果這個總數等於顯示的元素總數，那麼就會簡單地顯示最後一個來源。\n\n預設：5';
		COMPLETED_SOURCES_CHECKBOX = "對已完成";
		COMPLETED_SOURCES_CHECKBOX_TOOLTIP = "如果你想在鼠標提示中看到已完成的來源位置，請啟用此選項。\n\n举個例子，如果你在灰谷完成了任務“巴斯兰的頭髮”，當你鼠標悬停在埃凡纳·寂语身上時，他的鼠標提示就不會再顯示這個任務了。";
		...
		WITH_WRAPPING_CHECKBOX_TOOLTIP = "啟用此選項允許來源在鼠標提示中換行。\n這將確保鼠標提示不會超過必要的寬度，但不幸的是在許多情况下來源資訊會變得更加難以閱讀。";

		BEHAVIOR_LABEL = "列表行為";
		MAIN_LIST_SLIDER_LABEL = "主列表縮放";
		MAIN_LIST_SCALE_TOOLTIP = '使用此功能可以自定義主列表的縮放。\n\n預設：1';
		MINI_LIST_SLIDER_LABEL = "小列表縮放";
		MINI_LIST_SCALE_TOOLTIP = '使用此功能可以自定義所有小和小列表的縮放。\n\n預設：1';
		...
		SHOW_MODELS_CHECKBOX_TOOLTIP = "啟用此選項可在預覽中顯示模型而不是鼠標提示上的圖標。\n\n此選項可幫助你識別稀有生物或商人的模樣。因為這個原因你可能想保持這個開啟。";
		...
		NESTED_QUEST_CHAIN_CHECKBOX_TOOLTIP = "如果你想讓任務鏈要求（右鍵單擊任務）視窗將所需任務顯示為其後續任務的子組，即它們必須從内到外完成，請啟用此選項。\n\n這一點很有用，不會錯過個別任務，應該主要用於完成任務的考慮。\n\n否則任務鏈要求將以自上而下的方式顯示，最早的任務在最上面。";
		...
		PRECISION_SLIDER_TOOLTIP = '使用此選項可自定義百分比計算中所需的精度級別。\n\n預設：2';
	...
	-- Interface: Accessibility Page
		...
		MORE_COLORS_CHECKBOX_TOOLTIP = "如果你想看到使用更多的顏色來幫助区分列表中事物的附加條件，請啟用此選項（比如職業顏色，陣營顏色等。）";
		WINDOW_COLORS = "視窗顏色";
		--TODO: BACKGROUND = EMBLEM_BACKGROUND;
		BACKGROUND_TOOLTIP = "設置所有 ATT 視窗的背景顏色和透明度。";
		--TODO: BORDER = EMBLEM_BORDER;
		BORDER_TOOLTIP = "設置所有 ATT 視窗的邊框顏色和透明度。";
		RESET_TOOLTIP = "恢復預設設置。";
	...
	-- Features: Reporting Page
		...
		REPORT_NEARBY_CONTENT_FLASH_THE_TASKBAR_CHECKBOX = "闪烁任務栏";
		REPORT_NEARBY_CONTENT_FLASH_THE_TASKBAR_CHECKBOX_TOOLTIP = "如果你希望 ATT 在檢測到附近内容時闪烁任務栏，請啟用此選項。";
	...
	-- Profiles Page
		...
		PROFILE_INITIALIZE_TOOLTIP = "這將使您的 ATT 保存變數能夠支援和包含設定檔資料。您當前的設置和視窗資訊將被複製到 '"..DEFAULT.."' 設定檔中，該設定檔無法刪除，但可以修改並使用作為所有角色的初始設定檔。\n\n請务必將設定檔的任何異常行為或錯誤回報給 ATT Discord！";
		...
		PROFILE_SWITCH_TOOLTIP = "將選定的設定檔設置為當前設定檔\n\n一個設定檔也可以通過 "..SHIFT_KEY_TEXT.."點擊切換到它";
...
if app.IsRetail then
	...
	for key,value in pairs({
		...
		[38] = {1, "|CFFFF0000這僅適用於在《潘達利亞之謎》或通過黑市拍賣行完成傳奇披風任務鏈的玩家。|r", "決心罩氅，艾夏卡瑪斯"}, --TODO: 確認台版傳奇披風名字
...
if app.IsRetail then
	...
	for key,value in pairs({
		...
		["SL_SKIP"] = { icon = "|T"..app.asset("Expansion_SL")..":0|t", color = "ff76879c", text = "命运丝線", desc = "只有選擇跳過暗影國度故事線的角色才能收藏這個。" },
