...
TIER_TWELVE_HEROIC_GROUPS = {	-- Firelands [Tier 12] (Heroic)
	cl(WARRIOR, {
		...
		i(71599, {	-- Helmet of the Molten Giant
			["cost"] = { { "i", modItemId(71684,05), 1 }, },	-- Crown of the Fiery Protector
		}),
		i(71603, {	-- Pauldrons of the Molten Giant
			["cost"] = { { "i", modItemId(71687,05), 1 }, },	-- Shoulders of the Fiery Protector
		}),
		i(71601, {	-- Gauntlets of the Molten Giant
			["cost"] = {
				{ "i", 71069, 1 },	-- Gauntlets of the Molten Giant
				{ "i", modItemId(71683,05), 1 },	-- Gauntlets of the Fiery Protector
			},
		}),
		i(71600, {	-- Battleplate of the Molten Giant
			["cost"] = {
				{ "i", 71068, 1 },	-- Battleplate of the Molten Giant
				{ "i", modItemId(71686,05), 1 },	-- Chest of the Fiery Protector
			},
		}),
		i(71602, {	-- Legplates of the Molten Giant
			["cost"] = {
				{ "i", 71071, 1 },	-- Legplates of the Molten Giant
				{ "i", modItemId(71685,05), 1 },	-- Leggings of the Fiery Protector
			},
		}),
	...
	cl(PALADIN, {
		...
		i(71514, {	-- Immolation Helmet
			["cost"] = { { "i", modItemId(71677,05), 1 }, },	-- Crown of the Fiery Conqueror
		}),
		i(71516, {	-- Immolation Pauldrons
			["cost"] = { { "i", modItemId(71680,05), 1 }, },	-- Shoulders of the Fiery Conqueror
		}),
		i(71513, {	-- Immolation Gauntlets
			["cost"] = {
				{ "i", 71064, 1 },	-- Immolation Gauntlets
				{ "i", modItemId(71676,05), 1 },	-- Gauntlets of the Fiery Conqueror
			},
		}),
		i(71512, {	-- Immolation Battleplate
			["cost"] = {
				{ "i", 71063, 1 },	-- Immolation Battleplate
				{ "i", modItemId(71679,05), 1 },	-- Chest of the Fiery Conqueror
			},
		}),
		i(71515, {	-- Immolation Legplates
			["cost"] = {
				{ "i", 71066, 1 },	-- Immolation Legplates
				{ "i", modItemId(71678,05), 1 },	-- Leggings of the Fiery Conqueror
			},
		}),
	...
	cl(DEATHKNIGHT, {
		...
		i(71478, {	-- Elementium Deathplate Helmet
			["cost"] = { { "i", modItemId(71670,05), 1 }, },	-- Crown of the Fiery Vanquisher
		}),
		i(71480, {	-- Elementium Deathplate Pauldrons
			["cost"] = { { "i", modItemId(71673,05), 1 }, },	-- Shoulders of the Fiery Vanquisher
		}),
		i(71477, {	-- Elementium Deathplate Gauntlets
			["cost"] = {
				{ "i", 71059, 1 },	-- Elementium Deathplate Gauntlets
				{ "i", modItemId(71669,05), 1 },	-- Gauntlets of the Fiery Vanquisher
			},
		}),
		i(71476, {	-- Elementium Deathplate Breastplate
			["cost"] = {
				{ "i", 71058, 1 },	-- Elementium Deathplate Breastplate
				{ "i", modItemId(71672,05), 1 },	-- Chest of the Fiery Vanquisher
			},
		}),
		i(71479, {	-- Elementium Deathplate Greaves
			["cost"] = {
				{ "i", 71061, 1 },	-- Elementium Deathplate Greaves
				{ "i", modItemId(71671,05), 1 },	-- Leggings of the Fiery Vanquisher
			},
		}),
...
TIER_TWELVE_GROUPS = applyclassicphase(CATA_PHASE_FOUR,
