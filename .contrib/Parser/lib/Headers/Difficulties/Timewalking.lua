TIMEWALKING_HEADER = createHeader({
	...
	description = {
		...
		cn = "时光漫游难度为物品创建新的 sourceID，尽管它们的名称、外观和在收藏选项卡中的显示完全相同。\n\n向暴雪开发者提出请求：请清理 sourceID 数据库，既然时光漫游/泰坦造物物品的外观和名称完全相同，就请使用相同的 sourceID。这不仅会让数据库变得更加干净，也会让完美主义者们对更多的时光漫游内容感到兴奋而不是恐惧。\n\n - Crieve，非常苦逼的战网完美主义者，本来有99%的奥杜尔完成度，现在只有64%了，就因为暴雪团队复制了 sourceID，而不是重复使用现有的。",
