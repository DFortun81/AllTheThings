...
root(ROOTS.Unsorted, {
	expansion(EXPANSION.DF, {
		expansion(EXPANSION.DF, 2.6, bubbleDownSelf({ ["timeline"] = { ADDED_10_2_6 } }, {
			...
			i(217340),	-- Voyaging Wilderling's Harness
			i(217353),	-- Draconic Gladiator's Axe
			i(217354),	-- Draconic Gladiator's Dagger
			i(217355),	-- Draconic Gladiator's Sickle
			i(217356),	-- Draconic Gladiator's Warglaive
			i(217357),	-- Draconic Gladiator's Scythe
			i(217358),	-- Draconic Gladiator's Staff
			i(217359),	-- Draconic Gladiator's Greatstaff
			i(217360),	-- Draconic Gladiator's Axestaff
			i(217361),	-- Draconic Gladiator's Rifle
			i(217362),	-- Draconic Gladiator's Scepter
			i(217363),	-- Draconic Gladiator's Censer
			i(217364),	-- Draconic Gladiator's Shield
			i(217365),	-- Draconic Gladiator's Bulwark
			i(217366),	-- Draconic Gladiator's Claws
			i(217367),	-- Draconic Gladiator's Bow
			i(217368),	-- Draconic Gladiator's Greatsword
