...
root(ROOTS.NeverImplemented, filter(TOYS, {
	...
	expansion(EXPANSION.CATA, {
		-- 4.3.0
		expansion(EXPANSION.CATA, 3.0, sharedDataSelf({ ["timeline"] = { CREATED_4_3_0 } }, {
	...
	expansion(EXPANSION.MOP, {
		-- 5.0.4
		expansion(EXPANSION.MOP, 0.1, sharedDataSelf({ ["timeline"] = { CREATED_5_0_4 } }, {
			i(88587),	-- Iron Belly Spirits (TOY!)
		})),
	}),
	expansion(EXPANSION.WOD, {
		-- 6.0.2
		expansion(EXPANSION.WOD, 0.2, sharedDataSelf({ ["timeline"] = { CREATED_6_0_2 } }, {
		...
		-- 6.X.X
		n(P6xx, sharedDataSelf({ ["timeline"] = { CREATED_6_0_2 } }, {
	...
	expansion(EXPANSION.LEGION, {
		-- 7.0.3
		expansion(EXPANSION.LEGION, 0.3, sharedDataSelf({ ["timeline"] = { CREATED_7_0_3 } }, {
		...
		-- 7.1.0
		expansion(EXPANSION.LEGION, 1.0, sharedDataSelf({ ["timeline"] = { CREATED_7_1_0 } }, {
			i(143545),	-- Fel Focusing Crystal (TOY!)
		})),

		-- 7.2.5
		expansion(EXPANSION.LEGION, 2.5, sharedDataSelf({ ["timeline"] = { CREATED_7_2_5 } }, {
	...
	expansion(EXPANSION.BFA, {
		-- 8.0.1
		expansion(EXPANSION.BFA, 0.1, sharedDataSelf({ ["timeline"] = { CREATED_8_0_1 } }, {
		...
		-- 8.1.0
		expansion(EXPANSION.BFA, 1.0, sharedDataSelf({ ["timeline"] = { CREATED_8_2_0 } }, {
			i(166851),	-- Kojo's Master Matching Set (TOY!)
		})),

		-- 8.2.0
		expansion(EXPANSION.BFA, 2.0, sharedDataSelf({ ["timeline"] = { CREATED_8_2_0 } }, {
	...
	expansion(EXPANSION.SL, {
		-- 9.0.1
		expansion(EXPANSION.SL, 0.1, sharedDataSelf({ ["timeline"] = { CREATED_9_0_1 } }, {
		...
		-- 9.0.2
		expansion(EXPANSION.SL, 0.2, sharedDataSelf({ ["timeline"] = { CREATED_9_0_2 } }, {
			i(183810);	-- Shadowlands Mini: Grandmaster Vole (TOY!)
		})),

		-- 9.1.5
		expansion(EXPANSION.SL, 1.5, sharedDataSelf({ ["timeline"] = { CREATED_9_1_5 } }, {
	...
	expansion(EXPANSION.DF, {
		...
		-- 10.1.0
		expansion(EXPANSION.DF, 1.0, sharedDataSelf({ ["timeline"] = { CREATED_10_1_0 } }, {
			i(205034),	-- Enormous Ball of Yarn (TOY!)
			i(205027),	-- Explorer's Banner (TOY!)
		})),

		-- 10.1.7
		expansion(EXPANSION.DF, 1.7, sharedDataSelf({ ["timeline"] = { CREATED_10_1_7 } }, {
