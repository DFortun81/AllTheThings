...
root(ROOTS.NeverImplemented, bubbleDown({["u"] = NEVER_IMPLEMENTED}, {
	filter(BATTLE_PETS, {
		...
		tier(DF_TIER, {
			tier(DF_TIER, 0.0, {
				i(193363),	-- Auburntusk Calf (PET!)
				i(191930),	-- Blue Phoenix Hatchling (PET!)
				i(193854),	-- Blue Vorquin Foal (PET!)
				i(193835),	-- Brightfeather (PET!)
				i(193374),	-- Crimson Phoenix Hatchling (PET!)
				i(193853),	-- Emerald Frillfish (PET!)
				i(193614),	-- Groundshaker (PET!)
				i(193373),	-- Phoenix Wishwing (PET!)
				i(193380),	-- Pink Salamanther (PET!)
				i(193851),	-- Purple Frillfish (PET!)
				i(193908),	-- Sapphire Crystalspine (PET!)
				i(193235),	-- Scarlet Ottuk Pup (PET!)
				i(193364),	-- Time-Lost Baby Mammoth (PET!)
				i(193587),	-- Time-Lost Duck (PET!)
				i(191915),	-- Time-Lost Feral Rabbit (PET!)
