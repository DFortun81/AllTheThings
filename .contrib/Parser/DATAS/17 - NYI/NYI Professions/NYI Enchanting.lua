	...
	n(PROFESSIONS, {
		prof(ENCHANTING, {
			...
			filter(RECIPES, {
				...
				expansion(TBC_TIER, {
					-- 2.0.1
					expansion(TBC_TIER, 0.1, bubbleDownSelf({ ["timeline"] = { "created 2.0.1" } }, {
						-- With SpellID attached
				...
				expansion(WOTLK_TIER, {
					...
					-- 3.2.0
					expansion(WOTLK_TIER, 2.0, bubbleDownSelf({ ["timeline"] = { "created 3.2.0" } }, {
						i(37335),	-- Formula: Enchant Cloak - Superior Agility
					})),


					-- 3.2.2
					expansion(WOTLK_TIER, 2.2, bubbleDownSelf({ ["timeline"] = { "created 3.2.2" } }, {
						-- Without SpellID attached
						i(37348),	-- Formula: Enchant Cloak - Haste
					})),

					-- 3.3.3
					expansion(WOTLK_TIER, 3.3, bubbleDownSelf({ ["timeline"] = { "created 3.3.3" } }, {
						-- Without SpellID attached
