		...
		prof(ENCHANTING, {
			...
			filter(RECIPES, {
				...
				expansion(EXPANSION.TBC, {
					-- 2.0.1
					expansion(EXPANSION.TBC, 0.1, bubbleDownSelf({ ["timeline"] = { "created 2.0.1" } }, {
						-- With SpellID attached
				...
				expansion(EXPANSION.WRATH, {
					...
					-- 3.2.0
					expansion(EXPANSION.WRATH, 2.0, bubbleDownSelf({ ["timeline"] = { "created 3.2.0" } }, {
						i(37335),	-- Formula: Enchant Cloak - Superior Agility
					})),


					-- 3.2.2
					expansion(EXPANSION.WRATH, 2.2, bubbleDownSelf({ ["timeline"] = { "created 3.2.2" } }, {
						-- Without SpellID attached
						i(37348),	-- Formula: Enchant Cloak - Haste
					})),

					-- 3.3.3
					expansion(EXPANSION.WRATH, 3.3, bubbleDownSelf({ ["timeline"] = { "created 3.3.3" } }, {
						-- Without SpellID attached
