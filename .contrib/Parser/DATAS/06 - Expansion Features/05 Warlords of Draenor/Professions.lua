...
root(ROOTS.ExpansionFeatures, expansion(EXPANSION.WOD, bubbleDown({ ["timeline"] = { "added 6.0.2" } }, {
	n(PROFESSIONS, {
...
root(ROOTS.HiddenQuestTriggers, expansion(EXPANSION.WOD, bubbleDown({ ["timeline"] = { "added 6.0.2" } }, {
	n(PROFESSIONS, {
		prof(ARCHAEOLOGY, {
