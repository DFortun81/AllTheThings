...
root("ExpansionFeatures", tier(DF_TIER, bubbleDown({ ["timeline"] = TIMELINE_DF_REL }, {
	n(MARUUK_CENTAUR, {
		...
		n(GRAND_HUNTS, {	-- OHNAHRAN_PLAINS // Otherwise minilist doesnt work correctly
			["maps"] = {
				OHNAHRAN_PLAINS,	
			},
			["g"] = {
		...
		n(GRAND_HUNTS, {	-- THALDRASZUS // Otherwise minilist doesnt work correctly
			["maps"] = {
				THALDRASZUS,	
			},
			["g"] = {
		...
		n(GRAND_HUNTS, {	-- THE_AZURE_SPAN // Otherwise minilist doesnt work correctly
			["maps"] = {
				THE_AZURE_SPAN,	
			},	
			["g"] = {
		...
		n(GRAND_HUNTS, {	-- THE_WAKING_SHORES // Otherwise minilist doesnt work correctly
			["maps"] = {
				THE_WAKING_SHORES,	
			},	
			["g"] = {
