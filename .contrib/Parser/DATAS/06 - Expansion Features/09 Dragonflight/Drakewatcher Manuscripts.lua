...
root(ROOTS.ExpansionFeatures, expansion(EXPANSION.DF, bubbleDown({ ["timeline"] = { ADDED_10_0_2_LAUNCH } }, {
	n(DRAKEWATCHER_MANUSCRIPTS, {
			...
			header(HEADERS.Item, 194521, {	-- Cliffside Wylderdrake
				...
				ach(16726, {	-- Cliffside Wylderdrake Back and Tail
					...
					crit(56476, {	-- Spiked Legs
						["provider"] = { "i", 197004 },	-- Cliffside Wylderdrake: Spiked Legs (DM!)
					}),
				}),
				ach(16727, {	-- Cliffside Wylderdrake Head Features
					...
					crit(56533, {	-- Four Horned Chin
						["provider"] = { "i", 196974 },	-- Cliffside Wylderdrake: Four-Horned Chin (DM!)
					}),
					crit(56534, {	-- Head Fin
				...
				ach(16723, {	-- Cliffside Wylderdrake Scales and Patterns
					...
					crit(56442, {	-- Eclipse Scale Type
						["provider"] = { "i", 197015 },	-- Cliffside Wylderdrake: Dark Skin Variation (DM!)
					}),
			...
			header(HEADERS.Item, 194705, {	-- Highland Drake
				...
				ach(16712, {	-- Highland Drake Head Features
					...
					crit(56417, {	-- Finned Neck
						["provider"] = { "i", 197155 },	-- Highland Drake: Finned Neck (DM!)
					}),
				}),
			...
			header(HEADERS.Item, 194034, {	-- Renewed Proto-Drake
				...
				ach(16697, {	-- Renewed Proto-Drake Head Features
					crit(56274, {	-- Curved Spiked Brow
						["provider"] = { "i", 197358 },	-- Renewed Proto-Drake: Curved Spiked Brow (DM!)
					}),
					...
					crit(56286, {	-- Thin Spined Jaw
						["provider"] = { "i", 197387 },	-- Renewed Proto-Drake: Thin Spined Jaw (DM!)
					}),
				...
				ach(16700, {	-- Renewed Proto-Drake Horns and Hair
					...
					crit(56733, {	-- Brown Hair
						["provider"] = { "i", 197369 },	-- Renewed Proto-Drake: Brown Hair (DM!)
					}),
					crit(56734, {	-- Red Hair
			...
			header(HEADERS.Item, 194549, {	-- Windborne Velocidrake
				...
				ach(16706, {	-- Windborne Velocidrake Back and Tail
					...
					crit(56345, {	-- Feathered Back
						["provider"] = { "i", 197587 },	-- Windborne Velocidrake: Feathered Back (DM!)
					}),
				...
				ach(16705, {	-- Windborne Velocidrake Head Features
					...
					crit(56327, {	-- Small Head Fin
						["provider"] = { "i", 197590 },	-- Windborne Velocidrake: Small Head Fin (DM!)
					}),
					crit(56328, {	-- Hairy Head
						["provider"] = { "i", 197591 },	-- Windborne Velocidrake: Hairy Head (DM!)
					}),
					...
					crit(56339, {	-- Plated Neck
						["provider"] = { "i", 197628 },	-- Windborne Velocidrake: Plated Neck (DM!)
					}),
					crit(56341, {	-- Feathered Neck
						["provider"] = { "i", 197630 },	-- Windborne Velocidrake: Feathered Neck (DM!)
					}),
				}),
				ach(16704, {	-- Windborne Velocidrake Horns and Fur
					...
					crit(56314, {	-- Ox Horns
						["provider"] = { "i", 197604 },	-- Windborne Velocidrake: Ox Horns (DM!)
					}),
					...
					crit(56320, {	-- White Horns
						["provider"] = { "i", 197609 },	-- Windborne Velocidrake: White Horns (DM!)
					}),
				...
				ach(16701, {	-- Windborne Velocidrake Scales and Patterns
					...
					crit(56303, {	-- Shrieker Pattern
						["provider"] = { "i", 197636 },	-- Windborne Velocidrake: Shrieker Pattern (DM!)
					}),
				}),
			}),
		})),
		...
		header(HEADERS.Item, 194521, {	-- Cliffside Wylderdrake
			...
			i(196965, {["timeline"] = {ADDED_10_1_0}}),	-- Cliffside Wylderdrake: Bronze and Teal Armor (DM!)
			i(197000, {["timeline"] = {ADDED_10_0_7}}),	-- Cliffside Wylderdrake: Coiled Horns (DM!)
			i(196981),	-- Cliffside Wylderdrake: Conical Head (DM!)
			i(196979),	-- Cliffside Wylderdrake: Curled Head Horns (DM!)
			i(197015, {["timeline"] = {ADDED_10_0_7}}),	-- Cliffside Wylderdrake: Dark Skin Variation (DM!)
			applyevent(EVENTS.DAY_OF_THE_DEAD, i(208859, {["timeline"] = {ADDED_10_1_7}})),	-- Cliffside Wylderdrake: Day of the Dead Armor (DM!)
			...
			i(196974, {["timeline"] = {ADDED_10_0_7}}),	-- Cliffside Wylderdrake: Four-Horned Chin (DM!)
			...
			i(196990, {["timeline"] = {ADDED_10_1_0}}),	-- Cliffside Wylderdrake: Helm (DM!)
			...
			applyevent(EVENTS.MIDSUMMER_FIRE_FESTIVAL, i(224163, {["timeline"] = {ADDED_10_2_7}})),	-- Cliffside Wylderdrake: Midsummer Fire Festival Armor (DM!)
			i(197008),	-- Cliffside Wylderdrake: Narrow Stripes Pattern (DM!)
			i(196972),	-- Cliffside Wylderdrake: Plated Brow (DM!)
			i(197006, {["timeline"] = {ADDED_10_0_7}}),	-- Cliffside Wylderdrake: Plated Nose (DM!)
			...
			i(196978, {["timeline"] = {ADDED_10_1_0}}),	-- Cliffside Wylderdrake: Small Head Spikes (DM!)
			...
			i(197021, {["timeline"] = {ADDED_10_1_0}}),	-- Cliffside Wylderdrake: Spiked Club Tail (DM!)
			i(196995, {["timeline"] = {ADDED_10_0_7}}),	-- Cliffside Wylderdrake: Spiked Horns (DM!)
			i(197004, {["timeline"] = {ADDED_10_0_7}}),	-- Cliffside Wylderdrake: Spiked Legs (DM!)
			i(196977),	-- Cliffside Wylderdrake: Split Head Horns (DM!)
			i(196997, {["timeline"] = {ADDED_10_1_0}}),	-- Cliffside Wylderdrake: Split Horns (DM!)
			...
			i(208102, {["timeline"] = {ADDED_10_1_5}}),	-- Cliffside Wylderdrake: Visage of the Infinite (DM!)
		...
		header(HEADERS.Item, 194705, {	-- Highland Drake
			...
			i(197156, {["timeline"] = {ADDED_10_1_0}}),	-- Highland Drake: Bronze and Green Armor (DM!)
			...
			i(197155, {["timeline"] = {ADDED_10_0_7}}),	-- Highland Drake: Finned Neck (DM!)
			...
			i(197119, {["timeline"] = {ADDED_10_2_0}}),	-- Highland Drake: Helm (DM!)
			i(197126),	-- Highland Drake: Hooked Horns (DM!)
			i(197152),	-- Highland Drake: Hooked Tail (DM!)
			i(197102, {["timeline"] = {ADDED_10_0_7}}),	-- Highland Drake: Horned Chin (DM!)
			...
			i(197120, {["timeline"] = {ADDED_10_1_0}}),	-- Highland Drake: Ornate Helm (DM!)
			applyevent(EVENTS.PIRATES_DAY, i(208858, {["timeline"] = {ADDED_10_1_7}})),	-- Highland Drake: Pirates' Day Armor (DM!)
			...
			i(197129, {["timeline"] = {ADDED_10_0_7}}),	-- Highland Drake: Sleek Horns (DM!)
			...
			i(197109, {["timeline"] = {ADDED_10_1_0}}),	-- Highland Drake: Spiked Head (DM!)
			i(197134, {["timeline"] = {ADDED_10_1_0}}),	-- Highland Drake: Spiked Legs (DM!)
			...
			i(197104, {["timeline"] = {ADDED_10_1_0}}),	-- Highland Drake: Tapered Chin (DM!)
			i(197136, {["timeline"] = {ADDED_10_0_7}}),	-- Highland Drake: Tapered Nose (DM!)
			...
			i(208103, {["timeline"] = {ADDED_10_1_5}}),	-- Highland Drake: Visage of the Infinite (DM!)
			applyevent(EVENTS.FEAST_OF_WINTER_VEIL, i(210432, {["timeline"] = {ADDED_10_2_0}})),	-- Highland Drake: Winter Veil Armor (DM!)
		}),
		header(HEADERS.Item, 194034, {	-- Renewed Proto-Drake
			i(202278, {["timeline"] = {ADDED_10_0_7}}),	-- Renewed Proto-Drake: Antlers (DM!)
			i(197357),	-- Renewed Proto-Drake: Armor (DM!)
			i(197401),	-- Renewed Proto-Drake: Beaked Snout (DM!)
			i(197348, {["timeline"] = {ADDED_10_1_0}}),	-- Renewed Proto-Drake: Black and Red Armor (DM!)
			...
			applyevent(EVENTS.BREWFEST, i(208742, {["timeline"] = {ADDED_10_1_7}})),	-- Renewed Proto-Drake: Brewfest Armor (DM!)
			i(197353, {["timeline"] = {ADDED_10_1_0}}),	-- Renewed Proto-Drake: Bronze and Pink Armor (DM!)
			i(197391),	-- Renewed Proto-Drake: Bronze Scales (DM!)
			i(197369, {["timeline"] = {ADDED_10_0_7}}),	-- Renewed Proto-Drake: Brown Hair (DM!)
			i(202277, {["timeline"] = {ADDED_10_1_0}}),	-- Renewed Proto-Drake: Bruiser Horns (DM!)
			...
			i(197358, {["timeline"] = {ADDED_10_0_7}}),	-- Renewed Proto-Drake: Curved Spiked Brow (DM!)
			i(197366),	-- Renewed Proto-Drake: Dual Horned Crest (DM!)
			i(197376),	-- Renewed Proto-Drake: Ears (DM!)
			i(210537, {["timeline"] = {ADDED_10_2_0, REMOVED_10_2_7}}),	-- Renewed Proto-Drake: Embodiment of Shadowflame (DM!)
			i(210536, {["timeline"] = {ADDED_10_2_0}}),	-- Renewed Proto-Drake: Embodiment of the Blazing (DM!)
			...
			i(197371, {["timeline"] = {ADDED_10_2_0}}),	-- Renewed Proto-Drake: Green Hair (DM!)
			...
			i(197373, {["timeline"] = {ADDED_10_1_0}}),	-- Renewed Proto-Drake: Helm (DM!)
			i(197385),	-- Renewed Proto-Drake: Horned Jaw (DM!)
			i(197379),	-- Renewed Proto-Drake: Impaler Horns (DM!)
			applyevent(EVENTS.LOVE_IS_IN_THE_AIR, i(211812, {["timeline"] = {ADDED_10_2_5}})),	-- Renewed Proto-Drake: Love Armor (DM!)
			i(202279, {["timeline"] = {ADDED_10_0_7}}),	-- Renewed Proto-Drake: Malevolent Horns (DM!)
			i(197363),	-- Renewed Proto-Drake: Maned Crest (DM!)
			i(197405),	-- Renewed Proto-Drake: Maned Tail (DM!)
			i(202274, {["timeline"] = {ADDED_10_0_7}}),	-- Renewed Proto-Drake: Plated Brow (DM!)
			i(202275, {["timeline"] = {ADDED_10_1_0}}),	-- Renewed Proto-Drake: Plated Jaw (DM!)
			i(197394),	-- Renewed Proto-Drake: Predator Pattern (DM!)
			i(202280, {["timeline"] = {ADDED_10_1_0}}),	-- Renewed Proto-Drake: Pronged Tail (DM!)
			...
			i(197364, {["timeline"] = {ADDED_10_1_0}}),	-- Renewed Proto-Drake: Short Spiked Crest (DM!)
			...
			i(202273, {["timeline"] = {ADDED_10_0_7}}),	-- Renewed Proto-Drake: Stubby Snout (DM!)
			...
			i(208104, {["timeline"] = {ADDED_10_1_5}}),	-- Renewed Proto-Drake: Visage of the Infinite (DM!)
		...
		header(HEADERS.Item, 194549, {	-- Windborne Velocidrake
			...
			i(197577, {["timeline"] = {ADDED_10_1_0}}),	-- Windborne Velocidrake: Bronze and Green Armor (DM!)
			...
			i(197583, {["timeline"] = {ADDED_10_0_7}}),	-- Windborne Velocidrake: Exposed Finned Back (DM!)
			i(197626, {["timeline"] = {ADDED_10_0_7}}),	-- Windborne Velocidrake: Exposed Finned Neck (DM!)
			i(197587, {["timeline"] = {ADDED_10_0_7}}),	-- Windborne Velocidrake: Feathered Back (DM!)
			i(197630, {["timeline"] = {ADDED_10_0_7}}),	-- Windborne Velocidrake: Feathered Neck (DM!)
			...
			i(197591, {["timeline"] = {ADDED_10_0_7}}),	-- Windborne Velocidrake: Hairy Head (DM!)
			applyevent(EVENTS.HALLOWS_END, i(208680, {["timeline"] = {ADDED_10_1_7}})),	-- Windborne Velocidrake: Hallow's End Armor (DM!)
			i(197617, {["timeline"] = {ADDED_10_0_7}}),	-- Windborne Velocidrake: Heavy Scales (DM!)
			i(197600, {["timeline"] = {ADDED_10_1_0}}),	-- Windborne Velocidrake: Helm (DM!)
			...
			i(197604, {["timeline"] = {ADDED_10_0_7}}),	-- Windborne Velocidrake: Ox Horns (DM!)
			i(197628, {["timeline"] = {ADDED_10_0_7}}),	-- Windborne Velocidrake: Plated Neck (DM!)
			...
			i(197636, {["timeline"] = {ADDED_10_0_7}}),	-- Windborne Velocidrake: Shrieker Pattern (DM!)
			i(197578),	-- Windborne Velocidrake: Silver and Blue Armor (DM!)
			i(197581),	-- Windborne Velocidrake: Silver and Purple Armor (DM!)
			i(197594, {["timeline"] = {ADDED_10_0_7}}),	-- Windborne Velocidrake: Small Ears (DM!)
			i(197590, {["timeline"] = {ADDED_10_0_7}}),	-- Windborne Velocidrake: Small Head Fin (DM!)
			i(197586),	-- Windborne Velocidrake: Spiked Back (DM!)
			i(197629, {["timeline"] = {ADDED_10_0_7}}),	-- Windborne Velocidrake: Spiked Neck (DM!)
			...
			i(197615, {["timeline"] = {ADDED_10_1_5}}),	-- Windborne Velocidrake: Teal Scales (DM!)
			i(208105, {["timeline"] = {ADDED_10_1_5}}),	-- Windborne Velocidrake: Visage of the Infinite (DM!)
		...
		header(HEADERS.Item, 204361, bubbleDownSelf({ ["timeline"] = { ADDED_10_1_0 } }, {	-- Winding Slitherdrake
			...
			i(203322, {["timeline"] = {ADDED_10_1_5}}),	-- Winding Slitherdrake: Blonde Hair (DM!)
			...
			i(203340, {["timeline"] = {ADDED_10_2_0}}),	-- Winding Slitherdrake: Cluster Jaw Horns (DM!)
			...
			i(203349, {["timeline"] = {ADDED_10_1_5}}),	-- Winding Slitherdrake: Curved Nose Horn (DM!)
			i(203320),	-- Winding Slitherdrake: Ears (DM!)
			pvp(i(205865, {["timeline"] = {ADDED_10_1_0, REMOVED_10_2_0 }})),	-- Winding Slitherdrake: Embodiment of the Obsidian Gladiator (DM!)
			pvp(i(210064, {["timeline"] = {ADDED_10_2_0, REMOVED_10_2_6_SEASON_FOUR}})),	-- Winding Slitherdrake: Embodiment of the Verdant Gladiator (DM!)
			...
			i(203343, {["timeline"] = {ADDED_10_2_0}}),	-- Winding Slitherdrake: Hairy Jaw (DM!)
			i(203362),	-- Winding Slitherdrake: Hairy Tail (DM!)
			i(203365),	-- Winding Slitherdrake: Hairy Throat (DM!)
			i(203329, {["timeline"] = {ADDED_10_2_0}}),	-- Winding Slitherdrake: Heavy Horns (DM!)
			i(205341),	-- Winding Slitherdrake: Heavy Scales (DM!)
			i(203326),	-- Winding Slitherdrake: Helm (DM!)
			i(203306, {["timeline"] = {ADDED_10_1_7}}),	-- Winding Slitherdrake: Horned Brow (DM!)
			i(203339),	-- Winding Slitherdrake: Impaler Horns (DM!)
			i(203316),	-- Winding Slitherdrake: Large Finned Crest (DM!)
			i(203360, {["timeline"] = {ADDED_10_2_0}}),	-- Winding Slitherdrake: Large Finned Tail (DM!)
			...
			applyevent(EVENTS.LUNAR_FESTIVAL, i(211868, {["timeline"] = {ADDED_10_2_5}})),	-- Winding Slitherdrake: Lunar Festival Armor (DM!)
			i(203336, {["timeline"] = {ADDED_10_1_7}}),	-- Winding Slitherdrake: Paired Horns (DM!)
			...
			i(203359, {["timeline"] = {ADDED_10_1_7}}),	-- Winding Slitherdrake: Shark Finned Tail (DM!)
			i(203333, {["timeline"] = {ADDED_10_2_0}}),	-- Winding Slitherdrake: Short Horns (DM!)
			i(203344, {["timeline"] = {ADDED_10_2_0}}),	-- Winding Slitherdrake: Single Jaw Horn (DM!)
			...
			i(203315, {["timeline"] = {ADDED_10_2_0}}),	-- Winding Slitherdrake: Small Spiked Crest (DM!)
			i(203313),	-- Winding Slitherdrake: Spiked Chin (DM!)
			i(203332, {["timeline"] = {ADDED_10_2_0}}),	-- Winding Slitherdrake: Spiked Horns (DM!)
			i(203357, {["timeline"] = {ADDED_10_2_0}}),	-- Winding Slitherdrake: Spiked Tail (DM!)
			...
			i(203337, {["timeline"] = {ADDED_10_2_0}}),	-- Winding Slitherdrake: Thorn Horns (DM!)
			i(203342),	-- Winding Slitherdrake: Triple Jaw Horns (DM!)
			i(208106, {["timeline"] = {ADDED_10_1_5}}),	-- Winding Slitherdrake: Visage of the Infinite (DM!)
			i(213561, {["timeline"] = {ADDED_10_2_7}}),	-- Winding Slitherdrake: Void Scales (DM!)
