			...
			["g"] = {
				n(-901, sharedData({	-- Covenant Callings
					...
					q(60424, {	-- A Call to Ardenweald
						...
						["coord"] = { 55.4, 42.3, ELYSIAN_HOLD_ARCHONS_RISE },
						["g"] = {
					...
					q(60430, {	-- A Call to Maldraxxus
						["provider"] = { "n", 160037 },	-- Polemarch Adrestes
						["coord"] = { 55.5, 42.2, ELYSIAN_HOLD_ARCHONS_RISE },
						["g"] = {
					...
					q(60391, {	-- Aiding Ardenweald
						...
						["coord"] = { 41.0, 41.2, ELYSIAN_HOLD_ARCHONS_RISE },
						["g"] = {
							i(181475),	-- Bounty of the Grove Wardens
						},
					}),
					q(60392, {	-- Aiding Bastion
						["provider"] = { "n", 160387 },	-- Hermestes
						["coord"] = { 41.0, 41.1, ELYSIAN_HOLD_ARCHONS_RISE },
						["g"] = {
							i(181372),	-- Tribute of the Ascended
						},
					}),
					q(60395, {	-- Aiding Maldraxxus
						["provider"] = { "n", 160387 },	-- Hermestes
						["coord"] = { 40.9, 41.0, ELYSIAN_HOLD_ARCHONS_RISE },
						["g"] = {
							i(181732),	-- Tribute of the Ambitious
						},
					}),
					...
					q(60439, {	-- Challenges in Ardenweald
						...
						["coord"] = { 62.1, 37.6, ELYSIAN_HOLD_ARCHONS_RISE },
						["g"] = {
					...
					q(60442, {	-- Challenges in Bastion
						["provider"] = { "n", 154627 },	-- Xandria
						["coord"] = { 62.0, 37.4, ELYSIAN_HOLD_ARCHONS_RISE },
						["g"] = {
					...
					q(60447, {	-- Challenges in Maldraxxus
						["provider"] = { "n", 154627 },	-- Xandria
						["coord"] = { 61.9, 37.4, ELYSIAN_HOLD_ARCHONS_RISE },
						["g"] = {
					...
					q(60450, {	-- Challenges in Revendreth
						["provider"] = { "n", 154627 },	-- Xandria
						["coord"] = { 62.0, 37.3, ELYSIAN_HOLD_ARCHONS_RISE },
						["g"] = {
					...
					q(60415, {	-- Rare Resources
						...
						["coord"] = { 33.6, 44.7, ELYSIAN_HOLD_ARCHONS_RISE },
						["g"] = {
							i(181372),	-- Tribute of the Ascended
						},
					}),
					...
					q(60404, {	-- Training Our Forces
						...
						["coord"] = { 37.3, 61.1, ELYSIAN_HOLD_ARCHONS_RISE },
						["g"] = {
							i(181372),	-- Tribute of the Ascended
						},
					}),
					q(60403, {	-- Training in Ardenweald
						["provider"] = { "n", 168517 },	-- Kalisthene
						["coord"] = { 37.3, 61.0, ELYSIAN_HOLD_ARCHONS_RISE },
						["g"] = {
							i(181475),	-- Bounty of the Grove Wardens
						},
					}),
					...
					q(60412, {	-- Training in Revendreth
						["provider"] = { "n", 168517 },	-- Kalisthene
						["coord"] = { 37.2, 61.0, ELYSIAN_HOLD_ARCHONS_RISE },
						["g"] = {
							i(181556),	-- Tribute of the Court
						},
					}),
					q(60425, {	-- Troubles at Home
						["provider"] = { "n", 160037 },	-- Polemarch Adrestes
						["coord"] = { 55.3, 42.4, ELYSIAN_HOLD_ARCHONS_RISE },
						["g"] = {
							i(181372),	-- Tribute of the Ascended
						},
					}),
