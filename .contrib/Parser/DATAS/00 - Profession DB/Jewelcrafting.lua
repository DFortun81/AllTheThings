...
i(162382, 256257);	-- Laribole Staff of Alacrity [Rank 3] [A]
i(162764, 256257);	-- Laribole Staff of Alacrity [Rank 3] [H]
i(162379, 256517);	-- Owlseye Loop [Rank 3] [A]
i(162761, 256517);	-- Owlseye Loop [Rank 3] [H]
i(162381, 256521);	-- Royal Quartz Loop [Rank 3] [A]
i(162763, 256521);	-- Royal Quartz Loop [Rank 3] [H]
i(162385, 256260);	-- Scarlet Diamond Staff of Intuition [Rank 3] [A]
i(162765, 256260);	-- Scarlet Diamond Staff of Intuition [Rank 3] [H]
...
i(223093, 435391);	-- Beautification Iris
...
i(228329, 435389);	-- Remembrance Stone
