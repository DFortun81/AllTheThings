...
-----------------
--- TRAINER ---
i(0, 7411);			-- Enchanting (Apprentice) [REMOVED: 8.0.1]
i(0, 7412);			-- Enchanting (Journeyman) [REMOVED: 8.0.1]
i(0, 7413);			-- Enchanting (Expert) [REMOVED: 8.0.1]
i(0, 13920);		-- Enchanting (Artisan) [REMOVED: 8.0.1]
i(0, 13935);		-- Agility [Boots]
i(0, 13815);		-- Agility [Golves]
i(0, 13635);		-- Defense
i(0, 13262);		-- Disenchant
i(0, 17181);		-- Enchanted Leather
i(0, 17180);		-- Enchanted Thorium Bar
i(0, 13657);		-- Fire Resistance [REMOVED: 5.0.4]
...
i(0, 13939);		-- Greater Strength [Bracers]
...
i(0, 13607);		-- Mana
i(0, 7426);			-- Minor Absorption
i(0, 7779);			-- Minor Agility [Bracers]
...
i(0, 7457);			-- Minor Stamina [Bracers]
i(0, 13378);		-- Minor Stamina [Shield]
i(0, 13626);		-- Minor Stats
i(0, 7788);			-- Minor Striking
i(0, 13794);		-- Resistance [REMOVED: 5.0.4]
i(0, 7421);			-- Runed Copper Rod
i(0, 13628);		-- Runed Golden Rod [REMOVED: 5.0.4]
i(0, 7795);			-- Runed Silver Rod
i(0, 7861);			-- Runed Silver Rod [REMOVED: 5.0.4]
i(0, 13702);		-- Runed Truesilver Rod [REMOVED: 5.0.4]
i(0, 13836);		-- Stamina [Boots]
i(0, 13648);		-- Stamina [Bracers]
i(0, 13941);		-- Stats [Chest]
i(0, 13661);		-- Strength [Bracers]
i(0, 13887);		-- Strength [Golves]
i(0, 13693);		-- Striking
i(0, 13858);		-- Superior Health
i(0, 13917);		-- Superior Mana
i(0, 13642);		-- Versatility / CLASSIC: Spirit [Bracers]
i(0, 13659);		-- Versatility / CLASSIC: Spirit [Shield]
--- ITEM ---
i(11205, 13868);	-- Advanced Herbalism [REMOVED: 4.0.3]
...
i(20757, 25130);	-- Brilliant Mana Oil [REMOVED: 4.1.0]
i(20756, 25129);	-- Brilliant Wizard Oil [REMOVED: 4.1.0]
i(16252, 20034);	-- Crusader
i(11208, 13915);	-- Demonslaying
i(11223, 13931);	-- Dodge [Bracers]
i(20736, 25086);	-- Dodge [Cloak] [See 2.2.0 Also]
i(11207, 13898);	-- Fiery Weapon
i(20729, 25078);	-- Fire Power
i(11152, 13620);	-- Fishing
i(20728, 25074);	-- Frost Power
i(11224, 13933);	-- Frost Resistance [REMOVED: 5.0.4]
i(16245, 20023);	-- Greater Agility [Boots]
i(16219, 20012);	-- Greater Agility [Golves]
i(20732, 25081);	-- Greater Fire Resistance [REMOVED: 5.0.4]
i(16214, 20008);	-- Greater Intellect
i(20733, 25082);	-- Greater Nature Resistance [REMOVED: 5.0.4]
i(16216, 20014);	-- Greater Resistance [REMOVED: 5.0.4]
i(16215, 20020);	-- Greater Stamina [Boots]
i(11225, 13945);	-- Greater Stamina [Bracers]
i(16217, 20017);	-- Greater Stamina [Shield]
i(16253, 20025);	-- Greater Stats
i(16244, 20013);	-- Greater Strength [Golves]
i(11204, 13846);	-- Greater Versatility / CLASSIC: Greater Spirit [Bracers]
...
i(11813, 15596);	-- Smoking Heart of the Mountain [REMOVED 3.1.0, See new version]
i(18259, 22749);	-- SpellPower [Weapon]
i(11202, 13817);	-- Stamina [Shield]
i(20734, 25083);	-- Stealth [See 2.2.0 Also]
i(19444, 23799);	-- Strength [Weapon]
i(20735, 25084);	-- Subtlety [See 2.2.0 Also]
i(20731, 25080);	-- Superior Agility [See 2.2.0 Also]
i(16224, 20015);	-- Superior Defense
i(16247, 20030);	-- Superior Impact [REMOVED: 6.0.2]
...
i(20726, 25072);	-- Threat [See 2.2.0 Also]
...
-- #if BEFORE TBC
i(0, 7769);			-- CLASSIC: Imbue Bracers - Minor Wisdom OLD
...
-- #else
i(6343, 0);			-- CLASSIC: Imbue Chest - Minor Spirit
-- #endif
...
i(22546, 0);		-- Exceptional Mana

-----------------
-- PATCH 2.0.5 --
-----------------
--- TRAINER ---
i(0, 28029);		-- Enchanting (Master) [REMOVED: 8.0.1]
i(0, 33996);		-- Assault
i(0, 33993);		-- Blasting
i(0, 27899);		-- Brawn
...
i(28273, 33999);	-- Major Healing [Golves]
i(28281, 34010);	-- Major Healing [Weapon]
i(22551, 27968);	-- Major Intellect [Weapon]
i(22548, 27962);	-- Major Resistance [REMOVED: 5.0.4]
i(28272, 33997);	-- Major Spellpower [Golves]
i(22555, 27975);	-- Major Spellpower [Weapon]
...
i(22541, 27947);	-- Resistance [Shield] [REMOVED: 5.0.4]
i(25848, 32665);	-- Runed Adamantite Rod [REMOVED: 5.0.4]
i(25849, 32667);	-- Runed Eternium Rod [REMOVED: 5.0.4]
i(22554, 27971);	-- Savagery
i(22561, 27982);	-- Soulfrost
i(22534, 27917);	-- Spellpower [Bracers]
i(22536, 27924);	-- Spellpower [Ring] [REMOVED: 6.0.2]
i(22558, 28003);	-- Spellsurge
i(22538, 27927);	-- Stats [REMOVED: 6.0.2]
-- #if BEFORE 6.0.2
i(22535, 27920);	-- Striking [REMOVED: 6.0.2]
-- #else
i(0, 27920);		-- Striking [REMOVED: 6.0.2]
-- #endif
...
i(22532, 27913);	-- Versatility Prime / TBC: Restore Mana Prime [Bracers]
i(22542, 27948);	-- Vitality [Boots] [See 2.4.0 Also]

-----------------
-- PATCH 2.1.0 --
-----------------
--- ITEM ---
i(22552, 27967);	-- Major Striking

-----------------
-- PATCH 2.2.0 --
-----------------
--- TRAINER ---
i(0, 42613);		-- Nexus Transformation [REMOVED: 7.3.5]
i(0, 42615);		-- Small Prismatic Shard
--- ITEM ---
i(33148, 25086);	-- Dodge [Cloak]
i(33165, 42620);	-- Greater Agility [Weapon]
i(33149, 25083);	-- Stealth
i(33150, 25084);	-- Subtlety [A]
i(33151, 25084);	-- Subtlety [H]
i(33152, 25080);	-- Superior Agility
i(33153, 25072);	-- Threat
...
--- ITEM ---
i(33307, 42974);	-- Executioner [REMOVED: 4.1.0, new version 4.3.0]

-----------------
-- PATCH 2.4.0 --
-----------------
--- ITEM ---
i(35297, 34008);	-- Boar's Speed
i(35299, 34007);	-- Cat's Swiftness
i(35500, 46594);	-- Dodge / TBC: Defense [Cloak]
i(35756, 47051);	-- Greater Dodge / TBC: Steelweave [Cloak]
i(35298, 27948);	-- Vitality [Boots]
i(34872, 45765);	-- Void Shatter

-----------------
-- PATCH 2.4.2 --
-----------------
--- ITEM ---
i(35498, 46578);	-- Deathfrost
...
i(0, 47903);		-- Unknown
i(0, 47908);		-- Unknown
i(36837, 0);		-- 02 Enchanting Recipe Template (Good)
i(36840, 0);		-- 01 Enchanting Recipe Template (Standard)
i(36838, 0);		-- 03 Enchanting Recipe Template (Superior)
i(36839, 0);		-- 04 Enchanting Recipe Template (Epic)
i(37326, 0);		-- Enchant Bracer - Major Versatility
i(37342, 0);		-- Enchant Gloves - Greater Blasting

-----------------
-- PATCH 3.0.3 --
-----------------
--- TRAINER ---
i(0, 51313);		-- Enchanting (Grand Master) [REMOVED: 8.0.1]
i(0, 44645);		-- Assault [Ring] [REMOVED: 6.0.2]
i(0, 44489);		-- Dodge Shield
i(0, 44633);		-- Exceptional Agility
i(0, 44555);		-- Exceptional Intellect
i(0, 27958);		-- Exceptional Mana
i(0, 44592);		-- Exceptional Spellpower [Golves]
i(0, 44629);		-- Exceptional Spellpower [Weapon]
i(0, 44510);		-- Exceptional Versatility / WOTLK: Exceptional Spirit [Weapon]
i(0, 44506);		-- Gatherer Glove
i(0, 44513);		-- Greater Assault [Golves]
i(0, 47766);		-- Greater Dodge / WOTLK: Greater Defense
i(0, 44528);		-- Greater Fortitude
i(0, 44630);		-- Greater Savagery
i(0, 44635);		-- Greater Spellpower [Bracers]
i(0, 44636);		-- Greater Spellpower [Ring] [REMOVED: 6.0.2]
i(0, 44616);		-- Greater Stats
i(0, 44508);		-- Greater Versatility / WOTLK: Greater Spirit [Boots]
i(0, 44509);		-- Greater Versatility / WOTLK: Greater Mana Restoration [Chest]
i(0, 44584);		-- Greater Vitality
i(0, 44598);		-- Haste / WOTLK: Expertise [Bracers]
i(0, 44484);		-- Haste / WOTLK: Expertise [Golves]
i(0, 44529);		-- Major Agility [Golves]
...
i(0, 60619);		-- Runed Titanium Rod [REMOVED: 5.0.4]
i(0, 59636);		-- Stamina [Ring] [REMOVED: 6.0.2]
i(0, 44623);		-- Super Stats
i(0, 44589);		-- Superior Agility [Boots]
...
i(44484, 44575);	-- Greater Assault [Bracers]
...
i(37330, 44596);	-- Superior Arcane Resistance [REMOVED: 5.0.4]
i(37347, 44591);	-- Superior Dodge / WOTLK: Titanweave
i(37331, 44556);	-- Superior Fire Resistance [REMOVED: 5.0.4]
i(37332, 44483);	-- Superior Frost Resistance [REMOVED: 5.0.4]
i(37333, 44494);	-- Superior Nature Resistance [REMOVED: 5.0.4]
i(37334, 44590);	-- Superior Shadow Resistance [REMOVED: 5.0.4]
...
-----------------
--- TRAINER ---
i(0, 60606);		-- Assault [Boots]
i(0, 60616);		-- Assault / WOTLK: Striking [Bracers]
i(0, 60668);		-- Crusher
...
i(45050, 15596);	-- Smoking Heart of the Mountain
...
-----------------
--- NYI ---
i(37335, 0);		-- Enchant Cloak - Superior Agility
...
-----------------
--- NYI ---
i(37346, 0);		-- Enchant Bracer - Expertise
i(37343, 0);		-- Enchant Weapon - Exceptional Agility
i(37329, 0);		-- Enchant Weapon - Exceptional Versatility

-----------------
-- PATCH 3.3.5 --
-----------------
--- NYI ---
i(37341, 0);		-- Enchant Boots - Superior Agility
i(37337, 0);		-- Enchant Bracer - Greater Stats
i(37336, 0);		-- Enchant Chest - Greater Dodge

-----------------
-- PATCH 4.0.3 --
-----------------
--- TRAINER ---
i(0, 74258);		-- Enchanting (Illustrious) [REMOVED: 8.0.1]
i(0, 74216);		-- Agility [Ring] [REMOVED: 6.0.2]
i(0, 74197);		-- Avalanche
i(0, 74201);		-- Critical Strike [Bracers]
i(0, 74230);		-- Critical Strike [Cloak]
i(0, 74189);		-- Earthen Vitality
i(0, 74211);		-- Elemental Slayer
i(0, 74212);		-- Exceptional Strength
i(0, 74237);		-- Exceptional Versatility [Bracers]
i(0, 74231);		-- Exceptional Versatility [Chest]
i(0, 74239);		-- Greater Haste [Bracers]
i(0, 74220);		-- Greater Haste [Gloves]
i(0, 74240);		-- Greater Intellect
i(0, 74218);		-- Greater Stamina [Ring] [REMOVED: 6.0.2]
i(0, 74199);		-- Haste [Boots]
i(0, 74198);		-- Haste [Gloves]
i(0, 74225);		-- Heartsong
i(0, 74223);		-- Hurricane
i(0, 74202);		-- Intellect [Cloak]
i(0, 74217);		-- Intellect [Ring] [REMOVED: 6.0.2]
i(0, 74192);		-- Lesser Power
i(0, 74213);		-- Major Agility
i(0, 95471);		-- Mighty Agility
i(0, 74238);		-- Mastery [Boots]
i(0, 74132);		-- Mastery [Gloves]
i(0, 74226);		-- Mastery [Weapons]
i(0, 74195);		-- Mending
i(0, 74214);		-- Mighty Armor / CATA: Mighty Resilience
i(0, 74191);		-- Mighty Stats
i(0, 74232);		-- Precision [Bracers]
i(0, 74236);		-- Precision [Boots]
i(0, 74234);		-- Protection [Cloak]
i(0, 74207);		-- Protection [Weapons]
i(0, 74193);		-- Speed
i(0, 74200);		-- Stamina
i(0, 74215);		-- Strength [Ring] [REMOVED: 6.0.2]
...
i(71714, 13882);	-- Lesser Agility [Cloak]
...
i(65359, 92370);	-- Runed Elementium Rod [REMOVED: 5.0.4]
...
--- ITEM ---
i(78348, 42974);	-- Executioner
i(78343, 13617);	-- Herbalism

-----------------
-- PATCH 5.0.4 --
-----------------
--- TRAINER ---
i(0, 110400);		-- Enchanting (Zen Master) [REMOVED: 8.0.1]
i(0, 104398);		-- Accuracy
...
i(0, 103461);		-- Greater Agility [Ring] [REMOVED: 6.0.2]
i(0, 104407);		-- Greater Haste [Boots]
i(0, 104416);		-- Greater Haste [Gloves]
i(0, 103462);		-- Greater Intellect [Ring] [REMOVED: 6.0.2]
i(0, 130758);		-- Greater Parry
i(0, 104408);		-- Greater Precision
i(0, 104401);		-- Greater Protection
i(0, 103463);		-- Greater Stamina [Ring] [REMOVED: 6.0.2]
i(0, 103465);		-- Greater Strength [Ring] [REMOVED: 6.0.2]
...
--- NYI ---
i(84582, 0);		-- Enchant Weapon - Windsong
...
i(118431, 158880);	-- Breath of Multistrike [Cloak] [REMOVED: 7.0.3]
i(118441, 158895);	-- Breath of Multistrike [Neck] [REMOVED: 7.0.3]
...
i(118436, 158887);	-- Gift of Multistrike [Cloak] [REMOVED: 7.0.3]
i(118446, 158902);	-- Gift of Multistrike [Neck] [REMOVED: 7.0.3]
i(118456, 158917);	-- Gift of Multistrike [Ring] [REMOVED: 7.0.3]
...
-----------------
--- TRAINER ---
i(0, 195096);		-- Enchanting (Legion Master) [REMOVED: 8.0.1]
...
-----------------
--- TRAINER ---
i(0, 300381);		-- Disenchant [CLASSIC]
i(0, 300382);		-- Disenchant [The Burning Cruse]
i(0, 302690);		-- Disenchant [Wrath of the Lich King]
i(0, 302691);		-- Disenchant [Cataclysm]
i(0, 302692);		-- Disenchant [Mist of Pandaria]
i(0, 302693);		-- Disenchant [Warlords of Draenor]
i(0, 302694);		-- Disenchant [Legion]
i(0, 302695);		-- Disenchant [Battle for Azeroth]
...
--- NYI ---
i(168450, 0);		-- Accord of Critical Strike [Rank 3]
i(168451, 0);		-- Accord of Haste [Rank 3]
i(168452, 0);		-- Accord of Mastery [Rank 3]
i(168453, 0);		-- Accord of Versatility [Rank 3]
i(168584, 0);		-- REUSE ME [MTMM]
i(168585, 0);		-- REUSE ME [MTMM]
i(168587, 0);		-- REUSE ME [MTMM]
i(168588, 0);		-- REUSE ME [MTMM]
i(168590, 0);		-- REUSE ME [MTMM]
i(169537, 0);		-- REUSE ME [MTMM] (DNT)
...
i(0, 265105);		-- Enchanted Twilight Wand
...
--- SPECIAL ---
i(0, 343683);		-- Crafter's Mark II [Multiple Recipes Uses itemID 183870]
--- QUEST ---
i(0, 346026);		-- Boundless Basket
...
i(0, 392888);		-- Disenchant [Dragonflight]
...
i(199803, 389525);	-- Draconic Perception
i(199811, 389403);	-- Graceful Avoidance
i(199817, 389405);	-- Homebound Speed
i(200911, 391813);	-- Illusion: Primal Air
i(200912, 391814);	-- Illusion: Primal Earth
i(200913, 391815);	-- Illusion: Primal Fire
i(200914, 391816);	-- Illusion: Primal Frost
i(200916, 390839);	-- Illusion: Primal Mastery
i(199813, 389419);	-- Sustained Strength
i(199814, 389479);	-- Plainsrunner's Breeze
i(199815, 389404);	-- Regenerative Leech
i(199812, 389480);	-- Rider's Reassurance
i(199818, 389484);	-- Watcher's Loam
--- SPECIALIZATION ---
...
i(0, 391202);		-- Illustrious Insight
i(0, 390855);		-- Khadgar's Disenchanting Rod
i(0, 389417);		-- Reserve of Intellect
i(0, 390825);		-- Runed Khaz'gorite Rod
i(0, 391808);		-- Scepter of Spectacle: Order
i(0, 390831);		-- Sophic Amalgamation
i(0, 389550);		-- Sophic Devotion
