...
i(0, 447310);		-- Scour Through Scrap
...
i(0, 447324);		-- Bismuth Brainwave Projector
i(0, 447326);		-- Bismuth Fisherfriend
i(0, 447330);		-- Bismuth Miner's Headgear
...
i(0, 447373);		-- Crowd Pummeler 2-30
...
i(0, 447328);		-- Lapidary's Bismuth Clamps
i(0, 447335);		-- Miner's Aqirite Hoard
i(0, 447334);		-- Miner's Bismuth Hoard
...
i(0, 447322);		-- Spring-Loaded Bismuth Fabric Cutters
...
i(0, 447333);		-- Aqirite Fueled Samophlange
i(0, 447374);		-- Box o' Booms
