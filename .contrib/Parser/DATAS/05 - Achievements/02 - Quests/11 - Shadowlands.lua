	...
	n(-9956, {	-- Quests
		n(-10100, {	-- Shadowlands
			...
			ach(14280, {	-- Loremaster of Shadowlands
				crit(1),	-- The Path to Ascension
				crit(2),	-- Sojourner of Bastion
				crit(3),	-- Blade of the Primus
				crit(4),	-- Sojourner of Maldraxxus
				crit(5),	-- Awaken, Ardenweald
				crit(6),	-- Sojourner of Ardenweald
				crit(7),	-- The Master of Revendreth
				crit(8),	-- Sojourner of Revendreth
			}),
