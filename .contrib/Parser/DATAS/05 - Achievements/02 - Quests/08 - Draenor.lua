...
root(ROOTS.Achievements, achcat(ACHIEVEMENT_CATEGORY_QUESTS, {
	achcat(ACHIEVEMENT_CATEGORY_DRAENOR_QUESTS, {
		...
		a(ach(9833, {	-- Loremaster of Draenor (Alliance)
			...
			a(ach(8920, {	-- Don't Let the Tala-door Hit You on the Way Out (unlocks ability to buy Talador Treasure Map from Grakis in Stormshield)
		...
		h(ach(9923, {	-- Loremaster of Draenor (Horde)
			...
			h(ach(8924, {	-- Putting the Gore in Gorgrond (unlocks ability to buy Gorgrond Treasure Map from Srikka in Warspear)
				crit(1),		-- Your Base, Your Choice
				crit(2),		-- Supporting Your Garrison
				crit(3),		-- In the Land of Giants
				crit(4),		-- The Iron Approach
			})),
			h(ach(8919, {	-- Don't Let the Tala-door Hit You on the Way Out (unlocks ability to buy Talador Treasure Map from Srikka in Warspear)
				crit(1),		-- Establishing your Outpost
				crit(2),		-- The Battle for Shattrath
				crit(3),		-- The Plight of the Arakkoa
				crit(4),		-- In the Shadows of Auchindoun
		...
		a(ach(9825, {	-- Master Relic Hunter (Alliance) [A]
		...
		h(ach(9836, {	-- Master Relic Hunter (Alliance) [H]
			crit(1),		-- The Blessing of Beasts
			crit(2),		-- Breaching the Barrier
			crit(3),		-- The Apexis Device
			crit(4),		-- The Spirit Forge
		...
		a(ach(8921)),	-- Welcome to Draenor [A] NOTE: Quests look like they start in Blasted Lands, not added to any zone files
		h(ach(8922)),	-- Welcome to Draenor [H] NOTE: Quests look like they start in Blasted Lands, not added to any zone files
		...
		a(ach(9530)),	-- Writing in the Snow (Alliance)
		h(ach(9531)),	-- Bloodmaul Stronghold (Horde)
