...
root(ROOTS.Achievements, {
	...
	achcat(ACHIEVEMENT_CATEGORY_QUESTS, {
		...
		achcat(ACHIEVEMENT_CATEGORY_DRAGONFLIGHT_QUESTS, {["timeline"] = TIMELINE_10_0_2_LAUNCH }),
	}),
	achcat(ACHIEVEMENT_CATEGORY_EXPLORATION, {
		...
		achcat(ACHIEVEMENT_CATEGORY_DRAGONFLIGHT_EXP, {["timeline"] = TIMELINE_10_0_2_LAUNCH }),
	}),
