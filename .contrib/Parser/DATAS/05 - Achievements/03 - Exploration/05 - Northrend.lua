	...
	n(-9957, {	-- Exploration
		n(-9978, {	-- Northrend
			ach(1264, {	-- Explore Borean Tundra
				...
				crit(2),	-- Steeljaw's Caravan
				crit(3),	-- Riplash Strand
				crit(4),	-- Kaskala
				crit(5),	-- Garrosh's Landing
				crit(6),	-- Death's Stand
				crit(7),	-- Coldarra
				crit(8),	-- Bor'gorok Outpost
				crit(9),	-- Amber Ledge
				crit(10),	-- Warsong Hold
			...
			ach(1263, {	-- Explore Howling Fjord
				crit(1),	-- Kamagua
				crit(2),	-- Cauldros Isle
				crit(3),	-- Camp Winterhoof
				crit(4),	-- Apothecary Camp
				crit(5),	-- Vengeance Landing
				crit(6),	-- Steel Gate
				crit(7),	-- Scalawag Point
				crit(8),	-- Nifflevar
				crit(9),	-- Gjalerbron
				crit(10),	-- Ember Clutch
				crit(11),	-- Giant's Run
				crit(12),	-- Fort Wildervar
				crit(13),	-- Ivald's Ruin
				crit(14),	-- Halgrind
				crit(15),	-- New Agamand
				crit(16),	-- Skorn
				crit(17),	-- The Twisted Glade
				crit(18),	-- Utgarde Keep
				crit(19),	-- Westguard Keep
			...
			ach(1268, {	-- Explore Sholazar Basin
				...
				crit(2),	-- The Savage Thicket
				crit(3),	-- The Mosslight Pillar
				crit(4),	-- Makers' Overlook
				crit(5),	-- Makers' Perch
				crit(6),	-- The Suntouched Pillar
				crit(7),	-- Rainspeaker Canopy
				crit(8),	-- The Lifeblood Pillar
				crit(9),	-- The Avalanche
			...
			ach(1269, {	-- Explore Storm Peaks
				...
				crit(2),	-- Narvir's Cradle
				crit(3),	-- Dun Niffelem
				crit(4),	-- Bor's Breath
				crit(5),	-- Valkyrion
				crit(6),	-- Terrace of the Makers
				crit(7),	-- Sparksocket Minefield
				crit(8),	-- Engine of the Makers
				crit(9),	-- Temple of Life
				crit(10),	-- Ulduar
				crit(11),	-- Thunderfall
				crit(12),	-- Temple of Storms
				crit(13),	-- Snowdrift Plains
				crit(14),	-- Garm's Bane
				crit(15),	-- Frosthold
				crit(16),	-- Nidavelir
			}),
			...
			ach(2257, {	-- Frostbitten
				...
				crit(3),	-- Hildana Deathstealer (Icecrown)
				crit(4),	-- Old Crystalbark (Borean Tundra)
				crit(5),	-- Fumblub Gearwind (Borean Tundra)
				crit(6),	-- Icehorn (Borean Tundra)
				crit(7),	-- Perobas the Bloodthirster (Howling Fjord)
				crit(8),	-- Vigdis the War Maiden (Howling Fjord)
				crit(9),	-- King Ping (Howling Fjord)
				crit(10),	-- Tukemuth (Dragonblight)
				crit(11),	-- Crazed Indu'le Survivor (Dragonblight)
				crit(12),	-- Scarlet Highlord Daion (Dragonblight)
				crit(13),	-- Grocklar (Grizzly Hills)
				crit(14),	-- Seething Hate (Grizzly Hills)
				crit(15),	-- Syreian the Bonecarver (Grizzly Hills)
				crit(16),	-- Zul'drak Sentinel (Zul'Drak)
				crit(17),	-- Griegen (Zul'Drak)
				crit(18),	-- Terror Spinner (Zul'Drak and Storm Peaks)
				crit(19),	-- Aotona (Sholazar Basin)
				crit(20),	-- King Krush (Sholazar Basin)
				crit(21),	-- Vyragosa (The Storm Peaks)
				crit(22),	-- Dirkee (The Storm Peaks)
				crit(23),	-- Putridus the Ancient (Icecrown)
			...
			ach(1956, {	-- Higher Learning (Dalaran)
				...
				crit(4),	-- The Schools of Arcane Magic - Divination
				crit(5),	-- The Schools of Arcane Magic - Enchantment
