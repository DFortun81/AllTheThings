	...
	n(-9957, {	-- Exploration
		n(-9955, {	-- General
			...
			ach(8935, {		-- Draenor Explorer
				crit(1),		-- Explore Frostfire Ridge
				crit(2),		-- Explore Shadowmoon Valley
				crit(3),		-- Explore Gorgrond
				crit(4),		-- Explore Talador
				crit(5),		-- Explore Spires of Arak
				crit(6),		-- Explore Nagrand
			}),
