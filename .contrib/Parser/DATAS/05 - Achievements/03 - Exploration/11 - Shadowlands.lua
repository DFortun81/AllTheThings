	...
	n(-9957, {	-- Exploration
		n(-10100, {	-- Shadowlands
			...
			ach(14309, {	-- Adventurer of Ardenweald
				...
				crit(11),	-- Mymaen
				crit(12),	-- Astra, As Azshara
				crit(13),	-- Mi'kai, as Argus
				crit(14),	-- Glimmerdust, As Kil'jaeden
				crit(15),	-- Senthii, As Gul'dan
				crit(16),	-- Glimmerdust, As Jaina
				crit(17),	-- Dreamweaver, As N'Zoth
				crit(18),	-- Niya, As Xavius
				crit(19),	-- Rotbriar Changeling
				crit(20),	-- Egg-Tender Leh'go
				crit(21),	-- Rootwrithe
				crit(22),	-- The Slumbering Emperor
				crit(23),	-- Night Mare
				crit(24),	-- Dustbrawl
				crit(25),	-- Dustbrawl
				crit(26),	-- Valfir the Unrelenting
				crit(27),	-- Soultwister Cero
				crit(28),	-- Soultwister Cero
			}),
			ach(14307, {	-- Adventurer of Bastion
				...
				crit(25),	-- Corrupted Clawguard
			}),
			ach(14308, {	-- Adventurer of Maldraxxus
				crit(1),	-- Bonebreaker Moroc
				crit(2),	-- Scunner
				crit(3),	-- Zargox the Reborn
				crit(4),	-- Collector Kash
				crit(5),	-- Ravenomous
				crit(6),	-- Sister Chelicerae
				crit(7),	-- Pulsing Leech
				crit(8),	-- Taskmaster Xox
				crit(9),	-- Indomitable Schmitd
				crit(10),	-- Moregorger
				crit(11),	-- Nirvaska the Summoner
				crit(12),	-- Thread Mistress Leeda
				crit(13),	-- Gelloh
				crit(14),	-- Smorgas The Feaster
				crit(15),	-- Tahonta
				crit(16),	-- Oily Invertebrate
				crit(17),	-- Boneslurp
				crit(18),	-- Sabreil the Bonecleaver
				crit(19),	-- Gristlebeak
				crit(20),	-- Violet Mistake
				crit(21),	-- Devour'us
				crit(22),	-- Burnblister
				crit(23),	-- Corrupted Sediment
				crit(24),	-- Nerissa Heartless
				crit(25),	-- Deadly Dapperling
				crit(26),	-- Bubbleblood
				crit(27),	-- Gieger
				crit(28),	-- Pesticide
				crit(29),	-- Deepscar
				crit(30),	-- Necromantic Anomaly
				crit(31),	-- Warbringer Mal'Korak
			}),
			ach(14310, {	-- Adventurer of Revendreth
				...
				crit(4),	-- Tomb Burster
				crit(5),	-- Stonefist
				crit(6),	-- Forgemaster Madalav
				crit(7),	-- Worldedge Gorger
				crit(8),	-- Worldedge Gorger
				crit(9),	-- Executioner Adrastia
				crit(10),	-- Lord Mortegore
				crit(11),	-- Leeched Soul
				crit(12),	-- Endlurker
				crit(13),	-- Amalgamation of Light
				crit(14),	-- Tollkeeper Varaboss
				crit(15),	-- Harika the Horrid
				crit(16),	-- Amalgamation of Filth
				crit(17),	-- Famu the Infinite
				crit(18),	-- Azgar
				crit(19),	-- Hopecrusher
				crit(20),	-- Bog Beast
				crit(21),	-- Executioner Aatron
				crit(22),	-- Huntmaster Petrus
				crit(23),	-- Grand Arcanist Dimitri
				crit(24),	-- Manifestation of Wrath
				crit(25),	-- Amalgamation of Sin slain
				crit(26),	-- Sinstone Hoarder
			}),
			ach(14300, {	-- Ardenweald Achieved
				crit(1),	-- Treasures of Ardenweald
				crit(2),	-- Adventurer of Ardenweald
				crit(3),	-- Explore Ardenweald
				crit(4),	-- Awaken, Ardenweald
			}),
			...
			ach(14299, {	-- Bastion Bested
				crit(1),	-- The Ascended
				crit(2),	-- Treasures of Bastion
				crit(3),	-- Adventurer of Bastion
			...
			ach(14305, {	-- Explore Maldraxxus
				...
				crit(6),	-- Rotting Mound
				crit(7),	-- House of Plagues
				crit(8),	-- Unyielding Assembly
				crit(9),	-- House of Rituals
				crit(10),	-- House of Eyes
				crit(11),	-- House of Constructs
				crit(12),	-- Glutharn's Decay
				crit(13),	-- Forgotten Wounds
				crit(14),	-- Burning Thicket
			}),
			...
			ach(14659, {	-- Handling his Henchmen
				...
				crit(3),	-- Razkazzar
				crit(4),	-- Orrholyn
				crit(5),	-- Serath the Gluttonous
				crit(6),	-- Soulsmith Yol-Mattar
				crit(7),	-- Warren Mongrel
				crit(8),	-- Cyrixia
				crit(9),	-- Agonix
				crit(10),	-- Krala
				crit(11),	-- Akros
			...
			ach(14301, {	-- Maldraxxus Mastered
				crit(1),	-- Undying Army
				crit(2),	-- Treasures of Maldraxxus
				crit(3),	-- Adventurer of Maldraxxus
				crit(4),	-- Explore Maldraxxus
			...
			ach(14302, {	-- Revendreth Resolved
				crit(1),	-- Treasures of Revendreth
				crit(2),	-- Adventurer of Revendreth
				crit(3),	-- Explore Revendreth
				crit(4),	-- The Master of Revendreth
				crit(5),	-- It's Always Sinny in Revendreth
				crit(6),	-- Absolution for All
				crit(7),	-- Crypt Kicker
				crit(8),	-- Best Bud With Benefits
			}),
			...
			ach(14312, {	-- Treasures of Maldraxxus
				...
				crit(9),	-- Broken Flute
				crit(10),	-- Memorial Offering
				crit(11),	-- Chest of Eyes
				crit(12),	-- Misplaced Supplies
				crit(13),	-- Glutharn's Stash
				crit(14),	-- Runespeaker's Trove
				crit(15),	-- Plaguefallen Chest
				crit(16),	-- Ritualist's Cache
			}),
			ach(14310, {	-- Treasures of Revendreth
				crit(1),	-- Lost Quill
			...
			ach(14770),	-- What We Ride in the Shadow
