...
root(ROOTS.Achievements, achcat(ACHIEVEMENT_CATEGORY_FEATS_OF_STRENGTH, {
	achcat(ACHIEVEMENT_CATEGORY_EVENTS_FOS, {
		applyevent(EVENTS.FEAST_OF_WINTER_VEIL, ach(12850)),		-- At Least You're Being Careful
		...
		applyevent(EVENTS.FEAST_OF_WINTER_VEIL, ach(13927)),		-- Crashin' Splashin'
		...
		applyevent(EVENTS.WOW_ANNIVERSARY, ach(10335)),		-- Did Someone Say...?
		...
		applyevent(EVENTS.FEAST_OF_WINTER_VEIL, ach(15313)),	-- Rockin' Rollin' Racer
