...
--------------------------------------------
--[[
DRAGONRIDING_CUP_HEADER = createHeader({
...
root(ROOTS.Holidays, n(DRAGONRIDING_CUP_HEADER, applyevent(EVENTS.EASTERN_KINGDOMS_CUP, n(EASTERN_KINGDOMS_CUP_HEADER, bubbleDownSelf({ ["timeline"] = { ADDED_10_1_7 } }, {
	n(ACHIEVEMENTS, {
