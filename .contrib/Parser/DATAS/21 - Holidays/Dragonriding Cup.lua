...
root(ROOTS.Holidays, n(DRAGONRIDING_CUP_ROOT, {
	applyevent(EVENTS.EASTERN_KINGDOMS_CUP, n(EASTERN_KINGDOMS_CUP_HEADER, bubbleDownSelf({ ["timeline"] = { ADDED_10_1_7 } }, {
		n(ACHIEVEMENTS, {
	...
	applyevent(EVENTS.KALIMDOR_CUP, n(KALIMDOR_CUP_HEADER, bubbleDownSelf({ ["timeline"] = { ADDED_10_1_5 } }, {
		n(ACHIEVEMENTS, {
