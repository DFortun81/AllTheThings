				...
				q(8744, { 	-- A Carefully Wrapped Present
					...
					["g"] = {
						i(21191, {	-- Carefully Wrapped Present
							un(HOLIDAY_FEAST_OF_WINTER_VEIL, i(116451)),	-- Warm Blue Woolen Socks
							un(HOLIDAY_FEAST_OF_WINTER_VEIL, i(116450)),	-- Warm Green Woolen Socks
							un(HOLIDAY_FEAST_OF_WINTER_VEIL, i(116448)),	-- Warm Red Woolen Socks
							un(HOLIDAY_FEAST_OF_WINTER_VEIL, i(128650)),	-- "Merry Munchkin" Costume
							un(HOLIDAY_FEAST_OF_WINTER_VEIL, i(21254)),	-- Winter Veil Cookie
						}),
					},
				}),
				q(8803,	{	-- A Festive Gift
					...
					["g"] = {
						i(21363, {	-- Festive Gift
							un(HOLIDAY_FEAST_OF_WINTER_VEIL, i(21328)),	-- Wand of Holiday Cheer
						}),
					},
				}),
				q(8768, { 	-- A Gaily Wrapped Present
					...
					["g"] = {
						i(21310, {	-- Gaily Wrapped Present
							un(HOLIDAY_FEAST_OF_WINTER_VEIL, i(21301)),	-- Green Helper Box
							un(HOLIDAY_FEAST_OF_WINTER_VEIL, i(21308)),	-- Jingling Bell
							un(HOLIDAY_FEAST_OF_WINTER_VEIL, i(21305)),	-- Red Helper Box
							un(HOLIDAY_FEAST_OF_WINTER_VEIL, i(21309)),	-- Snowman Kit
						}),
					},
				}),
					...
					["g"] = {
						i(21270, {	-- Gently Shaken Gift
							...
							["g"] = {
								...
								un(HOLIDAY_FEAST_OF_WINTER_VEIL, i(116690)),	-- Safarai Lounge Cushion
								un(HOLIDAY_FEAST_OF_WINTER_VEIL, i(116691)),	-- Zhevra Lounge Cusion
								un(HOLIDAY_FEAST_OF_WINTER_VEIL, i(128768)),	-- Candy Cane
							},
						}),
						...
						i(151345, {	-- Gently Shaken Gift
							...
							["u"] = REMOVED_FROM_GAME,
							["g"] = {
								un(HOLIDAY_FEAST_OF_WINTER_VEIL, i(151344, {	-- Hearthstation [H]
									["races"] = HORDE_ONLY,
								})),
								un(HOLIDAY_FEAST_OF_WINTER_VEIL, i(151343, {	-- Hearthstation [A]
									["races"] = ALLIANCE_ONLY,
								})),
								un(HOLIDAY_FEAST_OF_WINTER_VEIL, i(128768)),	-- Candy Cane
							},
						...
						i(162974, {	-- Gently Shaken Gift
							...
							["u"] = REMOVED_FROM_GAME,
							["g"] = {
								un(HOLIDAY_FEAST_OF_WINTER_VEIL, i(162973)),	-- Greatfather Winter's Hearthstone
								un(HOLIDAY_FEAST_OF_WINTER_VEIL, i(128768)),	-- Candy Cane
							},
						}),
						i(172225, {	-- Gently Shaken Gift
							...
							["u"] = REMOVED_FROM_GAME,
							["g"] = {
								un(HOLIDAY_FEAST_OF_WINTER_VEIL, i(172219)),	-- Wild Holly
								un(HOLIDAY_FEAST_OF_WINTER_VEIL, i(128768)),	-- Candy Cane
							},
						}),
						i(178529, {	-- Gently Shaken Gift
							...
							["questID"] = 60238,
							["g"] = {
								un(HOLIDAY_FEAST_OF_WINTER_VEIL, i(178530)),	-- Wreath-A-Rang
							},
						}),
					},
				}),
					...
					["g"] = {
						i(34426, {	-- Winter Veil Gift
							...
							["g"] = {
								...
								un(HOLIDAY_FEAST_OF_WINTER_VEIL, i(34425)),	-- Clockwork Rocket Bot
							},
						}),
						i(34426, {	-- Winter Veil Gift
							["questID"] = 13203,
						...
						i(46740, {	-- Winter Veil Gift
							...
							["g"] = {
								...
								un(HOLIDAY_FEAST_OF_WINTER_VEIL, i(46725)),	-- Red Rider Air Rifle
							},
						}),
						...
						i(70938, {	-- Winter Veil Gift
							...
							["g"] = {
								...
								un(HOLIDAY_FEAST_OF_WINTER_VEIL, i(70923)),	-- Gaudy Winter Veil Sweater
							},
						}),
						...
						i(151350, {	-- Winter Veil Gift
							...
							["g"] = {
								...
								un(HOLIDAY_FEAST_OF_WINTER_VEIL, i(151349)),	-- Toy Weapon Set [A]
								un(HOLIDAY_FEAST_OF_WINTER_VEIL, i(151348)),	-- Toy Weapon Set [H]
							},
						}),
						i(162644, {	-- Winter Veil Gift
							...
							["g"] = {
								...
								un(HOLIDAY_FEAST_OF_WINTER_VEIL, i(162643, {	-- Toy Armor Set [A]
									["races"] = ALLIANCE_ONLY,
								})),
								un(HOLIDAY_FEAST_OF_WINTER_VEIL, i(162642, {	-- Toy Armor Set [H]
									["races"] = HORDE_ONLY,
								})),
							},
						}),
						i(172224, {	-- Winter Veil Gift
							...
							["g"] = {
								...
								un(HOLIDAY_FEAST_OF_WINTER_VEIL, i(172223)),	-- Crashin' Thrashin' Battleship [A]
								un(HOLIDAY_FEAST_OF_WINTER_VEIL, i(172222)),	-- Crashin' Thrashin' Juggernaught [H]
							},
						}),
						i(178528, {	-- Winter Veil Gift
							...
							["g"] = {
								un(HOLIDAY_FEAST_OF_WINTER_VEIL, i(178533)),	-- Shaking Pet Carrier
							},
						}),
					},
				}),
