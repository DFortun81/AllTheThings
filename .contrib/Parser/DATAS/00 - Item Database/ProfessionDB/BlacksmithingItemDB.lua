...
-----------------
--- TRAINER ---
i(0, 2018);			-- Blacksmithing (Apprentice) [REMOVED: 8.0.1]
i(0, 3100);			-- Blacksmithing (Journeyman) [REMOVED: 8.0.1]
i(0, 3538);			-- Blacksmithing (Expert) [REMOVED: 8.0.1]
i(0, 9785);			-- Blacksmithing (Artisan) [REMOVED: 8.0.1]
i(0, 20201);		-- Arcanite Rod [REMOVED: 5.0.4]
...
i(0, 14379);		-- Golden Rod [REMOVED: 5.0.4]
...
i(0, 9957);			-- Orcish War Leggings [REMOVED: 4.0.3]
i(0, 9972);			-- Ornate Mithril Breastplate [REMOVED: 4.0.3]
i(0, 9979);			-- Ornate Mithril Boots [REMOVED: 4.0.3]
i(0, 9980);			-- Ornate Mithril Helm [REMOVED: 4.0.3]
...
i(0, 7818);			-- Silver Rod [REMOVED: 5.0.4]
...
i(0, 14380);		-- Truesilver Rod [REMOVED: 5.0.4]
...
i(19776, 24136);	-- Bloodsoul Breastplate [REMOVED: 4.0.3]
i(19778, 24138);	-- Bloodsoul Gauntlets [REMOVED: 4.0.3]
i(19777, 24137);	-- Bloodsoul Shoulders [REMOVED: 4.0.3]
...
i(19779, 24139);	-- Darksoul Breastplate [REMOVED: 4.0.3]
i(19780, 24140);	-- Darksoul Leggings [REMOVED: 4.0.3]
i(19781, 24141);	-- Darksoul Shoulders [REMOVED: 4.0.3]
...
i(9367, 11643);		-- Golden Scale Gauntlets [REMOVED: 4.0.3]
...
i(7984, 9950);		-- Ornate Mithril Gloves [REMOVED: 4.0.3]
i(7983, 9945);		-- Ornate Mithril Pants [REMOVED: 4.0.3]
i(7985, 9952);		-- Ornate Mithril Shoulder [REMOVED: 4.0.3]
...
i(12696, 16667);	-- Demon Forged Breastplate [REMOVED: 4.0.3]
i(12727, 16745);	-- Enchanted Thorium Breastplate [REMOVED: 4.0.3]
i(12725, 16742);	-- Enchanted Thorium Helm [REMOVED: 4.0.3]
i(12726, 16744);	-- Enchanted Thorium Leggings [REMOVED: 4.0.3]
i(12699, 16655);	-- Fiery Plate Gauntlets [REMOVED: 4.0.3]
...
-----------------
--- TRAINER ---
i(0, 29844);		-- Blacksmithing (Master) [REMOVED: 8.0.1]
i(0, 34982);		-- Enchanted Thorium Blades [REMOVED: 5.0.4]
...
i(0, 32655);		-- Fel Iron Rod [REMOVED: 5.0.4]
i(0, 29654);		-- Fel Sharpening Stone
i(0, 34607);		-- Fel Weightstone
i(0, 34983);		-- Felsteel Whisper Knives [REMOVED: 5.0.4]
i(0, 32284);		-- Lesser Rune of Warding
i(0, 34979);		-- Thick Bronze Darts [REMOVED: 5.0.4]
i(0, 34981);		-- Whirling Steel Axes [REMOVED: 5.0.4]
--- ITEM ---
...
i(25846, 32656);	-- Adamantite Rod [REMOVED: 5.0.4]
...
i(12698, 16660);	-- Dawnbringer Shoulders
i(23636, 29699);	-- Dirge
...
i(25847, 32657);	-- Eternium Rod [REMOVED: 5.0.4]
...
i(0, 36257);		-- Bulwark of the Ancient Kings [REMOVED: 4.0.3]
i(0, 36122);		-- Earthforged Leggings [REMOVED: 4.0.3]
i(0, 36256);		-- Embrace of the Twisting Nether [REMOVED: 4.0.3]
i(0, 36129);		-- Heavy Earthforged Breastplate [REMOVED: 4.0.3]
i(0, 34529);		-- Nether Chain Shirt [REMOVED: 4.0.3]
i(0, 36130);		-- Stormforged Hauberk [REMOVED: 4.0.3]
i(0, 34530);		-- Twisting Nether Chain Shirt [REMOVED: 4.0.3]
i(0, 36124);		-- Windforged Leggings [REMOVED: 4.0.3]
-- #endif
--- WEAPONSMITH ---
-- #if BEFORE CATA
i(0, 36125, nil, WEAPONSMITH);	-- Light Earthforged Blade [REMOVED: 4.0.3]
i(0, 36128, nil, WEAPONSMITH);	-- Light Emberforged Hammer [REMOVED: 4.0.3]
i(0, 36126, nil, WEAPONSMITH);	-- Light Skyforged Axe [REMOVED: 4.0.3]
-- #else
i(0, 36125);		-- Light Earthforged Blade [CATA-7.1.5]
i(0, 36128);		-- Light Emberforged Hammer [REMOVED: 4.0.3]
i(0, 36126);		-- Light Skyforged Axe [REMOVED: 4.0.3]
-- #endif
--- AXESMITH ---
-- #if BEFORE CATA
i(0, 34542, nil, MASTER_AXESMITH);	-- Black Planar Edge [REMOVED: 4.0.3]
i(0, 36261, nil, MASTER_AXESMITH);	-- Bloodmoon [REMOVED: 4.0.3]
i(0, 34543, nil, MASTER_AXESMITH);	-- Lunar Crescent [REMOVED: 4.0.3]
i(0, 34544, nil, MASTER_AXESMITH);	-- Mooncleaver [REMOVED: 4.0.3]
i(0, 36135, nil, MASTER_AXESMITH);	-- Skyforged Great Axe [REMOVED: 4.0.3]
i(0, 36134, nil, MASTER_AXESMITH);	-- Stormforged Axe [REMOVED: 4.0.3]
i(0, 34541, nil, MASTER_AXESMITH);	-- The Planar Edge [REMOVED: 4.0.3]
i(0, 36260, nil, MASTER_AXESMITH);	-- Wicked Edge of the Planes [REMOVED: 4.0.3]
-- #else
i(0, 34542);		-- Black Planar Edge [REMOVED: 4.0.3]
i(0, 36261);		-- Bloodmoon [REMOVED: 4.0.3]
i(0, 34543);		-- Lunar Crescent [REMOVED: 4.0.3]
i(0, 34544);		-- Mooncleaver [REMOVED: 4.0.3]
i(0, 36135);		-- Skyforged Great Axe [CATA-7.1.5]
i(0, 36134);		-- Stormforged Axe [CATA-7.1.5]
i(0, 34541);		-- The Planar Edge [REMOVED: 4.0.3]
i(0, 36260);		-- Wicked Edge of the Planes [REMOVED: 4.0.3]
-- #endif
--- HAMMERSMITH ---
-- #if BEFORE CATA
i(0, 34548, nil, MASTER_HAMMERSMITH);	-- Deep Thunder [REMOVED: 4.0.3]
i(0, 34546, nil, MASTER_HAMMERSMITH);	-- Dragonmaw [REMOVED: 4.0.3]
i(0, 36262, nil, MASTER_HAMMERSMITH);	-- Dragonstrike [REMOVED: 4.0.3]
i(0, 34545, nil, MASTER_HAMMERSMITH);	-- Drakefist Hammer [REMOVED: 4.0.3]
i(0, 36137, nil, MASTER_HAMMERSMITH);	-- Great Earthforged Hammer [REMOVED: 4.0.3]
i(0, 36136, nil, MASTER_HAMMERSMITH);	-- Lavaforged Warhammer [REMOVED: 4.0.3]
i(0, 36263, nil, MASTER_HAMMERSMITH);	-- Stormherald [REMOVED: 4.0.3]
i(0, 34547, nil, MASTER_HAMMERSMITH);	-- Thunder [REMOVED: 4.0.3]
-- #else
i(0, 34548);		-- Deep Thunder [REMOVED: 4.0.3]
i(0, 34546);		-- Dragonmaw [REMOVED: 4.0.3]
i(0, 34545);		-- Drakefist Hammer [REMOVED: 4.0.3]
i(0, 36262);		-- Dragonstrike [REMOVED: 4.0.3]
i(0, 36137);		-- Great Earthforged Hammer [CATA-7.1.5]
i(0, 36136);		-- Lavaforged Warhammer [CATA-7.1.5]
i(0, 34547);		-- Thunder [REMOVED: 4.0.3]
i(0, 36263);		-- Stormherald [REMOVED: 4.0.3]
-- #endif
--- SWORDSMITH ---
-- #if BEFORE CATA
i(0, 36258, nil, MASTER_SWORDSMITH);	-- Blazefury [REMOVED: 4.0.3]
i(0, 34537, nil, MASTER_SWORDSMITH);	-- Blazeguard [REMOVED: 4.0.3]
i(0, 34535, nil, MASTER_SWORDSMITH);	-- Fireguard [REMOVED: 4.0.3]
i(0, 34538, nil, MASTER_SWORDSMITH);	-- Lionheart Blade [REMOVED: 4.0.3]
i(0, 34540, nil, MASTER_SWORDSMITH);	-- Lionheart Champion [REMOVED: 4.0.3]
i(0, 36259, nil, MASTER_SWORDSMITH);	-- Lionheart Executioner [REMOVED: 4.0.3]
i(0, 36133, nil, MASTER_SWORDSMITH);	-- Stoneforged Claymore [REMOVED: 4.0.3]
i(0, 36131, nil, MASTER_SWORDSMITH);	-- Windforged Rapier [REMOVED: 4.0.3]
-- #else
i(0, 36258);		-- Blazefury [REMOVED: 4.0.3]
i(0, 34537);		-- Blazeguard [REMOVED: 4.0.3]
i(0, 34535);		-- Fireguard [REMOVED: 4.0.3]
i(0, 34538);		-- Lionheart Blade [REMOVED: 4.0.3]
i(0, 34540);		-- Lionheart Champion [REMOVED: 4.0.3]
i(0, 36259);		-- Lionheart Executioner [REMOVED: 4.0.3]
i(0, 36133);		-- Stoneforged Claymore [CATA-7.1.5]
i(0, 36131);		-- Windforged Rapier [CATA-7.1.5]
-- #endif
...
i(30323, 36391);	-- Boots of the Protector
...
-----------------
--- ITEM ---
i(33186, 42688);	-- Adamantite Weapon Chain [BoE]
...
-----------------
--- ITEM ---
i(35296, 42688);	-- Adamantite Weapon Chain [BoP]
...
-----------------
--- TRAINER ---
i(0, 76666);		-- Blacksmithing (Illustrious) [REMOVED: 8.0.1]
i(0, 76434);		-- Cold-Forged Shank
i(0, 76433);		-- Decapitator's Razor
i(0, 92375);		-- Elementium Rod [REMOVED: 5.0.4]
...
--- TRAINING ---
i(0, 139753);		-- Training Project: Decorative Spoons [REMOVED: 6.0.3]
i(0, 139756);		-- Training Project: Ghost Iron Barrel [REMOVED: 6.0.3]
i(0, 139763);		-- Training Project: Ghost Iron Bells [REMOVED: 6.0.3]
i(0, 139762);		-- Training Project: Ghost Iron Bowls [REMOVED: 6.0.3]
i(0, 139764);		-- Training Project: Ghost Iron Crate [REMOVED: 6.0.3]
i(0, 139761);		-- Training Project: Ghost Iron Cups [REMOVED: 6.0.3]
i(0, 140166);		-- Training Project: Ghost Iron Frames [REMOVED: 6.0.3]
i(0, 139750);		-- Training Project: Ghost Iron Hook [REMOVED: 6.0.3]
i(0, 139748);		-- Training Project: Ghost Iron Ladle [REMOVED: 6.0.3]
i(0, 139755);		-- Training Project: Ghost Iron Needles [REMOVED: 6.0.3]
i(0, 140167);		-- Training Project: Ghost Iron Pans [REMOVED: 6.0.3]
i(0, 140165);		-- Training Project: Ghost Iron Picks [REMOVED: 6.0.3]
i(0, 139745);		-- Training Project: Ghost Iron Pins [REMOVED: 6.0.3]
i(0, 139749);		-- Training Project: Ghost Iron Poker [REMOVED: 6.0.3]
i(0, 139760);		-- Training Project: Ghost Iron Pot [REMOVED: 6.0.3]
i(0, 139757);		-- Training Project: Ghost Iron Saw [REMOVED: 6.0.3]
i(0, 139754);		-- Training Project: Ghost Iron Spade [REMOVED: 6.0.3]
i(0, 139751);		-- Training Project: Ghost Iron Spatulas [REMOVED: 6.0.3]
i(0, 140168);		-- Training Project: Ghost Iron Statue [REMOVED: 6.0.3]
i(0, 139759);		-- Training Project: Ghost Iron Wire [REMOVED: 6.0.3]
i(0, 139747);		-- Training Project: Ghost Iron Wok [REMOVED: 6.0.3]
i(0, 139746);		-- Training Project: Simple Eating Utensils [REMOVED: 6.0.3]
...
-----------------
--- TRAINER ---
i(0, 158737);		-- Blacksmithing (Draenor Master) [REMOVED: 8.0.1]
...
-----------------
--- ITEM ---
i(127725, 187490);	-- Mighty Steelforged Essence [REMOVED: 10.0.5]
i(127743, 187514);	-- Savage Steelforged Essence [REMOVED: 10.0.5]
i(127727, 187491);	-- Mighty Truesteel Essence [REMOVED: 10.0.5]
i(127745, 187515);	-- Savage Truesteel Essence [REMOVED: 10.0.5]

-----------------
-- PATCH 7.0.3 --
-----------------
--- TRAINER ---
i(0, 195097);		-- Blacksmithing (Legion) [REMOVED: 8.0.1]
...
i(142287, 36137);	-- Great Earthforged Hammer [7.1.5+]
i(142286, 36136);	-- Lavaforged Warhammer [7.1.5+]
i(142402, 36125);	-- Light Earthforged Blade [7.1.5+]
i(142283, 36135);	-- Skyforged Great Axe [7.1.5+]
i(142282, 36134);	-- Stormforged Axe [7.1.5+]
i(142284, 36133);	-- Stoneforged Claymore [7.1.5+]
i(142279, 36131);	-- Windforged Rapier [7.1.5+]
