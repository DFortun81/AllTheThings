...
i(19447, 23802);	-- Healing Power [Bracers] (P3)
i(20730, 25079);	-- Healing Power [Golves] (P5)
...
i(19444, 23799);	-- Strength [Weapon] (P3)
...
i(22542, 27948);	-- Vitality [Boots]
i(35298, 27948);	-- Vitality (2.4.0+) [Boots]
-- REMOVED --
...
-- REMOVED --
i(0, 42613);		-- Nexus Transformation
...
-- REMOVED --
i(33307, 42974);	-- Executioner
i(78348, 42974);	-- Executioner (4.3.0+)
...
i(37343, 0);		-- Formula: Enchant Weapon - Exceptional Agility
...
-----------------
-- NYI --
i(37341, 0);		-- Formula: Enchant Boots - Superior Agility
i(37337, 0);		-- Formula: Enchant Bracer - Greater Stats
i(37336, 0);		-- Formula: Enchant Chest - Greater Dodge
...
-- NYI --
i(84582, 0);		-- Formula: Enchant Weapon - Windsong
...
-- REMOVED --
i(0, 158716);		-- Enchanting (Draenor Master) (8.0.1)
i(0, 158910);		-- Breath of Multistrike [Ring] (7.0.3)
i(118431, 158880);	-- Breath of Multistrike [Cloak] (7.0.3)
i(118441, 158895);	-- Breath of Multistrike [Neck] (7.0.3)
i(118436, 158887);	-- Gift of Multistrike [Cloak] (7.0.3)
i(118446, 158902);	-- Gift of Multistrike [Neck] (7.0.3)
