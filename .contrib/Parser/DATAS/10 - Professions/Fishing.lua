root(ROOTS.Professions, prof(FISHING, bubbleDownSelf({ ["requireSkill"] = FISHING }, {
	n(ACHIEVEMENTS, bubbleDownSelf({ ["timeline"] = { ADDED_3_0_3 } }, {
	...
	expansion(EXPANSION.CLASSIC, bubbleDownSelf({ ["timeline"] = { ADDED_3_0_3 } }, {
	...
	expansion(EXPANSION.TBC, bubbleDownSelf({ ["timeline"] = { ADDED_3_0_3 } }, {
