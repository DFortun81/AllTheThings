...
--]]
	n(-5352, {	-- Tier Sets
		...
		--[[n(-3166, {	-- Tier 15 (Throne of Thunder)	-- WIP
			--["achievementID"] = 
			["g"] = {
				d(17, {	-- LFR
					gs(576, {	-- Battleplate of the All-Consuming Maw
					...
					gs(562, {	-- Vestments of the Haunted Forest
					...
					gs(543, {	-- Battlegear of the Saurok Stalker
					...
					gs(528, {	-- Regalia of the Chromatic Hydra
					...
					gs(492, {	-- Battlegear of the Lightning Emperor
					...
					gs(335, {	-- Regalia of the Exorcist
					...
					gs(426, {	-- Regalia of the Witch Doctor
					...
					gs(459, {	-- Regalia of the Thousandfold Hells
					...
					gs(442, {	-- Battleplate of the Last Mogu
				...
				d(14, {	-- Normal
					gs(575, {	-- Battleplate of the All-Consuming Maw
					...
					gs(560, {	-- Vestments of the Haunted Forest
					...
					gs(542, {	-- Battlegear of the Saurok Stalker
					...
					gs(526, {	-- Regalia of the Chromatic Hydra
					...
					gs(490, {	-- Battlegear of the Lightning Emperor
					...
					gs(310, {	-- Regalia of the Exorcist
					...
					gs(424, {	-- Regalia of the Witch Doctor
					...
					gs(458, {	-- Regalia of the Thousandfold Hells
					...
					gs(441, {	-- Battleplate of the Last Mogu
				...
				d(15, {	-- Heroic
					gs(577, {	-- Battleplate of the All-Consuming Maw
					...
					gs(561, {	-- Vestments of the Haunted Forest
					...
					gs(544, {	-- Battlegear of the Saurok Stalker
					...
					gs(527, {	-- Regalia of the Chromatic Hydra
					...
					gs(491, {	-- Battlegear of the Lightning Emperor
					...
					gs(334, {	-- Regalia of the Exorcist
					...
					gs(425, {	-- Regalia of the Witch Doctor
					...
					gs(460, {	-- Regalia of the Thousandfold Hells
					...
					gs(443, {	-- Battleplate of the Last Mogu
