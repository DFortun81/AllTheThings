...
root("GearSets", n(CLASS_TRIAL, {
	n(MOP_HEADER, bubbleDown({["u"] = REMOVED_FROM_GAME}, {
		n(LEVEL_NINETY, {
			["description"] = "These were obtained by creating a Level 90 Class Trial for each class and specialization.", -- This gear was awarded if you used your Lv90 boost before 6.0.1
			["lvl"] = 90,
			["groups"] = {
				cl(DEATHKNIGHT, {
