			...
			["groups"] = {
				n(-140, {	-- Communal
					...
					["groups"] = {
						...
						un(1, i(153940)),	-- Communal Robe	NYI
						i(153929),	-- Communal Vestments	*LA0104
						un(1, i(153943)),	-- Communal Bindings	NYI
						i(153933),	-- Communal Wristwraps	*LA0104
						un(1, i(153937)),	-- Communal Gloves	NYI
						i(153922),	-- Communal Handwraps	*LA0104
						i(153932),	-- Communal Cord	*LA0104
						un(1, i(153942)),	-- Communal Sash	NYI
						i(153924),	-- Communal Leggings	*LA0104
						un(1, i(153939)),	-- Communal Pants	NYI
						un(1, i(153936)),	-- Communal Boots	NYI
						i(153921),	-- Communal Sandals	*LA0104
						un(1, i(153916)),	-- Communal Band of Destruction	NYI
						i(153927),	-- Communal Band of Wisdom	*LA0104
						un(1, i(153917)),	-- Communal Ring of Destruction	NYI
						i(153928),	-- Communal Ring of Wisdom	*LA0104
						un(1, i(153918)),	-- Communal Stone of Destruction	NYI
						i(153930),	-- Communal Stone of Wisdom	*LA0104
						un(1, i(153915)),	-- Communal Idol of Destruction	NYI
