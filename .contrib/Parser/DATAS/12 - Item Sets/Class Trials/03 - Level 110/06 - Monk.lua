				...
				n(-144, {	-- Mistdancer
					...
					["groups"] = {
						...
						{	-- Mistdancer Hood
							...
							["u"] = REMOVED_FROM_GAME,	-- Only available if you boosted a Mistweaver Monk.
						},
						{	-- Mistdancer Amulet
							["itemID"] = 153831,	-- Mistdancer Amulet
							["u"] = REMOVED_FROM_GAME,	-- Only available if you boosted a Brewmaster Monk. [Crieve's Monk "Meditarp".]
						},
						{	-- Mistdancer Choker
