...
_.GearSets =
{
	n(-573, {	-- Scroll of Resurrection
		...
		["crs"] = {
			71304,	-- Iris Moondreamer <Quartermaster>
			36915,	-- Erunak Stonespeaker <The Earthen Ring>
			41618,	-- Erunak Stonespeaker <The Earthen Ring>
		},
		["coords"] = {
			{ 62.8, 24.2, 198},	-- Iris Moondreamer <Quartermaster>
