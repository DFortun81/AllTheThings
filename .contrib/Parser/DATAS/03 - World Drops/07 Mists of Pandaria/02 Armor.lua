	...
	tier(MOP_TIER, {
		n(ARMOR, {
			n(HEAD, {
				...
				i(87453),	-- Endwyn's Toothy Visage
				i(87454),	-- Light-Sealed Casque
				i(87455),	-- Davidian's All-Seeing Eyes
			...
			n(SHOULDER, {
				...
				i(87492),	-- Mantle of Bestial Force
				i(87493),	-- Enokian Growth Shoulderguards
			...
			n(BACK, {
				...
				i(82171),	-- Grummle Cloak
				i(82226),	-- Bejeweled Cloak
				i(82281),	-- Immaculate Cloak
				i(87427),	-- Blade-Dulling Greatcloak
				i(87428),	-- Aquino's Cloak of Unity
				i(87429),	-- Drape of Flowing Gauze
				i(87430),	-- Brilliant Cloak of Wu the Younger
				i(87431),	-- Roffle's Flowing Raiment
				i(90578),	-- Zom's Rain-Stained Cloak
				i(90580),	-- Cristof's Crushing Cloak
			...
			n(CHEST, {
				...
				i(87484),	-- Robes of the Quiet Isle
				i(87485),	-- Robes of Forgone Hope
				i(90577),	-- Boblet's Bouncing Hauberk
			...
			n(HANDS, {
				...
				i(87446),	-- Gauntlets of the Solemn Charge
				i(87447),	-- Toad-Slime Gloves
				i(87448),	-- Toremu's Crackling Grips
				i(87449),	-- Errick's Woundbinder Gauntlets
			...
			n(WAIST, {
				...
				i(87504),	-- Waistguard of Flaming Words
				i(87505),	-- Spirit-Speaking Belt
			...
			n(LEGS, {
				...
				i(87462),	-- Leggings of Perfect Balance
				i(87463),	-- Very Manly Leggings
