		...
		["g"] = {
			d(NORMAL_DUNGEON, {
				cr(101995, e(1693, {	-- Festerface
					...
					i(134468),	-- Gloves of Flesh-Shaping
					i(137436),	-- Pustulous Girdle
				...
				cr(101951, e(1694, {	-- Shivermaw
					...
					i(134434),	-- Cinch of Freezing Fog
					i(134523),	-- Etched Dragonbone Warboots
					i(134445),	-- Frostcarver Grips
				...
				cr(102431, e(1702, {	-- Blood-Princess Thal'ena
					...
					i(134457),	-- Sash of the Twilight Princess
				...
				cr(101976, e(1688, {	-- Millificent Manastorm
					...
					i(134450),	-- D-Lux Slipstream Pants
					i(134534),	-- Dingy Wedding Band
					i(137446),	-- Elementium Bomb Squirrel Generator
					i(134502),	-- Exo-Mesh Carpalform Armplates Mk. VII
				...
				cr(102246, e(1696, {	-- Anub'esset
					...
					i(134506),	-- Legplates of the Swarm
