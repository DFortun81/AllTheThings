	...
	inst(1273, {	-- Nerub'ar Palace
		...
		["g"] = {
			...
			Difficulty(DIFFICULTY.RAID.MULTI.HEROIC_PLUS).AddGroups({
				...
				BossOnly(SILKEN_COURT),
				BossOnly(ANSUREK, {
					ach(40253, {["timeline"] = { ADDED_11_0_1_LAUNCH, REMOVED_11_1_0 }}),	-- Ahead of the Curve: Queen Ansurek
				}),
			}),
			...
			Difficulty(DIFFICULTY.RAID.MYTHIC).AddGroups({
				...
				Boss(ANSUREK, {
					...
					ach(40254, {["timeline"] = { ADDED_11_0_1_LAUNCH, REMOVED_11_1_0 }}),	-- Cutting Edge: Queen Ansurek
					ach(40259, bubbleDownSelf({["timeline"] = { ADDED_11_0_1_LAUNCH, REMOVED_11_1_0 } }, {	-- Hall of Fame: Queen Ansurek
