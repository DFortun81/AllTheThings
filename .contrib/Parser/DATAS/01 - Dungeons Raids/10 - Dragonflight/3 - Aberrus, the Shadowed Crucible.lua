...
root(ROOTS.Instances, tier(DF_TIER, bubbleDown({ ["timeline"] = { ADDED_10_1_0 } }, {
	inst(1208, {	-- Aberrus, the Shadowed Crucible
		...
		["g"] = {
			...
			d(LFR_RAID, {
				n(ZONE_DROPS, {
					i(204410, bubbleDown({ ["modID"] = 3 }, { i(204410)})),	-- Bands of Purified Purpose
					i(204411, bubbleDown({ ["modID"] = 3 }, { i(204411)})),	-- Crucible Curator's Wingspan
					i(204429, bubbleDown({ ["modID"] = 3 }, { i(204429)})),	-- Devoted Warden's Gaze
					i(204423, bubbleDown({ ["modID"] = 3 }, { i(204423)})),	-- Faulds of Failed Experiments
					i(204414, bubbleDown({ ["modID"] = 3 }, { i(204414)})),	-- Laboratory Assistant's Abductors
					i(204415, bubbleDown({ ["modID"] = 3 }, { i(204415)})),	-- Mantle of Sunless Kindling
					i(204430, bubbleDown({ ["modID"] = 3 }, { i(204430)})),	-- Sanctum Guard's Forgewalkers
					i(204422, bubbleDown({ ["modID"] = 3 }, { i(204422)})),	-- Sundered Edgelord's Breastplate
				...
				header(HEADERS.Achievement, 18163, {	-- Discarded Works
					e(2522, {	-- Kazzara, the Hellforged
						["crs"] = { 201261 },	-- Kazzara, the Hellforged
						["g"] = {
							i(202594, bubbleDown({ ["modID"] = 3 }, { i(202594)})),	-- Bloodstench Skinguards
							i(202576, bubbleDown({ ["modID"] = 3 }, { i(202576)})),	-- Dreadrift Stompers
							i(202616, bubbleDown({ ["modID"] = 3 }, { i(202616)})),	-- Enduring Dreadplate
							i(202573, bubbleDown({ ["modID"] = 3 }, { i(202573)})),	-- Etchings of the Captive Revenant
							i(202583, bubbleDown({ ["modID"] = 3 }, { i(202583)})),	-- Grasps of Welded Anguish
							i(202557, bubbleDown({ ["modID"] = 3 }, { i(202557)})),	-- Hellsteel Mutilator
							i(202559, bubbleDown({ ["modID"] = 3 }, { i(202559)})),	-- Infernal Shadelance
							i(202590, bubbleDown({ ["modID"] = 3 }, { i(202590)})),	-- Kazzara's Grafted Companion
							i(202600, bubbleDown({ ["modID"] = 3 }, { i(202600)})),	-- Reanimator's Wicked Cassock
							i(202589, bubbleDown({ ["modID"] = 3 }, { i(202589)})),	-- Sash of Abandoned Hope
							i(202612, bubbleDown({ ["modID"] = 3 }, { i(202612)})),	-- Screaming Black Dragonscale
							i(202602, bubbleDown({ ["modID"] = 3 }, { i(202602)})),	-- Violent Gravemask
					...
					e(2529, {	-- The Amalgamation Chamber
						...
						["g"] = {
							i(202652, bubbleDown({ ["modID"] = 3 }, { i(202652)})),	-- Discarded Creation's Restraint
							i(202579, bubbleDown({ ["modID"] = 3 }, { i(202579)})),	-- Attendant's Concocting Cover
							i(202598, bubbleDown({ ["modID"] = 3 }, { i(202598)})),	-- Cuirass of Meticulous Mixture
							i(202617, bubbleDown({ ["modID"] = 3 }, { i(202617)})),	-- Elementium Pocket Anvil
							i(202572, bubbleDown({ ["modID"] = 3 }, { i(202572)})),	-- Entropic Convergence Loop
							i(202605, bubbleDown({ ["modID"] = 3 }, { i(202605)})),	-- Gloomfused Chemistry Belt
							i(202563, bubbleDown({ ["modID"] = 3 }, { i(202563)})),	-- Obsidian Stirring Staff
							i(202568, bubbleDown({ ["modID"] = 3 }, { i(202568)})),	-- Scholar's Thinking Cudgel
							i(202595, bubbleDown({ ["modID"] = 3 }, { i(202595)})),	-- Shoulderplates of Planar Isolation
							i(202596, bubbleDown({ ["modID"] = 3 }, { i(202596)})),	-- Tassets of Blistering Twilight
							i(202593, bubbleDown({ ["modID"] = 3 }, { i(202593)})),	-- Unstable Vial Handlers
							i(202615, bubbleDown({ ["modID"] = 3 }, { i(202615)})),	-- Vessel of Searing Shadow
						},
					}),
					e(2530, {	-- The Forgotten Experiments
						["crs"] = {
						...
						["g"] = {
							i(202624, {	-- Dreadful Mixing Fluid
								i(202462, bubbleDown({ ["modID"] = 3 }, { i(202462)})),	-- Lingering Phantom's Gauntlets
								i(202525, bubbleDown({ ["modID"] = 3 }, { i(202525)})),	-- Kinslayer's Bloodstained Grips
								i(202534, bubbleDown({ ["modID"] = 3 }, { i(202534)})),	-- Grips of the Sinister Savant
							}),
							i(202625, {	-- Mystic Mixing Fluid
								i(202516, bubbleDown({ ["modID"] = 3 }, { i(202516)})),	-- Handguards of the Autumn Blaze
								i(202480, bubbleDown({ ["modID"] = 3 }, { i(202480)})),	-- Ashen Predator's Skinners
								i(202552, bubbleDown({ ["modID"] = 3 }, { i(202552)})),	-- Underlight Conjurer's Gloves
							}),
							i(202626, {	-- Venerated Mixing Fluid
								i(202453, bubbleDown({ ["modID"] = 3 }, { i(202453)})),	-- Heartfire Sentinel's Protectors
								i(202543, bubbleDown({ ["modID"] = 3 }, { i(202543)})),	-- Grasp of the Furnace Seraph
								i(202471, bubbleDown({ ["modID"] = 3 }, { i(202471)})),	-- Knuckles of the Cinderwolf
							}),
							i(202638, {	-- Zenith Mixing Fluid
								i(202489, bubbleDown({ ["modID"] = 3 }, { i(202489)})),	-- Claws of Obsidian Secrets
								i(202507, bubbleDown({ ["modID"] = 3 }, { i(202507)})),	-- Fists of the Vermillion Forge
								i(202498, bubbleDown({ ["modID"] = 3 }, { i(202498)})),	-- Lurking Specter's Handgrips
								i(202444, bubbleDown({ ["modID"] = 3 }, { i(202444)})),	-- Handguards of the Onyx Crucible
							}),
							i(202652, bubbleDown({ ["modID"] = 3 }, { i(202652)})),	-- Discarded Creation's Restraint
							i(202588, bubbleDown({ ["modID"] = 3 }, { i(202588)})),	-- Exacting Augmenter's Sabatons
							i(202571, bubbleDown({ ["modID"] = 3 }, { i(202571)})),	-- Experiment 1, Kitewing
							i(202582, bubbleDown({ ["modID"] = 3 }, { i(202582)})),	-- Manacles of Cruel Progress
							i(202575, bubbleDown({ ["modID"] = 3 }, { i(202575)})),	-- Neldris's Sinewy Scapula
							i(203729, bubbleDown({ ["modID"] = 3 }, { i(203729)})),	-- Ominous Chromatic Essence
							i(202566, bubbleDown({ ["modID"] = 3 }, { i(202566)})),	-- Rionthus's Bladed Visage
							i(204318, bubbleDown({ ["modID"] = 3 }, { i(204318)})),	-- Thadrion's Erratic Arcanotrode
						},
					}),
				}),
				header(HEADERS.Achievement, 18164, {	-- Fury of Giants
					e(2524, {	-- Assault of the Zaqali
						...
						["g"] = {
							...
							i(202604, bubbleDown({ ["modID"] = 3 }, i(202604))),	-- Boulder-Tossing Bands
							i(202607, bubbleDown({ ["modID"] = 3 }, i(202607))),	-- Brutal Dragonslayer's Trophy
							i(202574, bubbleDown({ ["modID"] = 3 }, i(202574))),	-- Flamebound Huntsman's Footpads
							i(202591, bubbleDown({ ["modID"] = 3 }, i(202591))),	-- Gatecrasher Giant's Coif
							i(202618, bubbleDown({ ["modID"] = 3 }, i(202618))),	-- Kagni's Scorching Talisman
							i(202580, bubbleDown({ ["modID"] = 3 }, i(202580))),	-- Mystic's Scalding Frame
							i(202597, bubbleDown({ ["modID"] = 3 }, i(202597))),	-- Obsidian Guard's Chausses
							i(202578, bubbleDown({ ["modID"] = 3 }, i(202578))),	-- Phoenix-Plume Gloves
							i(202577, bubbleDown({ ["modID"] = 3 }, i(202577))),	-- Seal of the Defiant Hordes
							i(204279, bubbleDown({ ["modID"] = 3 }, i(204279))),	-- Wallclimber's Incursion Hatchet
							i(202586, bubbleDown({ ["modID"] = 3 }, i(202586))),	-- Warlord's Volcanic Vest
							i(202613, bubbleDown({ ["modID"] = 3 }, i(202613))),	-- Zaqali Chaos Grapnel
						},
					}),
					e(2525, {	-- Rashok, the Elder
						["crs"] = { 201320 },	-- Rashok, the Elder
						["g"] = {
							i(202634, {	-- Dreadful Cooling Fluid
								i(202460, bubbleDown({ ["modID"] = 3 }, { i(202460)})),	-- Lingering Phantom's Schynbalds
								i(202523, bubbleDown({ ["modID"] = 3 }, { i(202523)})),	-- Kinslayer's Legguards
								i(202532, bubbleDown({ ["modID"] = 3 }, { i(202532)})),	-- Leggings of the Sinister Savant
							}),
							i(202635, {	-- Mystic Cooling Fluid
								i(202514, bubbleDown({ ["modID"] = 3 }, { i(202514)})),	-- Pants of the Autumn Blaze
								i(202478, bubbleDown({ ["modID"] = 3 }, { i(202478)})),	-- Ashen Predator's Poleyns
								i(202550, bubbleDown({ ["modID"] = 3 }, { i(202550)})),	-- Underlight Conjurer's Trousers
							}),
							i(202636, {	-- Venerated Cooling Fluid
								i(202451, bubbleDown({ ["modID"] = 3 }, { i(202451)})),	-- Heartfire Sentinel's Faulds
								i(202541, bubbleDown({ ["modID"] = 3 }, { i(202541)})),	-- Breeches of the Furnace Seraph
								i(202469, bubbleDown({ ["modID"] = 3 }, { i(202469)})),	-- Braies of the Cinderwolf
							}),
							i(202640, {	-- Zenith Cooling Fluid
								i(202487, bubbleDown({ ["modID"] = 3 }, { i(202487)})),	-- Chausses of Obsidian Secrets
								i(202505, bubbleDown({ ["modID"] = 3 }, { i(202505)})),	-- Pantaloons of the Vermillion Forge
								i(202496, bubbleDown({ ["modID"] = 3 }, { i(202496)})),	-- Lurking Specter's Tights
								i(202442, bubbleDown({ ["modID"] = 3 }, { i(202442)})),	-- Legplates of the Onyx Crucible
							}),
							i(204319, bubbleDown({ ["modID"] = 3 }, { i(204319)})),	-- Bloodfire Extraction Conduit
							i(202569, bubbleDown({ ["modID"] = 3 }, { i(202569)})),	-- Djaruun, Pillar of the Elder Flame
							i(202655, bubbleDown({ ["modID"] = 3 }, { i(202655)})),	-- Elder's Volcanic Binding
							i(202614, bubbleDown({ ["modID"] = 3 }, { i(202614)})),	-- Rashok's Molten Heart
							i(202603, bubbleDown({ ["modID"] = 3 }, { i(202603)})),	-- Sandals of Ancient Fury
							-- TODO: hopefully blizzard fixes this without the bonusID. test with /att i:202659.04
							-- IDK how to bubble down this item
							i(202659, {["bonusID"]=451}),	-- Shackles of the Shadowed Bastille
							i(204466, bubbleDown({ ["modID"] = 3 }, { i(204466)})),	-- Tormentor's Siphoning Signet
							i(202592, bubbleDown({ ["modID"] = 3 }, { i(202592)})),	-- Unyielding Goliath's Burgonet
						},
					}),
					e(2532, {	-- The Vigilant Steward, Zskarn
						["crs"] = {
						...
						["g"] = {
							i(202631, {	-- Dreadful Ventilation Fluid
								i(202464, bubbleDown({ ["modID"] = 3 }, { i(202464)})),	-- Lingering Phantom's Plackart
								i(202527, bubbleDown({ ["modID"] = 3 }, { i(202527)})),	-- Kinslayer's Vest
								i(202536, bubbleDown({ ["modID"] = 3 }, { i(202536)})),	-- Cursed Robes of the Sinister Savant
							}),
							i(202632, {	-- Mystic Ventilation Fluid
								i(202518, bubbleDown({ ["modID"] = 3 }, { i(202518)})),	-- Chestroots of the Autumn Blaze
								i(202482, bubbleDown({ ["modID"] = 3 }, { i(202482)})),	-- Ashen Predator's Sling Vest
								i(202554, bubbleDown({ ["modID"] = 3 }, { i(202554)})),	-- Underlight Conjurer's Vestment
							}),
							i(202633, {	-- Venerated Ventilation Fluid
								i(202455, bubbleDown({ ["modID"] = 3 }, { i(202455)})),	-- Heartfire Sentinel's Brigandine
								i(202545, bubbleDown({ ["modID"] = 3 }, { i(202545)})),	-- Command of the Furnace Seraph
								i(202473, bubbleDown({ ["modID"] = 3 }, { i(202473)})),	-- Adornments of the Cinderwolf
							}),
							i(202639, {	-- Zenith Ventilation Fluid
								i(202491, bubbleDown({ ["modID"] = 3 }, { i(202491)})),	-- Hauberk of Obsidian Secrets
								i(202509, bubbleDown({ ["modID"] = 3 }, { i(202509)})),	-- Cuirass of the Vermillion Forge
								i(202500, bubbleDown({ ["modID"] = 3 }, { i(202500)})),	-- Lurking Specter's Brigandine
								i(202446, bubbleDown({ ["modID"] = 3 }, { i(202446)})),	-- Battlechest of the Onyx Crucible
							}),
							i(204393, bubbleDown({ ["modID"] = 3 }, { i(204393)})),	-- Clasps of the Diligent Steward
							i(202610, bubbleDown({ ["modID"] = 3 }, { i(202610)})),	-- Dragonfire Bomb Dispenser
							i(204467, bubbleDown({ ["modID"] = 3 }, { i(204467)})),	-- Drape of the Dracthyr Trials
							i(204391, bubbleDown({ ["modID"] = 3 }, { i(204391)})),	-- Failed Applicant's Footpads
							i(204322, bubbleDown({ ["modID"] = 3 }, { i(204322)})),	-- Failure Disposal Cannon
							i(204320, bubbleDown({ ["modID"] = 3 }, { i(204320)})),	-- Proctor's Tactical Cleaver
							i(204400, bubbleDown({ ["modID"] = 3 }, { i(204400)})),	-- Recycled Golemskin Waistguard
							i(202555, bubbleDown({ ["modID"] = 3 }, { i(202555)})),	-- Zskarn's Autopsy Scalpel
					...
					e(2527, {	-- Magmorax
						...
						["g"] = {
							i(202627, {	-- Dreadful Melting Fluid
								i(202461, bubbleDown({ ["modID"] = 3 }, { i(202461)})),	-- Lingering Phantom's Dreadhorns
								i(202524, bubbleDown({ ["modID"] = 3 }, { i(202524)})),	-- Kinslayer's Hood
								i(202533, bubbleDown({ ["modID"] = 3 }, { i(202533)})),	-- Grimhorns of the Sinister Savant
							}),
							i(202628, {	-- Mystic Melting Fluid
								i(202515, bubbleDown({ ["modID"] = 3 }, { i(202515)})),	-- Bough of the Autumn Blaze
								i(202479, bubbleDown({ ["modID"] = 3 }, { i(202479)})),	-- Ashen Predator's Faceguard
								i(202551, bubbleDown({ ["modID"] = 3 }, { i(202551)})),	-- Underlight Conjurer's Arcanocowl
							}),
							i(202629, {	-- Venerated Melting Fluid
								i(202452, bubbleDown({ ["modID"] = 3 }, { i(202452)})),	-- Heartfire Sentinel's Forgehelm
								i(202542, bubbleDown({ ["modID"] = 3 }, { i(202542)})),	-- Mask of the Furnace Seraph
								i(202470, bubbleDown({ ["modID"] = 3 }, { i(202470)})),	-- Spangenhelm of the Cinderwolf
							}),
							i(202630, {	-- Zenith Melting Fluid
								i(202488, bubbleDown({ ["modID"] = 3 }, { i(202488)})),	-- Crown of Obsidian Secrets
								i(202506, bubbleDown({ ["modID"] = 3 }, { i(202506)})),	-- Cover of the Vermillion Forge
								i(202497, bubbleDown({ ["modID"] = 3 }, { i(202497)})),	-- Lurking Specter's Visage
								i(202443, bubbleDown({ ["modID"] = 3 }, { i(202443)})),	-- Thraexhelm of the Onyx Crucible
							}),
							i(202560, bubbleDown({ ["modID"] = 3 }, { i(202560)})),	-- Claws of the Blazing Behemoth
							i(204394, bubbleDown({ ["modID"] = 3 }, { i(204394)})),	-- Cuffs of the Savage Serpent
							i(204395, bubbleDown({ ["modID"] = 3 }, { i(204395)})),	-- Hydratooth Girdle
							i(203996, bubbleDown({ ["modID"] = 3 }, { i(203996)})),	-- Igneous Flowstone
							i(202570, bubbleDown({ ["modID"] = 3 }, { i(202570)})),	-- Lavaflow Control Rod
							i(204397, bubbleDown({ ["modID"] = 3 }, { i(204397)})),	-- Magmorax's Fourth Collar
							i(204396, bubbleDown({ ["modID"] = 3 }, { i(204396)})),	-- Spittle-Resistant Sollerets
					...
					e(2523, {	-- Echo of Neltharion
						...
						["g"] = {
							i(202621, {	-- Dreadful Corrupting Fluid
								i(202459, bubbleDown({ ["modID"] = 3 }, { i(202459)})),	-- Lingering Phantom's Shoulderplates
								i(202522, bubbleDown({ ["modID"] = 3 }, { i(202522)})),	-- Kinslayer's Tainted Spaulders
								i(202531, bubbleDown({ ["modID"] = 3 }, { i(202531)})),	-- Amice of the Sinister Savant
							}),
							i(202622, {	-- Mystic Corrupting Fluid
								i(202513, bubbleDown({ ["modID"] = 3 }, { i(202513)})),	-- Mantle of the Autumn Blaze
								i(202477, bubbleDown({ ["modID"] = 3 }, { i(202477)})),	-- Ashen Predator's Trophy
								i(202549, bubbleDown({ ["modID"] = 3 }, { i(202549)})),	-- Underlight Conjurer's Aurora
							}),
							i(202623, {	-- Venerated Corrupting Fluid
								i(202450, bubbleDown({ ["modID"] = 3 }, { i(202450)})),	-- Heartfire Sentinel's Steelwings
								i(202540, bubbleDown({ ["modID"] = 3 }, { i(202540)})),	-- Devotion of the Furnace Seraph
								i(202468, bubbleDown({ ["modID"] = 3 }, { i(202468)})),	-- Thunderpads of the Cinderwolf
							}),
							i(202637, {	-- Zenith Corrupting Fluid
								i(202486, bubbleDown({ ["modID"] = 3 }, { i(202486)})),	-- Wingspan of Obsidian Secrets
								i(202504, bubbleDown({ ["modID"] = 3 }, { i(202504)})),	-- Spines of the Vermillion Forge
								i(202495, bubbleDown({ ["modID"] = 3 }, { i(202495)})),	-- Lurking Specter's Shoulderblades
								i(202441, bubbleDown({ ["modID"] = 3 }, { i(202441)})),	-- Pauldrons of the Onyx Crucible
							}),
							i(202606, bubbleDown({ ["modID"] = 3 }, { i(202606)})),	-- Ashkandur, Fall of the Brotherhood
							i(202558, bubbleDown({ ["modID"] = 3 }, { i(202558)})),	-- Calamity's Herald
							i(204324, bubbleDown({ ["modID"] = 3 }, { i(204324)})),	-- Echo's Maddening Volume
							i(204201, bubbleDown({ ["modID"] = 3 }, { i(204201)})),	-- Neltharion's Call to Chaos
							i(204202, bubbleDown({ ["modID"] = 3 }, { i(204202)})),	-- Neltharion's Call to Dominance
							i(204211, bubbleDown({ ["modID"] = 3 }, { i(204211)})),	-- Neltharion's Call to Suffering
							i(204398, bubbleDown({ ["modID"] = 3 }, { i(204398)})),	-- Onyx Impostor's Birthright
							i(204392, bubbleDown({ ["modID"] = 3 }, { i(204392)})),	-- Treads of Fractured Realities
							i(202601, bubbleDown({ ["modID"] = 3 }, { i(202601)})),	-- Twisted Vision's Demigaunts
							i(203714, bubbleDown({ ["modID"] = 3 }, { i(203714)})),	-- Ward of Faceless Ire
						},
					}),
				}),
				header(HEADERS.Achievement, 18167, {	-- Edge of the Void
					e(2520, {	-- Scalecommander Sarkareth
						...
						["g"] = {
							...
							i(203963, bubbleDown({ ["modID"] = 3 }, { i(203963)})),	-- Beacon to the Beyond
							i(204390, bubbleDown({ ["modID"] = 3 }, { i(204390)})),	-- Bonds of Desperate Ascension
							i(202585, bubbleDown({ ["modID"] = 3 }, { i(202585)})),	-- Coattails of the Rightful Heir
							...
							i(202584, bubbleDown({ ["modID"] = 3 }, { i(202584)})),	-- Scalecommander's Ebon Schynbalds
