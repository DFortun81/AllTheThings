...
root(ROOTS.Craftables, expansion(EXPANSION.DF, bubbleDownSelf({ ["timeline"] = { ADDED_10_0_2_LAUNCH } }, {
	...
	prof(ENCHANTING, {
		...
		n(FIRST_CRAFTS_HEADER, sharedData({
			...
			-- Infusions of Power
			--FirstCraft(79001, 429947, ADDED_10_2_6_SEASON_FOUR);		-- Enchanted Aspect's Awakened Crest
			...
			--FirstCraft(79002, 429945, ADDED_10_2_6_SEASON_FOUR);		-- Enchanted Wyrm's Awakened Crest
