		...
		m(1525, {	-- Revendreth
			...
			-- Welcome to Revendreth
				...
				q(58272, {	-- Words Have Power
					["provider"] = { "o", 352490 },	-- Join the Rebellion!						-- Need to add the Object
			...
			-- The Rebellion (The Penitent Hunt)
				...
				q(58936, {	-- Beast Control
					["provider"] = { "o", 355296 },	-- Bounty: Beast Control						-- Need to add the Object
			...
			-- Revelations of the Light
				...
				q(60276, {	-- WANTED: Summoner Marcelis								-- Need to add the Object
