		...
		m(1161, {	-- Boralus
			n(VENDORS, {
				...
				n(161091, {	-- Captain Nightrunner
					...
					--["races"] = ALLIANCE_ONLY,		-- Commenting out for now.  This causes problems with the vendor tooltips on horde/alliance.
					...
					["g"] = {
						...
						i(163043, {	-- Scouting Report: Grimwatt's Crash
							...
							["g"] = {
								...
								mission(2096, {	-- Ambush at Grimwatt's Crash
									--["questID"] = ,	-- Triggers when completed
									["races"] = ALLIANCE_ONLY,
								...
								q(53186, {	-- Mission Report: Ambush at Grimwatt's Crash
									...
									["races"] = ALLIANCE_ONLY,
									["coord"] = { 70.5, 27.2, 1161 },	-- Boralus
									--["sourceQuests"] = {  },	-- Ambush at Grimwatt's Crash Mission Complete
								}),
