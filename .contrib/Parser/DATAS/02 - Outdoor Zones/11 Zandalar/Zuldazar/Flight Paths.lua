	...
	m(ZULDAZAR, {
		n(FLIGHT_PATHS, {
			...
			fp(2148, {	-- Mugamba Overlook, Zuldazar (A)
				["description"] = "Mugamba Overlook, Zuldazar \n\nRequires completion of Mission Report: Mugamba Overlook and related quest line to unlock.",
				["coord"] = { 44.8, 27.0, ZULDAZAR },
			}),
			fp(1965, {	-- Nesingwary's Gameland, Zuldazar [N]
				["description"] = "Nesingwary's Gameland, Zuldazar",
				["coord"] = { 66.2, 17.6, ZULDAZAR },
			}),
			fp(2126, {	-- Scaletrader Post, Zuldazar [N]
				["description"] = "Scaletrader Post, Zuldazar",
