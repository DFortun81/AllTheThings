	...
	m(VALSHARAH, {
		n(ACHIEVEMENTS, {
			ach(11262, {	-- Adventurer of Val'sharah
				crit(1, {	-- Gorebeak
					["_npcs"] = { 92117 },	-- Gorebeak
				}),
				crit(2, {	-- Seersei
					["_npcs"] = { 92180 },	-- Seersei
				}),
				crit(3, {	-- Theryssia
					["_npcs"] = { 92423 },	-- Theryssia
				}),
				crit(4, {	-- Darkshade
					["_npcs"] = { 92965 },	-- Darkshade
				}),
				crit(5, {	-- Ironbranch
					["_npcs"] = { 93030 },	-- Ironbranch
				}),
				crit(6, {	-- Thondrax
					["_npcs"] = { 93205 },	-- Thondrax
				}),
				crit(7, {	-- Elindya Featherlight
					["_npcs"] = { 92334 },	-- Elindya Featherlight
				}),
				crit(8, {	-- Antydas Nightcaller
					["_npcs"] = { 93758 },	-- Antydas Nightcaller
				}),
				crit(9, {	-- Haunted Manor
					["_npcs"] = { 94414 },	-- Kiranys Duskwhisper
				}),
				crit(10, {	-- Purging the River
					["_npcs"] = { 94485 },	-- Pollous the Fetid
				}),
				crit(11, {	-- Grelda the Hag
					["_npcs"] = { 95123 },	-- Grelda the Hag
				}),
				crit(12, {	-- Old Bear Trap
					["_npcs"] = { 95221 },	-- Mad Henryk
				}),
				crit(13, {	-- Perrexx the Corruptor
					["_npcs"] = { 95318 },	-- Perrexx the Corruptor
				}),
				crit(14, {	-- Wraithtalon
					["_npcs"] = { 97504 },	-- Wraithtalon
				}),
				crit(15, {	-- Dreadbog
					["_npcs"] = { 97517 },	-- Dreadbog
				}),
				crit(16, {	-- Lyrath Moonfeather
					["_npcs"] = { 98241 },	-- Lyrath Moonfeather
				}),
				crit(17, {	-- Undergrell Attack
					["_npcs"] = { 109708 },	-- Undergrell Ringleader
				}),
				crit(18, {	-- Bahagar
					["_npcs"] = { 110562 },	-- Bahagar
				}),
				crit(19, {	-- Unguarded Thistleleaf Treasure
					["_quests"] = { 38466 },	-- Unguarded Thistleleaf Treasure
				}),
