			...
			n(ZONEDROPS, {
				...
				["g"] = sharedData({["b"] = 2}, {
					...
					i(152799, {	-- Unsullied Relic
						i(150996),	-- Archaic Meditation Crystal
						i(151002),	-- Argussian Wrought Blade
						i(151000),	-- Construct Forge Cinder
						i(150998),	-- Cragscaler Heart
						i(150997),	-- Crystallized Aether
						i(151003),	-- Petrified Seedling
						i(151001),	-- Phial of Kaarinos Frost
						i(151015),	-- Skyfin Tail Barb
