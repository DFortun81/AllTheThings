		...
		n(ACHIEVEMENTS, {
			...
			ach(13638, {	-- Undersea Usurper
				...
				ach(13712, {	-- Explore Nazjatar
					crit(1, {	-- Ashen Strand
						["coord"] = { 28.6, 40.7, 1355 },
					}),
					crit(2, {	-- Azsh'ari Terrace
						["coord"] = { 61.5, 24.8, 1355 },
					}),
					crit(3, {	-- Coral Forest
						["coord"] = { 57.5, 50.1, 1355 },
					}),
					crit(4, {	-- Deepcoil Tunnels
						["coord"] = { 66.2, 26.4, 1355 },
					}),
					crit(5, {	-- Dragon's Teeth Basin
						["coord"] = { 48.3, 48.5, 1355 },
					}),
					crit(6, {	-- The Drowned Market
						["coord"] = { 78.2, 44.9, 1355 },
					}),
					crit(7, {	-- Elun'alor Temple
						["coord"] = { 78.8, 33.7, 1355 },
					}),
					crit(8, {	-- The Empress's Approach
						["coord"] = { 47.4, 40.6, 1355 },
					}),
					crit(9, {	-- Gate of the Queen
						["coord"] = { 51.6, 15.2, 1355 },
					}),
					crit(10, {	-- The Hanging Reef
						["coord"] = { 43.1, 60.9, 1355 },
					}),
					crit(11, {	-- Kal'methir
						["coord"] = { 64.2, 42.3, 1355 },
					}),
					crit(12, {	-- Shirakess Repository
						["coord"] = { 60.1, 15.6, 1355 },
					}),
					crit(13, {	-- Spears of Azshara
						["coord"] = { 38.1, 74.1, 1355 },
					}),
					crit(14, {	-- Zanj'ir Terrace
						["coord"] = { 38.1, 28.7, 1355 },
					}),
					crit(15, {	-- Zanj'ir Wash
						["coord"] = { 43.1, 41.1, 1355 },
					}),
					crit(16, {	-- Zin-Azshari
						["coord"] = { 73.2, 31.7, 1355 },
					}),
				}),
