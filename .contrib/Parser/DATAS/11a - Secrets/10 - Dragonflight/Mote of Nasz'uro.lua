...
root(ROOTS.Secrets, tier(DF_TIER, bubbleDown({ ["timeline"] = { ADDED_10_1_0 } }, {
	header(HEADERS.Item, 206040, {	-- Mote of Nasz'uro
		...
		n(TREASURES, sharedData({
			...
			n(205876, { ["questID"] = 76178, ["coord"] = { 22.8, 88.4, THE_WAKING_SHORES }, }),
			n(205876, { ["questID"] = 76179, ["coord"] = { 24.1, 55.6, THE_WAKING_SHORES }, }),
			n(205876, { ["questID"] = 76180, ["coord"] = { 58.5, 67.7, THE_WAKING_SHORES }, }),
			n(205876, { ["questID"] = 76181, ["coord"] = { 63.9, 44.8, THE_WAKING_SHORES }, }),
		})),
	}),
})));