...
_.Mounts =
{
	n(-40, {
		...
		un(REMOVED_FROM_GAME, ach(4079, {	-- A Tribute to Immortality
		...
		un(REMOVED_FROM_GAME, ach(879, {	-- Old School Ride
			...
			un(REMOVED_FROM_GAME, i(12351)),	-- Horn of the Arctic Wolf
			un(REMOVED_FROM_GAME, i(12330)),	-- Horn of the Red Wolf
			un(REMOVED_FROM_GAME, i(13327)),	-- Icy Blue Mechanostrider Mod A
			un(REMOVED_FROM_GAME, i(12354)),	-- Palomino Bridle
			un(REMOVED_FROM_GAME, i(12302)),	-- Reins of the Ancient Frostsaber
