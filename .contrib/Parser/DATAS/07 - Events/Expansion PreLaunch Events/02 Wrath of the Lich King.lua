	...
	n(-520, {	-- Expansion Prelaunch Events
		n(-522, {	-- Wrath of the Lich King
			...
			["groups"] = {
				...
				filter(CLOTH, sharedData({["u"] = REMOVED_FROM_GAME}, {	-- Blessed Regalia of Undead Cleansing
				...
				filter(LEATHER, sharedData({["u"] = REMOVED_FROM_GAME}, {	-- Undead Slayer's Blessed Armor
				...
				filter(MAIL, sharedData({["u"] = REMOVED_FROM_GAME}, {	-- Blessed Garb of the Undead Slayer
				...
				filter(PLATE, sharedData({["u"] = REMOVED_FROM_GAME}, {	-- Blessed Battlegear of the Undead Slaying
