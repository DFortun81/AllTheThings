...
root("PVP", pvp(tier(DF_TIER, {
	n(SEASON_CRIMSON, bubbleDownSelf({ ["timeline"] = TIMELINE_DFREL }, {
		n(ACHIEVEMENTS, {
		...
		n(PVP_ELITE, bubbleDown({ ["bonusID"] = 7532 }, {	-- NOTE TO GOLD: I think this is correct! We just need to do another SourceID Harvester. Will after DF release since atm... Some weps are on beta only. // Braghe
			n(CLASSES, {
				cl(DEATHKNIGHT, {
					i(201911),	-- Crimson Gladiator's Cloak
					i(201912),	-- Crimson Gladiator's Drape
