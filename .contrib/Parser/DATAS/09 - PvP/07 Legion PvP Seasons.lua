				...
				n(PVP_COMBATANT, {
					cl(DEATHKNIGHT, {
						i(146164, {	-- Ensemble: Vindictive Combatant's Dreadplate Armor (A)
							["description"] = "You will need to log out and back in to register Season 2 items, as well as Shift+Click to refresh for your current faction./n/nAn ensemble might not grant every itemID, which neither ATT nor Blizzard can fix.",
				...
				n(PVP_COMBATANT, {
					cl(DEATHKNIGHT, {
						i(147677, {	-- Ensemble: Cruel Combatant's Dreadplate Armor (A)
							["description"] = "You will need to log out and back in to register Season 4 items, as well as Shift+Click to refresh for your current faction./n/nAn ensemble might not grant every itemID, which neither ATT nor Blizzard can fix.",
							["cost"] = { { "i", 137642, 12 } },	-- 12x Mark of Honor
							["sym"] = {
				...
				n(PVP_COMBATANT, {
					cl(DEATHKNIGHT, {
						i(150252, {	-- Ensemble: Fierce Combatant's Dreadplate Armor (A)
							["description"] = "You will need to log out and back in to register Season 6 & 7 items, as well as Shift+Click to refresh for your current faction./n/nAn ensemble might not grant every itemID, which neither ATT nor Blizzard can fix.",
							["cost"] = { { "i", 137642, 12 } },	-- 12x Mark of Honor
							["sym"] = {
