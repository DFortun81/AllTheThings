		...
		["g"] = {
			faction(729, {	-- Frostwolf Clan
				...
				["g"] = {
					...
					n(13419, sharedData({ ["timeline"] = { "added 1.5.0.4442", "removed 1.6.0.4500" } }, {	-- Ivus the Forest Lord
			...
			faction(730, {	-- Stormpike Guards
				...
				["g"] = {
					...
					n(13256, sharedData({ ["timeline"] = { "added 1.5.0.4442", "removed 1.6.0.4500" } }, {	-- Lokholar the Ice Lord
						i(19110),	-- Cold Forged Blade
						i(19105),	-- Frost Runed Headdress
						i(19111),	-- Winteraxe Epaulets
						i(19112),	-- Frozen Steel Vambraces
